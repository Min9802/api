...
+(function () {
    ...
    var DateTimePicker = /*#__PURE__*/ (function () {
            ...
            outpValue =
              (oldDate &&
                outpValue
                  ...
                  .replace(
                    new RegExp(
                      escapeRegExp(this._options.multidateSeparator) + '\\s*$',
                    ),
                    '',
                  )) ||
              '';
        ...
        if (this._isValid(targetMoment)) {
          ...
          if (this._options.allowMultidate && this._dates.length > 1) {
            for (var i = 0; i < this._dates.length; i++) {
              outpValue +=
                '' +
                this._dates[i].format(this.actualFormat) +
                this._options.multidateSeparator;
            }
            ...
            if (this.input !== undefined) {
              this.input.val(
                '' +
                  (this.unset
                    ? ''
                    : this._dates[index].format(this.actualFormat)),
              );
              this.input.trigger('input');
            }
          } else {
      ...
      _proto._dataToOptions = function _dataToOptions() {
        ...
        $.each(this._options, function (key) {
          var attributeName =
            'date' + key.charAt(0).toUpperCase() + key.slice(1); //todo data api key
      ...
      _proto._showMode = function _showMode(dir) {
        ...
        this.widget
          ...
          .hide()
          .filter(
            '.datepicker-' + DatePickerModes[this.currentViewMode].CLASS_NAME,
          )
          .show();
      };
      ...
      _proto._isInEnabledDates = function _isInEnabledDates(testDate) {
        return (
          this._options.enabledDates[testDate.format('YYYY-MM-DD')] === true
        );
      };
      ...
      _proto._parseInputDate = function _parseInputDate(inputDate, _temp) {
        var _ref = _temp === void 0 ? {} : _temp,
          ...
          isPickerShow =
            _ref$isPickerShow === void 0 ? false : _ref$isPickerShow;
      ...
      _proto.updateOnlyThroughDateOption = function updateOnlyThroughDateOption(
        _updateOnlyThroughDateOption,
      ) {
      ...
      _proto.daysOfWeekDisabled = function daysOfWeekDisabled(
        _daysOfWeekDisabled,
      ) {
        if (arguments.length === 0) {
      ...
      _proto.maxDate = function maxDate(_maxDate) {
        ...
        if (!parsedDate.isValid()) {
          throw new TypeError(
            'maxDate() Could not parse date parameter: ' + _maxDate,
          );
        }
      ...
      _proto.minDate = function minDate(_minDate) {
        ...
        if (!parsedDate.isValid()) {
          throw new TypeError(
            'minDate() Could not parse date parameter: ' + _minDate,
          );
        }
      ...
      _proto.defaultDate = function defaultDate(_defaultDate) {
        ...
        if (!parsedDate.isValid()) {
          throw new TypeError(
            'defaultDate() Could not parse date parameter: ' + _defaultDate,
          );
        }
      ...
      _proto.disabledTimeIntervals = function disabledTimeIntervals(
      ...
      _proto.viewDate = function viewDate(newDate) {
        ...
        this._viewUpdate(
          DatePickerModes[this.currentViewMode] &&
      ...
      _proto.multidateSeparator = function multidateSeparator(
        _multidateSeparator,
      ) {
        if (arguments.length === 0) {
  ...
  var TempusDominusBootstrap4 = (function ($) {
    ...
    var TempusDominusBootstrap4 = /*#__PURE__*/ (function (_DateTimePicker) {
      ...
      _proto2._getTimePickerMainTemplate =
      ...
      _proto2._updateYears = function _updateYears() {
        ...
        yearsViewHeader
          .eq(1)
          .attr('title', this._options.tooltips.selectDecade);
        yearsViewHeader
          .eq(2)
          .find('span')
      ...
      _proto2._fillTime = function _fillTime() {
        ...
        var timeComponents = this.widget.find(
      ...
      _proto2.widgetPositioning = function widgetPositioning(
        _widgetPositioning,
      ) {
        if (arguments.length === 0) {
        ...
        if (_widgetPositioning.vertical) {
          ...
          _widgetPositioning.vertical =
            _widgetPositioning.vertical.toLowerCase();
      ...
      TempusDominusBootstrap4._jQueryHandleThis = function _jQueryHandleThis(
        me,
        option,
        argument,
      ) {
      ...
      TempusDominusBootstrap4._jQueryInterface = function _jQueryInterface(
        option,
        argument,
      ) {
        if (this.length === 1) {
          return TempusDominusBootstrap4._jQueryHandleThis(
            this[0],
            option,
            argument,
          );
    ...
    $(document)
      .on(
        DateTimePicker.Event.CLICK_DATA_API,
        DateTimePicker.Selector.DATA_TOGGLE,
        function () {
      ...
      .on(
        ...
        function (event) {
          ...
          TempusDominusBootstrap4._jQueryInterface.call(
            $target,
            '_change',
            event,
          );

!(function (a) {
  ...
  (a.fn.doAutosize = function (b) {
    ...
    (a.fn.addTag = function (d, e) {
      return (
        (e = jQuery.extend({ focus: !1, callback: !0 }, e)),
        this.each(function () {
    ...
    (a.fn.removeTag = function (d) {
      return (
        ...
        this.each(function () {
          ...
          for (
            a('#' + e + '_tagsinput .tag').remove(), str = '', i = 0;
            i < f.length;
            i++
          )
                    ...
                    a(b.data.fake_input).val() != c
                      ? b.data.minChars <= a(b.data.fake_input).val().length &&
                        ...
                        a(b.data.real_input).addTag(
                          a(b.data.fake_input).val(),
                          { focus: !0, unique: f.unique },
                        )
                      : (a(b.data.fake_input).val(
                          a(b.data.fake_input).attr('data-default'),
                        ),
                        a(b.data.fake_input).css('color', f.placeholderColor)),
                    !1
                  );
                });
              a(h.fake_input).bind('keypress', h, function (b) {
                return d(b)
                  ? (b.preventDefault(),
                    ...
                    a(b.data.fake_input).resetAutosize(f),
                    !1)
                  : void (

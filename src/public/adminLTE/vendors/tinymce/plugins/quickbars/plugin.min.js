...
!(function () {
    ...
    a = function (e, t, n) {
      var r,
        ...
        u = i.create(
          ((r = 'mceu'),
          (o = new Date().getTime()),
          r + '_' + Math.floor(1e9 * Math.random()) + ++c + String(o)),
          n,
          t,
        );
      i.add(u), e.insertContent(e.dom.createHTML('img', { src: u.blobUri() }));
    },
    l = tinymce.util.Tools.resolve('tinymce.util.Promise'),
          ...
          (i = u),
            new l(function (n) {
              ...
              var o = function (e) {
                ...
                s.os.isAndroid() && 'remove' !== e.type
                  ? f.setEditorTimeout(i, t, 0)
                  : t(),
              ...
              (e = u).plugins.table
                ...
                : ((o = t),
                  ...
                  (r = e).undoManager.transact(function () {
                    ...
                    var e = r.dom.select('*[data-mce-id]')[0];
                    e.removeAttribute('data-mce-id');
                    var t = r.dom.select('td,th', e);
  ...
  function M(e, t, n, r, o) {
    return e(n, r) ? b.some(n) : E(o) && o(n) ? b.none() : t(n, r, o);
  }
  var S,
    C = function (e) {
    ...
    O = {
      ...
      fromPoint: function (e, t, n) {
        return b.from(e.dom.elementFromPoint(t, n)).map(C);
      },
    },
    x = function (e, t) {
      var n = e.dom;
    ...
    A =
      ...
      function (e, t, n) {
        for (var r = e.dom, o = E(n) ? n : d; r.parentNode; ) {
          r = r.parentNode;
          var i = O.fromDom(r);
      ...
      function (e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            return q(e) ? t : N(e) ? (!1 === e ? '' : t) : e;
          })(e.getParam(t, n), n)
        );
      }),
    L = function (o) {
      var e = _(o, 'quickbars_insert_toolbar', 'quickimage quicktable');
      0 < e.trim().length &&
        o.ui.registry.addContextToolbar('quickblock', {
          predicate: function (e) {
            var t = O.fromDom(e),
              n = o.schema.getTextBlockElements(),
              r = function (e) {
                return e.dom === o.getBody();
              };
            return M(x, D, t, 'table', r).fold(
              function () {
                return M(
                  function (e, t) {
                    return t(e);
                  ...
                  function (e) {
                    return (
                      e.dom.nodeName.toLowerCase() in n && o.dom.isEmpty(e.dom)
                    );
                  },
                  r,
                ).isSome();
    ...
    P = function (n) {
      var r = function (e) {
          return (
            'IMG' === e.nodeName ||
            ('FIGURE' === e.nodeName && /image/i.test(e.className))
          );
        },
        e = _(n, 'quickbars_image_toolbar', 'alignleft aligncenter alignright');
      0 < e.trim().length &&
        ...
        n.ui.registry.addContextToolbar('textselection', {
          predicate: function (e) {
            return (
              ...
              ((t = e), 'false' !== n.dom.getContentEditableParent(t))
            );
            var t;
          },
          items: t,

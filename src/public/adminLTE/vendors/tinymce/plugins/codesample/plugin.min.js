...
!(function () {
  ...
  var f = 'undefined' != typeof window ? window : Function('return this;')(),
    h = {},
    b = { exports: h },
    y = {};
  !(function (n, t, r, p) {
    ...
    (window.Prism = { manual: !0 }),
      (function (e) {
        ...
        return (function c(s, i, o) {
          ...
          for (var u = 'function' == typeof p && p, e = 0; e < o.length; e++)
            l(o[e]);
          return l;
        })(
          {
                  ...
                  (function () {
                    var e = (function (u) {
                        ...
                        O = {
                          ...
                          util: {
                            encode: function a(e) {
                              return e instanceof N
                                ? new N(e.type, a(e.content), e.alias)
                                : Array.isArray(e)
                                ? e.map(a)
                                : e
                                    .replace(/&/g, '&amp;')
                            ...
                            clone: function i(e, t) {
                              ...
                              switch (((t = t || {}), O.util.type(e))) {
                                case 'Object':
                                  if (((n = O.util.objId(e)), t[n]))
                                    return t[n];
                                  for (var a in ((r = {}), (t[n] = r), e))
                                    e.hasOwnProperty(a) && (r[a] = i(e[a], t));
                                  return r;
                                case 'Array':
                                  return ((n = O.util.objId(e)), t[n])
                                    ? t[n]
                                    : ((r = []),
                                      (t[n] = r),
                            ...
                            DFS: function l(e, n, t, r) {
                              ...
                              for (var o in e) {
                                e.hasOwnProperty(o) &&
                                  (n.call(e, o, e[o], t || o),
                                  (a = e[o]),
                                  'Object' !== (s = O.util.type(a)) || r[i(a)]
                                    ? 'Array' !== s ||
                                      r[i(a)] ||
                                      ((r[i(a)] = !0), l(a, n, o, r))
                                    : ((r[i(a)] = !0), l(a, n, null, r)));
                              }
                            },
                          },
                          plugins: {},
                          ...
                          highlightAllUnder: function (e, n, t) {
                            ...
                            for (var a, s = 0; (a = r.elements[s++]); )
                              O.highlightElement(a, !0 === n, r.callback);
                          },
                          highlightElement: function (e, n, t) {
                            ...
                            function l(e) {
                              (o.highlightedCode = e),
                                O.hooks.run('before-insert', o),
                                (o.element.innerHTML = o.highlightedCode),
                                O.hooks.run('after-highlight', o),
                                O.hooks.run('complete', o),
                                t && t.call(o.element);
                            }
                            if (
                              (O.hooks.run('before-sanity-check', o), !o.code)
                            )
                              return (
                                O.hooks.run('complete', o),
                                void (t && t.call(o.element))
                              );
                            O.hooks.run('before-highlight', o),
                              o.grammar
                                ? n && u.Worker
                                  ? (((i = new Worker(O.filename)).onmessage =
                                      function (e) {
                                        l(e.data);
                                      }),
                                    i.postMessage(
                          ...
                          highlight: function (e, n, t) {
                            ...
                            return (
                              ...
                              N.stringify(O.util.encode(r.tokens), r.language)
                            );
                          },
                                        ...
                                        if (!(v instanceof N)) {
                                          ...
                                          if (g && b != n.tail.prev) {
                                            ...
                                            var $ =
                                              ...
                                              E = y;
                                            for (E += b.value.length; E <= $; )
                                              (b = b.next),
                                                (E += b.value.length);
                                            if (
                                              ((E -= b.value.length),
                                              (y = E),
                                              b.value instanceof N)
                                            )
                                              continue;
                                            for (
                                              var z = b;
                      ...
                      return (
                        t &&
                          ((O.filename = t.src),
                          t.hasAttribute('data-manual') && (O.manual = !0)),
                        O.manual ||
                          ('loading' === (e = document.readyState) ||
                          ('interactive' === e && t && t.defer)
              ...
              function (e, n, t) {
                !(function (t) {
                  ...
                  var u = l(s),
                    ...
                    b = r(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [p, h]),
                    y = /\[\s*(?:,\s*)*\]/.source,
                    v = r(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [
                      b,
                      y,
                    ]),
                    w = r(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [
                    ...
                    (y.languages['markup-templating'] = {}),
                    {
                      ...
                      tokenizePlaceholders: {
                        value: function (d, g) {
                          ...
                          d.language === g &&
                            d.tokenStack &&
                            ((d.grammar = y.languages[g]),
                            (m = 0),
                            (f = Object.keys(d.tokenStack)),
                            (function h(e) {
                              for (
                                var n = 0;
                                n < e.length && !(m >= f.length);
                                n++
                              ) {
                                var t,
                                  r,
                                ...
                                (p.content && 'string' == typeof p.content)
                                  ? ((t = f[m]),
                                    ...
                                    -1 < (i = a.indexOf(s)) &&
                                      ...
                                      (l = new y.Token(
                                        g,
                                        y.tokenize(r, d.grammar),
                                        'language-' + g,
                                        r,
                                      )),
                                      (u = a.substring(i + s.length)),
                                      (c = []),
                                      o && c.push.apply(c, h([o])),
                                      c.push(l),
                                      u && c.push.apply(c, h([u])),
                                      'string' == typeof p
                                        ? e.splice.apply(e, [n, 1].concat(c))
                                        : (p.content = c)))
            ...
            14: [
              function (e, n, t) {
                ...
                e('prismjs/components/prism-clike'),
                  e('prismjs/components/prism-markup-templating'),
                  e('prismjs/components/prism-c'),
                  e('prismjs/components/prism-cpp'),
                  e('prismjs/components/prism-csharp'),
                  e('prismjs/components/prism-css'),
                  e('prismjs/components/prism-java'),
                  e('prismjs/components/prism-javascript'),
                  e('prismjs/components/prism-markup'),
                  e('prismjs/components/prism-php'),
                  e('prismjs/components/prism-python'),
                  e('prismjs/components/prism-ruby'),
                  (n.exports = { boltExport: r });
              },
              {
  ...
  var v = b.exports.boltExport,
    w = function (e) {
      return f.Prism && e.getParam('codesample_global_prismjs', !1, 'boolean')
        ? f.Prism
        : v;
    },
    k = function (e) {
    ...
    x = function (s) {
      var t,
        e = s.getParam('codesample_languages') || [
      ...
      r.ui.registry.addToggleButton('codesample', {
        ...
        onSetup: function (t) {
          var e = function () {
            var e, n;
            t.setActive(
              ((n = (e = r).selection.getStart()),
              e.dom.is(n, 'pre[class*="language-"]')),
            );
          };
          return (
            r.on('NodeChange', e),
  ...
  r.add('codesample', function (n) {
    var t, a, r;
    (a = (t = n).$),
      t.on('PreProcess', function (e) {
        a('pre[contenteditable=false]', e.node)
          .filter(m(g))
          .each(function (e, n) {
            var t = a(n),
              r = n.textContent;
            t.attr('class', a.trim(t.attr('class'))),
              t.removeAttr('contentEditable'),
              t.empty().append(
                a('<code></code>').each(function () {
                  this.textContent = r;
                }),
              );
          });
          ...
          t.undoManager.transact(function () {
            e.each(function (e, n) {
              a(n)
                ...
                (n.innerHTML = t.dom.encode(n.textContent)),
                w(t).highlightElement(n),
                (n.className = a.trim(n.className));
            });
          });
      }),
      _(n),
      (r = n).addCommand('codesample', function () {

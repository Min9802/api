...
!(function () {
  ...
  var n,
    ...
    f = tinymce.util.Tools.resolve('tinymce.EditorManager'),
    m = tinymce.util.Tools.resolve('tinymce.Env'),
    h = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    d = function (t) {
            ...
            !(function (t, e) {
              ...
              if (n) {
                var o = t.getParam('skin_url'),
                  i = o
                    ? t.documentBaseURI.toAbsolute(o)
                    : f.baseURL + '/skins/ui/' + n,
                  c = f.baseURL + '/skins/content/';
                return (
                  e ===
                    i + '/content' + (t.inline ? '.inline' : '') + '.min.css' ||
                  -1 !== e.indexOf(c)
                );
              }
              return !1;
    ...
    x = function (t, e) {
      ...
      if (n) {
        ...
        return (
          n[1]
            ? ((r = { title: e }),
              t.schema.getTextBlockElements()[o]
                ? (r.block = o)
                : t.schema.getBlockElements()[o] || c[o.toLowerCase()]
                ? (r.selector = o)
                : (r.inline = o))
            : n[2] && (r = { inline: 'span', title: e.substr(1), classes: i }),
          !1 !== t.getParam('importcss_merge_classes')
            ? (r.classes = i)
            : (r.attributes = { class: i }),
          r
        );
      }
    },
    ...
    r = function (y) {
      y.on('init', function (t) {
        var e,
            ...
            (n = {}),
            {
              ...
              toFormats: function () {
                return l(r, function (t) {
                  var e = n[t];
                  return 0 === e.length ? [] : [{ title: t, items: e }];
                }).concat(e);
              },
            }),
          g = {},
          c = p(y.getParam('importcss_selector_filter')),
          s =
            ((o = y.getParam('importcss_groups')),
            h.map(o, function (t) {
              return h.extend({}, t, {
                original: t,
                selectors: {},
          ...
          a = function (t, e) {
            if (
              ((f = t), (p = g), !(P(y, (m = e)) ? f in p : f in m.selectors))
            ) {
              (a = t),
                (l = g),
                P(y, (u = e)) ? (l[a] = !0) : (u.selectors[a] = !0);
              var r =
                ((i = (o = y).plugins.importcss),
                (c = t),
              ...
              if (r) {
                var n = r.name || v.DOM.uniqueId();
                return (
                  y.formatter.register(n, r),
        ...
        h.each(
          _(y, y.getDoc(), p(y.getParam('importcss_file_filter'))),
          function (r) {
            var t, e, n, o;
            -1 === r.indexOf('.mce-') &&
              ((c && !c(r)) ||
                ...
                (o = r),
                0 <
                (t = h.grep(n, function (t) {
                  return !t.filter || t.filter(o);
                })).length
                  ? h.each(t, function (t) {
                      var e = a(r, t);
                      e && i.addItemToGroup(t.title, e);
                    })
                  : (e = a(r, null)) && i.addItem(e)));
          },
        );
        var u = i.toFormats();
        y.fire('addStyleModifications', {
          items: u,
          replace: !y.getParam('importcss_append'),
        });
      });
    };

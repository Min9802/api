...
!(function () {
  ...
  var u,
    ...
    c = function () {
      ...
      for (var e = {}, r = 0; r < t.length; r++) {
        var o = t[r];
        for (var i in o) a.call(o, i) && (e[i] = u(e[i], o[i]));
      }
      return e;
    },
    i = function (t) {
    ...
    T = function (t) {
      ...
      return (
        (e = function (t) {
          return o({ keywords: [], category: 'user' }, t);
        }),
        b(n, function (t, n) {
          return { k: n, v: e(t, n) };
        })
    ...
    P = function (e, o, t) {
            ...
            var e,
              ...
              a = {
                ...
                char:
                  ...
                  (u = 0),
                  (i = '<img'),
                  (o = r).length >= i.length && o.substr(u, u + i.length) === i
                    ? e['char'].replace(/src="([^"]+)"/, function (t, n) {
                        return 'src="' + f + n + '"';
                      })
                    : e['char']),
                category: _(A, t.category),
              },
      ...
      e.on('init', function () {
        O.load(t, o).then(
          ...
          function (t) {
            console.log('Failed to load emoticons: ' + t),
              r.set(h.some({})),
              n.set(h.some([]));
          },
        );
            ...
            : new j(function (t, n) {
                var e = 15,
                  r = C.setInterval(function () {
                    a()
                      ? (C.clearInterval(r), t(!0))
                      : --e < 0 &&
                        (console.log('Could not load emojis from url: ' + o),
                        C.clearInterval(r),
                        n(!1));
                  }, 100);
              });
    ...
    L = function (o, u) {
      var e,
        r,
        i,
        t = { pattern: '', results: x(u.listAll(), '', h.some(300)) },
        a = m(k),
        c =
          ((e = function (t) {
            var n, e, r, o, i;
            (e = (n = t).getData()),
              (r = a.get()),
              (o = u.listCategory(r)),
              (i = x(o, e[D], r === k ? h.some(300) : h.none())),
              n.setData({ results: i });
          }),
          (r = 200),
          (i = null),
        ...
        n = { label: 'Search', type: 'input', name: D },
        l = { type: 'collection', name: 'results' },
        s = function () {
          return {
            title: 'Emoticons',
            size: 'normal',
            body: {
              ...
              tabs: (function (t, n) {
                ...
                return { title: t, name: t, items: [n, l] };
              }),
            },
            initialData: t,
            ...
            onAction: function (t, n) {
              var e, r;
              'results' === n.name &&
                ((e = o), (r = n.value), e.insertContent(r), t.close());
            },
  ...
  r.add('emoticons', function (t, n) {
    var e,
      ...
      f =
        ((r = n),
        (o = (e = t).getParam('emoticons_database', 'emojis', 'string')),
        e.getParam(
    ...
    (u = g),
      ...
      (l = g),
      (c = t).ui.registry.addAutocompleter('emoticons', {
        ch: ':',
        columns: 'auto',
        minChars: 2,
        fetch: function (n, e) {
      ...
      (s = t).on('PreInit', function () {
        s.parser.addAttributeFilter('data-emoticon', function (t) {
          !(function (t, n) {
            ...
            t.attr('data-mce-resize', 'false'),
              t.attr('data-mce-placeholder', '1');
          });
        });
      });
  });

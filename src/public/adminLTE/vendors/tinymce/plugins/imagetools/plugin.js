...
(function () {
  ...
  var isServiceErrorCode = function (code, blob) {
    return (
      (blob === null || blob === void 0 ? void 0 : blob.type) ===
        'application/json' &&
  ...
  var handleServiceErrorResponse = function (status, blob) {
    return isServiceErrorCode(status, blob)
      ? handleServiceError(blob)
  ...
  var requestServiceBlob = function (url, apiKey) {
    ...
    return sendRequest(appendApiKey(url, apiKey), headers).then(function (
      result,
    ) {
    ...
    var isEditable = function (imgNode) {
      return (
        ...
        (isLocalImage(editor, imgNode) ||
          ...
          isNonNullable(getProxyUrl(editor)))
      );
    };
  ...
  var isCorsImage = function (editor, img) {
    return (
      global$1.inArray(getCorsHosts(editor), new global$4(img.src).host) !== -1
    );
  };
  ...
  var startTimedUpload = function (editor, imageUploadTimerState) {
    var imageUploadTimer = global$2.setEditorTimeout(
      editor,
      function () {
  ...
  var selectedImageOperation = function (
    editor,
    imageUploadTimerState,
    fn,
    size,
  ...
  var register$1 = function (editor) {
    ...
    editor.ui.registry.addContextMenu('imagetools', {
      update: function (element) {
        return getEditableImage(editor, element).fold(
          function () {
            return [];
          },
          function (_) {

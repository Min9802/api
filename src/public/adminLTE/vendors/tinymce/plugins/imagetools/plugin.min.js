...
!(function () {
  ...
  var t,
    ...
    g = {
      ...
      none: f,
      from: function (t) {
        return null === t || t === undefined ? s : m(t);
      },
    },
    h = function (t) {
  ...
  function p(t, e) {
    return b(document.createElement('canvas'), t, e);
  }
  function y(t) {
    var e = p(t.width, t.height);
    return w(e).drawImage(t, 0, 0), e;
  }
  function w(t) {
    ...
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        ...
        if ('function' == typeof e)
          return void C(A(e, t), A(E, this), A(L, this));
      }
      (this._state = !0), (this._value = t), j.call(this);
    } catch (n) {
      L.call(this, n);
    }
  }
  function L(t) {
    (this._state = !1), (this._value = t), j.call(this);
  }
  function j() {
    ...
    return new U(function (t, e) {
      (function (t) {
        ...
        for (
          ...
          c[f] = new Uint8Array(d);
        }
        return g.some(new Blob(c, { type: r }));
      })(n).fold(function () {
  ...
  function z(e, t) {
    return M(e, t).then(function (t) {
      return H(U.resolve(e), t, e.toDataURL());
    });
  }
  function $(e, n) {
    return e.toCanvas().then(function (t) {
      return (function (t, e, n) {
        var r = p(t.width, t.height),
          o = w(r),
          i = 0,
          u = 0;
        (90 !== (n = n < 0 ? 360 + n : n) && 270 !== n) ||
          b(r, r.height, r.width);
        (90 !== n && 180 !== n) || (i = r.width);
        (270 !== n && 180 !== n) || (u = r.height);
        return (
          o.translate(i, u),
  ...
  var J = G,
      ...
      return (
        ...
        new U(function (t) {
          ...
          (n.onreadystatechange = function () {
            4 === n.readyState && t({ status: n.status, blob: n.response });
          }),
            n.open('GET', e, !0),
            (n.withCredentials = o),
            (function (t, e) {
              for (var n = V(t), r = 0, o = n.length; r < o; r++) {
                var i = n[r];
                e(t[i], i);
              }
            })(r, function (t, e) {
      ...
      var e,
        n =
          ...
          'ImageProxy HTTP error: ' +
            F(X, function (t) {
              return e === t.code;
            }).fold(u('Unknown ImageProxy error'), function (t) {
              return t.message;
            }));
      return U.reject(n);
    },
    tt = function (e) {
      return F(Q, function (t) {
        return t.type === e;
      }).fold(u('Unknown service error'), function (t) {
        return t.message;
      });
    },
    et = function (t) {
      return (
        ...
        (function (t) {
          try {
            return g.some(JSON.parse(t));
          } catch (e) {
            return g.none();
          }
        })(t)
          .bind(function (t) {
            return Y(t, ['error', 'type']).map(tt);
          })
    ...
    ot = function (t, e) {
      ...
      return W(
        ((r = e),
        (o = -1 === (n = t).indexOf('?') ? '?' : '&'),
        /[?&]apiKey=/.test(n) ? n : n + o + 'apiKey=' + encodeURIComponent(r)),
        i,
      ).then(function (t) {
        return rt(t.status)
          ? ((e = t.status),
            (n = t.blob),
            (r = e),
            'application/json' !== (null == (o = n) ? void 0 : o.type) ||
            (400 !== r && 403 !== r && 404 !== r && 500 !== r)
              ? Z(e)
              : nt(n))
          : U.resolve(t.blob);
        var e, n, r, o;
    ...
    it = function (t, e, n) {
      return (
        ...
        e
          ? ot(t, e)
          : W(t, {}, n).then(function (t) {
              return rt(t.status) ? Z(t.status) : U.resolve(t.blob);
            })
      );
    },
    ut = q,
    ...
    ct = {
      ...
      fromPoint: function (t, e, n) {
        return g.from(t.dom.elementFromPoint(e, n)).map(at);
      },
    },
    ft =
      ...
      function (t, e) {
        return (
          ...
          F(t.dom.childNodes, function (t) {
            return n(ct.fromDom(t));
          }).map(ct.fromDom)
        );
        var n;
      }),
    st = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    lt = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    dt = tinymce.util.Tools.resolve('tinymce.util.URI'),
    mt = function (t) {
  ...
  var vt = 0,
    pt = function (t) {
      return ft(ct.fromDom(t), 'img');
    },
    yt = function (t, e) {
      return t.dom.is(e, 'figure');
    },
    wt = function (t, e) {
      return t.dom.is(e, 'img:not([data-mce-object],[data-mce-placeholder])');
    },
    bt = function (e, t) {
      var n = function (t) {
        return wt(e, t) && (Rt(e, t) || Ut(e, t) || h(mt(e)));
      };
      return yt(e, t)
        ? pt(t).bind(function (t) {
            return n(t.dom) ? g.some(t.dom) : g.none();
          })
        : n(t)
        ? g.some(t)
        : g.none();
    ...
    _t = function (t, e, n) {
      var r = e.match(/(?:\/|^)(([^\/\?]+)\.(?:[a-z0-9.]+))(?:\?|$)/i);
      return h(r) ? t.dom.encode(r[n]) : null;
    },
    Rt = function (t, e) {
      var n = e.src;
      return (
        0 === n.indexOf('data:') ||
        0 === n.indexOf('blob:') ||
        new dt(n).host === t.documentBaseURI.host
      );
    },
    Ut = function (t, e) {
      return (
    ...
    At = function (t, e) {
      if (Ut(t, e))
        return it(
          ...
          -1 !==
            d.inArray(
              n.getParam('imagetools_credentials_hosts', [], 'string[]'),
              new dt(r.src).host,
            )),
        );
      var n, r, o;
      if (Rt(t, e)) return D(e);
      var i = mt(t),
        u =
          i +
          (-1 === i.indexOf('?') ? '?' : '&') +
        ...
        a = (o = t).getParam(
          'api_key',
          o.getParam('imagetools_api_key', '', 'string'),
          'string',
        );
      return it(u, a, !1);
    },
    xt = function (t, e) {
      return (
        (n = t),
        g.from(n.getParam('imagetools_fetch_image', null, 'function')).fold(
          function () {
            return At(t, e);
          },
          function (t) {
    ...
    Et = function (t, e) {
      var n = t.editorUpload.blobCache.getByUri(e.src);
      return n ? lt.resolve(n.blob()) : xt(t, e);
    },
    Lt = function (t) {
      st.clearTimeout(t.get());
    },
    jt = function (a, c, f, s, l, d, m) {
      return f.toBlob().then(function (t) {
        var e,
          n,
          o,
          r = a.editorUpload.blobCache,
          i = d.src,
          u = c.type === t.type;
        return (
          ...
          (o = r.create({
            ...
            uri: i,
            name: e,
            filename: u ? n : undefined,
          })),
          r.add(o),
          a.undoManager.transact(function () {
            a.$(d).on('load', function r() {
              var t, e, n;
              a.$(d).off('load', r),
                a.nodeChanged(),
                s
              ...
              m && a.$(d).attr({ width: m.w, height: m.h }),
              a.$(d).attr({ src: o.blobUri() }).removeAttr('data-mce-src');
          }),
          o
        );
      });
    ...
    kt = function (r, o, t, i) {
      return function () {
        return Tt(r).fold(
          function () {
            It(r, 'Could not find selected image');
          },
          function (n) {
            return r
              ._scanForImages()
    ...
    Ot = function (t, e, n) {
      return function () {
        return kt(t, e, function (t) {
          return J(t, n);
        })();
      };
    },
    Pt = function (e, n, u, a, c) {
      return N(c)
        .then(function (t) {
          var e,
            n,
            ...
            (a.w === i.w && a.h === i.h) ||
              (ht(u) &&
                ...
                (n = i) &&
                  ...
                  (o = e.height),
                  (r || o) &&
                    (e.setAttribute('width', String(n.w)),
                    e.setAttribute('height', String(n.h)))))),
    ...
    St = function (i, u) {
      return function () {
        ...
        r.each(function (e) {
          bt(i, e.dom).each(function (t) {
            Et(i, e.dom).then(function (t) {
              var e,
                n = { blob: (e = t), url: URL.createObjectURL(e) };
              i.windowManager.open({
                ...
                onSubmit: function (t) {
                  var n = t.getData().imagetools.blob;
                  r.each(function (e) {
                    o.each(function (t) {
                      Pt(i, u, e.dom, t, n);
                    });
  ...
  o.add('imagetools', function (t) {
    ...
    (n = t),
      ...
      d.each(
        {
          mceImageRotateLeft: Ct(n, e, -90),
          mceImageRotateRight: Ct(n, e, 90),
          mceImageFlipVertical: Ot(n, e, 'v'),
          mceImageFlipHorizontal: Ot(n, e, 'h'),
          mceEditImage: St(n, e),
        },
        function (t, e) {
          n.addCommand(e, t);
      ...
      r.ui.registry.addButton('editimage', {
        ...
        onSetup: function (e) {
          var t = function () {
            var t = Tt(r).forall(function (t) {
              return bt(r, t.dom).isNone();
            });
            e.setDisabled(t);
          };
          return (
      ...
      (u = t).on('NodeChange', function (t) {
        ...
        e &&
          ...
          (Lt(a), u.editorUpload.uploadImagesAuto(), c.set(null)),
          n.each(c.set);
      });
  });
})();

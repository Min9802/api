...
!(function () {
  ...
  var e,
    ...
    s = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    ...
    v = function (n) {
      var t,
        ...
        r = (function (t) {
          ...
          1 <= (t = parseInt(n.getParam('toc_depth', '3'), 10)) && t <= 9
            ? t
            : 3,
        ),
        i = n.$(r);
    ...
    u = function (t) {
      var e,
        ...
        d =
          (function (t) {
            for (var e = 9, n = 0; n < t.length; n++)
              if ((t[n].level < e && (e = t[n].level), 1 === e)) return e;
            return e;
          })(u) - 1;
      if (!u.length) return '';
      for (
        a +=
          ...
          (l = '</' + i + '>'),
          '<' + i + ' contenteditable="true">' + s.DOM.encode(c) + l),
          e = 0;
        e < u.length;
        e++
      ) {
        ...
        if (
          ...
          for (n = o.level; r < n; n--) a += '</li></ul><li>';
        else (a += '</li>'), r || (a += '</ul>');
        d = o.level;
      }
      return a;
    ...
    i = function (t) {
      ...
      (o = t),
        !(r = c).length ||
        0 < o.dom.getParents(r[0], '.mce-offscreen-selection').length
          ? t.insertContent(
              ((n = u((e = t))),
              '<div class="' +
                e.dom.encode(l(e)) +
    ...
    o = function (n) {
      return function (t) {
        var e = function () {
          return t.setDisabled(n.mode.isReadOnly() || !(0 < v(n).length));
        };
        return (
          e(),

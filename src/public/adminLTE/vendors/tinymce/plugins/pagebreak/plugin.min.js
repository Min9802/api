...
!(function () {
  ...
  e.add('pagebreak', function (e) {
    ...
    (a = e).addCommand('mcePageBreak', function () {
      i(a) ? a.insertContent('<p>' + m() + '</p>') : a.insertContent(m());
    }),
      ...
      (c = (o = e).getParam('pagebreak_separator', '\x3c!-- pagebreak --\x3e')),
      (t = new RegExp(
      ...
      o.on('BeforeSetContent', function (e) {
        e.content = e.content.replace(t, m());
      }),

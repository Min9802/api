...
!(function () {
  ...
  var e,
    ...
    k = tinymce.util.Tools.resolve('tinymce.html.SaxParser'),
    A = function (e, t) {
      if (e)
          ...
          start: function (e, t) {
            if (!c.get())
              if (j(t.map, 'data-ephox-embed-iri'))
                ...
                if (
                  (u.source || 'param' !== e || (u.source = t.map.movie),
                  ('iframe' !== e &&
                    'object' !== e &&
                    'embed' !== e &&
                    'video' !== e &&
                ...
                'source' === e &&
                  (u.source
                    ...
                    : (u.source = t.map.src)),
                  'img' !== e || u.poster || (u.poster = t.map.src);
              }
            var n, i, a;
          },
        }).parse(e),
    ...
    $ = tinymce.util.Tools.resolve('tinymce.html.Schema'),
    F = tinymce.util.Tools.resolve('tinymce.html.Writer'),
    M = _.DOM,
    z = function (e) {
    ...
    I = function (r, e) {
      ...
      var a,
        ...
        m,
        d,
        h = r.getParam('audio_template_callback'),
    ...
    q = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    B = {},
    W = function (t) {
      return function (e) {
        return I(t, e);
    ...
    J = function (e, t) {
      var r,
        ...
        a = H(e, i, t);
      return p(
        p(p(p(p({}, a('source')), a('altsource')), a('poster')), a('embed')),
        ((r = i),
        (n = {}),
    ...
    ee = function (m) {
      ...
      var s = { title: 'Advanced', name: 'advanced', items: u },
        l = [o, c];
      0 < u.length && l.push(s);
      var h = { type: 'tabpanel', tabs: l },
        f = m.windowManager.open({
        ...
        k(
          {
            ...
            start: function (e, t, r) {
              if (
                ((o = !0), 'script' !== e && 'noscript' !== e && 'svg' !== e)
              ) {
                for (var n = t.length - 1; 0 <= n; n--) {
                  var i = t[n].name;
                  0 === i.indexOf('on') && (delete t.map[i], t.splice(n, 1)),
                    'style' === i &&
    ...
    ie = function (e, t, r) {
      for (var n, i, a = t.attributes, o = a.length; o--; )
        (n = a[o].name),
          (i = a[o].value),
          'width' !== n &&
            'height' !== n &&
            'style' !== n &&
            (('data' !== n && 'src' !== n) || (i = e.convertURL(i, n)),
        ...
        for (var t, r, n, i, a, o, c = e.length; c--; )
          (t = e[c]).parent &&
            (t.parent.attr('data-mce-object') ||
              ('script' === t.name && !(r = A(O(u), t.attr('src')))) ||
              (r &&
                ...
                ? ae(t) ||
                  t.replace(
                    (function (e, t) {
                      ...
                      var a = new te('span', 1);
                      return (
                        a.attr('class', 'mce-shim'), n.append(i), n.append(a), n
                      );
                    })(u, t),
                  )
                : ae(t) ||
                ...
                for (
                  u = r.attr(t),
                    ...
                    'audio' !== u &&
                      'script' !== u &&
                      ((s = r.attr('class')) &&
                      -1 !== s.indexOf('mce-preview-object')
                        ? n.attr({
                  ...
                  var m = a[i].name;
                  0 === m.indexOf('data-mce-p-') &&
                    n.attr(m.substr(11), a[i].value);
                }
                'script' === u && n.attr('type', 'text/javascript'),

...
!(function () {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    c = function (e) {
      var n = e.dom;
      t(n).walk(e.selection.getRng(), function (e) {
        o.each(e, function (e) {
          var t;
    ...
    i = function (e, t) {
      ...
      l
        ? ((a = e),
          ...
          a.undoManager.add())
        : ((o = t),
          (n = e).undoManager.transact(function () {
            n.getParam('allow_html_in_named_anchor', !1, 'boolean') ||
              n.selection.collapse(!0),
              n.selection.isCollapsed()
                ? n.insertContent(n.dom.createHTML('a', { id: o }))
                : (c(n),
                  n.formatter.remove('namedAnchor', null, null, !0),
                  n.formatter.apply('namedAnchor', { value: o }),
                  n.addVisual());
          })),
        e.focus();
    },
    l = function (o) {
      ...
      o.windowManager.open({
        ...
        body: {
          type: 'panel',
          items: [
            { name: 'id', type: 'input', label: 'ID', placeholder: 'example' },
          ],
        },
        buttons: [
      ...
      return function (e) {
        for (var t, n, o = 0; o < e.length; o++) {
          ...
          (n = void 0),
            !(n = t = a) ||
              n.attr('href') ||
              (!n.attr('id') && !n.attr('name')) ||
              t.firstChild ||
              a.attr('contenteditable', r);
        }
      };
    };
  e.add('anchor', function (e) {
    ...
    (t = e).on('PreInit', function () {
      t.parser.addNodeFilter('a', d('false')),
        t.serializer.addNodeFilter('a', d(null));
    }),
      ...
      (o = e).ui.registry.addToggleButton('anchor', {
        ...
        onSetup: function (e) {
          return o.selection.selectorChangedWithUnbind(
            'a:not([href])',
            e.setActive,
          ).unbind;
        },

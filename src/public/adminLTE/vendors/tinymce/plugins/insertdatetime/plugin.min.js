  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    s = function (e, t, n) {
      return (
        ...
        )).replace('%b', '' + e.translate(i[n.getMonth()]))).replace(
          '%A',
    ...
    l = function (e, t) {
      var n, r, a, i, o, u, c, m;
      e.getParam('insertdatetime_element', !1)
        ? ((n = s(e, t)),
          (r = void 0),
          (r = /%[HMSIp]/.test(t) ? s(e, '%Y-%m-%dT%H:%M') : s(e, '%Y-%m-%d')),
          (a = e.dom.getParent(e.selection.getStart(), 'time'))
            ? ((o = a),
              (u = r),
              (c = n),

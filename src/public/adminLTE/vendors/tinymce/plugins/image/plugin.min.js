...
!(function () {
  ...
  var t,
    ...
    N = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    P = tinymce.util.Tools.resolve('tinymce.util.XHR'),
    _ = function (e) {
    ...
    X = function (e) {
      var t, n, r, a;
      $(e)
        ? ((a = (r = e).parentNode), j.insertAfter(r, a), j.remove(a))
        : ((t = e),
          (n = j.create('figure', { class: 'image' })),
          j.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(
            j.create('figcaption', { contentEditable: 'true' }, 'Caption'),
          ),
    ...
    re = function (e) {
      return (
        0 === j.getAttrib(e, 'alt').length &&
        'presentation' === j.getAttrib(e, 'role')
      );
    },
    ae = function () {
      return {
    ...
    ie = function (e, t) {
      ...
      return (
        J(n, 'style', t.style),
        (!B(n) && '' === t.hspace) || Q(n, t.hspace),
        (!F(n) && '' === t.vspace) || Y(n, t.vspace),
        (!G(n) && '' === t.border) || ee(n, t.border),
        (!q(n, 'borderStyle') && '' === t.borderStyle) || te(n, t.borderStyle),
    ...
    se = function (e, t, n) {
      ...
      n
        ? (j.setAttrib(e, 'role', 'presentation'),
          ...
          C(r, 'alt', ''))
        : (m(t)
            ? ((r = O.fromDom(e)), (a = 'alt'), r.dom.removeAttribute(a))
            : ((r = O.fromDom(e)), C(r, 'alt', t)),
          'presentation' === j.getAttrib(e, 'role') &&
            j.setAttrib(e, 'role', ''));
    },
    ue = function (r, a) {
    ...
    ce = function (e, t, n) {
      ...
      le(n, o, t, 'caption', function (e, t, n) {
        ...
        le(n, o, t, 'src', J),
        le(n, o, t, 'title', J),
        le(n, o, t, 'width', K(0, e)),
        le(n, o, t, 'height', K(0, e)),
        le(n, o, t, 'class', J),
        le(
          n,
          o,
        ...
        le(n, o, t, 'hspace', ue(Q, e)),
        le(n, o, t, 'vspace', ue(Y, e)),
        le(n, o, t, 'border', ue(ee, e)),
        le(n, o, t, 'borderStyle', ue(te, e)),
        (r = n),
        (a = o),
        ((i = t).alt === a.alt && i.isDecorative === a.isDecorative) ||
          se(r, i.alt, i.isDecorative);
    },
    me = function (e, t) {
    ...
    fe = function (t, e) {
      var n = (function (e, t) {
        var n = document.createElement('img');
        if (
          (ce(e, c(c({}, t), { caption: !1 }), n),
          se(n, t.alt, t.isDecorative),
          t.caption)
        ) {
      ...
      var r,
        a = t.dom.select('*[data-mce-id="__mcenew"]')[0];
      t.dom.setAttrib(a, 'data-mce-id', null),
        ne(a) ? ((r = ge(t, a)), t.selection.select(r)) : t.selection.select(a);
    },
    pe = function (t, e) {
      var n,
        r,
      ...
      ce(
        ...
        ne(s.parentNode)
          ? ((r = s.parentNode), ge(t, r), t.selection.select(s.parentNode))
          : (t.selection.select(s),
            (a = t),
            (i = e),
            (l = function () {
              (o.onload = o.onerror = null),
                a.selection && (a.selection.select(o), a.nodeChanged());
            }),
            ((o = s).onload = function () {
              i.width ||
                i.height ||
    ...
    ve = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    ye = function (e) {
      ...
      return (
        ve.each(e, function (e) {
          var t,
            n,
            r,
            a = A((t = e).text) ? t.text : A(t.title) ? t.title : '';
          e.menu !== undefined
            ? ((n = De(e.menu, i)), o.push({ text: a, items: n }))
            : ((r = i(e)), o.push({ text: a, value: r }));
        }),
        o
      );
    },
  ...
  var Ue = function (e) {
      ...
      var t,
        ...
        n = new N(function (t) {
          ...
          (n = function (e) {
            ...
            'string' == typeof (e = r.getParam('image_list', !1))
              ? P.send({
                  url: e,
                  success: function (e) {
                    n(JSON.parse(e));
        ...
        i = xe(r.getParam('image_class_list')),
        ...
        h = L(r),
        b = r.getParam('images_upload_base_path', undefined, 'string'),
        v = r.getParam('images_upload_credentials', !1, 'boolean'),
        y = E(r),
        D = r.getParam('automatic_uploads', !0, 'boolean'),
        w = S.some(r.getParam('image_prepend_url', '', 'string')).filter(
          function (e) {
    ...
    Re = function (e, t) {
      ...
      l !== undefined &&
        ...
        (a = n),
        (i = l),
        (r = e).hasDescription && A(i.alt) && (a.alt = i.alt),
        r.hasAccessibilityOptions &&
          (a.isDecorative = i.isDecorative || a.isDecorative || !1),
        r.hasImageTitle && A(i.title) && (a.title = i.title),
        r.hasDimensions &&
          (A(i.width) && (a.dimensions.width = i.width),
          A(i.height) && (a.dimensions.height = i.height)),
        A(i['class']) &&
          Te(r.classList, i['class']).each(function (e) {
            a.classes = e.value;
          }),
        r.hasImageCaption && d(i.caption) && (a.caption = i.caption),
        r.hasAdvTab &&
          (A(i.style) && (a.style = i.style),
          A(i.vspace) && (a.vspace = i.vspace),
          A(i.border) && (a.border = i.border),
          A(i.hspace) && (a.hspace = i.hspace),
          A(i.borderstyle) && (a.borderstyle = i.borderstyle)),
        t.setData(n));
    },
    ze = function (e, t, n, r) {
      ...
      return (
        (u.vspace =
          ...
          r['margin-top'] === r['margin-bottom']
            ? R(String(r['margin-top']))
            : ''),
        (u.hspace =
          (a = s)['margin-right'] &&
          a['margin-left'] &&
          a['margin-right'] === a['margin-left']
            ? R(String(a['margin-right']))
            : ''),
        (u.border = (i = s)['border-width']
          ? R(String(i['border-width']))
          : ''),
    ...
    je = function (h, b, v) {
      return function (e, t) {
        ...
        'src' === t.name
          ...
          ? ((n = h),
            (r = e),
            (a = be(Le(b.image), r.getData())),
            (i = ie(n.normalizeCss, Ee(a, !1))),
            r.setData({ style: i }))
          : 'fileinput' === t.name
          ? ke(h, b, v, e)
          : 'isDecorative' === t.name &&
      ...
      return function (e) {
        return (
          ...
          new N(function (t) {
            ...
            (n.onload = function () {
              var e = {
                width: M(n.width, n.clientWidth),
                height: M(n.height, n.clientHeight),
              };
              r(N.resolve(e));
            }),
              (n.onerror = function () {
    ...
    We = function (u) {
      u.addCommand('mceImage', Ge(u).open),
        u.addCommand('mceUpdateImage', function (e, s) {
              ...
              void ((l = de((t = u)))
                ? ((n = oe(function (e) {
                  ...
                  (r = c(c({}, n), e)).src
                    ...
                    : ((a = t),
                      (i = l) &&
                        ((o = a.dom.is(i.parentNode, 'figure.image')
                          ? i.parentNode
                          : i),
                        a.dom.remove(o),
                        a.focus(),

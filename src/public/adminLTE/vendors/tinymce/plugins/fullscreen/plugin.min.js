...
!(function () {
  ...
  var t,
    ...
    fn = function (n, e, t, r) {
      return { x: n, y: e, width: t, height: r, right: n + t, bottom: e + r };
    },
    an = function (n) {
      var e,
        t,
        ...
        c =
          ((e = M.fromDom(i)),
          (t = e !== undefined ? e.dom : document),
          (r = t.body.scrollLeft || t.documentElement.scrollLeft),
    ...
    gn = function (n, e) {
      n.fire('FullscreenStateChanged', { state: e });
    },
    pn = function (n) {
    ...
    yn = function (n) {
      return (
        n.dom ===
        ((e = W(n).dom).fullscreenElement !== undefined
          ? e.fullscreenElement
          : e.msFullscreenElement !== undefined
    ...
    bn = function (n) {
      return (
        (e = n),
        (o = t === undefined ? document : t.dom),
        (1 !== (r = o).nodeType && 9 !== r.nodeType && 11 !== r.nodeType) ||
        0 === r.childElementCount
          ? []
          : T(o.querySelectorAll(e), M.fromDom)
      );
      var e, t, r, o;
    },
    Sn = function (n, e) {
    ...
    Dn = function (n) {
      var e,
        ...
        u =
          ((t = 'background-color'),
          (r = (e = n).dom),
          '' !== (o = window.getComputedStyle(r).getPropertyValue(t)) || Y(e)
            ? o
            : $(r, t));
      ...
      var n,
        ...
        b = function () {
          ...
          p &&
            ...
            x(n, function (n) {
              var e = J(n, En);
              'no-styles' !== e ? Z(n, t.parseStyle(e)) : Q(n, 'style'),
                Q(n, En);
            })),
            w(Cn.removeClass),
            On.unbind(),
            S.from(r.get()).each(function (n) {
              return n.fullscreenChangeHandler.unbind();
            });
        };
      h
        ? (h.fullscreenChangeHandler.unbind(),
          pn(e) &&
            yn(m) &&
            ((u = W(m)),
            (i = u.dom).exitFullscreen
              ? i.exitFullscreen()
              : i.msExitFullscreen
              ? i.msExitFullscreen()
              : i.webkitCancelFullScreen && i.webkitCancelFullScreen()),
          (y.width = h.iframeWidth),
          (y.height = h.iframeHeight),
          (v.width = h.containerWidth),
          (v.height = h.containerHeight),
          (v.top = h.containerTop),
          (v.left = h.containerLeft),
          (o = h.scrollPos),
        ...
        : ((n = on(
          ...
          (t = {
            scrollPos: { x: (l = an(window)).x, y: l.y },
    ...
    Nn = function (t, r) {
      return function (e) {
        ...
        var n = function (n) {
          return e.setActive(n.state);
        };
        return (
          t.on('FullscreenStateChanged', n),
          function () {
  ...
  n.add('fullscreen', function (n) {
    ...
    return (
      n.inline ||
        ((t = u),
        (e = n).addCommand('mceFullScreen', function () {
          An(e, t);
        }),
        (o = u),

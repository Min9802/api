...
(function () {
  ...
  var toggleFullscreen = function (editor, fullscreenState) {
    ...
    if (!fullscreenInfo) {
      var fullscreenChangeHandler = bind$2(
        owner(fullscreenRoot),
        getFullscreenchangeEventName(),
        function (_evt) {
          if (getFullscreenNative(editor)) {
            if (
              !isFullscreenElement(fullscreenRoot) &&
              fullscreenState.get() !== null
            ) {

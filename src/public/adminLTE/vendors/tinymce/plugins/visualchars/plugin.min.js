...
!(function () {
  ...
  var n,
    ...
    m = function (n) {
      return null === n || n === undefined ? l : d(n);
    },
    v = function (t) {
      return function (n) {
        return typeof n === t;
    ...
    b = Object.keys,
    w = function (n, t) {
      for (var e = b(n), r = 0, o = e.length; r < o; r++) {
        var u = e[r];
        t(n[u], u);
      }
    },
    ...
    O = function (n, t) {
      var e,
        r,
        o = ((e = t), null === (r = n.dom.getAttribute(e)) ? undefined : r);
    ...
    E = function (n) {
      0 === (C(n) ? n.dom.classList : O(n, 'class')).length && A(n, 'class');
    },
    L = function (n) {
    ...
    x = {
      ...
      fromPoint: function (n, t, e) {
        return m(n.dom.elementFromPoint(t, e)).map(L);
      },
    },
    V = { '\xa0': 'nbsp', '\xad': 'shy' },
    B = function (n, t) {
    ...
    q = function (n) {
      return (
        '<span data-mce-bogus="1" class="mce-' + V[n] + '">' + n + '</span>'
      );
    },
    H = function (n) {
      var t = N(n);
      return T(n) && t !== undefined && P.test(t);
    },
    F = function (n, t) {
      var e = [],
        r = (function (n, t) {
          ...
          return r;
        })(n.dom.childNodes, x.fromDom);
      return (
        y(r, function (n) {
          t(n) && (e = e.concat([n])), (e = e.concat(F(n, t)));
        }),
        e
      );
    },
    I = function (n) {
      return (
        'span' === n.nodeName.toLowerCase() &&
        n.classList.contains('mce-nbsp-wrap')
      );
    },
    U = function (c, n) {
      var t = F(x.fromDom(n), H);
      y(t, function (n) {
        var t,
          e,
          r = n.dom.parentNode;
        if (I(r))
          (t = x.fromDom(r)), (e = M), C(t) ? t.dom.classList.add(e) : S(t, e);
        else {
          for (
            var o = c.dom.encode(N(n)).replace(_, q),
    ...
    K = function (r, n) {
      var t = r.dom.select(j, n);
      y(t, function (n) {
        var t, e;
        I(n)
          ? ((t = x.fromDom(n)),
            (e = M),
            C(t) ? t.dom.classList.remove(e) : D(t, e),
            E(t))
          : r.dom.remove(n, !0);
      });
    },
    R = function (n) {
      var t = n.getBody(),
        ...
        r =
          ...
          })(n.selection.getNode(), t)) !== undefined
            ? r
            : t;
      K(n, r), U(n, r), n.selection.moveToBookmark(e);
    },
    z = function (n, t) {
      var e, r;
      (e = n), (r = t.get()), e.fire('VisualChars', { state: r });
      var o = n.getBody();
      (!0 === t.get() ? U : K)(n, o);
    },
    G = function (n, t) {
      n.addCommand('mceVisualChars', function () {
        !(function (n, t) {
          ...
          z(n, t), n.selection.moveToBookmark(e);
        })(n, t);
      });
    },
  ...
  i.add('visualchars', function (n) {
    var t,
      ...
      f,
      l =
        ((t = n.getParam('visualchars_default_state', !1)),
        (e = t),
        {
          get: function () {
            return e;
    ...
    return (
      G(n, l),
      (o = l),
      (r = n).ui.registry.addToggleButton('visualchars', {
        tooltip: 'Show invisible characters',
        icon: 'visualchars',
        onAction: function () {
          return r.execCommand('mceVisualChars');
        },
        onSetup: Q(r, o),
      }),
      r.ui.registry.addToggleMenuItem('visualchars', {
      ...
      !1 !== u.getParam('forced_root_block') &&
        u.on('keydown', function (n) {
          !0 === i.get() && (13 === n.keyCode ? R(u) : c());
        }),
      u.on('remove', c.stop),
      (s = l),
      (a = n).on('init', function () {
        z(a, s);
      }),
      (f = l),
      {

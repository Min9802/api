  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    b = function (e, t) {
      var n,
        ...
        d = e.getDoc();
      d &&
        ((n = e).plugins.fullscreen && n.plugins.fullscreen.isFullscreen()
          ? p(e, !0)
          : ((i = d.documentElement),
            (o = e.getParam('autoresize_bottom_margin', 50, 'number')),
            (r = y(e)),
            (s = v(f, i, 'margin-top', !0)),
            (a = v(f, i, 'margin-bottom', !0)),
            (g = i.offsetHeight + s + a + o) < 0 && (g = 0),
            g +
              (u =
                e.getContainer().offsetHeight -
                e.getContentAreaContainer().offsetHeight) >
              y(e) && (r = g + u),
            (l = e.getParam('max_height', 0, 'number')) && l < r
              ? ((r = l), p(e, !0))
              : p(e, !1),
            r !== t.get() &&
              ((c = r - t.get()),
              f.setStyle(e.getContainer(), 'height', r + 'px'),
              t.set(r),
              e.fire('ResizeEditor'),
              h.browser.isSafari() &&
                h.mac &&
                (m = e.getWin()).scrollTo(m.pageXOffset, m.pageYOffset),

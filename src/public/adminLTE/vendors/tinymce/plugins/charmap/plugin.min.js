...
!(function () {
  ...
  var e,
    ...
    s = function (e, n) {
      var r,
        t = ((r = n), e.fire('insertCustomChar', { chr: r }).chr);
    ...
    m = {
      ...
      none: u,
      from: function (e) {
        return null === e || e === undefined ? l : g(e);
      },
    },
    f =
      ((t = 'array'),
    ...
    C = function (e) {
      var n = (function (e, n) {
        var r = e.getParam('charmap');
        r && (n = [{ name: b, characters: k(r) }]);
        var t = e.getParam('charmap_append');
        if (t) {
          var a = v.grep(n, function (e) {
            return e.name === b;
          });
          return a.length
            ? ((a[0].characters = [].concat(a[0].characters).concat(k(t))), n)
            : [].concat(n).concat({ name: b, characters: k(t) });
        }
        return n;
      })(e, [
        {
    ...
    q = function () {
      ...
      if (A) return A.apply(void 0, e);
      for (var r = [], t = '', a = 0, i = e.length; a !== i; ++a) {
        var o = +e[a];
        if (!(o < 1114111 && o >>> 0 === o))
      ...
      return t + String.fromCharCode.apply(null, r);
    },
    S = function (e, n) {
      var a = [],
        i = n.toLowerCase();
      return (
        (function (e, n) {
          ...
          (n = e[0]),
            ...
            (O(q(n).toLowerCase(), t) ||
              O(r.toLowerCase(), t) ||
              O(r.toLowerCase().replace(/\s+/g, ''), t)) &&
              a.push(e);
        }),
        p(a, function (e) {
          return { text: e[1], value: q(e[0]), icon: q(e[0]) };
        })
      );
    },
    T = 'pattern',
    E = function (r, a) {
      var t,
        ...
        n = function () {
          return [
            { label: 'Search', type: 'input', name: T },
            { type: 'collection', name: 'results' },
          ];
        },
        c = 1 === a.length ? x(b) : x('All'),
        u =
          ((t = function (e) {
            var r,
              t,
          ...
          body:
            1 === a.length
              ...
              : {
                  type: 'tabpanel',
                  tabs: p(a, function (e) {
                    return { title: e.name, name: e.name, items: n() };
                  }),
                },
          buttons: [
            { type: 'cancel', name: 'close', text: 'Close', primary: !0 },
          ],
          initialData: { pattern: '', results: S(a[0], '') },
          onAction: function (e, n) {
            'results' === n.name && (s(r, n.value), e.close());
          },
          onTabChange: function (e, n) {
            c.set(n.newTabName), u.throttle(e);
          },
          onChange: function (e, n) {
            n.name === T && u.throttle(e);
          },
        };
      r.windowManager.open(e).focus(T);
    },
    P = tinymce.util.Tools.resolve('tinymce.util.Promise');
  a.add('charmap', function (e) {
    var n,
      r,
      t,
      a,
    ...
    return (
      (r = c),
      (n = e).addCommand('mceShowCharmap', function () {
        E(n, r);
      }),
      (t = e).ui.registry.addButton('charmap', {
        icon: 'insert-character',
        tooltip: 'Special character',
        onAction: function () {
          return t.execCommand('mceShowCharmap');
        },
      }),
      t.ui.registry.addMenuItem('charmap', {
        icon: 'insert-character',
      ...
      (a = e),
      (i = c[0]),
      a.ui.registry.addAutocompleter('charmap', {
        ch: ':',
        columns: 'auto',
        minChars: 2,
        fetch: function (r, e) {
        ...
        onAction: function (e, n, r) {
          a.selection.setRng(n), a.insertContent(r), e.hide();
        },
      }),
      (o = e),
      {

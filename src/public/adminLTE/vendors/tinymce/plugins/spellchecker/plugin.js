...
(function () {
  ...
  var getSpellcheckerWordcharPattern = function (editor) {
    var defaultPattern = new RegExp(
      '[^' +
        '\\s!"#$%&()*+,-./:;<=>?@[\\]^_{|}`' +
        '\xA7\xA9\xAB\xAE\xB1\xB6\xB7\xB8\xBB' +
        '\xBC\xBD\xBE\xBF\xD7\xF7\xA4\u201D\u201C\u201E\xA0\u2002\u2003\u2009' +
        ']+',
      'g',
    );
  ...
  var defaultSpellcheckCallback = function (
    editor,
    pluginUrl,
  ...
  var sendRpcCall = function (
    ...
    var spellCheckCallback = userSpellcheckCallback
  ...
  var markErrors = function (
    ...
    getTextMatcher(editor, textMatcherState)
      .find(getSpellcheckerWordcharPattern(editor))

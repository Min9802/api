...
!(function () {
  ...
  var N = function (e) {
    ...
    d = tinymce.util.Tools.resolve('tinymce.util.URI'),
  ...
  var r = function (i, r) {
      ...
      function o(e) {
        ...
        for (var r = 0; r < t.length; r++) {
          ...
          null !== a &&
            a.length &&
            -1 !== o.className.indexOf('mce-spellchecker-word') &&
            ((a !== e && null !== e) || n.push(o));
        }
        return n;
      }
      ...
      function t(e) {
        for (var t = o(e ? c(e) : null), n = t.length; n--; )
          !(function (e) {
      ...
      var l = (function u(e) {
        ...
        if (
          ((t = ''),
          (f[e.nodeName] || g[e.nodeName]) && (t += '\n'),
          (e = e.firstChild))
        )
          for (; (t += u(e)), (e = e.nextSibling); );
        return t;
      })(i);
      return {
        text: l,
        ...
        reset: function () {
          return a.splice(0, a.length), t(), this;
        },
        ...
        add: function (e, t, n) {
          return (
            a.push({ start: e, end: e + t, text: l.substr(e, t), data: n }),
            this
          );
        },
        wrap: function (e) {
          ...
          return (
            a.length &&
              (function (e, t, n) {
                ...
                e: for (;;) {
                  if (
                    ((f[u.nodeName] || g[u.nodeName] || p(u)) && l++,
                    3 === u.nodeType &&
                      (!o && u.length + l >= c.end
                        ? ((o = u), (i = c.end - l))
                        : r && s.push(u),
                ...
                function (e) {
                  ...
                  if (r === o) {
                    ...
                    0 < e.startNodeIndex &&
                      ((t = i.createTextNode(
                        c.data.substring(0, e.startNodeIndex),
                      )),
                      s.insertBefore(t, c));
                    var l = m(e.match, a);
                    return (
                      s.insertBefore(l, c),
                      e.endNodeIndex < c.length &&
                        ((n = i.createTextNode(
                  ...
                  (t = i.createTextNode(r.data.substring(0, e.startNodeIndex))),
                    (n = i.createTextNode(o.data.substring(e.endNodeIndex)));
                  for (
                    var u = m(r.data.substring(e.startNodeIndex), a),
                      d = 0,
                  ...
                  var p = m(o.data.substring(0, e.endNodeIndex), a);
                  return (
                    (s = r.parentNode).insertBefore(t, r),
                    s.insertBefore(u, r),
                    s.removeChild(r),
                    (s = o.parentNode).insertBefore(p, o),
                    s.insertBefore(n, o),
                    s.removeChild(o),
                    p
                  );
        ...
        replace: function (e, t) {
          ...
          return (
            n.deleteContents(),
            0 < t.length && n.insertNode(r.dom.doc.createTextNode(t)),
            n
          );
        },
        rangeFromMatch: s,
    ...
    m = function (e, t, n, r, o, a, i) {
      var c,
        s,
        l,
        u = e.getParam('spellchecker_callback');
      (
        u ||
        ((c = e),
        (s = t),
        (l = n),
        function (e, t, r, o) {
          var n = { method: e, lang: l.get() },
            a = '';
          (n['addToDictionary' === e ? 'word' : 'text'] = t),
            g.each(n, function (e, t) {
              a && (a += '&'), (a += t + '=' + encodeURIComponent(e));
            }),
            f.send({
              url: new d(s).toAbsolute(h(c)),
              type: 'post',
              ...
              success: function (e) {
                ...
                n
                  ? n.error
                    ? o(n.error)
                    : r(n)
                  : ((t = c.translate("Server response wasn't proper JSON.")),
                    o(t));
              },
              error: function () {
                var e =
    ...
    o = function (t, e, n, r, o, a) {
      t.selection.collapse(),
        a
          ? g.each(t.dom.select('span.mce-spellchecker-word'), function (e) {
    ...
    S = function (t, e, n, r, o) {
      ...
      r.set({ suggestions: i, hasDictionarySupport: a });
    ...
    w = 'SpellcheckStart SpellcheckEnd',
    T = function (n, e, r, t, o, a) {
      var i,
        c,
        s,
        l =
    ...
    A = function (c, s, e, l, u, d, f, h) {
      var t = [],
        n = e.get().suggestions[f];
      return (
        g.each(n, function (e) {
          t.push({
            text: e,
            onAction: function () {
              c.insertContent(c.dom.encode(e)), c.dom.remove(h), v(c, l, u);
            },
          });
        }),
            ...
            onAction: function () {
              ...
              (e = s),
                ...
                m(
                  ...
                  a,
                  function () {
                    t.setProgressState(!1), t.dom.remove(i, !0), v(t, n, r);
                  },
                  function (e) {
                    t.notificationManager.open({ text: e, type: 'error' }),
                      t.setProgressState(!1);
    ...
    B = function (o, a, i, c, s, l) {
      o.ui.registry.addContextMenu('spellchecker', {
        update: function (e) {
          ...
          var n = (function (e, t) {
            var n = [],
              r = g.toArray(e.getBody().getElementsByTagName('span'));
            if (r.length)
  ...
  e.add('spellchecker', function (e, t) {
    if (
      !1 ==
      (!!e.hasPlugin('tinymcespellchecker', !0) &&

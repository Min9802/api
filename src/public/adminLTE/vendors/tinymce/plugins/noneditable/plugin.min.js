  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    e = function (e) {
      var t,
        ...
        n =
          ' ' +
          l.trim(e.getParam('noneditable_editable_class', 'mceEditable')) +
          ' ',
        a = ' ' + l.trim(u(e)) + ' ',
        i = f(n),
        o = f(a),
        c =
          (t = e.getParam('noneditable_regexp', [])) && t.constructor === RegExp
            ? [t]
            : t;
        ...
        0 < c.length &&
                    ...
                    (function (i, o, c) {
                      return function (t) {
                        ...
                        return (
                          ...
                          i.dom.encode(e[0]) +
                          '">' +
                          i.dom.encode('string' == typeof e[1] ? e[1] : e[0]) +
                          '</span>'
                        );
                      };
                    })(t, a, u(t)),
          ...
          e.parser.addAttributeFilter('class', function (t) {
            for (var e, n = t.length; n--; )
              (e = t[n]), i(e) ? e.attr(r, 'true') : o(e) && e.attr(r, 'false');
          }),
          e.serializer.addAttributeFilter(r, function (t) {
            for (var e, n = t.length; n--; )
              (e = t[n]),
                (i(e) || o(e)) &&
                  (0 < c.length && e.attr('data-mce-content')
                    ? ((e.name = '#text'),
                      (e.type = 3),
                      (e.raw = !0),
                      (e.value = e.attr('data-mce-content')))
                    : e.attr(r, null));
          });
      });
    };

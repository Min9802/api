  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    i = function (s) {
      function e(i) {
        var o, l, e, t, n, u;
        function r(e) {
          var t = m.select(':input:enabled,*[tabindex]:not(iframe)');
          function n(e) {
            return (
          ...
          if (
            (d.each(t, function (e, t) {
              if (e.id === s.id) return (o = t), !1;
            }),
            0 < e)
          ) {
            for (l = o + 1; l < t.length; l++) if (n(t[l])) return t[l];
          } else for (l = o - 1; 0 <= l; l--) if (n(t[l])) return t[l];
          return null;
        }
        i.keyCode !== f.TAB ||
          i.ctrlKey ||
          ...
          (1 ===
            (e = d.explode(
              (t = s).getParam(
                'tab_focus',
                t.getParam('tabfocus_elements', ':prev,:next'),
              ),
            )).length && ((e[1] = e[0]), (e[0] = ':prev')),
          (n = i.shiftKey
            ? ':prev' === e[0]
              ? r(-1)
              : m.get(e[0])
            ...
            n.id && u
              ...
              : y.setTimeout(function () {
                  a.webkit || window.focus(), n.focus();
                }, 10),
            i.preventDefault()));
      }
      s.on('init', function () {
        s.inline && m.setAttrib(s.getBody(), 'tabIndex', null),
          s.on('keyup', n),
          a.gecko ? s.on('keypress keydown', e) : s.on('keydown', e);
      });
    };

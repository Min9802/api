...
!(function () {
  ...
  var s = function (e) {
    ...
    m = tinymce.util.Tools.resolve('tinymce.html.Node'),
    ...
    d = function (l, i) {
      var e,
        ...
        c =
          ...
          ((a = {}).fontface = g(e)),
          (a.fontsize = y(e)),
          7 === (n = r.firstChild).type &&
            ((a.xml_pi = !0),
            (o = /encoding="([^"]+)"/.exec(n.value)) && (a.docencoding = o[1])),
          (n = r.getAll('#doctype')[0]) &&
            (a.doctype = '<!DOCTYPE' + n.value + '>'),
          (n = r.getAll('title')[0]) &&
            n.firstChild &&
            (a.title = n.firstChild.value),
          p.each(r.getAll('meta'), function (e) {
            var t,
              n = e.attr('name'),
              l = e.attr('http-equiv');
            n
          ...
          (a.stylesheets = []),
          p.each(r.getAll('link'), function (e) {
        ...
        onSubmit: function (e) {
          var t = e.getData(),
            n = (function (e, o, t) {
              ...
              function a(e) {
                c.firstChild ? c.insert(e, c.firstChild) : c.append(e);
              }
              var c,
                s = v(t);
              (c = s.getAll('head')[0]) ||
                ((r = s.getAll('html')[0]),
                (c = new m('head', 1)),
                r.firstChild ? r.insert(c, r.firstChild, !0) : r.append(c)),
                (r = s.firstChild),
                o.xml_pi
                  ? ((n = 'version="1.0"'),
                    o.docencoding && (n += ' encoding="' + o.docencoding + '"'),
                    7 !== r.type &&
                      ((r = new m('xml', 7)), s.insert(r, s.firstChild, !0)),
                    (r.value = n))
                  : r && 7 === r.type && r.remove(),
                (r = s.getAll('#doctype')[0]),
                o.doctype
                  ? (r ||
                      ((r = new m('#doctype', 10)),
                      o.xml_pi ? s.insert(r, s.firstChild) : a(r)),
                    (r.value = o.doctype.substring(9, o.doctype.length - 1)))
                  : r && r.remove(),
                (r = null),
                p.each(s.getAll('meta'), function (e) {
                  'Content-Type' === e.attr('http-equiv') && (r = e);
                }),
                o.docencoding
                  ? (r ||
                      ((r = new m('meta', 1)).attr(
                      ...
                      (r.shortEnded = !0),
                      a(r)),
                    r.attr('content', 'text/html; charset=' + o.docencoding))
                  : r && r.remove(),
                (r = s.getAll('title')[0]),
                o.title
                  ? (r ? r.empty() : a((r = new m('title', 1))),
                    (r.append(new m('#text', 3)).value = o.title))
                  : r && r.remove(),
                p.each(
                  'keywords,description,author,copyright,robots'.split(','),
                  function (e) {
                    for (
                      var t, n = s.getAll('meta'), l = o[e], i = 0;
                      i < n.length;
                      i++
                    )
              ...
              var d = {};
              p.each(s.getAll('link'), function (e) {
                'stylesheet' === e.attr('rel') && (d[e.attr('href')] = e);
              }),
                p.each(o.stylesheets, function (e) {
                  d[e] ||
                    ((r = new m('link', 1)).attr({
                      rel: 'stylesheet',
                      text: 'text/css',
                ...
                (r = s.getAll('body')[0]) &&
                  (i(r, 'dir', o.langdir),
                  i(r, 'style', o.style),
                  i(r, 'vlink', o.visited_color),
                  i(r, 'link', o.link_color),
                  i(r, 'alink', o.active_color),
                  l.setAttribs(e.getBody(), {
                    style: o.style,
                    dir: o.dir,
                ...
                (r = s.getAll('html')[0]) &&
                  (i(r, 'lang', o.langcode), i(r, 'xml:lang', o.langcode)),
                c.firstChild || c.remove();
              var u = f({
                validate: !1,
                indent: !0,
      ...
      l.selection ||
        ...
        ('raw' === l.format && t.get()) ||
          ...
          (0 !== r.length ||
            ...
            (r = p.trim(t.get()) + '\n' + p.trim(r) + '\n' + p.trim(n.get())),
          -1 !==
          (i = (r = r.replace(/<(\/?)BODY/gi, '<$1body')).indexOf('<body'))
            ? ((i = r.indexOf('>', i)),
              t.set(b(r.substring(0, i + 1))),
              -1 === (o = r.indexOf('</body', i)) && (o = r.length),
              (l.content = p.trim(r.substring(i + 1, o))),
              n.set(b(r.substring(o))))
            : (t.set(k(e)), n.set('\n</body>\n</html>')),
          (s = v(t.get())),
          _(s.getAll('style'), function (e) {
          ...
          (m = {}),
          p.each(u.getElementsByTagName('link'), function (e) {
            'stylesheet' === e.rel &&

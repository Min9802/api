...
!(function () {
  ...
  var e,
    ...
    f = {
      ...
      none: u,
      from: function (e) {
        return null === e || e === undefined ? l : c(e);
      },
    },
    P = function (e) {
    ...
    M = tinymce.util.Tools.resolve('tinymce.html.Entities'),
    N = function (e, t, n) {
      var r = e.split(/\n\n/),
        a = (function (e, t) {
          var n,
          ...
          if ('object' == typeof t) {
            for (n in t)
              t.hasOwnProperty(n) &&
                r.push(n + '="' + M.encodeAllRaw(t[n]) + '"');
            r.length && (a += ' ' + r.join(' '));
          }
          return a + '>';
        })(t, n),
        o = '</' + t + '>',
        i = k.map(r, function (e) {
          return e.split(/\n/).join('<br />');
        });
      return 1 === i.length
        ? i[0]
    ...
    B = tinymce.util.Tools.resolve('tinymce.html.DomParser'),
    H = tinymce.util.Tools.resolve('tinymce.html.Serializer'),
    L = '\xa0',
    $ = tinymce.util.Tools.resolve('tinymce.html.Node'),
    z = tinymce.util.Tools.resolve('tinymce.html.Schema');
  function U(t, e) {
    return (
      k.each(e, function (e) {
  ...
  function X(e) {
    ...
    function t(e, t, n) {
      var r = e._listLevel || s;
      r !== s && (o = r < s ? o && o.parent.parent : ((i = o), null)),
        o && o.name === t
          ? o.append(e)
          : ((i = i || o),
            (o = new $(t, 1)),
            ...
            e.wrap(o)),
        (e.name = 'li'),
        s < r && i && i.lastChild.append(o),
        (s = r),
        (function a(e) {
          if (e._listIgnore) e.remove();
          else if ((e = e.firstChild)) for (; a(e), (e = e.next); );
        })(e),
        u(e, /^\u00a0+/),
        u(e, /^\s*([\u2022\u00b7\u00a7\u25CF]|\w+\.)/),
        u(e, /^\u00a0+/);
    }
    for (var n = [], r = e.firstChild; null != r; )
      if ((n.push(r), null !== (r = r.walk())))
        for (; void 0 !== r && r.parent !== e; ) r = r.walk();
    for (var a = 0; a < n.length; a++)
      if ('p' === (e = n[a]).name && e.firstChild) {
        var l = (function d(e) {
          var t = '';
          if (3 === e.type) return e.value;
          if ((e = e.firstChild)) for (; (t += d(e)), (e = e.next); );
          return t;
        })(e);
        if (/^[\s\u00a0]*[\u2022\u00b7\u00a7\u25CF]\s*/.test(l)) {
          t(e, 'ul');
  ...
  var W,
    ...
    Z = function (r, e) {
      ...
      var n = r.getParam(
        ...
        o = z({ valid_elements: n, valid_children: '-li[p]' });
      k.each(o.elements, function (e) {
        e.attributes['class'] ||
        ...
        for (var t, n = e.length; n--; )
          (t = e[n]).attr(
            ...
            (function (n, r, a, o) {
              var i,
                s = {},
                e = n.dom.parseStyle(o);
              return (
                k.each(e, function (e, t) {
                  switch (t) {
                    case 'mso-list':
                      (i = /\w+ \w+([0-9]+)/i.exec(o)) &&
                        (a._listLevel = parseInt(i[1], 10)),
                        /Ignore/i.test(e) &&
                          a.firstChild &&
                          ((a._listIgnore = !0),
                          (a.firstChild._listIgnore = !0));
                      break;
                    case 'horiz-align':
                      t = 'text-align';
                      break;
                ...
                /(bold)/i.test(s['font-weight']) &&
                  (delete s['font-weight'], a.wrap(new $('b', 1))),
                /(italic)/i.test(s['font-style']) &&
                  (delete s['font-style'], a.wrap(new $('i', 1))),
                (s = n.dom.serializeStyle(s, a.name)) || null
              );
            })(r, a, t, t.attr('style')),
          ),
      ...
      var s = i.parse(e);
      return (
        r.getParam('paste_convert_word_fake_lists', !0) && X(s),
        (e = H({ validate: j(r) }, o).serialize(s))
      );
    },
    G = function (e, t) {
    ...
    J = function (e, t, n, r) {
      var a,
        ...
        h = (function (e, t) {
          ...
          return H({ validate: j(e) }, e.schema).serialize(r);
        })(e, v.content);
      return e.hasEventListeners('PastePostProcess') && !v.isDefaultPrevented()
        ? ((u = h),
          ...
          G(g.node.innerHTML, g.isDefaultPrevented()))
        : G(h, v.isDefaultPrevented());
    },
    Q = function (e, t, n) {
      var r,
        a,
        ...
        i = o
          ? ((a = t),
            (r = e).getParam('paste_enable_default_filters', !0) ? Z(r, a) : a)
          : t;
      return J(e, i, n, o);
    },
    ee = function (e, t) {
    ...
    ne = function (e, r) {
      return (
        te(r) &&
        g(A(e), function (e) {
          return x((t = r), (n = '.' + e), t.length - n.length);
          var t, n;
        })
      );
    },
    re = function (e, t, n) {
      return (
        !(!1 !== e.selection.isCollapsed() || !te(t)) &&
        ((a = t),
        (o = n),
    ...
    se = function (e, t) {
      var n,
        ...
        i =
          ((n = ' '),
          (r = e.getParam('paste_tab_spaces', 4, 'number')) <= 0
            ? ''
            : new Array(r + 1).join(n)),
        s = t.replace(/\t/g, i);
      return ((o = {
        pcIsSpace: !(a = function (e, t) {
          return -1 !== ' \f\t\x0B'.indexOf(t) || t === L
            ? e.pcIsSpace ||
              '' === e.str ||
              e.str.length === s.length - 1 ||
              ((n = s), (r = e.str.length + 1) < n.length && 0 <= r && ie(n[r]))
              ? { pcIsSpace: !1, str: e.str + L }
              : { pcIsSpace: !0, str: e.str + ' ' }
            : { pcIsSpace: ie(t), str: e.str + t };
          var n, r;
        }),
        str: '',
      }),
    ...
    ue = function (e, t, n, r) {
      var a = Q(e, t, n);
      !1 === a.cancelled && oe(e, a.content, r);
    },
    le = function (e, t, n) {
      var r = n || E(t);
      ue(e, t.replace(F, ''), r, !1);
    },
    ce = function (e, t) {
      var n,
        r,
        a,
        o = e.dom.encode(t).replace(/\r\n/g, '\n'),
        i = se(e, o),
        s =
          ((n = i),
          (r = e.getParam('forced_root_block')),
          (a = e.getParam('forced_root_block_attrs')),
          r ? N(n, !0 === r ? 'p' : r, a) : n.replace(/\r?\n/g, '<br>'));
      ue(e, s, !1, !0);
    },
    fe = function (e) {
      var t,
      ...
      if (
        ...
        (!e.getData ||
          ((t = e.getData('Text')) &&
            0 < t.length &&
            -1 === t.indexOf('data:text/mce-internal,') &&
            (n['text/plain'] = t)),
        e.types)
      )
    ...
    me = function (e) {
      return de(e, 'text/html') || de(e, 'text/plain');
    },
    pe =
      ((W = 'mceclip'),
      (Y = 0),
    ...
    ge = function (e, t) {
      ...
      (x.src = t.uri),
        (m = x),
        !(p = e.getParam('images_dataimg_filter')) || p(m)
          ? ((l = void 0),
            (o = (a = e.editorUpload.blobCache).getByData(v, h))
              ? (l = o)
              : ((s = (i = e.getParam('images_reuse_filename') && P(b.name))
                  ? ((c = e),
                    (f = b.name),
                    (d = f.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i)),
                    P(d) ? c.dom.encode(d[1]) : null)
                  : y),
                (u = i ? b.name : undefined),
                (l = a.create(y, b, v, s, u)),
                a.add(l)),
            le(e, '<img src="' + l.blobUri() + '">', !1))
          : le(e, '<img src="' + t.uri + '">', !1);
    },
    ve = function (e) {
      return T.all(
        v(e, function (r) {
          ...
          x(e, 'image/', 0) &&
            g(t, function (e) {
              return (
                ...
                (k.hasOwn(n, t) ? 'image/' + n[t] : 'image/' + t) === r.type
              );
              var t, n;
            })
        );
    ...
    be = function (e) {
      return (
        (C.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    xe = function (s, u, l) {
      ...
      function m(e, t, n, r, a) {
        ...
        var i =
          ...
          s = ne(e, o);
        (o.length && (!i || s)) || (r = !0),
          (r || s) && (o = de(t, 'text/plain') && i ? t['text/plain'] : q(o)),
          u.isDefaultContent(o)
            ? n ||
      ...
      s.on('keyup', d.clear),
        s.on('keydown', function (e) {
          var t,
            n = function (e) {
              be(e) && !e.isDefaultPrevented() && u.remove();
            };
          if (be(e) && !e.isDefaultPrevented()) {
            if (
              (c = e.shiftKey && 86 === e.keyCode) &&
              w.webkit &&
              -1 !== navigator.userAgent.indexOf('Version/')
            )
              return;
            if ((e.stopImmediatePropagation(), f.set(e), d.set(!0), w.ie && c))
              return (
                e.preventDefault(),
                (t = !0),
                void s.fire('paste', { ieFake: t })
              );
            u.remove(),
              u.create(),
              s.once('keyup', n),
      ...
      s.on('paste', function (e) {
        var t = f.isSet() || d.isSet();
        t && f.clear();
        var n,
          r,
          a = ((n = s), fe(e.clipboardData || n.getDoc().dataTransfer)),
          o = 'text' === l.get() || c,
          i = de(a, I);
        (c = !1),
          !(
          ...
          (me(a) || !ye(s, e, u.getLastRng() || s.selection.getRng()))
            ? (t || e.preventDefault(),
              !w.ie ||
                (t && !e.ieFake) ||
                de(a, 'text/html') ||
                (u.create(),
                s.dom.bind(u.getEl(), 'paste', function (e) {
                  e.stopPropagation();
                }),
                s.getDoc().execCommand('Paste', !1, null),
                (a['text/html'] = u.getHtml())),
              de(a, 'text/html')
                ? (e.preventDefault(),
                  (i = i || E(a['text/html'])),
                  m(s, a, t, o, i))
    ...
    Pe = function (i, e, t) {
      ...
      xe(i, e, t),
        i.parser.addNodeFilter('img', function (e, t, n) {
          var r,
            a = function (e) {
              e.attr('data-mce-object') || s === w.transparentSrc || e.remove();
            };
          if (!R(i) && (r = n).data && !0 === r.data.paste)
            for (var o = e.length; o--; )
              (s = e[o].attr('src')) &&
                ((0 !== s.indexOf('webkit-fake-url') &&
    ...
    we = function (e) {
      return w.ie && e.inline ? document.body : e.getBody();
    },
    _e = function (t, e, n) {
      var r;
      we((r = t)) !== r.getBody() &&
    ...
    De = function (e, t) {
      var n,
        r = Te(e);
      return (n = r) && 'mcepastebin' === n.id && Ce(t, r.innerHTML);
    },
    ke = function (e) {
      var t = d(null),
        n = '%MCEPASTEBIN%';
          ...
          return (function (e, t, n) {
            ...
            (w.ie || w.gecko) &&
              r.setStyle(
                o,
                'left',
                'rtl' === r.getStyle(a, 'direction', !0) ? 65535 : -65535,
              ),
              r.bind(o, 'beforedeactivate focusin focusout', function (e) {
                e.stopPropagation();
              }),
              _e(e, o, n),
              o.focus(),
        ...
        getHtml: function () {
          return (function (n) {
            var t = function (e, t) {
              ...
              e = k.grep(we(n).childNodes, function (e) {
            ...
            for (
              var a = n.dom.select('div[id=mcepastebin]', r), o = a.length - 1;
              0 <= o;
              o--
            ) {
    ...
    Se = function (n, r) {
      n.addCommand('mceTogglePlainTextPaste', function () {
        var e, t;
        (e = n),
          'text' === (t = r).pasteFormat.get()
            ? (t.pasteFormat.set('html'), D(e, !1))
            : (t.pasteFormat.set('text'), D(e, !0)),
          e.focus();
      }),
    ...
    Oe = function (e, t, n) {
      if (
        ((r = e),
        !1 !== w.iOS || 'function' != typeof (null == r ? void 0 : r.setData))
      )
        return !1;
      try {
        return (
    ...
    je = function (e, t, n, r) {
      Oe(e.clipboardData, t.html, t.text)
        ? (e.preventDefault(), r())
        : n(t.html, r);
    },
    Re = function (s) {
      return function (e, t) {
        var n = F + e,
          ...
          a = s.dom.create('div', { contenteditable: 'true' }, n);
        s.dom.setStyles(r, {
          position: 'fixed',
          top: '0',
          left: '-3000px',
    ...
    Fe = function (e) {
      ...
      e.on(
        ...
        function (e) {
          Ie(t) &&
            je(e, Ae(t), Re(t), function () {
              var e;
              w.browser.isChrome() || w.browser.isFirefox()
        ...
        e.on(
          ...
          ((n = e),
          function (e) {
            Ie(n) && je(e, Ae(n), Re(n), function () {});
          }),
        );
    },
    Ee = tinymce.util.Tools.resolve('tinymce.dom.RangeUtils'),
    Me = function (e, t) {
      return Ee.getCaretRangeFromPoint(t.clientX, t.clientY, e.getDoc());
    },
    Ne = function (e, t) {
      ...
      i.getParam('paste_block_drop', !1) &&
        ...
        i.on('drop', function (e) {
          ...
          e.isDefaultPrevented() ||
            ...
            (n = s.hasContentType(t, I)),
            ((!s.hasHtmlOrText(t) ||
              ((r = t['text/plain']) && 0 === r.indexOf('file://'))) &&
              s.pasteImageData(e, o)) ||
              !o ||
              !i.getParam('paste_filter_drop', !0) ||
              ((a = t['mce-internal'] || t['text/html'] || t['text/plain']) &&
                (e.preventDefault(),
                _.setEditorTimeout(i, function () {
        ...
        i.on('dragover dragend', function (e) {
          S(i) && !1 === u.get() && (e.preventDefault(), Ne(i, Me(i, e))),
            'dragend' === e.type && u.set(!1);
        });
    };
  function He(t, n) {
  ...
  function Le(e, t) {
    ...
    var n = [];
    return (
      k.each(e.schema.getBlockElements(), function (e, t) {
        n.push(t);
      }),
      (t = U(t, [
        [
  ...
  function $e(e, t, n, r) {
    ...
    return !1 === e.getParam('paste_remove_styles_if_webkit', !0) || 'all' === a
      ? t
      : (a && (l = a.split(/[, ]/)),
        (t = (t = l
          ? ((c = e.dom),
            ...
            t.replace(
              ...
              function (e, t, n, r) {
                var a = c.parseStyle(c.decode(n)),
                  o = {};
                if ('none' === l) return t + r;
                for (var i = 0; i < l.length; i++) {
                  var s = a[l[i]],
                    u = c.getStyle(f, l[i], !0);
                  /color/.test(l[i]) && ((s = c.toHex(s)), (u = c.toHex(u))),
                    u !== s && (o[l[i]] = s);
                }
                return (o = c.serializeStyle(o, 'span'))
                  ? t + ' style="' + o + '"' + r
                  : t + r;
              },
            ))
          : t.replace(/(<[^>]+) style="([^"]*)"([^>]*>)/gi, '$1$3')).replace(
          /(<[^>]+) data-mce-style="([^"]+)"([^>]*>)/gi,
          function (e, t, n, r) {
            return t + ' style="' + n + '"' + r;
          },
  ...
  var Ue = function (n, r) {
    return function (t) {
      t.setActive('text' === r.pasteFormat.get());
      var e = function (e) {
  ...
  a.add('paste', function (e) {
    if (
      !1 ==
      (!!e.hasPlugin('powerpaste', !0) &&
      ...
      var t = d(!1),
        n = d(e.getParam('paste_as_text', !1) ? 'text' : 'html'),
        r =
          ((c = n),
          (f = ke((l = e))),
      ...
      (i = e),
        ...
        w.ie &&
          (He(i, Le),
          (u = ze),
          (s = i).on('PastePostProcess', function (e) {
            u(s, e.node);
          }));
      return (
        (o = r),

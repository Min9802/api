...
(function () {
  ...
  var tab$2 = function (editor) {
    var availablePlugins = function () {
      ...
      return (
        ...
        '<ul>' +
        premiumPluginList +
        '<li class="tox-help__more-link" "><a href="https://www.tiny.cloud/pricing/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">' +
  ...
  var parseCustomTabs = function (editor, customTabs) {
    ...
    var tabs = __assign(
      ((_a = {}),
      (_a[shortcuts.name] = shortcuts),
      (_a[nav.name] = nav),
      (_a[plugins.name] = plugins),
      (_a[versions.name] = versions),
      _a),
      customTabs.get(),
    );
    return getHelpTabs(editor).fold(
      function () {

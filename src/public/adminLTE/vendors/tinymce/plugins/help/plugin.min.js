...
!(function () {
  ...
  var e,
    ...
    v = function (e) {
      ...
      return k.mac ? a.join('').replace(/\s/, '') : a.join('+');
    },
    w = [
    ...
    A = tinymce.util.Tools.resolve('tinymce.util.I18n'),
    C = [
                ...
                : '<div data-mce-tabstop="1" tabindex="-1">' +
                  (function (a) {
                    var e,
                      ...
                      o =
                        ((t = f((e = a).plugins)),
                        (n = e.getParam('forced_plugins')) === undefined
                          ? t
                          : (function (e, t) {
                              for (
                        ...
                        return (
                          ...
                          g(C, function (e) {
                            ...
                            function () {
                              ...
                              return 'function' == typeof e ? l(e()) : n;
                            },
                            function (e) {
                              var t = e.slug || e.key;
                              return l({
                                name: e.name,
                                url: 'https://www.tiny.cloud/docs/plugins/' + t,
                              });
                            },
                          )) +
                          '</li>'
    ...
    x = tinymce.util.Tools.resolve('tinymce.EditorManager'),
    P = function (e, t) {
      var n,
        a,
        o,
          ...
          items: [
            {
              ...
              cells: p(w, function (e) {
                var t = p(e.shortcuts, v).join(' or ');
                return [e.action, t];
              }),
            },
          ],
        ...
        u =
            ...
            '</a>'),
          {
            ...
            items: [
              {
                type: 'htmlpanel',
                html: '<p>' + A.translate(['You are using {0}', i]) + '</p>',
                presets: 'document',
              },
            ],
          }),
      ...
      return (
        (r = e),
        d.from(r.getParam('help_tabs')).fold(
          function () {
            return (
              (t = f((e = h))),
              -1 !== (n = t.indexOf('versions')) &&
                (t.splice(n, 1), t.push('versions')),
              { tabs: e, names: t }
            );
            var e, t, n;
          },
        ...
        var e = P(o, i),
          ...
          n = {
            ...
            tabs: (function (e) {
              ...
              p(t, function (e) {
                return y((t = a), (n = e)) ? d.from(t[n]) : d.none();
                var t, n;
              }),
            ),
          };
  ...
  a.add('help', function (e) {
    ...
    return (
      (o = l),
      (a = e).ui.registry.addButton('help', {
        icon: 'help',
        tooltip: 'Help',
        onAction: o,
      }),
      a.ui.registry.addMenuItem('help', {
        text: 'Help',
        icon: 'help',
        shortcut: 'Alt+0',
        onAction: o,

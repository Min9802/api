...
!(function () {
  ...
  var s,
    ...
    k = A,
    P = function (t) {
      for (var e = k, n = B.length, r = 0; r < n; ++r) {
        var o = B[r];
        if (o && o.test(t)) {
          e = r;
          break;
    ...
    _ = function (t, e) {
      var n = (function (t, e) {
        for (var n = e; n < t.length && !O.test(t[n]); n++);
        return n;
      })(t, e + 1);
      return '://' ===
        t
    ...
    N = function (t, e, n, r) {
      for (var o, u, c, i, a, s, g, l = [], p = [], f = 0; f < n.length; ++f) {
        p.push(t[f]),
          (function (t, e) {
            var n = t[e],
              r = t[e + 1];
            ...
            ((o = e[f]),
            (!r.includeWhitespace && O.test(o)) ||
              (!r.includePunctuation && U.test(o)) ||
              ((u = f - p.length + 1),
              (c = f + 1),
              (i = e.slice(u, c).join('')),
              ('http' !== (g = i) && 'https' !== g) ||
    ...
    $ = function (t, e, n) {
      n = a(a({}, { includeWhitespace: !1, includePunctuation: !1 }), n);
      for (var r = [], o = [], u = 0; u < t.length; u++) {
        var c = e(t[u]);
        '\ufeff' !== c && (r.push(t[u]), o.push(c));
      }
      var i = M(o);
      return N(r, o, i, n);
    },
    z = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    I = function (t, e) {
      for (
        var n,
          r = e.getBlockElements(),
          o = e.getShortEndedElements(),
          u = [],
          c = '',
          i = new z(t, t);
        (t = i.next());
    ...
    t.add('wordcount', function (t) {
      var e,
        ...
        a = {
          body: {
            getWordCount: L((e = t)),
            getCharacterCount: J(e, G),
            getCharacterCountWithoutSpaces: J(e, H),
          },
          selection: {
            getWordCount: K(e, q),
            getCharacterCount: K(e, G),
            getCharacterCountWithoutSpaces: K(e, H),
          },
          getCount: L(e),
        };
      return (
        (r = a),
        (n = t).ui.registry.addButton('wordcount', {
          tooltip: 'Word count',
        ...
        n.ui.registry.addMenuItem('wordcount', {
          text: 'Word count',
          icon: 'character-count',
          onAction: function () {
            return X(n, r);
        ...
        o.on('init', function () {
          V(o, u),
            Q.setEditorTimeout(
              o,
              function () {
                o.on('SetContent BeforeAddUndo Undo Redo keyup', i);
              },
              0,
            );
        }),

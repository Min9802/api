...
!(function () {
  ...
  var n,
    ...
    y = {
      ...
      none: s,
      from: function (t) {
        return null === t || t === undefined ? l : d(t);
      },
    },
    m = function (e) {
      return function (t) {
    ...
    T = function (t) {
      return (n = t), (r = 0) <= r && r < n.length ? y.some(n[r]) : y.none();
      var n, r;
    },
    N = Object.keys,
    ...
    S =
      ((function (i) {
        if (!h(i)) throw new Error('cases must be an array');
        ...
        w(i, function (t, e) {
          ...
          if (!h(a)) throw new Error('case arguments must be an array');
          u.push(o),
            (r[o] = function () {
    ...
    _ = function (o) {
      ...
      if (!p(o)) return a('Raw pattern is not an object');
      if (!g(o.start)) return a('Raw pattern is missing `start` parameter');
      if (o.end === undefined)
      ...
      if (!g(o.end)) return a('Inline pattern has non-string `end` parameter');
      if (0 === o.start.length && 0 === o.end.length)
    ...
    U = function (t) {
      return 'block-command' === t.type
        ...
        : 'inline-command' === t.type
        ? 'mceInsertContent' === t.cmd && '' === t.start
    ...
    q = function (t) {
      return { inlinePatterns: C(t, D), blockPatterns: j(C(t, I)) };
    },
    L = function (e) {
      return {
          ...
          return (function () {
            ...
            for (var e = Array(t), o = 0, n = 0; n < r; n++)
              for (var a = arguments[n], i = 0, u = a.length; i < u; i++, o++)
                e[o] = a[i];
            return e;
          })(O(e.get().inlinePatterns, U), O(e.get().blockPatterns, U));
        },
      };
    },
    ...
    J = tinymce.util.Tools.resolve('tinymce.util.VK'),
    K = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    X = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    z = tinymce.util.Tools.resolve('tinymce.dom.TextSeeker'),
    Q = function (t, n) {
    ...
    Z = function (t, n, r) {
      ...
      n &&
        t.isEmpty(n) &&
        !r(n) &&
        ((e = n.parentNode), t.remove(n), Z(t, e, r));
    },
    $ = function (t, n, r, e) {
      void 0 === e && (e = !0);
      ...
      n.deleteContents(),
        e &&
          !r(n.startContainer) &&
          (Y(n.startContainer) &&
            0 === n.startContainer.data.length &&
            t.remove(n.startContainer),
          Y(n.endContainer) &&
            0 === n.endContainer.data.length &&
    ...
    rt = function (t, n) {
      var r = y.from(t.dom.getParent(n.startContainer, t.dom.isBlock));
      return '' === G(t)
        ? r.orThunk(function () {
    ...
    at = function (t, n, r) {
      if (Y(t) && 0 <= n) return y.some(Q(t, n));
      var e = z(et);
    ...
    it = function (t, r, e) {
      ...
      var n = t.textContent;
      if (0 <= r && r <= n.length) return y.some(Q(t, r));
      var o = z(et);
      ...
      var a,
        i = z(
          ...
          function (t) {
            return (
              a.isBlock(t) ||
              k(['BR', 'IMG', 'HR', 'INPUT'], t.nodeName) ||
              'false' === a.getContentEditable(t)
            );
          }),
        );
    ...
    lt = function (t, n) {
      ...
      o).bind(function (t) {
        return Y(t) && (i < 0 || i > t.data.length)
          ? y.none()
          : y.some({ node: t, offset: i });
      });
    },
    dt = function (n, r) {
    ...
    gt = function (e, a) {
      ...
      return rt(e, t)
        ...
        .bind(function (n) {
          ...
          (e = (r = o).replace('\xa0', ' ')),
          x(t, function (t) {
            return 0 === r.indexOf(t.start) || 0 === e.indexOf(t.start);
          })).map(function (t) {
    ...
    bt = function (t, n, r) {
      var e = dt(t.getRoot(), r).getOrDie('Unable to resolve path range'),
        o = e.startContainer,
        a = e.endContainer,
    ...
    wt = function (a, i, u) {
      ...
      return it(l, d - u.pattern.end.length, i).bind(function (t) {
        var e = st(c, t.container, t.offset, l, d);
        if (nt(s))
          return y.some({
            matches: [{ pattern: s, startRng: e, endRng: e }],
            position: t,
          });
        var n = Ct(a, u.remainingPatterns, t.container, t.offset, i),
          o = n.getOr({ matches: [], position: t }),
          r = o.position;
        return (function (t, r, n, e, o, a) {
          if ((void 0 === a && (a = !1), 0 !== r.start.length || a))
      ...
      return at(g, p, v.getRoot()).bind(function (t) {
        ...
        for (var r, e, o, a, i, u = n.toString(), f = 0; f < m.length; f++) {
          ...
          if (
            ...
            var s = m.slice();
            s.splice(f, 1);
            var l = wt(d, h, { pattern: c, remainingPatterns: s, position: t });
    ...
    xt = function (o, t) {
      var n,
        ...
        i = E(
          t,
          function (t, n) {
            var r = bt(o, a + '_end' + t.length, n.endRng);
            return t.concat([u(u({}, n), { endMarker: r })]);
          },
          [],
        );
      return E(
        ...
        function (t, n) {
          ...
          return t.concat([u(u({}, n), { startMarker: e })]);
        },
        [],
      );
    },
      ...
      0 !== t.length &&
        ...
        w(r, function (t) {
          var n,
            ...
            o,
            a,
            i = c.getParent(t.startMarker.start, c.isBlock),
            u = function (t) {
              return t === i;
            };
          nt(t.pattern)
            ...
            : (function (t, n, r, e, o) {
                var a = t.dom,
                  ...
                  u = yt(a, r);
                $(a, u, o), $(a, i, o);
                var f = { prefix: r.prefix, start: r.end, end: e.start },
                  c = yt(a, f);
                Et(t, n, c);
    ...
    Pt = function (t, n, r) {
      for (var e = 0; e < t.length; e++) if (r(t[e], n)) return !0;
    },
    St = function (n, r) {
      var e = [',', '.', ';', ':', '!', '?'],
        o = [32];
        ...
        function (t) {
          13 !== t.keyCode ||
            ...
            !(function (r, t) {
              ...
              var e = Rt(r, t.inlinePatterns, !1),
                o = gt(r, t.blockPatterns);
              return (
                ...
                r.undoManager.extra(
                  ...
                  function () {
                    ...
                    var t = r.selection.getRng(),
                      n = at(t.startContainer, t.startOffset, r.dom.getRoot());
                    r.execCommand('mceInsertNewLine'),
                      n.each(function (t) {
                        var n = t.container;
  ...
  t.add('textpattern', function (t) {
    var n,
      ...
      e =
        ((n = (function (t) {
          var n = t.getParam('textpattern_patterns', F, 'array');
          if (!h(n))
            return (
          ...
          var r = S(O(n, _));
          return (
            w(r.errors, function (t) {
              return W(t.message, t.pattern), 0;
            }),
            q(r.values)
          );
        })(t)),

...
!(function () {
  ...
  var e,
    ...
    g = {
      ...
      none: c,
      from: function (e) {
        return null === e || e === undefined ? l : s(e);
      },
    },
    p = u,
    ...
    I = {
      ...
      fromPoint: function (e, t, n) {
        return g.from(e.dom.elementFromPoint(t, n)).map(F);
      },
    },
    P = function (e, t) {
    ...
    R = function (e, t) {
      var n = N(e.dom.childNodes, I.fromDom);
      return 0 < n.length && t < n.length ? P(n[t], 0) : P(e, t);
    },
    W = function (t, n) {
      var e;
      ((e = t), g.from(e.dom.parentNode).map(I.fromDom)).each(function (e) {
        e.dom.insertBefore(n.dom, t.dom);
      });
    },
    j = function (e, t) {
      var n;
      W(e, t), (n = e), t.dom.appendChild(n.dom);
    };
  var q,
    V,
    _,
    H =
      ...
      (V = 'text'),
      {
        ...
        getOption: (_ = function (e) {
          return q(e) ? g.from(e.dom.nodeValue) : g.none();
        }),
        set: function (e, t) {
          if (!q(e))
            throw new Error(
              'Can only set raw ' + V + ' value of a ' + V + ' node',
            );
          e.dom.nodeValue = t;
        },
      }),
    ...
    U = function (e, t) {
      return (
        (n = t),
        (i = (r = e) === undefined ? document : r.dom),
        (1 !== (o = i).nodeType && 9 !== o.nodeType && 11 !== o.nodeType) ||
        0 === o.childElementCount
          ? []
          : N(i.querySelectorAll(n), I.fromDom)
      );
      var n, r, o, i;
    },
    $ = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    z = function (e, t) {
      return e.isBlock(t) || D(e.schema.getShortEndedElements(), t.nodeName);
    },
    G = function (e, t) {
      return 'false' === e.getContentEditable(t);
    },
    K = function (e, t) {
      return !e.isBlock(t) && D(e.schema.getWhiteSpaceElements(), t.nodeName);
    },
    J = function () {
      return { sOffset: 0, fOffset: 0, elements: [] };
    },
    Q = function (e, t) {
      return R(I.fromDom(e), t);
    },
    ...
    Y = function (e, t, n, r, o) {
      ...
      z((i = e), (a = n)) ||
        ...
        K(i, a) ||
        ((c = a),
        'true' === (u = i).getContentEditable(c) &&
          'false' === u.getContentEditableParent(c.parentNode)) ||
        ((l = e.getParent(r, e.isBlock)),
        (s = new $(n, l)),
        (f = o ? s.next : s.prev),
        X(e, f, n, {
          boundary: m,
      ...
      return (
        X(
          ...
          n,
          {
            ...
            text: function (e) {
              c.elements.push(I.fromDom(e)), o && o.text(e, c);
            },
          },
          r,
          i,
    ...
    ee = function (i, e) {
      ...
      return Z(
        ...
        a,
        {
          text: function (e, t) {
            e === a
              ? (t.fOffset += e.length - o.offset)
              : e === r && (t.sOffset += n.offset);
          },
          cef: function (e) {
            var t,
              n,
              r,
              o = S(U(I.fromDom(e), '*[contenteditable=true]'), function (e) {
                var t = e.dom;
                return Z(i, t, t);
              });
            return (
              ...
              (n = function (e, t) {
                return (
                  ...
                  0 != (o.compareDocumentPosition(i) & a) ? 1 : -1
                );
                var n, r, o, i, a;
              }),
              (r = C.call(t, 0)).sort(n),
    ...
    re = function (e, a) {
      ...
      return (function (e, t) {
        ...
        ((t = function (e, n) {
          ...
          return { results: e.results.concat(i), last: o };
        }),
        (n = { results: [], last: 0 }),
        E(e, function (e) {
          n = t(n, e);
          ...
          r = (function (e, t, n, r) {
            ...
            for (var i, a = []; (i = o.exec(e)); ) {
              var u = i[t.matchIndex],
                ...
                l = c + u.length;
              if (r < l) break;
              a.push({ start: c, finish: l }), (o.lastIndex = l);
            }
            return a;
    ...
    ie = function (e, i) {
      k(e, function (e, o) {
        k(e, function (e) {
          var t = I.fromDom(i.cloneNode(!1));
          B(t, 'data-mce-index', o);
          var n,
            r = e.element.dom;
          r.length === e.finish && 0 === e.start
            ? j(e.element, t)
            : (r.length !== e.finish && r.splitText(e.finish),
              (n = r.splitText(e.start)),
              j(I.fromDom(n), t));
        });
      });
    },
    ...
    ce = function (e, t, n, r) {
      var o = e.dom.create('span', { 'data-mce-bogus': 1 });
    ...
    se = function (e, t) {
      var n = [],
        r = v.toArray(e.getBody().getElementsByTagName('span'));
      if (r.length)
    ...
    fe = function (e, t, n) {
      ...
      (n = !1 !== n)
        ...
        ? (o = r.count - 1)
        : o--,
        i.removeClass(se(e, r.index), 'mce-match-marker-selected');
      var a = se(e, o);
      return a.length
        ? (i.addClass(se(e, o), 'mce-match-marker-selected'),
      ...
      var a,
        ...
        l =
          ...
          (u =
            ...
            ')'),
          a ? '(?:^|\\s|' + p() + ')' + u + '(?=$|\\s|' + p() + ')' : u),
        s = { regex: new RegExp(l, r ? 'g' : 'gi'), matchIndex: 1 },
        f = ce(e, t, s, i);
      return (
        f &&
          ((c = fe(e, t, !0)),
    ...
    ve = function (e, t, n, r, o) {
      ...
      for (
        var l = e.getBody(),
          s = v.grep(v.toArray(l.getElementsByTagName('span')), pe),
          f = 0;
        f < s.length;
        f++
      ) {
        ...
        if (o || m === a.index) {
          for (
            n.length
              ? ((s[f].firstChild.nodeValue = n), le(s[f]))
              : de(e.dom, s[f]);
            s[++f];
      ...
      return (
        t.set(h(h({}, a), { count: o ? 0 : a.count - 1, index: c })),
        (r ? he : ge)(e, t),
        !o && 0 < t.get().count
      );
    },
    ye = function (e, t, n) {
      for (
        var r,
          o,
          i = t.get(),
          a = v.toArray(e.getBody().getElementsByTagName('span')),
          u = 0;
        u < a.length;
        u++
      ) {
        ...
        null !== c &&
          c.length &&
          (c === i.index.toString() &&
            ((r = r || a[u].firstChild), (o = a[u].firstChild)),
          le(a[u]));
      }
      if ((t.set(h(h({}, i), { index: -1, count: 0, text: '' })), r && o)) {
        var l = e.dom.createRng();
        return (
          l.setStart(r, 0),
          l.setEnd(o, o.data.length),
          !1 !== n && e.selection.setRng(l),
          l
        );
      }
    },
    ...
    be = function (i, a) {
      ...
      i.undoManager.add();
      var n = v.trim(i.selection.getContent({ format: 'text' }));
      function u(e) {
        (1 < a.get().count ? e.enable : e.disable)('next'),
          (1 < a.get().count ? e.enable : e.disable)('prev');
      }
      var c = function (e, t) {
        var n = t ? e.disable : e.enable;
        E(['replace', 'replaceall', 'prev', 'next'], n);
      };
      var l = function (e, t) {
          xe.browser.isSafari() &&
            xe.deviceType.isTouch() &&
        ...
        f = function (e) {
          ...
          r.findtext.length
            ? (o.text === r.findtext &&
              o.matchCase === r.matchcase &&
              o.wholeWord === r.wholewords
                ? he(i, a)
                : ((t = me(
                    i,
                    a,
        ...
        o = {
          ...
          buttons: [
            ...
            { type: 'custom', name: 'replace', text: 'Replace', disabled: !0 },
            {
              type: 'custom',
              name: 'replaceall',
              text: 'Replace All',
      ...
      e.set(i.windowManager.open(o, { inline: 'toolbar' }));
    },
    we = function (e, t) {
      return function () {
        be(e, t);
  ...
  o.add('searchreplace', function (e) {
    ...
    return (
      (n = u),
      (t = e).addCommand('SearchReplace', function () {
        be(t, n);
      }),
      (o = u),
      (r = e).ui.registry.addMenuItem('searchreplace', {

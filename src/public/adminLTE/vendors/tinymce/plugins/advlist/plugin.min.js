...
!(function () {
  ...
  var n,
    ...
    u = function (n, e, t) {
      ...
      n.execCommand(r, !1, !1 === t ? null : { 'list-style-type': t });
    },
    ...
    d = function (n) {
      return null === n || n === undefined ? a : f(n);
    },
    g = function (n) {
    ...
    y = function (o, n, e, t, r, i) {
      o.ui.registry.addSplitButton(n, {
        ...
        onItemAction: function (n, e) {
          u(o, r, e);
        },
        select: function (e) {
          var n, t, r;
          return ((t = (n = o).dom.getParent(n.selection.getNode(), 'ol,ul')),
          (r = n.dom.getStyle(t, 'listStyleType')),
          d(r))
            .map(function (n) {
              return e === n;
            })
  ...
  r.add('advlist', function (n) {
    ...
    n.hasPlugin('lists') &&
      ...
      v(
        ...
        'InsertUnorderedList',
        'UL',
        (o = e.getParam('advlist_bullet_styles', 'default,circle,square'))
          ? o.split(/[ ,]/)
          : [],
      ),
      (t = n).addCommand('ApplyUnorderedListStyle', function (n, e) {

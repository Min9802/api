  ...
  var n,
    ...
    y = {
      ...
      fromPoint: function (n, t, e) {
        return s.from(n.dom.elementFromPoint(t, e)).map(h);
      },
    },
    v =
    ...
    D =
      g(Element.prototype.attachShadow) && g(Node.prototype.getRootNode)
        ...
        : function (n) {
            return T(n) ? n : ((t = n), y.fromDom(t.dom.ownerDocument));
            var t;
          },
    w = function (n) {
      var t = D(n);
      return N(t) ? s.some(t) : s.none();
    },
    O = function (n) {
      return y.fromDom(n.dom.host);
    },
    C = function (n) {
      var t = p(n) ? n.dom.parentNode : n.dom;
      if (t === undefined || null === t || null === t.ownerDocument) return !1;
      var e,
        o,
        r = t.ownerDocument;
      return w(y.fromDom(t)).fold(
        function () {
    ...
    S = function (n, t) {
      return (e = n).style !== undefined && g(e.style.getPropertyValue)
    ...
    L = function (n) {
      return 'rtl' ===
        ((e = 'direction'),
        (o = (t = n).dom),
        '' !== (r = window.getComputedStyle(o).getPropertyValue(e)) || C(t)
          ? r
          : S(o, e))
        ? 'rtl'
        : 'ltr';

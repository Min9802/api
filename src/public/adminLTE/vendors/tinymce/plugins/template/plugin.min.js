...
!(function () {
  ...
  var n,
      ...
      return (
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
          (t = (t = t.replace('%D', '%m/%d/%Y')).replace(
            '%r',
            '%I:%M:%S %p',
          )).replace('%Y', '' + n.getFullYear())).replace(
          '%y',
          '' + n.getYear(),
        )).replace('%m', m(n.getMonth() + 1, 2))).replace(
          '%d',
          m(n.getDate(), 2),
        )).replace('%H', '' + m(n.getHours(), 2))).replace(
          '%M',
          '' + m(n.getMinutes(), 2),
        )).replace('%S', '' + m(n.getSeconds(), 2))).replace(
          '%I',
          '' + (((n.getHours() + 11) % 12) + 1),
        )).replace('%p', n.getHours() < 12 ? 'AM' : 'PM')).replace(
          '%B',
          '' + e.translate(c[n.getMonth()]),
    ...
    g = function (e, t) {
      var r = e.dom,
        a = l(e);
      _.each(r.select('*', t), function (n) {
        _.each(a, function (e, t) {
          r.hasClass(n, t) && 'function' == typeof a[t] && a[t](n);
        });
      });
    },
    v = function (e, t) {
    ...
    y = function (n, e, t) {
      var r,
        a = n.dom,
        o = n.selection.getContent();
      (t = x(t, l(n))), (r = a.create('div', null, t));
      var c = a.select('.mceTmpl', r);
      c &&
        0 < c.length &&
        (r = a.create('div', null)).appendChild(c[0].cloneNode(!0)),
        _.each(a.select('*', r), function (e) {
          var t;
          v(
            e,
            ...
            v(e, i(n).replace(/\s+/g, '|')) && (e.innerHTML = p(n, f(n))),
            v(
              e,
              n
    ...
    N = function (e) {
      return e.replace(/["'<>&]/g, function (e) {
        return (A((t = C), (n = e)) ? O.from(t[n]) : O.none()).getOr(e);
        var t, n;
      });
    },
    I = function (M, t) {
      ...
      (function () {
          ...
          return O.from(
            _.map(t, function (e, t) {
              ...
              return {
                ...
                text: e.title,
                value: {
                  url: n(e) ? O.from(e.url) : O.none(),
                  content: n(e) ? O.none() : O.from(e.content),
        ...
        return M.notificationManager.open({ text: e, type: 'info' }), O.none();
      })().each(function (o) {
        var b = e(o),
          T = function (e, t) {
            return {
              ...
              onSubmit: function (t) {
                var e = t.getData();
                u(n, e.template).each(function (e) {
                  l(e)
                    .then(function (e) {
                      y(M, 0, e), t.close();
                    })
              ...
              onChange:
                ...
                function (n, e) {
                  var t;
                  'template' === e.name &&
                    ((t = n.getData().template),
                    u(r, t).each(function (t) {
                      n.block('Loading...'),
                        l(t)
                          .then(function (e) {
                            a(n, t, e);
          ...
          c = function (e, t, n) {
            var r,
              ...
              v =
                ...
                -1 === (a = n).indexOf('<html>') &&
                  ((o = ''),
                  (c = r.getParam('content_style', '', 'string')) &&
                    (o += '<style type="text/css">' + c + '</style>'),
                  (u = r.getParam('content_css_cors', !1, 'boolean')
                    ? ' crossorigin="anonymous"'
                    : ''),
                  _.each(r.contentCSS, function (e) {
                    o +=
                      '<link type="text/css" rel="stylesheet" href="' +
                      r.documentBaseURI.toAbsolute(e) +
                      '"' +
                      u +
                      '>';
                  }),
                  (i =
                    -1 ===
                    (g = (p = r).getParam('body_class', '', 'string')).indexOf(
                      '=',
                    )
                      ? g
                      : (d = p).getParam('body_class', '', 'hash')[d.id] || ''),
                  (l = r.dom.encode),
                  (s =
                    ...
                    (S.mac ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
                    ')) {e.preventDefault();}}}, false);</script> '),
                  (m = (f = r.getBody().dir) ? ' dir="' + l(f) + '"' : ''),
                  (a =
                    '<!DOCTYPE html><html><head><base href="' +
                    l(r.documentBaseURI.getURI()) +
                    '">' +
                    o +
                    s +
                    '</head><body class="' +
                    ...
                    a +
                    '</body></html>')),
                x(a, r.getParam('template_preview_replace_values'))),
              y = [
                {
                  type: 'selectbox',
                  name: 'template',
                ...
                },
                {
                  type: 'htmlpanel',
                  html:
                    '<p aria-live="polite">' + N(t.value.description) + '</p>',
                },
                {
                  label: 'Preview',
                  type: 'iframe',
              ...
              h = { template: t.text, preview: v };
            e.unblock(), e.redial(T(y, h)), e.focus('template');
          },
          t = M.windowManager.open(T([], { template: '', preview: '' }));
        t.block('Loading...'),
          l(o[0])
            .then(function (e) {
              c(t, o[0], e);
  ...
  e.add('template', function (e) {
    ...
    (t = e).ui.registry.addButton('template', {
      ...
      (r = e).on('PreProcess', function (e) {
        var t = r.dom,
          n = f(r);
        _.each(t.select('div', e.node), function (e) {
          t.hasClass(e, 'mceTmpl') &&
            (_.each(t.select('*', e), function (e) {
              t.hasClass(e, i(r).replace(/\s+/g, '|')) &&
                (e.innerHTML = p(r, n));
            }),
            g(r, e));
        });

  ...
  var n,
    ...
    M = function (t, i) {
      ...
      return (
        L.each(t, function (t) {
          ...
          t.menu !== undefined
            ? ((e = M(t.menu, i)), u.push({ text: o, items: e }))
            : ((r = i(t)), u.push({ text: o, value: r }));
        }),
        u
      );
    },
    ...
    B = {
      ...
      createUi: function (n, e) {
        return function (t) {
          return { name: n, type: 'listbox', label: e, items: t };
        };
      },
      getValue: E,
    },
    ...
    G = function (t, n) {
      ...
      for (
        var e = t.cloneContents(),
          r = new F(e.firstChild, e),
          o = [],
          i = e.firstChild;
        n(i) && o.push(i), (i = r.next());
    ...
    Q = function (t, n) {
      return (
        ...
        nt(n) ? t.dom.select('a[href]', n)[0] : t.dom.getParent(n, 'a[href]')
      );
    },
    Y = function (t, n) {
      var e = n
    ...
    tt = function (t) {
      ...
      return (
        0 ===
        G(t.selection.getRng(), function (t) {
    ...
    rt = function (t, n) {
      ...
      return (
        0 < h(t).length ||
          !1 !== v(t) ||
          ((e = $(i.rel, '_blank' === i.target)), (i.rel = e || null)),
        N.from(i.target).isNone() && !1 === d(t) && (i.target = p(t)),
        (i.href =
          ((r = i.href),
          ('http' !== (o = g(t)) && 'https' !== o) || J(r)
            ? r
            : o + '://' + r)),
        i
      );
      ...
      l.undoManager.transact(function () {
        ...
        nt(a)
          ...
          : ((n = (t = l).dom),
            (e = t.selection),
            (r = e.getBookmark()),
            (o = e.getRng().cloneRange()),
            (i = n.getParent(o.startContainer, 'a[href]', t.getBody())),
            (u = n.getParent(o.endContainer, 'a[href]', t.getBody())),
            i && o.setStartBefore(i),
            u && o.setEndAfter(u),
            e.setRng(o),
    ...
    lt = function (t, n) {
      ...
      !r ||
        ((e = t.dom.getParents(r, 'a[href]', n)[0]) &&
          (e.parentNode.insertBefore(r, e), t.dom.remove(e)));
    },
    ct = function (t, n, e) {
      var r,
    ...
    mt = function (n, t, e, r) {
      var o = r[t],
        i = 0 < n.length;
      return o !== undefined
        ? st(o, e).map(function (t) {
            return {
              url: {
                value: t.value,
                meta: { text: i ? n : t.text, attach: y },
              },
              text: i ? n : t.text,
            };
          })
    ...
    gt = function (t, i) {
      var u = { text: t.text, title: t.title },
        r = function (t) {
          var n,
            e,
            r =
              ((n = t.url),
              D(u.text.length <= 0, N.from(n.meta.text).getOr(n.value))),
            o =
              ((e = t.url),
              D(u.title.length <= 0, N.from(e.meta.title).getOr('')));
        ...
        function (i) {
          return new ht(function (n) {
            ...
            (e = u),
              ...
              dt.setEditorTimeout(e, function () {
    ...
    bt = function (n) {
      ...
      return new ht(function (n) {
        ...
        return t.bind(B.sanitizeWith(e)).map(function (t) {
          if (0 < t.length) {
            return [{ text: 'None', value: '' }].concat(t);
          }
          return t;
        });
      });
      ...
      return bt(f).then(function (t) {
        var n,
          ...
          c =
            ((e = s),
            (r = (n = f).dom),
            (o = tt(n) ? N.some(Y(n.selection, e)) : N.none()),
          ...
          return (
            ...
            (d = gt(m, g)),
            {
              ...
              body: {
                ...
                items: S([
                  ...
                  (function (t) {
                    ...
                    g.anchor.map(B.createUi('anchor', 'Anchors')),
                    g.rels.map(B.createUi('rel', 'Rel')),
                    g.targets.map(B.createUi('target', 'Open link in...')),
                    g.link.map(B.createUi('link', 'Link list')),
                    g.classes.map(B.createUi('linkClass', 'Class')),
                  ]),
                ]),
              },
              buttons: [
              ...
              onChange: function (n, t) {
                var e = t.name;
                d.onChange(n.getData, { name: e }).each(function (t) {
                  n.setData(t);
                });
              },
              onSubmit: e,
    ...
    Rt = function (t, n) {
      ...
      n &&
        ((e = X(n)),
        /^#/.test(e)
          ? (r = t.$(e)).length && t.selection.scrollIntoView(r[0], !0)
          : Tt(n.href));
    },
    Dt = function (t) {
      return function () {
    ...
    Ut = function (n) {
      return function (t) {
        return Mt(n, function () {
          t.setActive(
            !n.mode.isReadOnly() && null !== Q(n, n.selection.getNode()),
          );
        });
      };
    },
            ...
            onAction: function (t) {
              ...
              r
                ? i.undoManager.transact(function () {
                    i.dom.setAttrib(r, 'href', o),
                      i.selection.collapse(!1),
                      t.hide();
                  })
                : ((n = { href: o, attach: function () {} }),
                  (e = tt(i)
                    ? N.some(Y(i.selection, r))
                        .filter(function (t) {
                          return 0 < t.length;
                        })
                        .or(N.from(o))

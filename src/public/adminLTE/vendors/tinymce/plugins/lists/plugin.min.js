...
!(function () {
  ...
  var e,
    ...
    I = function (e, n) {
      return 0 <= n && n < e.length ? g.some(e[n]) : g.none();
    },
    R = function (e) {
      return I(e, 0);
    },
    ...
    q = function (e, t) {
      return j(e, t).map(function (e) {
        var n = $.detect(e.versionRegexes, t);
    ...
    X = [
      ...
      },
      {
        ...
        search: function (e) {
          return V(e, 'chrome') && !V(e, 'chromeframe');
        },
      },
      {
        name: 'IE',
        ...
        search: function (e) {
          return V(e, 'msie') || V(e, 'trident');
        },
      },
      {
        name: 'Opera',
        versionRegexes: [W, /.*?opera\/([0-9]+)\.([0-9]+).*/],
        search: Q('opera'),
      },
      {
        name: 'Firefox',
      ...
      },
      {
        ...
        search: function (e) {
          return (V(e, 'safari') || V(e, 'mobile/')) && V(e, 'applewebkit');
        },
      },
    ],
    z = [
    ...
    ee = {
      unknown: function () {
        return Z({ current: undefined, version: $.unknown() });
      },
      nu: Z,
      edge: y(G),
      chrome: y('Chrome'),
    ...
    ae = {
      unknown: function () {
        return ue({ current: undefined, version: $.unknown() });
      },
      nu: ue,
      windows: y(ne),
      ios: y('iOS'),
    ...
    se = function (e, n) {
      var t,
        ...
        p = Y.browsers(),
        g = Y.oses(),
        v = q(p, e).fold(ee.unknown, ee.nu),
        h = K(g, e).fold(ae.unknown, ae.nu);
      return {
        browser: v,
        os: h,
        deviceType:
    ...
    fe =
      ((i = !(r = function () {
        return se(navigator.userAgent, ce);
      })),
      function () {
    ...
    le = {
      ...
      fromPoint: function (e, n, t) {
        return g.from(e.dom.elementFromPoint(n, t)).map(de);
      },
    },
    me = function (e, n) {
      return e.dom === n.dom;
    ...
    pe = function (e, n) {
      return (
        ...
        0 != (o.compareDocumentPosition(i) & u)
      );
      var t, r, o, i, u;
    },
    ge = function (e, n) {
      return fe().browser.isIE()
        ? pe(e, n)
    ...
    he = tinymce.util.Tools.resolve('tinymce.dom.RangeUtils'),
    ye = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    Se = tinymce.util.Tools.resolve('tinymce.util.VK'),
    be = Object.keys,
    Ce = function (e, n) {
      for (var t = be(e), r = 0, o = t.length; r < o; r++) {
        var i = t[r];
        n(e[i], i);
      }
    },
    ...
    ke = function (e) {
      return g.from(e.dom.parentNode).map(le.fromDom);
    },
    we = function (e) {
      return D(e.dom.childNodes, le.fromDom);
    },
    xe = function (e, n) {
      var t = e.dom.childNodes;
      return g.from(t[n]).map(le.fromDom);
    },
    Ae = function (e) {
      return xe(e, 0);
    },
    Ee = function (e) {
      return xe(e, e.dom.childNodes.length - 1);
    },
    Pe = function (n, t) {
      ke(n).each(function (e) {
    ...
    Me = function (e) {
      return (n = e), (t = !0), le.fromDom(n.dom.cloneNode(t));
      var n, t;
    },
    Ue = function (e, n) {
      var t,
        ...
        o,
        i,
        u = ((t = e), (r = n), (o = le.fromTag(r)), (i = De(t)), Te(o, i), o);
      Pe(e, u);
      var a = we(e);
      return Ie(u, a), Re(e), u;
    },
    _e = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    Fe = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    He = function (n) {
      return function (e) {
    ...
    Je = function (e, n, t) {
      var r = e.isEmpty(n);
      return (
        !(t && 0 < e.select('span[data-mce-type=bookmark]', n).length) && r
      );
    },
    Ze = function (e, n) {
    ...
    en = function (e, n) {
      ...
      if (
        (c &&
          ...
          Ge(n.firstChild, a) || s.appendChild(o)),
        n)
      )
        for (; (r = n.firstChild); ) {
          var f = r.nodeName;
          i ||
            ('SPAN' === f && 'bookmark' === r.getAttribute('data-mce-type')) ||
            (i = !0),
            Ge(r, a)
        ...
        : ve(t, 'dt') &&
          ke(t).each(function (e) {
            return (function (e, n, t) {
              var r = nn.select('span[data-mce-type="bookmark"]', n),
                o = en(e, t),
                i = nn.createRng();
              ...
              e.dom.isEmpty(a) || nn.insertAfter(a, n),
                nn.insertAfter(o, n),
                Je(e.dom, t.parentNode) &&
                  ((u = t.parentNode),
                  Fe.each(r, function (e) {
                    u.parentNode.insertBefore(e, t.parentNode);
                  }),
                  nn.remove(u)),
                nn.remove(t),
                Je(e.dom, n) && nn.remove(n);
            })(n, e.dom, t.dom);
          });
    },
    rn = function (e) {
    ...
    an = tinymce.util.Tools.resolve('tinymce.dom.DomQuery'),
    sn = function (e, n) {
      var t = n || e.selection.getStart(!0);
      return e.dom.getParent(t, 'OL,UL,DL', dn(e, t));
    },
    cn = function (e) {
      var n,
        t,
      ...
      return (
        (r = i),
        (t = o) && 1 === r.length && r[0] === t
          ? ((n = o),
            Fe.grep(n.querySelectorAll('ol,ul,dl'), function (e) {
              return qe(e);
            }))
          : Fe.grep(i, function (e) {
              return qe(e) && o !== e;
            })
      );
    },
    fn = function (e) {
      ...
      return Fe.grep(
        ((t = e),
        (n = o),
        (r = Fe.map(n, function (e) {
          var n = t.dom.getParent(e, 'li,dd,dt', dn(t, e));
          return n || e;
        })),
        an.unique(r)),
        function (e) {
    ...
    ln = function (e, n) {
      var t = e.dom.getParents(n, 'ol,ul', dn(e, n));
      return M(t);
    },
    mn = function (e) {
      var n,
        ...
        r,
        o =
          ((t = ln((n = e), n.selection.getStart())),
          (r = w(n.selection.getSelectedBlocks(), Ke)),
          t.toArray().concat(r));
      return pn(e, o);
    },
    pn = function (n, e) {
      var t = D(e, function (e) {
        return ln(n, e).getOr(e);
      });
      return an.unique(t);
    },
    gn = function (e, n, t) {
      return e.isSome() && n.isSome()
        ? g.some(t(e.getOrDie(), n.getOrDie()))
        : g.none();
    },
    vn = function (e, n, t) {
    ...
    Sn = function (e, n, t) {
      for (var r, o, i, u = [], a = 0; a < t; a++)
        u.push(
          ((r = e),
          (o = n.listType),
          (i = { list: le.fromTag(o, r), item: le.fromTag('li', r) }),
          Be(i.list, i.item),
          i),
        );
      return u;
    ...
    bn = function (e, n) {
      for (var t, r, o, i, u = 0; u < e.length - 1; u++)
        (t = e[u].item),
          (r = 'list-style-type'),
          (o = 'none'),
          (i = t.dom),
          hn(i, r, o);
      M(e).each(function (e) {
        Te(e.list, n.listAttributes),
          Te(e.item, n.itemAttributes),
          Ie(e.item, n.content);
      });
    },
    Cn = function (f, e, d) {
      var n = e.slice(0, d.depth);
      return (
        M(n).each(function (e) {
          var n,
            t,
          ...
          (u = c),
            ...
            (i.item = u),
            (s = d),
            Ne((a = e).list) !== s.listType &&
              (a.list = Ue(a.list, s.listType)),
            Te(a.list, s.listAttributes);
        }),
        n
      );
    },
    On = function (e, n, t) {
      var r,
        o = Sn(e, t, t.depth - n.length);
      return (
        (function (e) {
          for (var n = 1; n < e.length; n++) yn(e[n - 1], e[n]);
        })(o),
        bn(o, t),
        (r = o),
        gn(M(n), R(r), yn),
    ...
    kn = function (e) {
      var n = we(e),
        t = Ee(e).map(Nn).getOr(!1) ? n.slice(0, -1) : n;
      return D(t, Me);
    },
    wn = function (a) {
      return (
        k(a, function (r, e) {
          ...
          (o = (n = a)[(t = e)].depth),
            ...
            A(B(n.slice(0, t)), i, u)
              .orThunk(function () {
                return A(n.slice(t + 1), i, u);
              })
              .fold(
                function () {
                  var e;
                  r.dirty &&
                    ((e = r).listAttributes = Oe(
                      e.listAttributes,
                      function (e, n) {
                        return 'start' !== n;
                      },
                ...
                function (e) {
                  return (
                    ...
                    void (n.listAttributes = U({}, t.listAttributes))
                  );
                  var n, t;
                },
              );
    ...
    An = function (n, t, r, e) {
      return P(we(e), function (e) {
        return (Nn(e) ? An : xn)(n + 1, t, r, e);
      });
    },
    En = function (e, n) {
      var t,
      ...
      return D(e, function (e) {
        return { sourceList: e, entries: An(0, n, r, e) };
      });
    },
    Pn = function (i, e) {
      var n = wn(e);
    ...
    Bn = function (e, n) {
      ...
      return (
        ...
        (r = x(
          o,
          function (e, n) {
            return (n.depth > e.length ? On : Cn)(t, e, n);
          },
          [],
        )),
        R(r)
    ...
    In = function (a, e, s) {
      var n,
        t = En(
          e,
          ((n = D(fn(a), le.fromDom)),
          gn(E(n, c(Ln)), E(B(n), c(Ln)), function (e, n) {
        ...
        var r,
          ...
          u =
            ...
            P(
              ...
              function (e) {
                return (R(e).map(Tn).getOr(!1) ? Bn : Pn)(r, e);
              },
            ));
        k(u, function (e) {
          vn(a, 'Indent' === s ? 'IndentList' : 'OutdentList', e.dom);
        }),
          (i = e.sourceList),
          k(u, function (e) {
            Pe(i, e);
    ...
    Rn = function (e, n) {
      var t,
        r,
        o = D(mn(e), le.fromDom),
        i = D(w(fn(e), Qe), le.fromDom),
        u = !1;
      return (
        (o.length || i.length) &&
          ((t = e.selection.getBookmark()),
          In(e, o, n),
          (r = e),
          k(
            i,
          ...
          e.selection.setRng(un(e.selection.getRng())),
          e.nodeChanged(),
          (u = !0)),
        u
      );
    ...
    Fn = tinymce.util.Tools.resolve('tinymce.dom.BookmarkManager'),
    Hn = _e.DOM,
    $n = function (o) {
      var i = {},
        e = function (e) {
    ...
    jn = function (o) {
      function e(e) {
        var n,
          t = (n = o[e ? 'startContainer' : 'endContainer']),
          r = o[e ? 'startOffset' : 'endOffset'];
        t &&
          (1 === t.nodeType &&
            ((r = (function (e) {
            ...
            !t.hasChildNodes() &&
              Hn.isBlock(t) &&
              t.appendChild(Hn.create('br'))),
          (o[e ? 'startContainer' : 'endContainer'] = t),
          (o[e ? 'startOffset' : 'endOffset'] = r));
      }
      e(!0), e();
      var n = Hn.createRng();
      return (
    ...
    Vn = function (e, t, r) {
      var n = function (e) {
          var n = A(e.parents, qe, Xe)
            .filter(function (e) {
              return e.nodeName === t && !Kn(e);
            })
            .isSome();
          r(n);
        },
    ...
    Qn = function (e, n, t) {
      ...
      (r = e),
        ...
        Fe.each(a.select('li', s), function (e) {
          Wn(e, c['list-item-attributes']);
        });
    },
    Xn = function (e, n, t, r) {
      var o = n[t ? 'startContainer' : 'endContainer'],
        i = n[t ? 'startOffset' : 'endOffset'];
      for (
        1 === o.nodeType &&
          (o = o.childNodes[Math.min(i, o.childNodes.length - 1)] || o),
          !t && ze(o.nextSibling) && (o = o.nextSibling);
        o.parentNode !== r;
    ...
    zn = function (f, d, l) {
      ...
      var e,
        ...
        m = 'LI',
        t = dn(f, f.selection.getStart(!0)),
        p = f.dom;
      'false' !== p.getContentEditable(f.selection.getNode()) &&
        ('DL' === (d = d.toUpperCase()) && (m = 'DT'),
        (e = $n(n)),
        Fe.each(
          (function (t, e, r) {
            for (
            ...
            return (
              Fe.each(s, function (e) {
                if (Ye(t, e)) return i.push(e), void (o = null);
                if (u.isBlock(e) || ze(e))
                  return ze(e) && u.remove(e), void (o = null);
                var n = e.nextSibling;
                Fn.isBookmarkNode(e) && (Ye(t, n) || (!n && e.parentNode === r))
                  ? (o = null)
                  : (o ||
                      ((o = u.create('p')),
    ...
    Gn = function (e, n) {
      var t,
        r = n.nextSibling;
      if (Yn(e, n, r)) {
        for (; (t = r.firstChild); ) n.appendChild(t);
        e.remove(r);
      }
      if (((r = n.previousSibling), Yn(e, n, r))) {
        for (; (t = r.lastChild); ) n.insertBefore(t, n.firstChild);
        e.remove(r);
      }
    },
    Jn = function (u, e, n, a, s) {
      var t;
      e.nodeName !== a || Zn(s)
        ? ((t = $n(u.selection.getRng(!0))),
          Fe.each([e].concat(n), function (e) {
            var n, t, r, o, i;
            (n = u),
              (r = a),
              (o = s),
              (t = e).nodeName !== r
                ? ((i = n.dom.rename(t, r)), Qn(n.dom, i, o), vn(n, qn(r), i))
                : (Qn(n.dom, t, o), vn(n, qn(r), t));
          }),
          u.selection.setRng(jn(t)))
        : _n(u);
    },
    Zn = function (e) {
      ...
      (t = t || {}),
        c && 0 < f.length
          ...
          : ((i = n),
            ...
            (o = c) !== (r = e).getBody() &&
              (o
                ? o.nodeName !== i || Zn(u) || Kn(o)
                  ? ((a = $n(r.selection.getRng(!0))),
                    Qn(r.dom, o, u),
                    (s = r.dom.rename(o, i)),
                    Gn(r.dom, s),
                    r.selection.setRng(jn(a)),
                    vn(r, qn(i), s))
                  : _n(r)
                : (zn(r, i, u), vn(r, qn(i), o))));
    },
    nt = _e.DOM,
    tt = function (i, e) {
      Fe.each(Fe.grep(i.select('ol,ul', e)), function (e) {
        var n, t, r, o;
        (n = i),
          'LI' === (o = (t = e).parentNode).nodeName &&
            o.firstChild === t &&
            ((r = o.previousSibling) && 'LI' === r.nodeName
              ? (r.appendChild(t), Je(n, o) && nt.remove(o))
              : nt.setStyle(o, 'listStyleType', 'none')),
          qe(o) &&
            (r = o.previousSibling) &&
            'LI' === r.nodeName &&
            r.appendChild(t);
    ...
    rt = function (e, n, t, r) {
      var o = n.startContainer,
        i = n.startOffset;
      if (je(o) && (t ? i < o.data.length : 0 < i)) return o;
      ...
      for (
        ...
        if (je(o) && 0 < o.data.length) return o;
      }
    },
    ot = function (e, n) {
      var t = n.childNodes;
      return 1 === t.length && !qe(t[0]) && e.isBlock(t[0]);
    },
    it = function (e, n, t) {
      var r,
        o,
        i,
        u = ot(e, t) ? t.firstChild : t;
      if ((ot((o = e), (i = n)) && o.remove(i.firstChild, !0), !Je(e, n, !0)))
    ...
    ut = function (n, e, t) {
      ...
      Ze(n, e) &&
        Ze(n, t) &&
        (qe(t.lastChild) && (r = t.lastChild),
        u === t.lastChild &&
          ze(u.previousSibling) &&
          n.remove(u.previousSibling),
        (o = t.lastChild) && ze(o) && e.hasChildNodes() && n.remove(o),
        Je(n, t, !0) && n.$(t).empty(),
        it(n, e, t),
        r && t.appendChild(r),
        (i = ge(le.fromDom(t), le.fromDom(e)) ? n.getParents(e, qe, t) : []),
        n.remove(e),
        k(i, function (e) {
          Je(n, e) && e !== n.getRoot() && n.remove(e);
        }));
    },
    at = function (e, n, t, r) {
      var o,
      ...
      s.isEmpty(r)
        ? ((u = t),
          ...
          (i = e).dom.$(a).empty(),
          ut(i.dom, u, a),
          i.selection.setCursorLocation(a))
        : ((o = $n(n)), ut(s, t, r), e.selection.setRng(jn(o)));
    },
    st = function (n, t) {
      var e = n.dom,
        r = n.selection,
        o = r.getStart(),
        i = dn(n, o),
        u = e.getParent(r.getStart(), 'LI', i);
      if (u) {
        var a = u.parentNode;
        if (a === n.getBody() && Je(e, a)) return !0;
        var s = un(r.getRng()),
          c = e.getParent(rt(n, s, t, i), 'LI', i);
        if (c && c !== u)
          return (
        ...
        if (!c && !t && 0 === s.startOffset && 0 === s.endOffset)
          return (
            n.undoManager.transact(function () {
              _n(n);
            }),
    ...
    ct = function (o, i) {
      ...
      if (s && u.isEmpty(s)) {
        var n = un(o.selection.getRng()),
          c = u.getParent(rt(o, n, i, a), 'LI', a);
        if (c)
          return (
    ...
    ft = function (e, n) {
      return e.selection.isCollapsed()
        ...
        : ((r = (t = e).selection.getStart()),
          (o = dn(t, r)),
          !!(t.dom.getParent(r, 'LI,DT,DD', o) || 0 < fn(t).length) &&
            (t.undoManager.transact(function () {
              t.execCommand('Delete'), tt(t.dom, t.getBody());
            }),
            !0));
      var t, r, o, i, u;
    },
      ...
      Ve(e) &&
        t.windowManager.open({
          ...
          onSubmit: function (e) {
            var n = e.getData();
            t.undoManager.transact(function () {
              r.setAttrib(sn(t), 'start', '1' === n.start ? '' : n.start);
            }),
              e.close();
          },
        });
      ...
      e.getParam('lists_indent_on_tab', !0) &&
        (n = e).on('keydown', function (e) {
          e.keyCode !== Se.TAB ||
            Se.metaKeyPressed(e) ||
            n.undoManager.transact(function () {
              (e.shiftKey ? Un : Mn)(n) && e.preventDefault();
            });
        }),
        (t = e).on('keydown', function (e) {
          e.keyCode === Se.BACKSPACE
            ? ft(t, !1) && e.preventDefault()
            : e.keyCode === Se.DELETE && ft(t, !0) && e.preventDefault();
        });
    };
  a.add('lists', function (e) {
    ...
    return (
      !1 === e.hasPlugin('rtc', !0) &&
        ...
        t.addQueryStateHandler('InsertUnorderedList', lt(t, 'UL')),
        t.addQueryStateHandler('InsertOrderedList', lt(t, 'OL')),
        t.addQueryStateHandler('InsertDefinitionList', lt(t, 'DL'))),
      (r = function (e) {
        return function () {
          return n.execCommand(e);
        };
      }),
      (n = e).hasPlugin('advlist') ||
      ...
      (i = {
        ...
        onSetup: function (n) {
          return Vn(o, 'OL', function (e) {
            return n.setDisabled(!e);
          });
        },
      }),
      (o = e).ui.registry.addMenuItem('listprops', i),
      o.ui.registry.addContextMenu('lists', {
        update: function (e) {
          var n = sn(o, e);
          return Ve(n) ? ['listprops'] : [];
        },
      }),
      (u = e),
      {

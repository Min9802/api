...
(function () {
  ...
  var processEvent = function (eventName, initialTarget, f) {
    var status = get$1(eventConfig.get(), eventName)
      .orThunk(function () {
        var patterns = keys(eventConfig.get());
        return findMap(patterns, function (p) {
          return eventName.indexOf(p) > -1
            ? Optional.some(eventConfig.get()[p])
            : Optional.none();
        });
      })
  ...
  var tieredMenuMarkers = function () {
    return strictObjOf(
      'markers',
      [strict$1('backgroundMenu')].concat(menuFields()).concat(itemFields()),
    );
  };
  ...
  var orientation = function (onReceive) {
    return Receiving.config({
      channels: wrap$1(orientationChanged, { onReceive: onReceive }),
    });
  };
  ...
  var getHighlighted = function (component, hConfig, _hState) {
    return descendant$1(component.element, '.' + hConfig.highlightClass).bind(
      function (e) {
  ...
  var getLast = function (component, hConfig, _hState) {
    ...
    var last =
      items.length > 0
        ? Optional.some(items[items.length - 1])
        : Optional.none();
      ...
      return infoSchema.concat([
        ...
        defaultedOf(
          ...
          valueOf(function (val) {
            return contains(['onFocus', 'onEnterOrSpace', 'onApi'], val)
              ? Result.value(val)
  ...
  var getKeydownRules = function (
    ...
    var spaceExec =
      executeConfig.useSpace && !inside(component.element) ? SPACE : [];
  ...
  var fireShiftTab = function (
    ...
    return menuConfig.moveOnTab
      ? move(moveUp$1)(component, simulatedEvent, menuConfig, menuState)
      : Optional.none();
  };
  var fireTab = function (component, simulatedEvent, menuConfig, menuState) {
    return menuConfig.moveOnTab
      ? move(moveDown$1)(component, simulatedEvent, menuConfig, menuState)
      : Optional.none();
  };
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return get$1(placeholders, compSpec.name).fold(
      function () {
        throw new Error(
  ...
  var subs = function (owner, detail, parts) {
    ...
    each(parts, function (part) {
      part.fold(
        function (data) {
          internals[data.pname] = single(
            true,
            function (detail, partSpec, partValidated) {
        ...
        function (data) {
          internals[data.pname] = multiple(
            true,
            function (detail, _partSpec, _partValidated) {
  ...
  var makeApi = function (f) {
    return markAsSketchApi(function (component) {
      ...
      return f.apply(
        void 0,
        __spreadArrays([component.getApis(), component], rest),
      );
    }, f);
  };
  ...
  var composite = function (owner, schema, partTypes, factory, spec) {
    ...
    var detail = asRawOrDie$1(owner, schema, specWithUid, partSchemas, [
      partUidsSchema,
    ]);
  ...
  var supplyUid = function (spec) {
    return hasUid(spec)
      ? spec
      : __assign(__assign({}, spec), { uid: generate$3('uid') });
  };
  ...
  var dataset = function () {
    ...
    var update = function (items) {
      ...
      dataByValue.set(
        __assign(__assign({}, currentDataByValue), newDataByValue),
      );
  ...
  var getCenterOffsetOf = function (
    componentMinEdge,
    componentMaxEdge,
    spectrumMinEdge,
  ) {
  ...
  var findOffsetOfValue$1 = function (
    spectrum,
    detail,
    value,
    minEdge,
  ...
  var findPositionOfValue = function (
    slider,
    spectrum,
    value,
    minEdge,
  ...
  var findOffsetOfValue$2 = function (
    spectrum,
    detail,
    value,
    minEdge,
  ...
  var findPositionOfValue$1 = function (
    slider,
    spectrum,
    value,
    minEdge,
  ...
  var handleMovement$2 = function (direction, isVerticalMovement) {
    return function (spectrum, detail) {
      return moveBy$2(direction, isVerticalMovement, spectrum, detail).map(
        function () {
          return true;
        },
      );
  ...
  var setPositionFromValue$2 = function (slider, thumb, detail, edges) {
    ...
    var yPos = findPositionOfValue$1(
      slider,
      edges.getSpectrum(slider),
      value.y,
      edges.getTopEdge(slider),
  ...
  var sketch = function (detail, components, _spec, _externals) {
    ...
    return {
      ...
      behaviours: augment(detail.sliderBehaviours, [
        ...
        Receiving.config({
          channels:
            ((_a = {}), (_a[mouseReleased()] = { onReceive: choose }), _a),
        }),
      ]),
      events: derive([
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts.spectrum({
          ...
          behaviours: derive$1([
            Toggling.config({ toggleClass: resolve('thumb-active') }),
          ]),
        }),
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = isElement(rawStart)
      ? Optional.some(rawStart)
      : parent(rawStart).filter(isElement);
    return optStart
      .map(function (start) {
        var inline = closest$1(
          start,
          function (elem) {
  ...
  var record = function (spec) {
    var uid =
      isSketchSpec(spec) && hasNonNullableKey(spec, 'uid')
        ? spec.uid
        : generate$3('memento');
  ...
  var promise = function () {
    ...
    var asap =
      Promise.immediateFn ||
      (typeof anyWindow.setImmediate === 'function' &&
        anyWindow.setImmediate) ||
      function (fn) {
        setTimeout(fn, 1);
      };
  ...
  var exhibit$4 = function (base, disableConfig) {
    return nu$5({
      classes: disableConfig.disabled()
        ? disableConfig.disableClass.toArray()
        : [],
    });
  };
  ...
  var sketch$6 = function (rawSpec) {
    ...
    var reposition = function (dialog, message) {
      descendant$1(
        dialog.element,
        '.' + resolve('serialised-dialog-chain'),
    ...
    var navigate = function (dialog, direction) {
      var screens = descendants(
        dialog.element,
        '.' + resolve('serialised-dialog-screen'),
      );
      descendant$1(
        dialog.element,
        '.' + resolve('serialised-dialog-chain'),
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (_wrapper, simulatedEvent) {
            ...
            spec$1.state.dialogSwipeState.set(
              init$2(event.raw.touches[0].clientX),
            );
          }),
          run(touchmove(), function (_wrapper, simulatedEvent) {
            ...
            spec$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event.prevent();
              spec$1.state.dialogSwipeState.set(
                move$1(state, event.raw.touches[0].clientX),
              );
            });
          }),
      ...
      objOf([
        ...
        field(
          ...
          mergeWith(
            ...
            (_a[focus()] = [baseBehaviour, 'focusing', 'keying']),
            (_a[systemInit()] = [
              baseBehaviour,
              'disabling',
              'toggling',
            ...
            (_a[receive()] = ['receiving', 'reflecting', 'tooltipping']),
            _a),
          ),
          anyValue$1(),
        ),
  ...
  var build$1 = function (spec) {
    return getPremade(spec).fold(
      function () {
        var userSpecWithUid = spec.hasOwnProperty('uid')
          ? spec
          : __assign({ uid: uids('') }, spec);
      ...
      behaviours: SketchBehaviours.augment(detail.itemBehaviours, [
        detail.toggling.fold(Toggling.revoke, function (tConfig) {
          return Toggling.config(
            __assign({ aria: { mode: 'checked' } }, tConfig),
          );
        }),
        Focusing.config({
    ...
    group({
      ...
      defaults: function (detail, u) {
        return u.hasOwnProperty('uid')
          ? u
          : __assign(__assign({}, u), { uid: generate$3('item') });
      },
  ...
  var make$3 = function (detail, _rawUiSpec) {
        ...
        return Optional.from(path[0]).bind(function (menuName) {
          return layeredState
            ...
            .bind(function (activeMenuPrep) {
              var activeMenu = buildIfRequired(
                container,
                menuName,
                activeMenuPrep,
              );
    ...
    var collapseLeft = function (container, item) {
      ...
      return layeredState.collapse(value).bind(function (path) {
        updateAriaExpansions(container, path);
        return updateMenuPath(container, layeredState, path).map(function (
          activeMenu,
        ) {
    ...
    var repositionMenus = function (container) {
      var maybeActivePrimary = layeredState
        .getPrimary()
  ...
  var jumpTo = function (comp, transConfig, transState, destination) {
    ...
    if (
      ...
      get$2(comp.element, transConfig.stateAttr) !== destination
    ) {
  ...
  var fasttrack = function (comp, transConfig, _transState, _destination) {
    if (has$1(comp.element, transConfig.destinationAttr)) {
      getOpt(comp.element, transConfig.destinationAttr).each(function (
        destination,
      ) {
        set(comp.element, transConfig.stateAttr, destination);
      });
    ...
    return derive([
      run(transitionend(), function (component, simulatedEvent) {
        ...
        getCurrentRoute(component, transConfig).each(function (route) {
          findRoute(component, transConfig, transState, route).each(function (
            rInfo,
          ) {
  ...
  var convert$1 = function (formats, memMenuThunk) {
    var mainMenu = makeMenu(
      'Styles',
      [].concat(
        map(formats.items, function (k) {
          return makeItem(
            getValue$4(k),
            k.title,
            k.isSelected(),
            k.getPreview(),
            hasNonNullableKey(formats.expansions, getValue$4(k)),
          );
        }),
      ),
      memMenuThunk,
    ...
    var submenus = map$1(formats.menus, function (menuItems, menuName) {
      var items = map(menuItems, function (item) {
        return makeItem(
          ...
          hasNonNullableKey(formats.expansions, getValue$4(item)),
        );
      });
    ...
    var memMenu = record(
      tieredMenu.sketch({
        ...
        onOpenSubmenu: function (container, item, submenu) {
          var w = get$8(container.element);
          var menu = ancestor$2(item.element, '[role="menu"]').getOrDie(
            'hacky',
          );
        ...
        onCollapseMenu: function (container, item, menu) {
          var submenu = ancestor$2(item.element, '[role="menu"]').getOrDie(
            'hacky',
          );
    ...
    var doPrune = function (items) {
      return bind(items, function (item) {
        if (item.items !== undefined) {
          ...
          var keep = hasNonNullableKey(item, 'format')
  ...
  var getBodyFromFrame = function (frame) {
    return Optional.some(
      SugarElement.fromDom(frame.dom.contentWindow.document.body),
    );
  };
  var getDocFromFrame = function (frame) {
    return Optional.some(
      SugarElement.fromDom(frame.dom.contentWindow.document),
    );
  };
    ...
    if (!range.collapsed) {
      ...
      return parent(start_1)
        .bind(function (parent) {
          var selection = SimSelection.exact(
            start_1,
            range.startOffset,
            parent,
            getEnd(parent),
          );
          var optRect = getFirstRect$1(
  ...
  var getBounds$1 = function (cWin) {
    ...
    return rects.length > 0
      ? Optional.some(rects[0]).map(getBoundsFrom)
      : Optional.none();
  };
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var onResize = bind$3(
      SugarElement.fromDom(outerWindow),
      'resize',
      function () {
  ...
  var create$4 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      androidApi.set(
        setup$1(platform.win, getWin$1(platform.editor).getOrDie('no')),
      );
      getActiveApi(platform.editor).each(function (editorApi) {
        clobberStyles(platform.container, editorApi.body);
        androidEvents.set(
          initEvents(editorApi, platform.toolstrip, platform.alloy),
        );
      });
    };
    var exit = function () {
  ...
  var hasScroll = function (container) {
    return get$2(container, dataHorizontal) === 'true'
  ...
  var ScrollingToolbar = function () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        components: [
          Container.sketch({ components: [ToolbarGroup.parts.items({})] }),
        ],
  ...
  var doImmediateShrink = function (
    component,
    slideConfig,
    slideState,
    _calculatedSize,
    ...
    return derive([
      runOnSource(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension.property) {
          ...
          var notify = slideState.isExpanded()
            ? slideConfig.onGrown
  ...
  function FakeSelection(win, frame) {
    ...
    var make = function (rectangle) {
      ...
      add$3(span, [resolve('layer-editor'), resolve('unfocused-selection')]);
      setAll$1(span, {
  ...
  var accountableKeyboardHeight = function (outerWindow) {
    ...
    var visualScreenHeight = portrait
      ? outerWindow.screen.height
      : outerWindow.screen.width;
  ...
  var classify = function (element) {
    ...
    var classifier =
      get$2(element, yScrollingData) === 'true'
        ? classifyScrolling
        : classifyFixed;
  ...
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    ...
    var viewportHeight = deriveViewportHeight(
      viewport,
      toolbarHeight,
      dropupHeight,
    );
    var viewportSetup = takeoverViewport(
      toolbarHeight,
      viewportHeight,
      viewport,
    );
    ...
    var refresh = function () {
      if (isActive) {
        ...
        var newHeight = deriveViewportHeight(
          viewport,
          newToolbarHeight,
          dropupHeight_1,
        );
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    ...
    if (top > greenzone || bottom > greenzone) {
      moveOnlyScroll(socket, socket.dom.scrollTop - greenzone + bottom).get(
        refreshCursor,
      );
    } else if (top < 0) {
  ...
  var derive$3 = function (editor) {
    var base = Optional.from(getSkinUrl(editor)).fold(
      function () {
  ...
  var renderMobileTheme = function (editor) {
    var renderUI = function () {
      ...
      var realm = detect$3().os.isAndroid()
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTapContent: function (evt) {
              ...
              if (name(target) === 'img') {
                ...
                var component = realm.system.getByDom(
          ...
          toolstrip: SugarElement.fromDom(
            editor.editorContainer.querySelector('.' + resolve('toolstrip')),
          ),
          toolbar: SugarElement.fromDom(
            editor.editorContainer.querySelector('.' + resolve('toolbar')),
          ),
          dropup: realm.dropup,
          alloy: realm.system,

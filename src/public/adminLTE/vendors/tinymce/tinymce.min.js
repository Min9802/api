...
!(function () {
  ...
  var Ae,
    ...
    Je = [
      ...
      { name: 'Solaris', search: Ye('sunos'), versionRegexes: [] },
    ...
    Cn = function (e) {
      ...
      return r === n
        ? yn(r.offsetLeft, r.offsetTop)
        : hn(e)
        ? ((t = n.getBoundingClientRect()), yn(t.left, t.top))
        : yn(0, 0);
    },
    wn = function (e) {
    ...
    Sn = function (e, t) {
      dt().browser.isSafari() && T(e.dom.scrollIntoViewIfNeeded)
    ...
    ur = function (e, t, n) {
      ...
      if (((n = n || e), t)) {
        if (
          ...
          'static' === er(At.fromDom(e), 'position')
        )
          return {
            x: (a =
  ...
  (De = undefined),
    ...
    (Pe = undefined),
    (function (e) {
      'object' == typeof Oe && void 0 !== Be
        ? (Be.exports = e())
        : 'function' == typeof De && De.amd
        ? De([], e)
  ...
  var Sr,
    ...
    Dr = function (e, t) {
      return (
        ...
        Dt(o) ? U.none() : U.from(o.querySelector(n)).map(At.fromDom)
      );
      var n, r, o;
    },
    Or = function (e, t, n) {
      ...
      : ((Sr =
        ...
        (Nr.all = function () {
          var s = Array.prototype.slice.call(
            1 === arguments.length && Sr(arguments[0])
              ? arguments[0]
              : arguments,
          );
        ...
        (Nr.resolve = function (t) {
          return t && 'object' == typeof t && t.constructor === Nr
            ? t
            : new Nr(function (e) {
                e(t);
              });
    ...
    try {
      ...
      if (e && ('object' == typeof e || 'function' == typeof e)) {
        ...
        if ('function' == typeof t)
          return void zr(Pr(t, e), Pr(Ir, this), Pr(Mr, this));
      }
    ...
    var g = 0,
        ...
        t && i.passed.push(t),
          ...
          1 !== i.status &&
            (2 !== i.status
              ? 3 !== i.status
                ? ((i.status = 1),
                  (a = At.fromTag('link', y.dom)),
                  Yn(a, { rel: 'stylesheet', type: 'text/css', id: i.id }),
                  (u = Date.now()),
                  p.contentCssCors && Xn(a, 'crossOrigin', 'anonymous'),
                  p.referrerPolicy && Xn(a, 'referrerpolicy', p.referrerPolicy),
                  ((r = a.dom).onload = d),
                  (r.onerror = f),
                  (s = a),
                  fn(on(v), s),
      ...
      t = function (e) {
        ...
        ge(h, r).each(function (e) {
          var t, n;
          0 == --e.count &&
            (delete h[r], (t = e.id), (n = on(v)), Dr(n, '#' + t).each(pn));
        });
      };
    return {
      load: n,
  ...
  var Gr,
    ...
    vo = function (e) {
      return (
        ho(e) && (e = e.parentNode), go(e) && e.hasAttribute('data-mce-caret')
      );
    },
    yo = function (e) {
    ...
    wo = function (e) {
      ...
      return (
        !!In(t) &&
        (t.data.charAt(e.offset()) === fo ||
          (e.isAtStart() && yo(t.previousSibling)))
      );
    },
    xo = function (e) {
      var t = e.container();
      return (
        !!In(t) &&
        (t.data.charAt(e.offset() - 1) === fo ||
          (e.isAtEnd() && yo(t.nextSibling)))
      );
    },
    So = function (e, t, n) {
      var r,
    ...
    ko = function (e) {
      return e && e.hasAttribute('data-mce-caret')
        ? ((t = e.getElementsByTagName('br')),
          (n = t[t.length - 1]),
          On(n) && n.parentNode.removeChild(n),
    ...
    Lo = function (e) {
      return (
        !Po(e) && (To(e) ? !Do(e.parentNode) : Oo(e) || Ro(e) || Bo(e) || Io(e))
      );
    },
    Io = function (e) {
      return (
        !1 === (An((t = e)) && 'true' === t.getAttribute('unselectable')) &&
        Ao(e)
      );
      var t;
    },
    ...
    jo = function (e, t) {
      return (
        (Lo(e) &&
          !1 === ((o = t), In((r = e)) && Uo(r.data) && !1 === zo(r, o))) ||
        (An((n = e)) &&
          'A' === n.nodeName &&
          !n.hasAttribute('href') &&
          (n.hasAttribute('name') || n.hasAttribute('id'))) ||
        Ho(e)
      );
      var n, r, o;
    },
        ...
        return e.replace(ei, function (e, t) {
          return t
            ? 65535 <
              ...
              : ti[t] || String.fromCharCode(t)
            : ri[e] ||
                ii[e] ||
                ((n = e),
                ((r = At.fromTag('div').dom).innerHTML = n),
    ...
    yi = function (e) {
      ...
      return li[e]
        ...
        : ((s = 'id accesskey class dir lang style tabindex title role'),
          ...
          mi(vi('a form meter progress dfn'), function (e) {
  ...
  function Ci(i) {
    var S = {},
      ...
      e = function (e, t, n) {
        ...
        return (
          r
            ? (r = di(r, /[, ]/, di(r.toUpperCase(), /[, ]/)))
            : (r = li[e]) ||
              ((r = di(t, ' ', di(t.toUpperCase(), ' '))),
              (r = pi(r, n)),
              (li[e] = r)),
          r
        );
    ...
    var E = function (e) {
          ...
          for (
            ...
            if ((i = b.exec(x[t]))) {
              ...
              h || '@' !== c || ((h = d), (v = m)),
                ...
                w.test(c) ? ((a.pattern = E(c)), N.push(a)) : (S[c] = a);
            }
        }
      },
      C = function (e) {
      ...
      w = function (e) {
        var a = /^(~)?(.+)$/;
        e &&
          ((li.text_block_elements = li.block_elements = null),
          mi(vi(e, ','), function (e) {
            var t,
              n = a.exec(e),
              r = '~' === n[1],
            ...
            (u[i] = u[o]),
              ...
              S[i] ||
                ((t = S[o]),
                delete (t = pi({}, t)).removeEmptyAttrs,
    ...
    i.valid_elements
      ...
      : (mi(n, function (e, t) {
        ...
        'html5' !== i.schema &&
          mi(vi('strong/b em/i'), function (e) {
            var t = vi(e, '/');
            S[t[1]].outputName = t[0];
          }),
        mi(
          vi('ol ul sub sup blockquote span font a table tbody strong em b i'),
          function (e) {
            S[e] && (S[e].removeEmpty = !0);
          },
        ),
        mi(
          vi('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'),
          function (e) {
            S[e].paddEmpty = !0;
          },
        ),
      ...
      i.invalid_elements &&
        mi(gi(i.invalid_elements), function (e) {
          S[e] && delete S[e];
        }),
        ...
        parse: function (e) {
          ...
          if (e) {
            for (
              ...
              if (
                ((x.lastIndex = t.index + t[0].length),
                (n = t[1].replace(S, '').toLowerCase()),
                (r = t[2].replace(S, '')),
                n && r)
              ) {
                if (
                ...
                'font-weight' === n && '700' === r
                  ...
                  : ('color' !== n && 'background-color' !== n) ||
                    (r = r.toLowerCase()),
                  (r = (r = r.replace(C, wi)).replace(w, y)),
                  (c[n] = o ? g(r, !0) : r);
              }
            d('border', '', !0),
              d('border', '-width'),
    ...
    Ri = function (e, t) {
      ...
      return (
        ...
        (s.preventDefault = function () {
          (s.isDefaultPrevented = ki),
            e && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1));
        }),
        (s.stopPropagation = function () {
          (s.isPropagationStopped = ki),
            e &&
        ...
        !(s.stopImmediatePropagation = function () {
          ...
          ((u = s).isDefaultPrevented === ki || u.isDefaultPrevented === Ei) &&
          ((s.isDefaultPrevented = Ei),
          (s.isPropagationStopped = Ei),
          (s.isImmediatePropagationStopped = Ei)),
        'undefined' == typeof s.metaKey && (s.metaKey = !1),
        s
      );
    },
    Ti =
      ((Di.prototype.bind = function (e, t, n, r) {
        var o,
          i,
          a,
          u,
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
          e[l.expando]
            ? (o = e[l.expando])
            : ((o = l.count++), (e[l.expando] = o), (l.events[o] = {})),
            (r = r || e);
                            ...
                            n.domLoaded
                              ...
                              : ((r = function () {
                                ...
                                ('interactive' === o.readyState && o.body)
                                  ? r()
                                  : _i(e, 'DOMContentLoaded', r),
                                n.domLoaded || _i(e, 'load', r));
                          })(e, s, l)
                        : _i(e, u || a, s, c)));
          return (e = i = null), n;
        }
          ...
          if (((i = this.events[a]), e)) {
            for (var u, s, c, l, f = e.split(' '), d = f.length; d--; )
              if ((l = i[(o = f[d])])) {
                ...
                (t && 0 !== l.length) ||
                  (delete i[o],
                  Ai(n, l.fakeName || o, l.nativeHandler, l.capture));
              }
          } else
            ue(i, function (e, t) {
  ...
  try {
    sa.apply((ia = ca.call(Gi.childNodes)), Gi.childNodes),
      ia[Gi.childNodes.length].nodeType;
  } catch (Ok) {
    sa = {
      apply: ia.length
        ? function (e, t) {
  ...
  var Ta = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Gi) !== Vi && Hi(t),
      (n = n || []),
      !e || 'string' != typeof e)
    )
      return n;
    ...
    if ($i && !r) {
      if ((o = Ea.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && Oi.getElementsByClassName)
            return sa.apply(n, t.getElementsByClassName(a)), n;
        }
  ...
  function Da() {
    ...
    function r(e, t) {
      return (
        n.push(e + ' ') > Bi.cacheLength && delete r[n.shift()],
        (r[e + ' '] = t)
      );
    }
    return r;
    ...
    return (
      ...
      Oa(function (e, t, n, r) {
        var o,
          ...
          d = g ? (v || (e ? m : c || h) ? [] : t) : f;
        if ((g && g(f, d, n, r), h))
          for (o = za(d, s), h(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (v || m) {
            if (v) {
  ...
  (Oi = Ta.support = {}),
    ...
    (Hi = Ta.setDocument =
      function (e) {
        var t,
          ...
          n = s.defaultView;
        return s !== Vi && 9 === s.nodeType && s.documentElement
          ? ((qi = (Vi = s).documentElement),
            ($i = !Li(s)),
            n &&
              n !==
                (function (e) {
            ...
            (Oi.attributes = !0),
            (Oi.getElementsByTagName = !0),
            (Oi.getElementsByClassName = Na.test(s.getElementsByClassName)),
            (Oi.getById = !0),
            (Bi.find.ID = function (e, t) {
            ...
            (Bi.find.TAG = Oi.getElementsByTagName
              ? function (e, t) {
                  if (typeof t.getElementsByTagName != ra)
            ...
            (Bi.find.CLASS =
              Oi.getElementsByClassName &&
              function (e, t) {
                if ($i) return t.getElementsByClassName(e);
              }),
            (Ki = []),
            (Wi = []),
            (Oi.disconnectedMatch = !0),
            (Wi = Wi.length && new RegExp(Wi.join('|'))),
            (Ki = Ki.length && new RegExp(Ki.join('|'))),
            (t = Na.test(qi.compareDocumentPosition)),
            (Xi =
              t || Na.test(qi.contains)
                ? function (e, t) {
                    ...
                    (1 &
                      (n =
                        (e.ownerDocument || e) === (t.ownerDocument || t)
                          ...
                          : 1) ||
                    (!Oi.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === s || (e.ownerDocument === Gi && Xi(Gi, e))
                        ? -1
                        : t === s || (t.ownerDocument === Gi && Xi(Gi, t))
                        ? 1
                        : zi
                        ? la.call(zi, e) - la.call(zi, t)
                        : 0
                      : 4 & n
                      ? -1
                      : 1)
    ...
    (Ta.attr = function (e, t) {
      ...
      var n = Bi.attrHandle[t.toLowerCase()],
        r =
          n && oa.call(Bi.attrHandle, t.toLowerCase())
            ? n(e, t, !$i)
            : undefined;
      return r !== undefined
        ? r
    ...
    (Ta.uniqueSort = function (e) {
      var t,
        ...
        o = 0;
      if (
        ((ji = !Oi.detectDuplicates),
        (zi = !Oi.sortStable && e.slice(0)),
        e.sort(na),
        ji)
      ) {
    ...
    ((Bi = Ta.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(Aa, Ra)),
              (e[3] = (e[3] || e[4] || e[5] || '').replace(Aa, Ra)),
              '~=' === e[2] && (e[3] = ' ' + e[3] + ' '),
              e.slice(0, 4)
            );
          },
        ...
        filter: {
          ...
          CLASS: function (e) {
            ...
            return (
              t ||
              ((t = new RegExp('(^|' + fa + ')' + e + '(' + fa + '|$)')) &&
                Zi(e, function (e) {
                  return t.test(
                    ('string' == typeof e.className && e.className) ||
                      (typeof e.getAttribute != ra &&
          ...
          PSEUDO: function (e, i) {
            var t,
              a =
                Bi.pseudos[e] ||
                Bi.setFilters[e.toLowerCase()] ||
                Ta.error('unsupported pseudo: ' + e);
            return a[Yi]
              ? a(i)
              : 1 < a.length
              ? ((t = [e, e, '', i]),
                Bi.setFilters.hasOwnProperty(e.toLowerCase())
                  ? Oa(function (e, t) {
        ...
        pseudos: {
          ...
          lang: Oa(function (n) {
            return (
              Ca.test(n || '') || Ta.error('unsupported lang: ' + n),
              (n = n.replace(Aa, Ra).toLowerCase()),
              function (e) {
                var t;
                do {
                  if (
      ...
      }).pseudos.nth = Bi.pseudos.eq),
    W(['radio', 'checkbox', 'file', 'password', 'image'], function (e) {
      var t;
      Bi.pseudos[e] =
        ((t = e),
        function (e) {
    ...
    (Ia.prototype = Bi.filters = Bi.pseudos),
    (Bi.setFilters = new Ia()),
    (Ii = Ta.tokenize =
      function (e, t) {
        var n,
          r,
        ...
        for (a = e, u = [], s = Bi.preFilter; a; ) {
          for (i in ((n && !(r = ha.exec(a))) ||
            (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = va.exec(a)) &&
            ((n = r.shift()),
            o.push({ value: n, type: r[0].replace(ga, ' ') }),
            (a = a.slice(n.length))),
          Bi.filter))
            Bi.filter.hasOwnProperty(i) &&
              (!(r = wa[i].exec(a)) ||
                (s[i] && !(r = s[i](r))) ||
                ((n = r.shift()),
          ...
          for (n = (t = t || Ii(e)).length; n--; )
            (a = (function f(e) {
              for (
                ...
                if ((t = Bi.relative[e[u].type])) l = [Fa(Ua(l), t)];
                else {
                  if (
                    (t = Bi.filter[e[u].type].apply(null, e[u].matches))[Yi]
                  ) {
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            $i &&
            Bi.relative[i[1].type]
          ) {
            if (!(t = (Bi.find.ID(a.matches[0].replace(Aa, Ra), t) || [])[0]))
              return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (
            o = wa.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !Bi.relative[(u = a.type)]);

          )
            if (
              (s = Bi.find[u]) &&
              (r = s(
                a.matches[0].replace(Aa, Ra),
                (ka.test(i[0].type) && La(t.parentNode)) || t,
              ))
            ) {
              if ((i.splice(o, 1), !(e = r.length && Ma(i))))
                return sa.apply(n, r), n;
              break;
            }
        }
        return (
          (c || Mi(e, l))(r, t, !$i, n, (ka.test(e) && La(t.parentNode)) || t),
          n
        );
      }),
    (Oi.sortStable = Yi.split('').sort(na).join('') === Yi),
    (Oi.detectDuplicates = !!ji),
    Hi(),
    (Oi.sortDetached = !0);
  var Ha = document,
    ...
    Ja = function (e, t, n, r) {
      var o;
      if (Ya(t)) t = Ga(t, fu(e[0]));
      else if (t.length && !t.nodeType) {
        if (((t = hu.makeArray(t)), r))
          for (o = t.length - 1; 0 <= o; o--) Ja(e, t[o], n, r);
        else for (o = 0; o < t.length; o++) Ja(e, t[o], n, r);
        return e;
      }
    ...
    nu = { for: 'htmlFor', class: 'className', readonly: 'readOnly' },
    ru = { float: 'cssFloat' },
    ou = {},
    iu = {},
    au = function (e, t) {
  ...
  (au.fn = au.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = hu.unique(this.toArray().concat(hu.makeArray(e))),
      ...
      css: function (n, r) {
        ...
        if ('object' == typeof n)
          ...
          (n = t(n)),
            'number' != typeof r || eu[n] || (r = r.toString() + 'px'),
            i.each(function () {
              var e = this.style;
              if ((o = iu[n]) && o.set) o.set(this, r);
              else {
                try {
                  this.style[ru[n] || n] = r;
                } catch (t) {}
  ...
  var du = function (e, t, n) {
      var r = [],
        o = e[t];
      for (
        'string' != typeof n && n instanceof hu && (n = n[0]);
        o && 9 !== o.nodeType;
  ...
  cu(
    ...
    (au.fn.init.prototype = au.fn),
    (au.overrideDefaults = function (n) {
      var r,
        o = function (e, t) {
          return (
            (r = r || n()),
    ...
    var r = {},
      ...
      b = function (e, t, n) {
        ...
        var r,
          ...
          i = o.attr(t);
        o.length &&
          ((r = H[t]) && r.set ? r.set(o, n, t) : o.attr(t, n),
          i !== n &&
            u.onSetAttrib &&
        ...
        return n
          ...
          : ('float' ===
              (t = t.replace(/-(\D)/g, function (e, t) {
                return t.toUpperCase();
              })) && (t = wt.browser.isIE() ? 'styleFloat' : 'cssFloat'),
      ...
      _ = function (e, n, r) {
        ...
        if (!t) return !1;
        if (kt.isArray(t) && (t.length || 0 === t.length))
          return (
            (o = []),
            vu(t, function (e, t) {
      ...
      L = function (t, e, n) {
        return _(e, function (e) {
          return (
            kt.is(e, 'array') && (t = t.cloneNode(!0)),
            n &&
              vu(yu(e.childNodes), function (e) {
                t.appendChild(e);
              }),
      ...
      j = {
        ...
        getOuterHTML: function (e) {
          ...
          return An(t)
            ? t.outerHTML
            : hu('<div></div>').append(hu(t).clone()).html();
        },
        ...
        split: function (e, t, n) {
          ...
          if (e && t)
            return (
              a.setStart(e.parentNode, Su(e)),
              a.setEnd(t.parentNode, Su(t)),
              (r = a.extractContents()),
              (a = M()).setStart(t.parentNode, Su(t) + 1),
              a.setEnd(e.parentNode, Su(e) + 1),
              (o = a.extractContents()),
              (i = e.parentNode).insertBefore(Yo(j, r), e),
              n ? i.insertBefore(n, e) : i.insertBefore(t, e),
              i.insertBefore(Yo(j, o), e),
              B(e),
              n || t
            );
        },
  ...
  var Eu = Nu,
    ...
    Au = kt.grep,
    Ru =
      ((Tu.prototype._setReferrerPolicy = function (e) {
      ...
      (Tu.prototype.loadScript = function (e, t, n) {
        ...
        (a.id = i),
          ...
          (a.src = kt._addCacheSuffix(e)),
          this.settings.referrerPolicy &&
            r.setAttrib(a, 'referrerpolicy', this.settings.referrerPolicy),
          (a.onload = function () {
            o(), t();
          }),
          (a.onerror = function () {
        ...
        var u = function () {
          ...
          (n.length = 0),
            ...
            o.loading ||
              ...
              _u(e, function (e) {
                0 === i.length
                  ? T(e.success) && e.success.call(e.scope)
                  : T(e.failure) && e.failure.call(e.scope, i);
              }));
        };
        u();
      }),
      (Tu.ScriptLoader = new Tu()),
      Tu);
  function Tu(e) {
    void 0 === e && (e = {}),
      (this.states = {}),
  ...
  function Mu() {
    var r = this,
        ...
        s[o] ||
          (0 !==
            (t =
              'string' == typeof i
                ? i
                : i.prefix + i.resource + i.suffix).indexOf('/') &&
            -1 === t.indexOf('://') &&
            (t = Mu.baseURL + '/' + t),
      ...
      e = function (e, t, n) {
        void 0 === n && (n = 'added'),
          (he(c, e) && 'added' === n) || (he(s, e) && 'loaded' === n)
            ? t()
        ...
        !1 !== Mu.languageLoad &&
          e(
            ...
            function () {
              ...
              !e ||
                (n && -1 === (',' + (n || '') + ',').indexOf(',' + e + ',')) ||
                Ru.ScriptLoader.add(s[t] + '/langs/' + e + '.js');
            },
            'loaded',
          );
      },
  ...
  var Fu,
    ...
    Gu = function (e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? document : r.dom),
        Dt(o) ? [] : z(o.querySelectorAll(n), At.fromDom)
      );
      var n, r, o;
    },
    Ju = E('mce-annotation'),
    ...
    ds = function (e, t, n) {
      return e.isSome() && t.isSome()
        ? U.some(n(e.getOrDie(), t.getOrDie()))
        : U.none();
    },
    ms = Math.round,
    ps = function (e) {
    ...
    vs = function (e, t) {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && hs(t.top - e.bottom, e, t))
      );
    },
    ys = function (e, t) {
      return (
        e.top > t.bottom || (!(e.bottom < t.top) && hs(t.bottom - e.top, e, t))
      );
    },
    bs = function (e, t, n) {
      ...
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              Ss(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !Ms(n))
            )
              return o(zs(Us(n), !1)), r;
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), Ms(n) || o(zs(Us(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), Ms(n) || o(zs(Us(n), !0)));
        };
      if (Ts(e.container())) return i(e.container(), e.offset()), r;
      if (Ns(e.container()))
        if (e.isAtEnd())
          (n = Bs(e.container(), e.offset())),
            Ts(n) && i(n, n.data.length),
            As(n) && !Ds(n) && o(zs(Us(n), !1));
        else {
          if (
            ((n = Bs(e.container(), e.offset())),
            Ts(n) && i(n, 0),
            ...
            return o(zs(Us(n), !1)), r;
          (t = Bs(e.container(), e.offset() - 1)),
            As(t) &&
              !Ds(t) &&
              ((!ks(t) && !ks(n) && As(n)) || o(zs(Us(t), !1))),
            As(n) && o(zs(Us(n), !0));
        }
      return r;
    };
  ...
  var Vs,
    ...
    tc = function (e, t) {
      ...
      return (
        ...
        (o = we(o, d(On))),
        (i = i.concat(Ce(o, ec))).reverse().join('/') + ',' + n
      );
    },
    nc = function (e, t) {
      if (!t) return null;
      ...
      return i
        ? Xs(i)
          ? (function (e, t) {
              ...
              return (
                Xs(e) && t > e.data.length && (t = e.data.length), $s(e, t)
              );
            })(i, parseInt(o, 10))
          : ((o = 'after' === o ? Gs(i) + 1 : Gs(i)), $s(i.parentNode, o))
        : null;
    },
    rc = Vn,
        ...
        In(a)
          ? s.push(
              n
                ? (function (e, t, n) {
                    for (
                      var r = e(t.data.slice(0, n)).length,
                        o = t.previousSibling;
                      o && In(o);
                      o = o.previousSibling
                    )
    ...
    sc = function (e, t) {
      ...
      if (bo(e)) {
        if (
          (In(e) && vo(e) && (e = e.parentNode), (n = e.previousSibling), rc(n))
        )
          return n;
    ...
    cc = function (e, t, n) {
      ...
      var a,
        ...
        d,
        m =
          sc((a = i).startContainer, a.startOffset) ||
          sc(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: ic(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
          ((d = {}).start = oc(f, u, c, l, !0)),
          s.isCollapsed() || (d.end = oc(f, u, c, l, !1)),
          d);
    },
    lc = function (e, t, n) {
      var r = {
    ...
    fc = function (e, t) {
      ...
      var s,
        c = uc(r.cloneRange());
      i || (c.collapse(!1), (s = lc(n, o + '_end', t)), Ks(n, c, s)),
        (r = uc(r)).collapse(!0);
    ...
    Ic = function (e, t) {
      return Tc(e) && t.container() === e
        ? ((r = t),
          (o = Oc((n = e).data.substr(0, r.offset()))),
          (i = Oc(n.data.substr(r.offset()))),
          0 < (o.text + i.text).length
            ? (Bc(n), $s(n, r.offset() - o.count))
            : r)
        : Pc(e, t);
      var n, r, o, i;
    },
    Mc = function (e, t) {
      return $s.isTextPosition(t)
        ? Ic(e, t)
        : ((n = e), ((r = t).container() === n.parentNode ? Lc : Pc)(n, r));
      var n, r;
    },
    Fc = function (e) {
      Rc(e) && bo(e) && (Co(e) ? e.removeAttribute('data-mce-caret') : Dc(e)),
        Tc(e) && (Bc(e), 0 === e.data.length && Dc(e));
    },
    Uc = dt().browser,
    zc = Vn,
    jc = $n,
    ...
    Vc = function (e, t, n) {
      ...
      return (
        ...
        (u.bottom += s),
        (u.width = 1),
        0 < (i = t.offsetWidth - t.clientWidth) &&
          (n && (i *= -1), (u.left += i), (u.right += i)),
        u
      );
    },
    qc = function (e, i, a, t) {
      var n,
        ...
        f = function () {
          n = qr.setInterval(function () {
            t()
              ? hu('div.mce-visual-caret', i).toggleClass(
                  'mce-visual-caret-hidden',
                )
              : hu('div.mce-visual-caret', i).addClass(
                  'mce-visual-caret-hidden',
                );
          }, 500);
        };
    ...
    ul = function (e, t, n) {
      for (
        var r, o, i, a = e ? 'previousSibling' : 'nextSibling';
        n && n !== t;
    ...
    ll = function (e, t, n) {
      ...
      if (vo(u)) {
        if (
          (Zc(u) || (u = u.parentNode),
          'before' === (o = u.getAttribute('data-mce-caret')) &&
            ((r = u.nextSibling), Kc(r)))
        )
          return sl(r);
      ...
      if (In(u)) {
        ...
        if (Eo(u) && s >= u.data.length - 1)
          return 1 === e && (r = a(u)) ? sl(r) : n;
  ...
  ((qs = Vs = Vs || {})[(qs.Backwards = -1)] = 'Backwards'),
    (qs[(qs.Forwards = 1)] = 'Forwards');
  var hl,
    vl = Vn,
    yl = In,
    bl = An,
    ...
    El = function (e, t) {
      if (0 < e) {
        if (wl(t.previousSibling) && !yl(t.previousSibling))
          return $s.before(t);
    ...
    kl = function (e, t, n) {
      ...
      if (t.isEqual($s.after(n)) && n.lastChild) {
        if (
          ((a = $s.after(n.lastChild)),
          e < 0 && wl(n.lastChild) && bl(n.lastChild))
        )
          return Cl(n.lastChild) ? $s.before(n.lastChild) : a;
      } else a = t;
      var u,
        s,
        c,
      ...
      if (yl(l)) {
        ...
        if (e < 0 && 0 < f && ((o = Nl(l, f - 1)), wl(o)))
          return !xl(o) && (i = nl(o, e, Sl, o))
            ? yl(i)
              ? $s(i, i.data.length)
              : $s.after(i)
            : yl(o)
            ? $s(o, o.data.length)
            : $s.before(o);
        if (0 < e && f < l.childNodes.length && ((o = Nl(l, f)), wl(o)))
          return Cl(o)
            ? ((u = n),
              (c = (s = o).nextSibling) && wl(c)
                ? yl(c)
                  ? $s(c, 0)
                  : $s.before(c)
                : kl(Vs.Forwards, $s.after(s), u))
            : !xl(o) && (i = nl(o, e, Sl, o))
            ? yl(i)
              ? $s(i, 0)
              : $s.before(i)
    ...
    Dl = function (e, t, n) {
      return e
        ? !Tl(t, n) &&
            ((r = t), !(!$s.isTextPosition(r) && zn(r.getNode()))) &&
            Rl(t) &&
            Al(n)
        : !Tl(n, t) && Al(t) && Rl(n);
      var r;
    ...
    Ll = function (e, t) {
      ...
      return In(u)
        ? U.some($s(u, e ? 0 : u.data.length))
        : u
        ? Lo(u)
          ? U.some(e ? $s.before(u) : zn((a = u)) ? $s.before(a) : $s.after(a))
          : ((r = t),
            (o = u),
            (i = (n = e) ? $s.before(o) : $s.after(o)),
            Ol(n, r, i))
        : U.none();
    },
    Il = N(Ol, !0),
    ...
    ql = function (e, t, n) {
      return (
        ...
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(fo)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        !0)
    ...
    Xl = function (e, t) {
      var n,
        ...
        h = e.dom;
      if (t) {
        if (((g = t), kt.isArray(g.start)))
          return (
            (m = t),
            (p = (d = h).createRng()),
            $l(d, !0, m, p) && $l(d, !1, m, p) ? U.some(p) : U.none()
          );
        if ('string' == typeof t.start)
          return U.some(
            ((c = t),
            (l = (s = h).createRng()),
            (f = nc(s.getRoot(), c.start)),
            l.setStart(f.container(), f.offset()),
            (f = nc(s.getRoot(), c.end)),
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ? ((s = i[u]), (r = new Xr(s, e.getParent(s, e.isBlock))))
            : ((s = i[i.length - 1]),
              (r = new Xr(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
          if (3 === o.nodeType && !uf(o))
    ...
    xf = function (e, t) {
      for (var n = t; n; ) {
        if (An(n) && e.getContentEditable(n))
    ...
    kf = function (i, e, t, n, a, r) {
      ...
      return o(t, n, Nf)
        ...
        .orThunk(function () {
          return u
            ? U.some({ container: u, offset: a ? 0 : u.length })
            : U.none();
        });
    },
    ...
    Af = function (t, e, n, r) {
      ...
      if (
        ...
        i && e[0].wrapper && (i = bf(a, i, 'ul,ol').reverse()[0] || i),
        !i)
      )
        for (i = n; i[r] && !a.isBlock(i[r]) && ((i = i[r]), !cf(i, 'br')); );
      return i || n;
    },
    Rf = function (e, t, n, r) {
      var o = n.parentNode;
      return (
        !D(n[r]) && (!(o !== t && !$(o) && !e.isBlock(o)) || Rf(e, t, o, r))
      );
    },
    ...
    Of = function (e, t, n, r) {
      ...
      var o = t.startContainer,
        ...
        s = e.dom;
      return (
        An(o) && o.hasChildNodes() && ((o = ws(o, i)), In(o) && (i = 0)),
        An(a) &&
          a.hasChildNodes() &&
          ((a = ws(a, t.collapsed ? u : u - 1)),
          In(a) && (u = a.nodeValue.length)),
        (o = xf(s, o)),
        (a = xf(s, a)),
        Df(o) &&
          ((o = yf(o) ? o : o.parentNode),
          (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
          In(o) && (i = t.collapsed ? o.length : 0)),
        Df(a) &&
          ((a = yf(a) ? a : a.parentNode),
          (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a),
          In(a) && (u = t.collapsed ? 0 : a.length)),
        t.collapsed &&
          (kf(s, e.getBody(), o, i, !0, r).each(function (e) {
            var t = e.container,
              n = e.offset;
            (o = t), (i = n);
          }),
        ...
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && In(o) && 0 !== i) || (o = Tf(s, n, o, i, !0)),
          (n[0].inline && In(a) && u !== a.nodeValue.length) ||
            (a = Tf(s, n, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = _f(s, n, t, o, 'previousSibling')),
          (a = _f(s, n, t, a, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((o = Af(e, n, o, 'previousSibling')),
          (a = Af(e, n, a, 'nextSibling')),
          n[0].block &&
            (s.isBlock(o) || (o = Tf(s, n, o, i, !0)),
            s.isBlock(a) || (a = Tf(s, n, a, u, !1)))),
        An(o) && ((i = s.nodeIndex(o)), (o = o.parentNode)),
        An(a) && ((u = s.nodeIndex(a) + 1), (a = a.parentNode)),
    ...
    Pf = function (e, t, u) {
      ...
      if (
        (1 === n.nodeType && n.hasChildNodes() && (n = Bf(n, r)),
        1 === o.nodeType && o.hasChildNodes() && (o = Bf(o, i - 1)),
        n === o)
      )
        return u(s([n]));
      ...
      return ds(
        ...
        In(a)
          ? 0 === u
            ? U.some(At.fromDom(a))
            : U.none()
          : U.from(a.childNodes[u]).map(At.fromDom)),
        ((n = (t = e).endContainer),
        (r = t.endOffset),
        In(n)
          ? r === n.data.length
            ? U.some(At.fromDom(n))
            : U.none()
          : U.from(n.childNodes[r - 1]).map(At.fromDom)),
        function (e, t) {
          var n = Y(Uf(o), N(Ot, e)),
            r = Y(zf(o), N(Ot, t));
    ...
    Hf = function (e, t, n, r) {
      ...
      do {
        if (In(n) && 0 !== kt.trim(n.nodeValue).length)
  ...
  var Wf,
    ...
    Yf =
      ...
      (Kf = 'text'),
      {
        get: function (e) {
          if (!Wf(e))
            throw new Error(
              'Can only get ' + Kf + ' value of a ' + Kf + ' node',
            );
          return Xf(e).getOr('');
        },
        ...
        set: function (e, t) {
          if (!Wf(e))
            throw new Error(
              'Can only set raw ' + Kf + ' value of a ' + Kf + ' node',
            );
          e.dom.nodeValue = t;
        },
      }),
    ...
    Jf = function (r, o, i, a) {
      return $t(o).fold(
        ...
        function (e) {
          return 'br' === a || (Ut((n = o)) && Gf(n) === fo)
            ? 'valid'
            : Ft((t = o)) && Xu(t, Ju())
            ? 'existing'
            : jl(o.dom)
            ? 'caret'
            : af(r, i, a) && af(r, Lt(e), i)
            ? 'valid'
            : 'invalid-child';
          var t, n;
        },
  ...
  var rd,
    ...
    cd = function (r, l) {
      var f,
        ...
        n = function (e) {
          ...
          !(function (e, t) {
            if ('longpress' !== e.type && 0 !== e.type.indexOf('touch'))
              return D(e.target) && !ad(e.clientX, e.clientY, t);
            var n = e.touches[0];
        ...
        L = function (e) {
          ...
          (w = s * p[2] + v),
            ...
            (w = w < 5 ? 5 : w),
            (x = x < 5 ? 5 : x),
            (D(f) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean')
              ? !ud.modifierPressed(e)
              : ud.modifierPressed(e)) &&
              (_(s) > _(c)
                ? ((x = A(w * b)), (w = A(x / b)))
                : ((w = A(x / b)), (x = A(w * b)))),
            ...
            p[2] < 0 &&
              d.clientWidth <= w &&
              E.setStyle(d, 'left', void 0 + (v - w)),
            p[3] < 0 &&
              d.clientHeight <= x &&
              E.setStyle(d, 'top', void 0 + (y - x)),
            (s = R.scrollWidth - S) + (c = R.scrollHeight - N) !== 0 &&
              E.setStyles(m, { left: t - s, top: n - c }),
            C ||
              ((r = l),
              (o = f),
              (i = v),
        ...
        I = function () {
          ...
          var t,
            ...
            a = function (e, t) {
              t &&
                (f.style[e] || !l.schema.isValid(f.nodeName.toLowerCase(), e)
                  ? E.setStyle(O(f), e, t)
                  : E.setAttrib(O(f), e, '' + t));
            };
          e && (a('width', w), a('height', x)),
            ...
            e &&
              ...
              (o = x),
              (i = 'corner-' + p.name),
              t.fire('ObjectResized', {
                target: n,
                width: r,
                height: o,
                origin: i,
              }),
              E.setAttrib(f, 'style', E.getAttrib(f, 'style'))),
            l.nodeChanged();
        },
        u = function (e) {
          M(), F();
                ...
                e && E.remove(e),
                  ...
                  E.bind(e, 'mousedown', function (e) {
                    ...
                    e.stopImmediatePropagation(),
                      ...
                      E.bind(c, 'mouseup', I),
                      k !== c &&
                        (E.bind(k, 'mousemove', L), E.bind(k, 'mouseup', I)),
                      (m = E.add(
                        R,
                        'div',
        ...
        o = function (e) {
          ...
          C ||
            l.removed ||
            (s(
              E.select('img[data-mce-selected],hr[data-mce-selected]'),
              function (e) {
                e.removeAttribute('data-mce-selected');
              },
            ),
            (t = 'mousedown' === e.type ? e.target : r.getNode()),
            n((t = E.$(t).closest('table,img,figure.image,hr')[0]), R) &&
            (a(), n(r.getStart(!0), t) && n(r.getEnd(!0), t))
              ? u(t)
              : M());
        },
        i = function (e) {
      ...
      l.on('init', function () {
        var e;
        a(),
          (wt.browser.isIE() || wt.browser.isEdge()) &&
        ...
        try {
          ...
          r = (function (e, n, t) {
            ...
            if (
              ...
              0 <
                (r = (r = kt.toArray(i.getClientRects())).sort(function (e, t) {
                  return (
    ...
    gd = function (e, t, n) {
      for (
        var r = new Xr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
        (t = r[n ? 'prev' : 'next']());
    ...
    hd = function (e, t, n, r, o) {
      ...
      if (r && zn(o) && t && e.isEmpty(c))
        return U.some(Hs(o.parentNode, e.nodeIndex(o)));
      for (var l, f, d = new Xr(o, c); (a = d[r ? 'prev' : 'next']()); ) {
        if (
          'false' === e.getContentEditableParent(a) ||
          ((f = u), bo((l = a)) && !1 === md(l, f, jl))
        )
          return U.none();
        if (In(a) && 0 < a.nodeValue.length)
          return !1 ===
            (function (e, t, n) {
            ...
            ? U.some(Hs(a, r ? a.nodeValue.length : 0))
            : U.none();
    ...
    vd = function (e, t, n, r) {
      ...
      if (
        (An(l) && f > l.childNodes.length - 1 && (p = !1),
        Fn(l) && ((l = s), (f = 0)),
        l === s)
      ) {
        ...
        if (l.hasChildNodes()) {
          if (
            ((f = Math.min(!p && 0 < f ? f - 1 : f, l.childNodes.length - 1)),
            (l = l.childNodes[f]),
            (f = In(l) && d ? l.data.length : 0),
            !t && l === s.lastChild && pd(l))
          )
            return U.none();
          if (
            (function (e, t) {
          ...
          if (l.hasChildNodes() && !1 === pd(l)) {
            ...
            do {
              ...
              if (
                m[o.nodeName.toLowerCase()] &&
                (!(i = o) || !/^(TD|TH|CAPTION)$/.test(i.nodeName))
              ) {
        ...
        t &&
          ...
          An(l) &&
            (!(o = (o = l.childNodes[f]) || l.childNodes[f - 1]) ||
              !zn(o) ||
              ((u = 'A'),
              (a = o).previousSibling && a.previousSibling.nodeName === u) ||
              gd(e, o, !1) ||
              gd(e, o, !0) ||
              hd(e, d, t, !0, o).each(function (e) {
                (l = e.container()), (f = e.offset()), (c = !0);
              }))),
        p &&
          !t &&
      ...
      return (
        t === r && In(t)
          ? 0 < n &&
            ...
            ((t = (r = bd(t, n)).previousSibling),
            n < o
              ? ((t = r = bd(r, (o -= n)).previousSibling),
          ...
          : (In(t) &&
            ...
            In(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = bd(r, o).previousSibling).nodeValue.length)),
  ...
  ((rd = wd = wd || {}).compareRanges = dd),
    (rd.getCaretRangeFromPoint = fd),
    (rd.getSelectedNode = Cs),
    (rd.getNode = ws);
  var xd = wd;
  var Sd,
    Nd,
    ...
    Ad =
      ...
      }),
      {
        set: function (e, t) {
          if (!O(t) && !t.match(/^[0-9]+$/))
            throw new Error(
              Sd + '.set accepts only positive integer values. Value was ' + t,
            );
          var n = e.dom;
    ...
    Id = function (e, t, n, r, o) {
      ...
      (i = u),
        e.fire('ScrollIntoView', i).isDefaultPrevented() ||
          (n(t, wn(t).top, r, o), (a = u), e.fire('AfterScrollIntoView', a));
    },
    Md = function (e, t, n, r) {
    ...
    Vd = function (e, t, n, r) {
      ...
      i.top < a.y
        ? Sn(n.element, !1 !== r)
        : i.top > a.bottom && Sn(n.element, !0 === r);
    },
    qd = function (e, t, n) {
      return Ld(e, Hd, t, n);
    },
    ...
    Gd = function (e) {
      return (
        void 0 === e && (e = At.fromDom(document)),
        U.from(e.dom.activeElement).map(At.fromDom)
      );
    },
    Jd = function (e, t, n, r) {
    ...
    om = function (e) {
      return tm.range(
        e.start,
        rm(e.soffset, e.start),
        e.finish,
        rm(e.foffset, e.finish),
      );
    },
    im = function (e, t) {
    ...
    sm = function (e) {
      return tm.range(
        At.fromDom(e.startContainer),
        e.startOffset,
        At.fromDom(e.endContainer),
        e.endOffset,
      );
    },
    cm = function (e) {
    ...
    dm = function (r) {
      return (r.bookmark ? r.bookmark : U.none())
        .bind(function (e) {
          return (
            (t = At.fromDom(r.getBody())),
            (n = e),
            U.from(n).filter(am(t)).map(om)
          );
          var t, n;
        })
        .bind(lm);
    ...
    gm = function (r) {
      ...
      r.on('init', function () {
        ...
        r.inline &&
          ...
          Eu.DOM.bind(document, 'mouseup', n),
      ...
      gm(t),
        t.on('focusin', function () {
          ...
          e !== this &&
            ...
            n.setActive(this),
            (n.focusedEditor = this).fire('focus', { blurredEditor: e }),
            this.focus(!0));
        }),
    ...
    bm = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (hm.unbind(document, 'focusin', _d), (_d = null));
    },
    Cm = function (t, e) {
      return (
        (n = e).collapsed
          ? U.from(ws(n.startContainer, n.startOffset)).map(At.fromDom)
          : U.none()
      ).bind(function (e) {
    ...
    Em = function (e) {
      return e.inline
        ? (n = e.getBody()) && Sm(At.fromDom(n))
        : (t = e).iframeElement && Yd(At.fromDom(t.iframeElement));
      var t, n;
    },
    km = function (t) {
      var e = t.selection,
      ...
      t.inline || (wt.opera || xm(n), t.getWin().focus()),
        (wt.gecko || t.inline) && (xm(n), wm(t, r)),
        _m(t);
    },
    _m = function (e) {
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (
                ((u = 'attributes' === r ? e.getAttrib(t, a) : ff(e, t, a)),
                o && !u && !n.exact)
              )
                return;
          ...
          for (s = 0; s < c.length; s++)
            if ('attributes' === r ? e.getAttrib(t, c[s]) : ff(e, t, c[s]))
              return n;
      return n;
    },
    ...
    Hm = function (r, t) {
      ...
      return U.from(r.selection.getStart(!0))
        .bind(function (e) {
          return Pm(
            At.fromDom(e),
            function (n) {
        ...
        if (r)
          do {
            ...
            if (
              ...
              return !1;
            if (3 === r.type && r.parent && t[r.parent.name] && Uo(r.value))
              return !1;
            if (n && n(r)) return !1;
          } while ((r = $m(r, this)));
        return !0;
  ...
  var Ym = kt.makeMap,
    ...
    ep = function (e, t, n) {
      return (
        ...
        (/^data:image\//i.test(t)
          ? ((r = e.allow_svg_data_urls),
            (o = n),
            !($(r) ? M(Zm, o) : r) && /^data:image\/svg\+xml/i.test(t))
          : /^data:/i.test(t))
      );
      var r, o;
    },
    ...
    var X = W.comment ? W.comment : e,
      ...
      n = function (f, e) {
        ...
        for (
          ...
          var q = t[0];
          if ((x < t.index && T(E(w.substr(x, t.index - x))), (i = t[7])))
            ':' === (i = i.toLowerCase()).charAt(0) && (i = i.substr(1)), R(i);
          else if ((i = t[8])) {
            if (t.index + q.length > w.length) {
              T(E(w.substr(t.index))), (x = t.index + q.length);
              continue;
            }
            ':' === (i = i.toLowerCase()).charAt(0) && (i = i.substr(1)),
              (u = i in I),
              j && M[i] && 0 < S.length && S[S.length - 1].name === i && R(i);
            var $ = (function (e, t) {
              var n = e.exec(t);
              if (n) {
                var r = n[1],
            ...
            if (!U || (s = K.getElementRule(i))) {
              if (
                ((c = !0),
                U && ((g = s.attributes), (h = s.attributePatterns)),
                (p = t[9])
                  ? ((m = -1 !== p.indexOf('data-mce-type')) && z && (c = !1),
                    ((d = []).map = {}),
                    p.replace(L, function (e, t, n, r, o) {
                      return B(i, t, n, r, o), '';
                    }))
                  : ((d = []).map = {}),
                U && !m)
                ...
                if (
                  ((v = s.attributesRequired),
                  (y = s.attributesDefault),
                  (b = s.attributesForced),
                  s.removeEmptyAttrs && !d.length && (c = !1),
                  b)
                )
                  for (r = b.length; r--; )
                    (a = (l = b[r]).name),
                      ...
                      (d.map[a] = C),
                      d.push({ name: a, value: C });
                if (y)
                  for (r = y.length; r--; )
                    (a = (l = y[r]).name) in d.map ||
                      ('{$uid}' === (C = l.value) && (C = 'mce_' + N++),
                      (d.map[a] = C),
                      d.push({ name: a, value: C }));
                if (v) {
            ...
            if ((n = H[i])) {
              (n.lastIndex = x = t.index + q.length),
                (x = (t = n.exec(w))
                  ? (c && (o = w.substr(x, t.index - x)), t.index + t[0].length)
                  : ((o = w.substr(x)), w.length)),
                c && (0 < o.length && T(o, !0), Q(i)),
                (P.lastIndex = x);
              continue;
            }
            u ||
              (p && p.indexOf('/') === p.length - 1
                ? c && Q(i)
                : S.push({ name: i, valid: c }));
          } else if ((i = t[1])) D(i);
          else if ((i = t[2])) {
            if (
              !(
  ...
  var rp,
    ...
    sp = function (e, t, n, r) {
      ...
      return (
        ...
        (o =
          'raw' === t.format
            ? kt.trim(up(e.serializer, r.innerHTML))
            : 'text' === t.format
            ? e.dom.isEmpty(r)
              ? ''
              : po(r.innerText || r.textContent)
            : 'tree' === t.format
            ...
            : ((a = (i = e).serializer.serialize(r, t)),
              ...
              a.replace(s, ''))),
        M(['text', 'tree'], t.format) || so(At.fromDom(r))
          ? (t.content = o)
          : (t.content = kt.trim(o)),
    ...
    pp = function (e) {
      ...
      return (
        In(t) &&
        (0 === t.data.length || (mo(t.data) && od.isBookmarkNode(t.parentNode)))
      );
    },
    gp = function (t, n) {
      return function (e) {
        return U.from(il(t ? 0 : -1, e))
          .filter(n)
          .isSome();
      };
    },
    ...
    vp = function (e) {
      return (
        Vn(e) && !(An((t = e)) && 'all' === t.getAttribute('data-mce-bogus'))
      );
      var t;
    },
    yp = gp(!0, hp),
    ...
    Vp = function (e, t) {
      return (
        (n = t),
        U.from(n.getNode(!0)).map(At.fromDom).exists(no) ||
          jp(!1, e, t).isSome()
      );
      var n;
    },
    ...
    eg = function (e, t) {
      return (
        ...
        Zp(
          ...
          ((r = (n = t).container()),
          (o = n.offset()),
          In(r) && o < r.data.length ? Hs(r, o + 1) : n),
        )
      );
      var n, r, o;
    },
    ...
    og = function (l, e) {
      return U.some(e)
        ...
        .bind(function (e) {
          ...
          (u = (a = c).data),
          (s = Hs(a, 0)),
          !(!tg(u, 0) || eg(i, s) || ((a.data = ' ' + u.slice(1)), 0)) ||
            rg(c) ||
            ((t = l),
            (r = (n = c).data),
            (o = Hs(n, r.length - 1)),
    ...
    ig = function (t) {
      ...
      t.selection.isCollapsed() &&
        og(e, Hs.fromRangeStart(t.selection.getRng())).each(function (e) {
    ...
    ag = function (e, t, n) {
      ...
      0 !== n &&
        ...
        (a = t + n >= e.data.length && Zp(o, $s(e, e.data.length))),
        (u = 0 === t && Qp(o, $s(e, 0))),
        e.replaceData(
          t,
          n,
            ...
            function (e, t) {
              return Zl(t) || Ql(t)
                ? e.previousCharIsSpace ||
                  ...
                  ? { previousCharIsSpace: !1, str: e.str + lo }
    ...
    lg = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === $s.isTextPosition(n) &&
        o === r.parentNode &&
        i > $s.before(r).offset()
          ? $s(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    fg = function (e) {
      return Lo(e.previousSibling)
        ? U.some(
            ((t = e.previousSibling),
            In(t) ? $s(t, t.data.length) : $s.after(t)),
          )
        : e.previousSibling
        ? Ul(e.previousSibling)
        : U.none();
      var t;
    },
    dg = function (e) {
      return Lo(e.nextSibling)
        ? U.some(((t = e.nextSibling), In(t) ? $s(t, 0) : $s.before(t)))
        : e.nextSibling
        ? Fl(e.nextSibling)
        : U.none();
      var t;
    ...
    pg = function (n, r) {
      return dg(r)
        ...
        .orThunk(function () {
          return (
            (t = r),
            Il((e = n), $s.after(t)).fold(function () {
    ...
    bg = function (e, t, a) {
      ...
      return (
        ...
        ((n = u).isSome() && r.isSome() && o.isSome()
          ? U.some(i(n.getOrDie(), r.getOrDie(), o.getOrDie()))
          : U.none()
        ).orThunk(function () {
          return (
            a &&
        ...
        : ds(t, n, wg).fold(
            ...
            function (e) {
              return Rg(r, e)
                ? U.none()
                : ((n = r),
                  Ng((t = e).start, n).bind(function (e) {
                    return re(_g(e)).map(function (e) {
                      return wg(t.start, e);
                    });
                  }));
    ...
    Bg = function (n) {
      return ds(
        Dg((r = n).cells, r.rng.start),
        Dg(r.cells, r.rng.end),
        function (e, t) {
    ...
    Pg = function (e, t) {
      var n,
        ...
        s =
          ((o = u),
          (i = Sg((r = t).startContainer, o)),
          (a = Sg(r.endContainer, o)),
          ds(i, a, wg));
      return Og(s, t, u)
        .map(function (e) {
    ...
    Lg = function (e) {
      var t;
      return (8 === It((t = e)) || '#comment' === Lt(t) ? Wt : Zt)(e)
        .bind(Lg)
        .orThunk(function () {
          return U.some(e);
        });
    ...
    Mg = function (e, t, n) {
      ...
      return (
        $o(a) && (_p(a), e.selection.setCursorLocation(a.dom, 0)),
        Ot(n, a) ||
          ((r = $t(a).is(n)
            ? []
            : $t((o = a))
        ...
        .bind(function (e) {
          return (
            ...
            Fl((r = l).dom)
              ...
              : ((t = l),
                (n = e),
                jg(s, At.fromDom(n.getNode())).map(function (e) {
                  return !1 === Ot(e, t);
                }))
          );
          var t, n, r, o, i, a;
        ...
        .bind(function (e) {
          return $o(e)
            ...
            : ((t = a),
              (n = e),
              (r = u),
              Bl(i, o.getBody(), r).bind(function (e) {
      ...
      return jg(s, r).fold(
        function () {
          return (
            ...
            ((e = a),
            (t = u),
            (n = $s.fromRangeStart(e.selection.getRng())),
            $g(t, n) ||
              Ol(t, e.getBody(), n).exists(function (e) {
                return $g(t, e);
              }))
          );
          var e, t, n;
        ...
        function (e) {
          return (
            ...
            ($o(o) ? Hg(t, o) : Vg(t, r, n, o, i)).getOr(!1)
          );
          var t, n, r, o, i;
        },
      );
    ...
    Kg = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === s.length
        ...
        : ((n = e),
          (r = u),
          (o = At.fromDom(n.getBody())),
          (i = n.selection.getRng()),
          0 !== (a = Ff(n)).length ? Ig(n, a) : Ug(n, o, i, r));
    },
    Xg = function (a) {
    ...
    Gg = function (e, t) {
      ...
      return (
        ...
        ('br' === (n = t.firstChild).name || n.value === lo)
      );
    },
    Jg = function (e, t) {
      var n,
    ...
    Qg = function (e) {
      return (
        ...
        ((t = e.firstChild).data === lo || zn(t))
      );
      var t;
    },
    Zg = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Qg(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    nh = function (t, e, n) {
      var r,
        ...
        u = t.parentNode;
      return (
        kt.each(e, function (e) {
          u.insertBefore(e, t);
        }),
        (r = t),
        (o = n),
        (i = $s.before(r)),
        (a = _l(o).next(i)) ? a.toRange() : null
      );
    },
    rh = function (e, o, i, t) {
      var n,
        ...
        k = Zg(
          ((f = N.firstChild),
          kt.grep(f.childNodes, function (e) {
    ...
    ih = function (e) {
      ...
      (r = t),
        (o = n),
        null !== (i = a) &&
        i === r.getParent(o.endContainer, oh) &&
        jf(At.fromDom(i), o)
          ? Mg(e, n, At.fromDom(a))
    ...
    ah = function (e, t, n) {
      ...
      /^ | $/.test(t) &&
        ...
        (c = d.getRng()),
        (l = t),
        (f = At.fromDom(s.getRoot())),
        (l = Qp(f, $s.fromRangeStart(c))
          ? l.replace(/^ /, '&nbsp;')
          : l.replace(/^&nbsp;/, ' ')),
        (t = l =
          Zp(f, $s.fromRangeEnd(c))
            ? l.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;')
            : l.replace(/&nbsp;(<br( \/)?>)?$/, ' ')));
      var p = e.parser,
        g = n.merge,
        h = Jm({ validate: e.getParam('validate') }, e.schema),
        v = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>',
        y = { content: t, format: 'html', selection: !0, paste: n.paste };
      if ((y = e.fire('BeforeSetContent', y)).isDefaultPrevented())
        e.fire('SetContent', {
          content: y.content,
          format: 'html',
          selection: !0,
        ...
        -1 === (t = y.content).indexOf('{$caret}') && (t += '{$caret}'),
          (t = t.replace(/\{\$caret\}/, v));
        var b,
          C,
          w =
            (a = d.getRng()).startContainer ||
            (a.parentElement ? a.parentElement() : null),
          x = e.getBody();
        w === x &&
          d.isCollapsed() &&
          ...
          ((b = e),
          (C = x.firstChild) &&
            !b.schema.getShortEndedElements()[C.nodeName]) &&
          m.isEmpty(x.firstChild) &&
          ((a = m.createRng()).setStart(x.firstChild, 0),
          a.setEnd(x.firstChild, 0),
          d.setRng(a)),
          d.isCollapsed() || ih(e);
        var S,
          N,
          ...
          F = p.parse(t, M);
        if (!0 === n.paste && Jg(e.schema, F) && eh(m, r))
          return (
            (a = rh(h, m, d.getRng(), F)),
            d.setRng(a),
            void e.fire('SetContent', y)
          );
        if (
          (!(function (e) {
          ...
          for (u = (i = u).prev; u; u = u.walk(!0))
            if (3 === u.type || !m.isBlock(u.name)) {
              e.schema.isValidChild(u.parent.name, 'span') &&
                u.parent.insert(i, u, 'br' === u.name);
              break;
            }
        if ((e._selectionOverrides.showBlockCaretContainer(r), M.invalid)) {
          for (
            e.selection.setContent(v),
              r = d.getNode(),
              o = e.getBody(),
              9 === r.nodeType ? (r = u = o) : (u = r);
            u !== o;
          ...
          (t = h.serialize(F)),
            ...
            'all' === (E = r).getAttribute('data-mce-bogus')
              ...
              : ((k = E.firstChild),
                ...
                !k || (k === _ && 'BR' === k.nodeName)
                  ? S.dom.setHTML(E, N)
                  : S.selection.setContent(N));
        (R = g),
          (O = (A = e).schema.getTextInlineElements()),
          (B = A.dom),
          R &&
            ((T = A.getBody()),
            (D = new lp(B)),
            kt.each(B.select('*[data-mce-fragment]'), function (e) {
          ...
          (P = e.getBody()),
          kt.each(P.getElementsByTagName('*'), function (e) {
            e.removeAttribute('data-mce-fragment');
          }),
          (L = m),
          (I = d.getStart()),
          U.from(L.getParent(I, 'td,th')).map(At.fromDom).each(Ap),
          e.fire('SetContent', y),
          e.addVisual();
      }
    },
    ...
    fh = function (u, s, c) {
      return (
        ...
        (c.set = !0),
        (c.content = ch(s) ? '' : s),
        c.no_events || u.fire('BeforeSetContent', c),
        ch(s) || (s = c.content),
        U.from(u.getBody()).fold(E(s), function (e) {
          return ch(s)
            ? (function (e, t, n, r) {
                sh(
                ...
                return (
                  (r.content = so(At.fromDom(t)) ? o : kt.trim(o)),
                  lh(e, r.content),
                ...
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    ...
                    t.schema.isValidChild(
                      ...
                      ? ((r = a), t.dom.createHTML(i, yc(t), r))
                      : r || '<br data-mce-bogus="1">'),
                  lh(t, r),
                  t.fire('SetContent', o))
                : ('raw' !== o.format &&
                    (r = Jm({ validate: t.validate }, t.schema).serialize(
                      t.parser.parse(r, { isRootContent: !0, insert: !0 }),
                    )),
                  (o.content = so(At.fromDom(n)) ? r : kt.trim(r)),
                  lh(t, o.content),
    ...
    dh = function (e, t) {
      return (
        (r = t),
        ((o = (n = e).dom).parentNode
          ? Rr(At.fromDom(o.parentNode), function (e) {
              return !Ot(n, e) && r(e);
            })
          : U.none()
        ).isSome()
    ...
    yh = function (e, t, n) {
      ...
      gh(t)
        ...
        : ((r = d.getRng()),
          ...
          (u = r.endContainer),
          (s = r.endOffset),
          (l = hh(t)) && l.nodeValue.charAt(0) === mh && l.deleteData(0, 1),
          (c = l),
          f.remove(t, !0),
          i === c && 0 < a && r.setStart(c, a - 1),
          u === c && 0 < s && r.setEnd(c, s - 1),
          o && f.isEmpty(o) && _p(At.fromDom(o)),
          d.setRng(r));
    },
    bh = function (e, t, n) {
      void 0 === n && (n = !0);
    ...
    xh = function (e, t, n, r) {
      ...
      for (
        3 === w.nodeType &&
        (x !== w.nodeValue.length && (o = !0), (S = S.parentNode));
        S;
      ...
      i &&
        (o
          ...
          : ((s = Hl(e.getBody(), i)),
            ...
            (p = null !== s ? s : i),
            (g = (d = e).dom),
            (h = g.getParent(p, N(of, d))) && g.isEmpty(h)
            ...
            (l = (function (t, e, n, r, o, i) {
              ...
              if (
                ...
                var l = n.cloneNode(!1);
                return (
                  u.add(e, l), a.remove(r, o, l, i), u.remove(l), U.some(l)
                );
              }
              return U.none();
            })(e, c, i, t, n, r)),
            (f = wh(b.concat(l.toArray()), c)),
            yh(e, s, !1),
    ...
    Sh = function (i) {
      i.on('mouseup keydown', function (e) {
        ...
        (t = i),
          ...
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== mh ||
            bh(t, Hl(o, r.getStart())),
          (37 !== n && 39 !== n) || bh(t, Hl(o, r.getStart()));
      });
    },
    Nh = function (e, t) {
      return (
        e.schema.getTextInlineElements().hasOwnProperty(Lt(t)) &&
        !jl(t.dom) &&
        !On(t.dom)
      );
    },
    ...
    n.collapsed ||
      ...
      _h(
        ...
        function (e) {
          ...
          (t = e.previousSibling),
            hu((n = e)).remove(),
            hu(t).append('<br><br>').append(n.childNodes);
        },
      ));
  }),
    Eh[(rp = 'pre')] || (Eh[rp] = []),
  ...
  var Ah = kt.each,
    ...
    Ih = Cr([{ keep: [] }, { rename: ['name'] }, { removed: [] }]),
    Mh = /^(src|href|style)$/,
    Fh = kt.each,
    Uh = cf,
    zh = function (e, t, n) {
    ...
    jh = function (e, t, n) {
      ...
      return (
        ...
        In(o) &&
          ...
          (o = new Xr(o, e.getBody()).next() || o),
        In(o) && !n && 0 === i && (o = new Xr(o, e.getBody()).prev() || o),
        o
      );
    },
    Hh = function (e, t) {
    ...
    Wh = function (e, r, o, t, i) {
      ...
      if (
        ...
        !(
          Uh((s = t), (c = r).inline) ||
          Uh(s, c.block) ||
          (c.selector && An(s) && u.is(s, c.selector)) ||
      ...
      if (r.inline && 'all' === r.remove && S(r.preserve_attributes)) {
        ...
        if (
          ...
          return Ih.rename('span');
      }
      if ('all' !== r.remove) {
        Fh(r.styles, function (e, t) {
          (e = lf(l, sf(e, o), t + '')),
            O(t) && ((t = e), (i = null)),
            (!r.remove_similar && i && !Uh(ff(l, i, t), e)) ||
              l.setStyle(y, t, ''),
            (n = !0);
        }),
          n &&
          ...
          Fh(r.attributes, function (e, t) {
            var n;
            if (
              ((e = sf(e, o)),
              O(t) && ((t = e), (i = null)),
              r.remove_similar || !i || Uh(l.getAttrib(i, t), e))
            ) {
              if (
                'class' === t &&
                (e = l.getAttrib(y, t)) &&
              ...
              'class' === t && y.removeAttribute('className'),
                Mh.test(t) && y.removeAttribute('data-mce-' + t),
                y.removeAttribute(t);
            }
          }),
      ...
      return 'none' !== r.remove
        ? ((f = e),
          ...
          m.block &&
            (v
              ? g === h.getRoot() &&
                ((m.list_block && Uh(d, m.list_block)) ||
                  W(oe(d.childNodes), function (e) {
                    af(f, v, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = Vh(h, e, v)),
              ...
              : h.isBlock(d) &&
                !h.isBlock(g) &&
                ($h(h, d, !1) ||
                  $h(h, d.firstChild, !0, !0) ||
                  d.insertBefore(h.create('br'), d.firstChild),
                $h(h, d, !0) ||
                  $h(h, d.lastChild, !1, !0) ||
                  d.appendChild(h.create('br')))),
          (m.selector && m.inline && !Uh(m.inline, d)) || h.remove(d, !0),
          Ih.removed())
        : Ih.keep();
    },
    Kh = function (t, e, n, r, o) {
      return Wh(t, e, n, r, o).fold(
        C,
        function (e) {
      ...
      if (n) {
        for (
          ...
          for (
            ...
            null !==
              (s = (function (t, e, n, r) {
                return Wh(t, e, n, r, r).fold(
                  E(r),
                  function (e) {
                    return (
                      t.dom.createFragment().appendChild(r), t.dom.rename(r, e)
                    );
                  },
                  E(null),
                );
    ...
    Yh = function (s, c, l, e, f) {
      var t,
        ...
        u = function (e) {
          var n,
            ...
            u =
              ...
              (o = l),
              (i = f),
              W(mf((n = s).dom, t.parentNode).reverse(), function (e) {
                var t;
                a ||
                  '_start' === e.id ||
                  '_end' === e.id ||
                  ((t = zm(n, e, r, o, i)) && !1 !== t.split && (a = e));
              }),
              a);
        ...
        p = function (e) {
          ...
          if (i && !n)
            for (var o = 0; o < d.length && !Kh(s, d[o], l, e, e); o++);
          if (m.deep && r.length) {
      ...
      if (e)
        tf(e)
          ? ((t = a.createRng()).setStartBefore(e), t.setEndAfter(e), r(t))
          : r(e);
      else if ('false' !== a.getContentEditable(n.getNode()))
        n.isCollapsed() && m.inline && !Ff(s).length
          ? xh(s, c, l, f)
          : ($f(n, !0, function () {
              qf(s, r);
            }),
            m.inline && jm(s, c, l, n.getStart()) && nf(a, n, n.getRng()),
            s.nodeChanged());
      else {
        e = n.getNode();
        for (
          var o = 0;
          o < d.length && (!d[o].ceFalseOverride || !Kh(s, d[o], l, e, e));
          o++
        );
      }
    },
      ...
      var e,
        ...
        T = function (n, e) {
          ...
          (e = e || R),
            n &&
              ...
              Qh(e.styles, function (e, t) {
                a.setStyle(n, t, sf(e, _));
              }),
              !e.styles ||
                ((t = a.getAttrib(n, 'style')) &&
                  a.setAttrib(n, 'data-mce-style', t)),
              Qh(e.attributes, function (e, t) {
        ...
        m = function (e, t) {
          ...
          return (
            !!hf(R) &&
            (Qh(e, function (e) {
              if (!('collapsed' in e && e.collapsed !== i))
                return a.is(t, e.selector) && !jl(t)
                  ? (T(t, e), !(n = !0))
                  : void 0;
            }),
            n)
                    ...
                    zn(e) &&
                      !(function (e, t, n, r) {
                        if (
                          ...
                          return (
                            ve(o, r) && $o(At.fromDom(n.parentNode), !1) && !i
                          );
                        }
                        return !1;
                      })(E, R, e, o))
                  )
                    return (u = null), void (gf(R) && S.remove(e));
                  if (R.wrapper && zm(E, e, k, _)) u = null;
                  else {
                    if (
                      l &&
                      !t &&
                    ...
                    jl(e) ||
                    (Zh(R, 'inline') && S.isBlock(e))
                      ? ((u = null),
                        Qh(kt.grep(e.childNodes), s),
                        t && (l = n),
                        (u = null))
                      : (u ||
                          ((u = S.clone(d, !1)),
            ...
            Qh(N, function (e) {
              ...
              (!(1 < N.length) && S.isBlock(e)) || 0 !== x
                ? (vf(R) || R.wrapper) &&
                  ...
                  (g = k),
                  (h = _),
                  (zm((m = E), (v = e).parentNode, g, h) && Kh(m, p, h, v)) ||
                  ...
                  (d = e),
                  (l = R).styles &&
                    l.styles.backgroundColor &&
                    Bh(
                      d,
                      Ph(c, 'fontSize'),
                      Lh(c, 'backgroundColor', sf(l.styles.backgroundColor, f)),
                    ),
                  (i = S),
                  (u = e),
                  (s = function (e) {
                    ...
                    1 === e.nodeType &&
                      ...
                      ((t = df(i, e.parentNode)),
                      i.getStyle(e, 'color') && t
                        ? i.setStyle(e, 'text-decoration', t)
                        : i.getStyle(e, 'text-decoration') === t &&
                          i.setStyle(e, 'text-decoration', null));
                  }),
                  (a = R).styles &&
                    (a.styles.color || a.styles.textDecoration) &&
                    (kt.walk(u, s, 'childNodes'), s(u)),
                  (t = S),
                  (o = e),
                  ('sub' !== (r = R).inline && 'sup' !== r.inline) ||
                    (Bh(o, Ph(t, 'fontSize'), Lh(t, 'fontSize', '')),
                    t.remove(
      ...
      if ('false' !== a.getContentEditable(u.getNode())) {
        R &&
          (r
            ? tf(r)
              ? m(A, r) ||
                ((e = a.createRng()).setStartBefore(r),
                e.setEndAfter(r),
                s(a, Of(E, e, A), 0, !0))
              : s(a, r, 0, !0)
            : i && vf(R) && !Ff(E).length
            ...
            : ((t = u.getNode()),
              ...
              E.settings.forced_root_block ||
                !n.defaultBlock ||
                a.getParent(t, a.isBlock) ||
                ev(E, n.defaultBlock),
              u.setRng(Yg(u.getRng())),
              $f(u, !0, function (e) {
                qf(E, function (e, t) {
                  var n = t ? e : Of(E, e, A);
                  s(a, n);
        ...
        for (var c = 0, l = A.length; c < l; c++) {
          var f = A[c];
          if (f.ceFalseOverride && hf(f) && a.is(r, f.selector))
            return void T(r, f);
        }
      }
    },
    ...
    cv = function (e, t) {
      for (var n = e.rows, r = 0; r < n.length; r++)
        for (var o = n[r].cells, i = 0; i < o.length; i++)
          if (Ot(o[i], t)) return U.some({ x: i, y: r });
      return U.none();
    },
          ...
          W(Gu(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              ...
              (function (e, t, n) {
                for (
                  ;
                  (r = t), (o = n), ((i = e.rows)[o] ? i[o].cells : [])[r];
      ...
      return cv(l, e).bind(function (c) {
        return cv(l, t).map(function (e) {
          return (
            ...
            (a = r.x),
            (u = r.y),
            (s = i < u ? lv(t, o, i, a, u) : lv(t, o, u, a, i)),
            iv(t.element, sv(s), s)
          );
          var t, n, r, o, i, a, u, s;
        });
    ...
    bv = function (e, t) {
      ...
      return 0 < o.length
        ? yv(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? hv() : vv(n, r[0]));
    },
    Cv = function (e, t) {
    ...
    xv = function (f) {
      return U.from(f.selection.getRng())
        .map(function (e) {
          var t = U.from(
              f.dom.getParent(e.commonAncestorContainer, f.dom.isBlock),
            ),
            n = f.getBody(),
            r = t
              .map(function (e) {
    ...
    Ev = function (e, t, n) {
      ...
      e.hasChildNodes() && n < e.childNodes.length
        ? (r = e.childNodes[n]).parentNode.insertBefore(o, r)
        : e.appendChild(o);
    },
    kv = function (e, o) {
      var i = 0;
    ...
    Rv = function (n) {
      var e,
        t =
          ((e = n.getBody()),
          H(z(oe(e.childNodes), Nv), function (e) {
            return 0 < e.length;
          })),
        r = J(t, function (e) {
    ...
    Bv = function (e, t) {
      return (
        !(!e || !t) && ((r = t), Dv(e) === Dv(r) || ((n = t), Ov(e) === Ov(n)))
      );
      var n, r;
    },
    Pv = function (e) {
      ...
      return {
        undoManager: {
          beforeChange: function (e, t) {
            return (
              (n = f), (r = t), void (Pv(e) && r.set(U.some(mc(n.selection))))
            );
            var n, r;
          },
          ...
          undo: function (e, t, n) {
            return (
              ...
              (i = t),
              (a = n),
              (o = e).typing && (o.add(), (o.typing = !1), Lv(o, !1, i)),
              0 < a.get() &&
                (a.set(a.get() - 1),
                (u = o.data[a.get()]),
                Tv(r, u, !0),
          ...
          hasUndo: function (e, t) {
            return (
              (n = f),
              (r = e),
              0 < t.get() || (r.typing && r.data[0] && !Bv(Rv(n), r.data[0]))
            );
            var n, r;
          },
          ...
          transact: function (e, t, n) {
            return (
              (o = n), Iv((r = e), t), r.beforeChange(), r.ignore(o), r.add()
            );
            var r, o;
          },
          ignore: function (e, t) {
          ...
          extra: function (e, t, n, r) {
            return (
              ...
              void (
                (i = e).transact(u) &&
                ((c = i.data[a.get()].bookmark),
                (l = i.data[a.get() - 1]),
                Tv(o, l, !0),
                i.transact(s) && (i.data[a.get() - 1].beforeBookmark = c))
              )
            );
            var o, i, a, u, s, c, l;
          },
        ...
        formatter: {
          ...
          canApply: function (e) {
            return (function (e, t) {
              ...
              if (u)
                for (
                  n = e.selection.getStart(), r = mf(s, n), i = u.length - 1;
                  0 <= i;
                  i--
                ) {
          ...
          toggle: function (e, t, n) {
            return (
              ...
              (i = t),
              (a = n),
              (u = (r = f).formatter.get(o)),
              void (
                !jm(r, o, i, a) || ('toggle' in u[0] && !u[0].toggle) ? ev : Yh
              )(r, o, i, a)
            );
            var r, o, i, a, u;
          },
        ...
        editor: {
          getContent: function (e, t) {
            return (
              ...
              (r = e),
              (o = t),
              U.from(n.getBody()).fold(
                E('tree' === r.format ? new Km('body', 11) : ''),
                function (e) {
                  return sp(n, r, o, e);
                },
              )
          ...
          addVisual: function (e) {
            return (
              ...
              (n = D(t) ? t : i.getBody()),
              R(i.hasVisual) &&
                (i.hasVisual = i.getParam('visual', !0, 'boolean')),
              W(a.select('table,a', n), function (e) {
                switch (e.nodeName) {
                  case 'TABLE':
                    var t = i.getParam(
                        'visual_table_class',
    ...
    jv = function (i, a) {
      ...
      return {
        ...
        editor: {
          getContent: function (e, t) {
            if ('html' !== t && 'tree' !== t)
              return zv(i).editor.getContent(e, t);
            var n = a.getContent(),
              r = Jm({ inner: !0 });
          ...
          setContent: function (e, t) {
            var n = Mv(e)
              ? e
              : i.parser.parse(e, { isRootContent: !0, insert: !0 });
        ...
        selection: {
          getContent: function (e, t) {
            if ('html' !== e && 'tree' !== e)
              return zv(i).selection.getContent(e, t);
    ...
    Kv = function (e, t, s, c) {
      e.bind(function (u) {
        return (
          (c ? sg : ug)(u.dom, c ? u.dom.length : 0),
          t.filter(Ut).map(function (e) {
            return (
              (t = e),
              (n = s),
              (r = c),
              ...
              void (r
                ? (cg(o, i, !1, !r), n.setStart(i, a))
                : (cg(i, o, !1, !r), n.setEnd(i, a)))
            );
            var t, n, r, o, i, a;
          })
        );
        ...
        t
          ...
          .bind(e ? Kt : Wt)
          .or(t)
          .filter(Ut)).map(function (e) {
          return (
            (r = c),
            void $t((n = e)).each(function (e) {
              var t = n.dom;
              r && Qp(e, $s(t, 0))
                ? ug(t, 0)
                : !r && Zp(e, $s(t, t.length)) && sg(t, t.length);
            })
          );
          var n, r;
        });
  ...
  var Gv = function (e) {
    ...
    Jv = function (e) {
      return (
        !(!e || !e.ownerDocument) &&
        Pt(At.fromDom(e.ownerDocument), At.fromDom(e))
      );
    },
    Qv = function (u, s, e, c) {
      var l,
        ...
        p = function () {
          ...
          return (
            (t =
              t || (o.createRange ? o.createRange() : o.body.createTextRange()))
              .setStart &&
        ...
        g = function (e, t) {
          ...
          if (
            (r = e) &&
            (Gv(r) || (Jv(r.startContainer) && Jv(r.endContainer)))
          ) {
            var r,
              o = Gv(e) ? e : null;
            if (o) {
        ...
        v = {
          ...
          setCursorLocation: function (e, t) {
            var n = u.createRng();
            e
              ? (n.setStart(e, t), n.setEnd(e, t), g(n), o(!1))
              : (Hf(u, n, c.getBody(), !0), g(n));
          },
          ...
          getNode: function () {
            return (function (e, t) {
              ...
              return !t.collapsed &&
                ...
                3 === n.nodeType &&
                  3 === r.nodeType &&
                  ((n = n.length === o ? Dm(n.nextSibling, !0) : n.parentNode),
                  (r = 0 === i ? Dm(r.previousSibling, !1) : r.parentNode),
                  n && n === r))
                ? n
                : a && 3 === a.nodeType
                ? a.parentNode
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              var o,
                ...
                a = e.getRoot();
              if (
                ((n = e.getParent(n || Rm(a, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || Tm(a, t, t.collapsed), e.isBlock)),
                n && n !== a && i.push(n),
                n && r && n !== r)
              )
                for (var u = new Xr((o = n), a); (o = u.next()) && o !== r; )
          ...
          getBoundingClientRect: function () {
            var e = p();
            return e.collapsed
              ? $s.fromRangeStart(e).getClientRects()[0]
    ...
    ey = function (e, t) {
      ...
      t.convert_fonts_to_spans &&
        Zv(e, r, kt.explode(t.font_size_legacy_values)),
        (n = r),
            ...
            if (u[n.src] !== undefined)
              return new Br(function (t) {
                u[n.src].then(function (e) {
                  return 'string' == typeof e
                    ? e
                    : void t({ image: n, blobInfo: e.blobInfo });
                });
              });
  ...
  var sy,
    ...
    ly = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Km('br', 1)).shortEnded = !0)
        : (r.empty().append(new Km('#text', 3)).value = lo);
    },
    fy = function (e, t) {
      return (
        e &&
              ...
              .filter(function () {
                return (function (e, t) {
                  if (t.images_dataimg_filter) {
                    ...
                    return (
                      (n.src = e.attr('src')),
                      ue(e.attributes.map, function (e, t) {
                        n.setAttribute(t, e);
                      }),
            ...
            if (
              ...
              o &&
                ...
                dy(h, m, p, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && ly(g, n, d, i)));
            } else {
              for (
                a = o;
                i &&
              ...
              a === i &&
                ...
                (((l = new Km('#text', 3)).value = lo), o.replace(l));
            }
        }),
    ...
    by = function (A, R) {
      ...
      var e,
        ...
        P = function (e) {
          ...
          for (; t--; )
            (r = D[t].name) in e.attributes.map &&
              ((n = B[r]) ? n.push(e) : (B[r] = [e]));
          return e;
        },
        n = {
          schema: R,
          ...
          getNodeFilters: function () {
            var e = [];
            for (var t in T)
              T.hasOwnProperty(t) && e.push({ name: t, callbacks: T[t] });
            return e;
          },
          filterNode: P,
          parse: function (e, u) {
            ...
            var f,
              d = yy(
                gy('script,style,head,html,body,title,meta,param'),
                R.getBlockElements(),
              ),
              ...
              E = function (e) {
                for (
                  var t, n, r, o = R.getBlockElements(), i = e.prev;
                  i && 3 === i.type;

                ) {
                  if (0 < (n = i.value.replace(C, '')).length)
                    return void (i.value = n);
                  if ((t = i.next)) {
                    ...
                    if (a) {
                      if (d[e] && !S) {
                        if ((t = c.firstChild) && 3 === t.type)
                          if (0 < (n = t.value.replace(b, '')).length)
                            (t.value = n), (t = t.next);
                          else
                            for (
                      ...
                      if (
                        (S && y[e] && (S = !1), a.removeEmpty && dy(R, m, y, c))
                      )
                        return (
                          (o = c.parent),
                          d[c.name] ? c.empty().remove() : c.unwrap(),
                          void (c = o)
                        );
                      a.paddEmpty &&
                        ((fy((i = c), '#text') && i.firstChild.value === lo) ||
                          dy(R, m, y, c)) &&
                        ly(A, u, d, c),
                        (c = c.parent);
                    }
                  ...
                  : (function (e) {
                      for (
                        var t,
                          ...
                          c,
                          l,
                          f = gy('tr,td,th,tbody,thead,tfoot,table'),
                          d = R.getNonEmptyElements(),
                          m = R.getWhiteSpaceElements(),
                          p = R.getTextBlockElements(),
                          g = R.getSpecialElements(),
                          h = 0;
                        h < e.length;
                        h++
                      )
                        if ((t = e[h]).parent && !t.fixed)
                          if (p[t.name] && 'li' === t.parent.name) {
                            ...
                            if (n && 1 < r.length) {
                              for (
                                r.reverse(), o = i = P(r[0].clone()), s = 0;
                                s < r.length - 1;
                                s++
                              ) {
                                for (
                                  R.isValidChild(i.name, r[s].name)
                                    ? ((a = P(r[s].clone())), i.append(a))
                                    : (a = i),
                                    u = r[s].firstChild;
                                  u && u !== r[s + 1];
                              ...
                              R.isValidChild(t.parent.name, 'div') &&
                              R.isValidChild('div', t.name)
                                ? t.wrap(P(new Km('div', 1)))
                                : g[t.name]
                                ? t.empty().remove()
                                : t.unwrap();
                            }
                    ...
                    for (; n; )
                      (e = n.next),
                        ...
                        (1 === n.type &&
                          ...
                          ? (t ||
                              ((t = N(v, 1)).attr(A.forced_root_block_attrs),
                              _.insert(t, n)),
                            t.append(n))
                          : (r(t), (t = null)),
                        (n = e);
    ...
    Sy = function (y, b) {
      ...
      (y.entity_encoding = y.entity_encoding || 'named'),
        (y.remove_trailing_brs =
          !('remove_trailing_brs' in y) || y.remove_trailing_brs);
      var t,
        s,
        c,
        x = by(y, w);
        ...
        serialize: function (e, t) {
          ...
          var n,
            ...
            h =
              ((n = C),
              (r = g),
              (i = po((o = p).getInner ? r.innerHTML : n.getOuterHTML(r))),
              o.selection || so(At.fromDom(r)) ? i : kt.trim(i)),
            v =
              ((a = x),
              (u = h),
              (d = (s = p).selection ? ke({ forced_root_block: !1 }, s) : s),
              (m = a.parse(u, d)),
              (l = function (e) {
                return e && 'br' === e.name;
              }),
    ...
    Ry = function (e) {
      ...
      e.removed ||
        ...
        !e.inline && r && ((i = e), _y.setStyle(i.id, 'display', i.orgDisplay)),
        e.fire('detach'),
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              _y.unbind(r, 'submit reset', n.formEventDelegate)),
    ...
    Fy = { table_grid: !1, object_resizing: !1, resize: !1 },
    Uy = function (e) {
      var t = S(e) ? e.join(' ') : e,
        n = z(q(t) ? t.split(' ') : [], $e);
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              s && s.external_plugins
                ? kt.extend({}, s.external_plugins, l)
                : l),
          },
        );
      return qy(e, m, r, p);
          ...
          'string' == typeof (i = u)
            ? W(
                ...
                function (e) {
                  var t = e.split('=');
                  1 < t.length
                    ? (a[kt.trim(t[0])] = kt.trim(t[1]))
                    : (a[kt.trim(t[0])] = kt.trim(t[0]));
                },
              )
            : (a = i),
          a)
  ...
  function ob(n) {
    var t,
      ...
      r = function (r, e) {
        if ((void 0 === e && (e = !0), !n.removed && rb(n)))
          return (
            e && n.fire('BeforeOpenNotification', { notification: r }),
            Y(o, function (e) {
              return (
                (t = i().getArgs(e)),
                (n = r),
  ...
  var ub = function (n) {
    ...
    mb = function (e) {
      ...
      r &&
        (r.error ? r.error.apply(r, _e([e], t)) : r.log.apply(r, _e([e], t)));
    },
    pb = function (t) {
      var e,
        n,
      ...
      var n,
        ...
        l =
          ...
          }),
          {
            create: function (e, t, n, r, o) {
              if (q(e))
                return i({ id: e, name: r, filename: o, blob: t, base64: n });
              if (_(e)) return i(e);
            ...
            removeByUri: function (t) {
              n = H(n, function (e) {
                return (
                  e.blobUri() !== t || (URL.revokeObjectURL(e.blobUri()), !1)
                );
              });
            },
            destroy: function () {
        ...
        h = function (e, t, n) {
          var r =
            ...
            n +
            '"' +
            (n === wt.transparentSrc ? ' data-mce-placeholder="1"' : '');
          return (
            (e = g(e, 'src="' + t + '"', r)),
        ...
        v = function (t, n) {
          W(s.undoManager.data, function (e) {
            'fragmented' === e.type
              ? (e.fragments = z(e.fragments, function (e) {
                  return h(e, t, n);
                }))
        ...
        b = function (e, t) {
          ...
          v(e.src, t),
            s.$(e).attr({
              src: s.getParam('images_reuse_filename', !1, 'boolean')
                ? (n = t) +
                  (-1 === n.indexOf('?') ? '?' : '&') +
                  new Date().getTime()
                : t,
                  ...
                  p(function (e) {
                    var a = [],
                      t = z(e, function (e, t) {
                        ...
                        return (
                          e.status &&
                          s.getParam('images_replace_blob_uris', !0, 'boolean')
                            ? (l.removeByUri(i.src), b(i, e.url))
                            : e.error &&
                              (e.error.options.remove &&
                                (v(i.getAttribute('src'), wt.transparentSrc),
                                a.push(i)),
                              (n = s),
                              (r = e.error.message),
                              cb(
        ...
        x = function (t) {
          return (
            ...
            (0 !== t.getAttribute('src').indexOf('data:') ||
              s.getParam('images_dataimg_filter', k, 'function')(t))
          );
        },
        S = function () {
          return (o = o || uy(f, l)).findAll(s.getBody(), x).then(
            p(function (e) {
              return (
                (e = H(e, function (e) {
  ...
  var Cb,
    ...
    Nb = function (e, t) {
      var n,
        ...
        p = function (e) {
          ...
          return (
            (t = r),
            (n = o).classes.length && Sb.addClass(t, n.classes.join(' ')),
            Sb.setAttribs(t, n.attrs),
            r
          );
        },
        g = function (n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = Sb.create('div')).appendChild(n),
              kt.each(t, function (e) {
                var t = p(e);
                r.insertBefore(t, n);
              })),
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = p(o)),
          (r = Sb.create('div')).appendChild(g(n, e.slice(1), o.siblings)),
          r)
        : '';
    },
    Eb = function (e) {
    ...
    kb = function (n, e) {
      ...
      var c,
        l =
          (c = e.selector) && 'string' == typeof c
            ...
            : [],
        f = l.length
          ? (l[0].name || (l[0].name = t), (t = e.selector), Nb(l, n))
          : Nb([t], n),
      ...
      return (
        ...
        Sb.setStyles(f, { position: 'absolute', left: -65535 }),
        n.getBody().appendChild(f),
        (r = Sb.getStyle(n.getBody(), 'fontSize', !0)),
        (r = /px$/.test(r) ? parseInt(r, 10) : 0),
        xb(a.split(' '), function (e) {
          var t = Sb.getStyle(d, e, !0);
          if (
            !(
              ('background-color' === e &&
                /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                ((t = Sb.getStyle(n.getBody(), e, !0)),
                '#ffffff' === Sb.toHex(t).toLowerCase())) ||
              ('color' === e && '#000000' === Sb.toHex(t).toLowerCase())
            )
          ) {
        ...
        Sh(s),
        {
          ...
          matchNode: function (e, t, n, r) {
            return (
              ...
              (a = n),
              (u = r),
              qv(s).formatter.matchNode(o, i, a, u)
            );
            var o, i, a, u;
          },
          canApply: function (e) {
          ...
          formatChanged: function (e, t, n) {
            return (
              ...
              (i = t),
              void 0 === (a = n) && (a = !1),
              qv(s).formatter.formatChanged(r, o, i, a)
            );
            var r, o, i, a;
          },
          getCssText: N(kb, s),
            ...
            ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
              ...
              : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                !(n < 16 || 20 < n) ||
                  ...
                  r.typing ||
                  t ||
                  (r.beforeChange(), Lv(r, !0, o), r.add({}, e), i.set(!0))));
        }),
        ...
        d = {
          ...
          add: function (e, t) {
            return (
              ...
              (a = e),
              (u = t),
              qv(s).undoManager.addUndoLevel(n, r, o, i, a, u)
            );
            var n, r, o, i, a, u;
          },
          undo: function () {
          ...
          transact: function (e) {
            return (
              (t = d), (n = l), (r = e), qv(s).undoManager.transact(t, n, r)
            );
            var t, n, r;
          },
          ignore: function (e) {
          ...
          extra: function (e, t) {
            ...
            (n = d),
              ...
              (o = e),
              (i = t),
              qv(s).undoManager.extra(n, r, o, i);
          },
        };
      return (
        Hv(s) || Ab(s, d, l),
    ...
    Pb = function (a) {
      var e,
        ...
        c = (e = a).getParam(
          'placeholder',
          pc.getAttrib(e.getElement(), 'placeholder'),
          'string',
        ),
        l = function (e, t) {
          var n, r, o, i;
          !(function (e) {
            ...
            (r =
              !(
                Ob((o = e)) &&
                !(Bb(o) || ('keyup' === o.type && 229 === o.keyCode))
              ) &&
              (function (e, t, n) {
                if ($o(At.fromDom(t), !1)) {
                  var r = '' === n,
            ...
            (('' !== u.getAttrib(n, Db)) === r && !t) ||
              (u.setAttrib(n, Db, r ? c : null),
              u.setAttrib(n, 'aria-placeholder', r ? c : null),
              (i = r),
              a.fire('PlaceholderToggle', { state: i }),
              a.on(r ? 'keydown' : 'keyup', l),
              a.off(r ? 'keyup' : 'keydown', l)));
        };
      c &&
    ...
    Mb = function (e) {
      return (
        'rtl' === Eu.DOM.getStyle(e, 'direction', !0) ||
    ...
    Fb = function (e, t, n) {
      var r,
        ...
        a =
          ...
          (o = t),
          (i = n),
          H(Eu.DOM.getParents(i.container(), '*', o), r));
    ...
    Ub = function (e, t) {
      ...
      return e
        ? yo(n)
          ...
          : t
        : yo(n)
        ? In(n.previousSibling)
          ? $s(n.previousSibling, n.previousSibling.data.length)
          : $s.before(n)
        : xo(t)
        ? $s(n, r - 1)
        : t;
    ...
    Wb = function (o, i, e) {
          ...
          return Ol(i, o, e.position).bind(function (e) {
            return $b(o, e).map(function (e) {
              return (
                (t = o),
                (n = i),
                zn((r = e).position.getNode()) && !1 === $o(r.block)
                  ? Ll(!1, r.block.dom)
                      .bind(function (e) {
                        return e.isEqual(r.position)
                          ? Ol(n, t, e).bind(function (e) {
                              return $b(t, e);
                            })
                          : U.some(r);
                      })
      ...
      return ds(t, n, qb).filter(function (e) {
        return (
          !1 === Ot((r = e).from.block, r.to.block) &&
          $t((n = e).from.block)
            .bind(function (t) {
    ...
    Zb = function (e, t, n) {
      return (
        Qb(!0, t), Qb(!1, n), Jb(t, n).fold(N(Gb, e, t, n), N(Yb, e, t, n))
      );
    },
    eC = function (e, t, n, r) {
    ...
    tC = function (t, n) {
      var e,
        ...
        a =
          ((e = i.dom),
          (r = n),
          ((o = t.selection.getRng()).collapsed ? Wb(e, r, o) : U.none()).bind(
            function (e) {
    ...
    rC = function (e, t) {
      ...
      return (
        !(nC((n = e), (r = t).startContainer) || nC(n, r.endContainer)) &&
        o &&
        i
      );
    },
    oC = function (e) {
      ...
      return rC(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          ds(
            Hb(n, At.fromDom(o.startContainer)),
            Hb(n, At.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === Ot(e, t) &&
                (o.deleteContents(),
                eC(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
    ...
    cC = function (e, t) {
      ...
      return e.fire('BeforeObjectSelected', { target: t }).isDefaultPrevented()
        ? U.none()
        : U.some(((r = (n = t).ownerDocument.createRange()).selectNode(n), r));
    },
    lC = function (e, t, n) {
    ...
    pC = function (n, r, e, t, o, i) {
      var a, u;
      return (
        sC(t, n, i.getNode(!o), o, !0).each(function (e) {
          var t;
          r.collapsed
            ? ((t = r.cloneRange()),
              o
        ...
        (a = n.dom),
        In((u = e)) && 0 === u.data.length && a.remove(u),
        !0
      );
    },
    gC = function (e, t) {
    ...
    vC = function (e, t, n, r) {
      var o = r.getNode(!1 === t);
      return Hb(At.fromDom(e), At.fromDom(n.getNode()))
        .map(function (e) {
    ...
    yC = function (u, s, c) {
      return Ol(s, u, c).bind(function (e) {
        return (
          (a = e.getNode()),
          uo(At.fromDom(a)) || io(At.fromDom(a))
            ? U.none()
            : ((t = u),
              (o = e),
              (i = function (e) {
              ...
              fl(!(n = s), (r = c)).fold(function () {
                ...
                ? U.none()
                : (s && Vn(e.getNode())) || (!1 === s && Vn(e.getNode(!0)))
                ? vC(u, s, c, e)
                : (s && Ep(c)) || (!1 === s && Np(c))
                ? U.some(hC.moveToPosition(e))
                : U.none())
        );
        var t, n, r, o, i, a;
      });
    ...
    bC = function (r, e, o) {
      return (
        ...
        (a = o.getNode(!1 === i)),
        (u = i ? 'after' : 'before'),
        An(a) && a.getAttribute('data-mce-caret') === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            (t && Vn(n.nextSibling)
              ? U.some(hC.moveToElement(n.nextSibling))
              : !1 === t && Vn(n.previousSibling)
              ? U.some(hC.moveToElement(n.previousSibling))
              : U.none()
            ).fold(function () {
              return yC(r, e, o);
            }, U.some))
          : yC(r, e, o).bind(function (e) {
              return (
                (t = r),
                (n = o),
                e.fold(
      ...
      return CC(a, e)
        ...
        .fold(function () {
          return (
            ...
            (i = At.fromDom(e)),
            (!1 === t && Ep(o)
              ? U.some(hC.remove(o.getNode(!0)))
              : t && Np(o)
              ? U.some(hC.remove(o.getNode()))
              : !1 === t && Np(o) && Vp(i, o)
              ? qp(i, o).map(function (e) {
                  return hC.remove(e.getNode());
                })
              : t && Ep(o) && Hp(i, o)
              ? $p(i, o).map(function (e) {
                  return hC.remove(e.getNode());
                })
              : bC(e, t, o)
            ).exists(function (e) {
        ...
        CC(t, e.parentNode)
          ...
          .fold(
            function () {
              var e;
              return (
                (e = At.fromDom(t.getBody())),
                W(Gu(e, '.mce-offscreen-selection'), pn),
                Cg(t, n, At.fromDom(t.selection.getNode())),
                Vb(t),
                !0
              );
            },
    ...
    EC = function (e, t) {
      return (
        ...
        ((n = e),
        (r = t),
        (o = $s.fromRangeStart(n.selection.getRng())),
        Ol(r, n.getBody(), o)
          .filter(function (e) {
            return (r ? yp : bp)(e);
          })
    ...
    TC = function (e, t) {
      return (
        e
          ? function (e) {
              if (kC(e.previousSibling))
                return (
                  AC(e.previousSibling) || e.previousSibling.appendData(fo),
                  e.previousSibling
                );
          ...
          : function (e) {
              if (kC(e.nextSibling))
                return (
                  _C(e.nextSibling) || e.nextSibling.insertData(0, fo),
                  e.nextSibling
                );
    ...
    ZC = function (e, t) {
      return e
        ? t.fold(a(U.some, MC.start), U.none, a(U.some, MC.after), U.none)
        : t.fold(U.none, a(U.some, MC.before), U.none, a(U.some, MC.end));
    },
    ew = function (e, a, u, s) {
      var t = Ub(e, s),
        c = WC(a, u, t);
    ...
    tw =
      ...
      function (e, t, n) {
        var r = e ? 1 : -1;
        return (
          t.setRng($s(n.container(), n.offset() + r).toRange()),
    ...
    nw = function (e, t) {
      ...
      return (
        !!T(t.selection.getSel().modify) &&
        (e && wo(r)
          ? tw(!0, t.selection, r)
          : !(e || !xo(r)) && tw(!1, t.selection, r))
      );
    },
    rw = function (e, t) {
    ...
    uw = function (e, t, n) {
      return (
        ...
        (i = n),
        (a = (r = e).getBody()),
        (u = $s.fromRangeStart(r.selection.getRng())),
        (s = N(Ib, r)),
        ew(i, s, a, u)
          .bind(function (e) {
            return iw(r, o, e);
    ...
    cw = function (d) {
      ...
      return (
        d.on('NodeChange', function (e) {
          ...
          !_c(d) ||
            (wt.browser.isIE() && e.initial) ||
            ((a = p),
            (u = d.dom),
            (s = e.parents),
            (c = z(
              Gu(
                At.fromDom(u.getRoot()),
    ...
    mw = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          WC(s, u, $s.fromRangeStart(r.selection.getRng()))
            .map(GC)
            .map(dw(r, o));
      }),
        r.nodeChanged();
    ...
    pw = function (n, r, i, o) {
      ...
      return s
        .bind(function (e) {
          return i
            ? e.fold(E(U.some(GC(e))), U.none, E(U.some(YC(e))), U.none)
            : e.fold(U.none, E(U.some(YC(e))), U.none, E(U.some(GC(e))));
        })
        .map(dw(n, r))
        .getOrThunk(function () {
          var t = Bl(i, a, o),
    ...
    yw = function (r, o) {
      ...
      return re(s).exists(function (e) {
        ...
        return (
          ...
          (u = e.dom),
          !(
            !ds(Fl(u), Ul(u), function (e, t) {
              var n = Ub(!0, e),
                r = Ub(!1, t),
                o = Ub(!1, a);
              return i
                ? Il(u, o).exists(function (e) {
    ...
    ww = function (e, t) {
      return e.selection.isCollapsed()
        ? ((i = e),
          (u = (a = t) ? Cp : wp),
          (s = a ? Vs.Forwards : Vs.Backwards),
          (c = dl(s, i.getBody(), i.selection.getRng())),
          u(c)
            ? Cw(i, a, c.getNode(!a))
            : U.from(Ub(a, c))
                .filter(function (e) {
    ...
    _w = function (e, c) {
      ...
      e.queryCommandState('InsertUnorderedList') ||
        ...
        '' !== o ||
        l.getParent(t.getNode(), l.isBlock) ||
        n.apply('div'),
        W(kw(e), function (e) {
          var t, n, r, o, i, a, u, s;
          (t = l),
            ...
            (s = Sw(r, At.fromDom(a))),
            'outdent' === n
              ? ((u = Math.max(0, xw(a.style[s]) - o)),
                t.setStyle(a, s, u ? u + i : ''))
              : ((u = xw(a.style[s]) + o + i), t.setStyle(a, s, u));
        });
    },
    Aw = function (e, t) {
              ...
              Dw(e).each(function (i) {
                u.get().each(function (e) {
                  ...
                  (t = i),
                    ...
                    (5 < r || 5 < o) &&
                      (u.set(U.none()), s.set(!1), a.fire('longpresscancel'));
                });
              });
          },
          !0,
    ...
    Pw = function (e) {
      ...
      if (s && An(s) && l) {
        ...
        if (
          ...
          (m = c),
          (p = s),
          !F(Tp(At.fromDom(p), At.fromDom(m)), function (e) {
            return Bw(d, e.dom);
          }))
        ) {
          for (
              ...
              if (
                (function (e, t) {
                  if (In(t)) {
                    ...
                    if (
                      /^\s+$/.test(t.nodeValue) &&
                      (!t.nextSibling || Bw(e, t.nextSibling))
                    )
                      return !0;
                  }
                  return !1;
    ...
    Iw = function (e, t) {
      var n,
        r =
          ((n = e),
          Dr(At.fromDom(n.getBody()), '*[data-mce-caret]').fold(
            E(null),
            function (e) {
              return e.dom;
            },
      ...
      if (r)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void Lw(e, r))
          : void (Co(r) && (Lw(e, r), e.undoManager.add()));
    };
  ((wb = Cb = Cb || {})[(wb.Br = 0)] = 'Br'),
    (wb[(wb.Block = 1)] = 'Block'),
    (wb[(wb.Wrap = 2)] = 'Wrap'),
  ...
  var Mw,
    ...
    zw = function (e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = _l(n), f = r, d = [];
        f &&
        ((s = l), (c = f), (o = t === Vs.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (zn(o.getNode(!1)))
          return t === Vs.Forwards
            ? {
  ...
  var Gw = function (o, i, a, e, u, t) {
      var s = 0,
        ...
        n = function (e) {
          ...
          for (-1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
            if (((n = r[t]), !a(n, l))) {
              if ((0 < c.length && i(n, Ee(c)) && s++, (n.line = s), u(n)))
                return !0;
              c.push(n);
            }
        },
    ...
    ux = function (e, o) {
      return Se(e, function (e, t) {
        ...
        return ix(o, t) || (!ix(o, e) && ((r === n && tx(t.node)) || r < n))
          ? t
          : e;
      });
    },
        ...
        if (
          (u = ux(
            (function (e, r, t) {
              ...
              return (
                o.push(r),
                sx(Mw.Up, e, N(n, vs), r.node, t),
                sx(Mw.Down, e, N(n, ys), r.node, t),
                o
              );
            })(e, u, s),
            t,
          ...
          return (o = t), { node: (r = u).node, before: rx(r, o) < ox(r, o) };
      }
      return null;
    },
    lx = function (e, t) {
      ...
      if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Cs(n))) {
        var h = (function (e, t, n, r) {
            var o,
              ...
              d =
                1 === e
                  ? ((o = s.next), (i = ys), (a = vs), $s.after(r))
                  : ((o = s.prev), (i = vs), (a = ys), $s.before(r)),
              m = f(d);
            do {
              if (d.isVisible() && !a((u = f(d)), m)) {
                if (
                  (0 < c.length && i(u, Ee(c)) && l++,
                  ((u = ps(u)).position = d),
                  (u.line = l),
                  n(u))
                )
    ...
    vx = function (e, t, n) {
      ...
      if (n.collapsed && '' !== vc(e)) {
        ...
        if (!s) return;
        a($s.fromRangeStart(n)) ||
          ((o = (r = e).dom.create(vc(r))),
          (!wt.ie || 11 <= wt.ie) && (o.innerHTML = '<br data-mce-bogus="1">'),
          (u = o),
          1 === t ? e.$(s).after(u) : e.$(s).before(u),
    ...
    kx = function (e, t, n, r) {
      return '' === t
        ? ((l = e), (f = r), (d = At.fromTag('br')), Ex(l, d, f), Nx(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    _x = function (e, t, n) {
      return t
        ? ((o = e.dom), $w(o, n).breakAt.isNone())
        : ((r = e.dom), qw(r, n).breakAt.isNone());
      var r, o;
    },
    Ax = function (t, n) {
      var e,
      ...
      return (
        (e = i),
        (r = N(Ot, o)),
        Ar(At.fromDom(e.container()), eo, r)
          .filter(Sx)
          .exists(function () {
            if (_x(o, n, i)) {
              var e = kx(o, a, u, n);
    ...
    Hx = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === Cb.Wrap && 0 === a.positions.length) ||
        (!zn(n.getNode()) &&
          (i = u).breakType === Cb.Br &&
    ...
    $x = function (t, e, n, r) {
      ...
      return (
        !(
          ...
          (i = s),
          (a = n),
          (u = $s.fromRangeStart(i)),
          !Ll(!o, a).exists(function (e) {
            return e.isEqual(u);
          }))
        ) &&
    ...
    Qx = function (i, a) {
      i.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Ox(
            [
              { keyCode: ud.RIGHT, action: Dx(Cx, t, !0) },
              { keyCode: ud.LEFT, action: Dx(Cx, t, !1) },
              { keyCode: ud.UP, action: Dx(wx, t, !1) },
              { keyCode: ud.DOWN, action: Dx(wx, t, !0) },
              { keyCode: ud.RIGHT, action: Dx(Gx, t, !0) },
              { keyCode: ud.LEFT, action: Dx(Gx, t, !1) },
              { keyCode: ud.UP, action: Dx(Jx, t, !1) },
              { keyCode: ud.DOWN, action: Dx(Jx, t, !0) },
              { keyCode: ud.RIGHT, action: Dx(Bx, t, !0) },
              { keyCode: ud.LEFT, action: Dx(Bx, t, !1) },
              { keyCode: ud.UP, action: Dx(Px, t, !1) },
              { keyCode: ud.DOWN, action: Dx(Px, t, !0) },
              { keyCode: ud.RIGHT, action: Dx(uw, t, n, !0) },
              ...
              { keyCode: ud.UP, action: Dx(Rx, t, !1) },
              { keyCode: ud.DOWN, action: Dx(Rx, t, !0) },
            ],
            r,
          ).each(function (e) {
            r.preventDefault();
    ...
    Zx = function (o, i) {
      o.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Ox(
            [
              { keyCode: ud.BACKSPACE, action: Dx(Aw, t, !1) },
              { keyCode: ud.BACKSPACE, action: Dx(NC, t, !1) },
              { keyCode: ud.DELETE, action: Dx(NC, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(gC, t, !1) },
              { keyCode: ud.DELETE, action: Dx(gC, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(gw, t, n, !1) },
              { keyCode: ud.DELETE, action: Dx(gw, t, n, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(Kg, t, !1) },
              { keyCode: ud.DELETE, action: Dx(Kg, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(EC, t, !1) },
              { keyCode: ud.DELETE, action: Dx(EC, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(ww, t, !1) },
              { keyCode: ud.DELETE, action: Dx(ww, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(iC, t, !1) },
              { keyCode: ud.DELETE, action: Dx(iC, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(tC, t, !1) },
              { keyCode: ud.DELETE, action: Dx(tC, t, !0) },
              { keyCode: ud.BACKSPACE, action: Dx(bw, t, !1) },
              { keyCode: ud.DELETE, action: Dx(bw, t, !0) },
            ],
            r,
          ).each(function (e) {
            r.preventDefault();
        ...
        o.on('keyup', function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            Ox(
              [
                { keyCode: ud.BACKSPACE, action: Dx(SC, t) },
                { keyCode: ud.DELETE, action: Dx(SC, t) },
              ],
              n,
            ));
        });
      ...
      if (t) {
        !/^(LI|DT|DD)$/.test(t.nodeName) ||
          ((r = (function (e) {
            ...
            t.insertBefore(i.doc.createTextNode(lo), t.firstChild));
        var u = i.createRng();
    ...
    aS = function (e, t, n, r, o) {
      ...
      n !== e.getBody() &&
        (rS((i = n)) && rS(i.parentNode) && (o = 'LI'),
        (a = o ? t(o) : f.create('BR')),
        iS(n, r, !0) && iS(n, r, !1)
          ? nS(n, 'LI')
            ? f.insertAfter(a, oS(n))
            : f.replace(a, n)
          : iS(n, r, !0)
          ? nS(n, 'LI')
            ? (f.insertAfter(a, oS(n)),
              a.appendChild(f.doc.createTextNode(' ')),
              a.appendChild(n))
          ...
          : ((n = oS(n)),
            ...
            (s = u.extractContents()),
            'LI' === o &&
            ((l = 'LI'), (c = s).firstChild && c.firstChild.nodeName === l)
              ? ((a = s.firstChild), f.insertAfter(s, n))
              : (f.insertAfter(s, n), f.insertAfter(a, n))),
        f.remove(r),
        eS(e, a));
    },
    uS = function (e) {
    ...
    lS = function (e, t, n) {
      return !1 === In(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === fo
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === fo
        ? t.data.length
        : n;
    },
    fS = function (e, t) {
    ...
    mS = function (a, e) {
      var t,
        ...
        g = function (e) {
          ...
          if (!1 === a.getParam('keep_styles', !0))
            f.setAttrib(o, 'style', null), f.setAttrib(o, 'class', null);
          else
            do {
              if (r[n.nodeName]) {
          ...
          for (
            ...
            if (An(t)) {
              if (
                ...
                ((n = t.nodeName.toLowerCase()), m[n] && 'br' !== n)
              )
                return !1;
        ...
        v = function () {
          (n = /^(H[1-6]|PRE|FIGURE)$/.test(c) && 'HGROUP' !== C ? g(N) : g()),
      ...
      An(u) &&
        u.hasChildNodes() &&
        ((l = i > u.childNodes.length - 1),
        (u = u.childNodes[Math.min(i, u.childNodes.length - 1)] || u),
        (i = l && In(u) ? u.nodeValue.length : 0));
      var C,
        w,
        x,
        S,
      ...
      E &&
          ...
          (u = (function (e, t, n, r, o) {
            ...
            if (!p || !cS(d, p)) {
              if (
                ((c =
                  (p = p || m) === e.getBody() ||
                  ((l = p) && /^(TD|TH|CAPTION)$/.test(l.nodeName))
                    ? p.nodeName.toLowerCase()
                    : p.parentNode.nodeName.toLowerCase()),
                !p.hasChildNodes())
              )
                return (
                  (i = d.create(f)),
        ...
        'LI' !== (C = o ? o.nodeName.toUpperCase() : '') ||
          b ||
          ((o = (s = o).parentNode), (c = C)),
        /^(LI|DT|DD)$/.test(c) && f.isEmpty(s)
          ? aS(a, g, o, s, N)
          : (N && s === a.getBody()) ||
            ((N = N || 'P'),
            vo(s)
              ? ((n = ko(s)), f.isEmpty(s) && uS(s), dS(a, n), eS(a, n))
              : h()
              ? v()
              : h(!0)
              ? ((n = s.parentNode.insertBefore(g(), s)),
                eS(a, sS(s, 'HR') ? n : s))
              : ((S = (x = p).cloneRange()).setStart(
                  x.startContainer,
                  lS(!0, x.startContainer, x.startOffset),
                ),
                S.setEnd(x.endContainer, lS(!1, x.endContainer, x.endOffset)),
                (t = S.cloneRange()).setEndAfter(s),
                (r = t.extractContents()),
                (w = r),
                W(Yu(At.fromDom(w), Ut), function (e) {
                  var t = e.dom;
                ...
                f.isEmpty(s) && uS(s),
                n.normalize(),
                f.isEmpty(n) ? (f.remove(n), v()) : (dS(a, n), eS(a, n))),
            f.setAttrib(n, 'id', ''),
    ...
    hS = function (e, t) {
      ...
      'LI' !== d || m || (l = f),
        c &&
          ...
          !(function (e, t, n) {
            for (
              var r, o = new Xr(t, n), i = e.getNonEmptyElements();
              (r = o.next());
    ...
    yS = function (e, t) {
      ...
      var n = At.fromTag('br');
      cn(At.fromDom(t), n),
        pS(e.dom, e.selection, n.dom),
        gS(e.dom, e.selection, n.dom, !1),
        e.undoManager.add();
    },
    bS = function (e, t) {
      return (
    ...
    IS = function (e, t) {
      return IC(
        [
          LS([kS], ES.none()),
          LS([RS('summary', !0)], ES.br()),
          LS([TS(!0), DS(!1), BS], ES.br()),
          LS([TS(!0), DS(!1)], ES.block()),
          LS([TS(!0), DS(!0), BS], ES.block()),
          LS([TS(!0), DS(!0)], ES.br()),
          LS([AS(!0), BS], ES.br()),
          LS([AS(!0)], ES.block()),
          LS([_S(!0), BS, PS], ES.block()),
          LS([_S(!0)], ES.br()),
          LS([OS], ES.br()),
          LS([_S(!1), BS], ES.br()),
          LS([PS], ES.block()),
    ...
    US = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Ox(
            [
              { keyCode: ud.END, action: Dx(xx, t, !0) },
              { keyCode: ud.HOME, action: Dx(xx, t, !1) },
              { keyCode: ud.END, action: Dx(Lx, t, !0) },
              { keyCode: ud.HOME, action: Dx(Lx, t, !1) },
            ],
            n,
          ).each(function (e) {
            n.preventDefault();
    ...
    HS = function (n, r) {
      var e = r.container(),
        t = r.offset();
      return In(e)
        ? (e.insertData(t, n), U.some(Hs(e, t + n.length)))
        : ml(r).map(function (e) {
            var t = At.fromText(n);
    ...
    $S = function (r, o) {
      return function (e) {
        return (
          (t = r),
          (!Gp((n = e)) && (Jp(t, n) || Xp(t, n) || Yp(t, n)) ? VS : qS)(o)
        );
        var t, n;
      };
    },
    ...
    KS = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          Ox([{ keyCode: ud.SPACEBAR, action: Dx(WS, t) }], n).each(function (
            e,
          ) {
            n.preventDefault();
          }));
    ...
    XS = function (e) {
      var t,
        n = cw(e);
      return (
        (t = e).on('keyup compositionstart', N(Iw, t)),
        Qx(e, n),
        Zx(e, n),
        FS(e),
        KS(e),
    ...
    YS =
      ((GS.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
  ...
  function GS(r) {
    ...
    'onselectionchange' in r.getDoc() ||
      r.on('NodeChange click mouseup keyup focus', function (e) {
        ...
        ('nodechange' !== e.type && dd(n, o)) || r.fire('SelectionChange'),
          (o = n);
      }),
      ...
      r.on('SelectionChange', function () {
        ...
        !e ||
          (!wt.range && r.selection.isCollapsed()) ||
          (Vf(r) &&
      ...
      r.on('mouseup', function (e) {
        !e.isDefaultPrevented() &&
          ...
          ('IMG' === r.selection.getNode().nodeName
            ? qr.setEditorTimeout(r, function () {
                r.nodeChanged();
              })
            : r.nodeChanged());
      });
  ...
  var JS = function (e) {
    ...
    ZS = function (a) {
      a.on('click', function (e) {
        ...
        3 <= e.detail &&
          ...
          (o = Hs.fromRangeStart(r)),
          (i = Hs.fromRangeEnd(r)),
          Hs.isElementPosition(o) &&
            ((n = o.container()),
            QS(n) &&
              Fl(n).each(function (e) {
                return r.setStart(e.container(), e.offset());
              })),
          Hs.isElementPosition(i) &&
            ((n = o.container()),
            QS(n) &&
              Ul(n).each(function (e) {
    ...
    tN = function (e, t) {
      return (
        (n = (u = e).inline ? eN(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
        (r = i.inline
        ...
        function (g) {
          return e.on(function (e) {
            var t,
              ...
              m,
              p = Math.max(
                Math.abs(g.screenX - e.screenX),
                Math.abs(g.screenY - e.screenY),
              );
            if (!e.dragging && 10 < p) {
              if (
                h.fire('dragstart', { target: e.element }).isDefaultPrevented()
              )
                return;
        ...
        e.on(function (e) {
          ...
          e.dragging &&
            ...
            i === a ||
              ...
              (t = r),
              l
                .fire('drop', { clientX: c.clientX, clientY: c.clientY })
                .isDefaultPrevented() ||
                l.undoManager.transact(function () {
                  oN(e.element),
                    l.insertContent(l.dom.getOuterHTML(t)),
                    l._selectionOverrides.hideFakeCaret();
                })));
        }),
          sN(e);
      };
        ...
        (n = e).on('drop', function (e) {
          var t =
            'undefined' != typeof e.clientX
              ...
              : null;
          (!nN(t) && 'false' !== n.dom.getContentEditableParent(t)) ||
            e.preventDefault();
        }),
          ...
          ((a = function (e) {
            ...
            e.defaultPrevented ||
              ((t = e.dataTransfer) &&
                ...
                (e.preventDefault(),
                'drop' === e.type &&
                  cb(i, 'Dropped file type is not supported')));
          }),
          (u = function (e) {
            vm(i, e.target) && a(e);
          }),
      ...
      var s,
        ...
        v = function (e, t, n, r) {
          return (
            ...
            u
              ...
              .isDefaultPrevented()
              ? null
              : (r && c.scrollIntoView(t, -1 === e), m.show(n, t))
          );
        },
        t = function (e) {
        ...
        b = function (e) {
          var t = u.schema.getShortEndedElements(),
            ...
            a = e.endOffset;
          return (
            he(t, r.nodeName.toLowerCase())
              ? 0 === o
                ? n.setStartBefore(r)
                : n.setStartAfter(r)
              : n.setStart(r, o),
            he(t, i.nodeName.toLowerCase())
              ? 0 === a
                ? n.setEndBefore(i)
                : n.setEndAfter(i)
              : n.setEnd(i, a),
        ...
        C = function (e) {
          ...
          var r = (function (e, t, n) {
              var r = u.$,
                o = Dr(At.fromDom(u.getBody()), '#' + p).fold(
                  function () {
                    return r([]);
                  },
                  function (e) {
              ...
              t === n && wt.ie
                ? (o
                  ...
                  i.setEndAfter(t))
                : (o.empty().append(lo).append(t).append(lo),
          ...
          return (
            W(
              Gu(At.fromDom(u.getBody()), '*[data-mce-selected]'),
              function (e) {
                Ot(o, e) || Qn(e, i);
              },
            ),
        ...
        w = function (e, t) {
          ...
          if (
            (3 === a.nodeType &&
              0 === u &&
              dN(a.parentNode) &&
              ((a = a.parentNode), (u = l.nodeIndex(a)), (a = a.parentNode)),
            1 !== a.nodeType)
          )
            return null;
        ...
        x = function () {
          s && s.removeAttribute(i),
            Dr(At.fromDom(u.getBody()), '#' + p).each(pn),
            (s = null);
        },
        S = function () {
          m.hide();
        ...
        wt.ceFalse &&
          (function () {
            u.on('mouseup', function (e) {
              var t = r();
              t.collapsed &&
                nb(u, e.clientX, e.clientY) &&
                lC(u, t, !1).each(h);
            }),
              u.on('click', function (e) {
                var t = mN(u, e.target);
                t &&
                  (dN(t) && (e.preventDefault(), u.focus()),
                  fN(t) && l.isChildOf(t, c.getNode()) && x());
              }),
              ...
              i = function (e, t) {
                ...
                return (
                  ...
                  (o &&
                    ((n = o),
                    (r = i),
                    !(l.getParent(n, f) === l.getParent(r, f))) &&
                    a(o))
                );
              };
            u.on(
              ...
              function (e) {
                var t = e.target,
                  n = mN(u, t);
                dN(n)
                  ? (e.preventDefault(), cC(u, n).each(w))
                  : g(t) && cC(u, t).each(w);
              },
              !0,
            ),
              u.on('mousedown', function (e) {
                ...
                (o !== d && 'HTML' !== o.nodeName && !l.isChildOf(o, d)) ||
                  !1 === nb(u, e.clientX, e.clientY) ||
                  ((t = mN(u, o))
                    ? dN(t)
                      ? (e.preventDefault(), cC(u, t).each(w))
                      : (x(),
                        (fN(t) && e.shiftKey) ||
                          ad(e.clientX, e.clientY, c.getRng()) ||
                          (S(), c.placeCaretAt(e.clientX, e.clientY)))
                    : g(o)
                    ? cC(u, o).each(w)
                    : !1 === Kc(o) &&
                      (x(),
                      S(),
                      (n = cx(d, e.clientX, e.clientY)) &&
                        (i(o, n.node) ||
                          (e.preventDefault(),
                          (r = v(1, n.node, n.before, !1)),
                          u.getBody().focus(),
                          h(r)))));
              }),
              u.on('keypress', function (e) {
                ud.modifierPressed(e) ||
                  (dN(c.getNode()) && e.preventDefault());
              }),
            ...
            u.on('AfterSetSelectionRange', function (e) {
              ...
              y(n) || 'mcepastebin' === r.id || S(),
                (t = r),
                l.hasClass(t, 'mce-offscreen-selection') || x();
            }),
              u.on('copy', function (e) {
                ...
                e.isDefaultPrevented() ||
                  !e.clipboardData ||
                  wt.ie ||
                  ((t = (n = l.get(p)) ? n.getElementsByTagName('*')[0] : n) &&
                    (e.preventDefault(),
                    r.clearData(),
              ...
              (e = zu(function () {
                ...
                n.removed ||
                  ...
                  ((e = n.selection.getRng()).collapsed &&
                    ((t = fC(n, e, !1)), n.selection.setRng(t)));
              }, 0)),
          ...
          Range.prototype.getClientRects ||
            u.on('mousedown', function (e) {
              ...
              h(e) ||
                ...
                ((t = u.getBody()).blur(),
                qr.setEditorTimeout(u, function () {
                  t.focus();
                }));
            }),
          (n = function () {
    ...
    bN = function (u) {
      var e = u.dom.getRoot();
      u.inline ||
        (Vf(u) && u.selection.getStart(!0) !== e) ||
        Fl(e).each(function (e) {
          var t,
            n,
            r,
            o,
          ...
          wt.browser.isIE()
            ? ((t = u),
              (n = a.toRange()),
              (r = At.fromDom(t.getBody())),
              (o = (um(t) ? U.from(n) : U.none()).map(sm).filter(am(r))),
    ...
    wN = function (t, e) {
      ...
      n.browser_spellcheck ||
        n.gecko_spellcheck ||
        ((r.body.spellcheck = !1), hN.setAttrib(o, 'spellcheck', 'false')),
        (t.quirks = gN(t)),
        t.fire('PostRender');
      var i,
        a,
      ...
      h !== undefined && (o.dir = h),
        ...
        0 < t.contentStyles.length &&
          ((i = ''),
          kt.each(t.contentStyles, function (e) {
            i += e + '\r\n';
          }),
          t.dom.addStyle(i)),
        (u = (a = t).contentCSS),
    ...
    xN = function (t, e) {
      ...
      n.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.inline &&
          (hN.addClass(r, 'mce-content-body'),
      ...
      (c.disabled = !0),
        ...
        t.readonly ||
          (t.inline &&
            'static' === hN.getStyle(c, 'position', !0) &&
            (c.style.position = 'relative'),
          (c.contentEditable = t.getParam('content_editable_state', !0))),
        (c.disabled = !1),
        (t.editorUpload = yb(t)),
        (t.schema = Ci(n)),
        (t.dom = Eu(o, {
        ...
        (t.parser =
          ((i = by(yN((u = t)), u.schema)).addAttributeFilter(
          ...
          i.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
            for (var t = e.length, n = u.schema.getNonEmptyElements(); t--; ) {
              ...
              r.isEmpty(n) &&
                ...
                (r.append(new Km('br', 1)).shortEnded = !0);
            }
          }),
          i)),
        (t.serializer = Ny(
        ...
        (t.selection = Qv(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = td(t)),
        (t.formatter = _b(t)),
        (t.undoManager = Rb(t)),
        (t._nodeChangeDispatcher = new YS(t)),
        (t._selectionOverrides = pN(t)),
        Ow(t),
        JS(t),
        Hv(t) || ZS(t);
      var l,
      ...
      Tw(t, p),
        vc((f = t)) && f.on('NodeChange', N(Pw, f)),
        Pb(t),
        t.fire('PreInit'),
        ge((m = d = t).plugins, 'rtc')
          .fold(
            function () {
    ...
    _N = function (t, n, e) {
      ...
      if (((e = kt.trim(e)), r && -1 === kt.inArray(n, e))) {
        if (
          (kt.each(ib.dependencies(e), function (e) {
            _N(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    TN = function (e) {
      ...
      return e.inline
        ? RN(null)
        : ((t = r), (n = kN.create('div')), kN.insertAfter(n, t), RN(n));
    },
    DN = function (e) {
      var t,
        n,
      ...
      return (
        ...
        q(kc(e))
          ...
          : T(kc(e))
          ? ((n = (t = e).getElement()),
            (r = kc(t)(t, n)).editorContainer.nodeType &&
    ...
    ON = function (e) {
      ...
      e.fire('ScriptsLoaded'),
        ...
        (o = ke(ke({}, Yy.get('default').icons), Yy.get(t).icons)),
        ue(o, function (e, t) {
          he(r, t) || n.ui.registry.addIcon(t, e);
        }),
        (u = kc((i = e))),
        q(u)
          ? ((i.settings.theme = AN(u)),
            (a = ab.get(u)),
            (i.theme = new a(i, ab.urls[u])),
            i.theme.init &&
              i.theme.init(
                i,
                ab.urls[u] || i.documentBaseUrl.replace(/\/$/, ''),
                i.$,
              ))
          : (i.theme = {}),
        (s = e),
        (c = []),
        kt.each(Ac(s).split(/[ ,]/), function (e) {
          _N(s, c, AN(e));
        });
      var l,
        f,
      ...
      return (
        (e.editorContainer = y.editorContainer ? y.editorContainer : null),
        ((p = e).contentCSS = p.contentCSS.concat(pb(p))),
        e.inline
          ? xN(e)
          : ((v = EN((g = e), (h = y))),
            h.editorContainer &&
              ((SN.get(h.editorContainer).style.display = g.orgDisplay),
              (g.hidden = SN.isHidden(h.editorContainer))),
            (g.getElement().style.display = 'none'),
            SN.setAttrib(g.id, 'aria-hidden', 'true'),
            void (v || xN(g)))
      );
    },
    BN = Eu.DOM,
        ...
        function (r) {
          e.add(r.url, V, undefined, function () {
            ...
            (e = o),
              ...
              lb(e, 'IconsLoadError', fb('icons', t, n));
          });
        },
      );
    },
      ...
      (n = s),
        ...
        (i = function () {
          ...
          LN(s, e),
            ...
            (r = e),
            (o = t),
            kt.each(r.getParam('external_plugins'), function (e, t) {
        ...
        q(u)
          ? (PN(u) ||
              ab.urls.hasOwnProperty(u) ||
              ((a = r.getParam('theme_url'))
                ? ab.load(u, r.documentBaseURI.toAbsolute(a))
                : ab.load(u, 'themes/' + u + '/theme' + o + '.js')),
    ...
    UN = function (t) {
      ...
      Ti.Event.domLoaded
        ? t.getElement() &&
          ...
          (a = t.getElement().form || BN.getParent(e, 'form')) &&
            ((t.formElement = a),
            t.getParam('hidden_input') &&
              !Ln(t.getElement()) &&
              (BN.insertAfter(
                BN.create('input', { type: 'hidden', name: e }),
                e,
              ),
              (t.hasHiddenInput = !0)),
            ...
            BN.bind(a, 'submit reset', t.formEventDelegate),
            t.on('reset', function () {
              t.resetContent();
            }),
          ...
          (t.windowManager = ub(t)),
          (t.notificationManager = ob(t)),
    ...
    VN = function (o) {
      return function (r, e) {
        return U.from(e)
          ...
          .filter(Ft)
          .bind(function (e) {
            return HN(o, r, e.dom).or(
              ((t = o), (n = e.dom), U.from(Eu.DOM.getStyle(n, t, !0))),
            );
            var t, n;
          })
          .getOr('');
    ...
    GN = function (e, t) {
      var n,
        ...
        a =
          'string' != typeof (n = t)
            ? ((r = kt.extend({ paste: n.paste, data: { paste: n.paste } }, n)),
    ...
    ZN = kt.inArray,
    eE =
      ((tE.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (JN(this.editor.plugins, function (e) {
      ...
      (tE.prototype.setupCommands = function (i) {
        ...
        this.addCommands({
          ...
          'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone':
            function (e) {
              var t = e.substring(7);
              'full' === t && (t = 'justify'),
                JN('left,center,right,justify'.split(','), function (e) {
          ...
          FontSize: function (e, t, n) {
            var r, o;
            (o = n),
              (r = i).formatter.toggle('fontsize', { value: XN(r, o) }),
              r.nodeChanged();
          },
          LineHeight: function (e, t, n) {
            ...
            (o = n),
              (r = i).undoManager.transact(function () {
                r.formatter.toggle('lineheight', { value: String(o) }),
                  r.nodeChanged();
              });
          },
          ...
          selectAll: function () {
            ...
            t &&
              ((e = i.dom.createRng()).selectNodeContents(t),
              i.selection.setRng(e));
          },
        ...
        var e = function (r) {
          return function () {
            var e = i.selection,
              t = e.isCollapsed()
                ? [i.dom.getParent(e.getNode(), i.dom.isBlock)]
                : e.getSelectedBlocks(),
              n = QN(t, function (e) {
  ...
  var nE = 'data-mce-contenteditable',
    rE = function (e, t, n) {
      var r, o;
      Xu(e, t) && !1 === n
        ? ((o = t), Vu((r = e)) ? r.dom.classList.remove(o) : $u(r, o), Ku(r))
        : n && Wu(e, t);
    },
    oE = function (e, t, n) {
      try {
      ...
      rE(i, 'mce-content-readonly', t),
        t
          ? (e.selection.controlSelection.hideResizeRect(),
            ...
            (e.readonly = !0),
            iE(i, !1),
            W(Gu(i, '*[contenteditable="true"]'), function (e) {
              Xn(e, nE, 'true'), iE(e, !1);
            }))
          : ((e.readonly = !1),
            iE(i, !0),
            W(Gu(i, '*[' + nE + '="true"]'), function (e) {
              Qn(e, nE), iE(e, !0);
            }),
            oE(e, 'StyleWithCSS', !1),
            oE(e, 'enableInlineTableEditing', !1),
            oE(e, 'enableObjectResizing', !1),
            (Em((r = e)) || Nm(r)) && e.focus(),
            (n = e).selection.setRng(n.selection.getRng()),
            e.nodeChanged());
    },
    ...
    sE = function (t) {
      t.parser.addAttributeFilter('contenteditable', function (e) {
        uE(t) &&
          W(e, function (e) {
            e.attr(nE, e.attr('contenteditable')),
              ...
              /^#/.test(e)
                ? (t = a.dom.select(
                    e +
                      ',[name="' +
                      (Ve((n = e), (r = '#'))
                        ? ((o = n), (i = r.length), o.substring(i))
                        : n) +
                      '"]',
                  )).length && a.selection.scrollIntoView(t[0], !0)
                : window.open(
                    e,
                    '_blank',
      ...
      (dE.prototype.fire = function (e, t) {
        ...
        (r.type = n),
          ...
          r.preventDefault ||
            ...
            (r.isPropagationStopped = C),
            (r.isImmediatePropagationStopped = C)),
        ...
        if (o)
          for (var i = 0, a = o.length; i < a; i++) {
            var u = o[i];
            if (
              (u.once && this.off(n, u.func), r.isImmediatePropagationStopped())
            )
      ...
      (dE.prototype.on = function (e, t, n, r) {
        if ((!1 === t && (t = C), t)) {
          ...
          for (var i = e.toLowerCase().split(' '), a = i.length; a--; ) {
            var u = i[a],
              s = this.bindings[u];
            s || ((s = this.bindings[u] = []), this.toggleEvent(u, !0)),
  ...
  var mE,
    ...
    vE = function (e, t) {
      ...
      var n = Ec(e);
      return n
        ? (e.eventRoot || (e.eventRoot = hE.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    yE = function (e, t, n) {
      var r;
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(vE(n, e), e, n.delegates[e]),
    ...
    xE = function (e, t, n, r) {
      ...
      i.deactivate(),
        i.editorReadOnly !== a.editorReadOnly && aE(e, a.editorReadOnly),
        t.set(r),
        (o = r),
    ...
    AE =
      ((RE.prototype.add = function (e, n, t, r) {
        var o = this,
          i = o.normalizeCommandFunc(t);
        return (
          NE(EE(kt.trim(e)), function (e) {
        ...
        NE(EE(e.toLowerCase(), '+'), function (e) {
          e in _E
            ...
            : ((n.charCode = e.charCodeAt(0)),
              (n.keyCode = kE[e] || e.toUpperCase().charCodeAt(0)));
        });
        var r = [n.keyCode];
        for (t in _E) n[t] ? r.push(t) : (n[t] = !1);
        return (
          (n.id = r.join(',')),
          n.access && ((n.alt = !0), wt.mac ? (n.ctrl = !0) : (n.shift = !0)),
          n.meta && (wt.mac ? (n.meta = !0) : ((n.ctrl = !0), (n.meta = !1))),
          n
        );
      }),
      (RE.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = kt.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor,
          })),
          kt.extend(o[0], {
  ...
  var TE = function () {
    ...
    PE = { ftp: 21, http: 80, https: 443, mailto: 25 },
    LE =
      ((IE.parseDataUri = function (e) {
        var t,
          n = decodeURIComponent(e).split(','),
          r = /data:([^;]+)/.exec(n[0]);
        return r && (t = r[1]), { type: t, data: n[1] };
        ...
        return (
          0 !==
            (r =
              (n = u.length - o) <= 0
                ? Z(i).join('/')
                : u.slice(0, n).join('/') + '/' + Z(i).join('/')).indexOf(
              '/',
            ) && (r = '/' + r),
      ...
      : ((n = 0 === e.indexOf('//')),
        ...
        /^[\w\-]*:?\/\//.test(e) ||
          ((r = this.settings.base_uri
            ...
            : new IE(document.location.href).directory),
          (e =
  ...
  var ME = Eu.DOM,
    ...
    HE =
      ...
      (VE.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (ME.show(this.getContainer()), ME.hide(this.id)),
          this.load(),
          this.fire('show'));
      }),
      (VE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (ME.hide(e.getContainer()),
              ME.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      }),
          ...
          return (
            ...
            Ln(o)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = ME.getParent(r.id, 'form')) &&
                  UE(n.elements, function (e) {
      ...
      (VE.prototype.resetContent = function (e) {
        e === undefined
          ? ky(this, this.startContent, { format: 'raw' })
          : ky(this, e),
      ...
      (VE.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = ME.get(this.id)), this.targetElm
        );
      }),
  ...
  function VE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      FE(this, CE),
      (this.settings = Wy(this, e, this.documentBaseUrl, n.defaultSettings, t)),
      ...
      this.settings.referrer_policy &&
        ...
        Eu.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy,
        )),
      (Uu.languageLoad = this.settings.language_load),
      (Uu.baseURL = n.baseURL),
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new LE(this.settings.document_base_url, {
        base_uri: this.baseUri,
      })),
      (this.baseURI = this.baseUri),
      (this.inline = !!this.settings.inline),
      (this.shortcuts = new AE(this)),
      (this.editorCommands = new eE(this)),
      this.settings.cache_suffix &&
        (wt.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, '')),
      (this.ui = {
        registry: TE(),
    ...
    (this.mode = o),
      ...
      (this.$ = hu.overrideDefaults(function () {
        return {
  ...
  var qE,
    ...
    ek = function (e) {
      e !== GE &&
        (e
          ? hu(window).on('resize scroll', ZE)
          : hu(window).off('resize scroll', ZE),
        (GE = e));
    },
    tk = function (t) {
      var e = QE;
      ...
      return (
        ...
        rk.activeEditor === t &&
          (rk.activeEditor = 0 < QE.length ? QE[0] : null),
        rk.focusedEditor === t && (rk.focusedEditor = null),
        e.length !== QE.length
      );
    },
    ...
    rk = ke(ke({}, gE), {
      ...
      setup: function () {
        ...
        if (o) (e = o.base || o.baseURL), (t = o.suffix);
          ...
          for (
            var i, a = document.getElementsByTagName('script'), u = 0;
            u < a.length;
            u++
          ) {
            if ('' !== (i = a[u].src || '')) {
          ...
          !e &&
            ...
            (-1 !== (i = document.currentScript.src).indexOf('.min') &&
              (t = '.min'),
            (e = i.substring(0, i.lastIndexOf('/'))));
        }
        (this.baseURL = new LE(n).toAbsolute(e)),
          (this.documentBaseURL = n),
          (this.baseURI = new LE(this.baseURL)),
          (this.suffix = t),
          (r = this).on('AddEditor', N(ym, r)),
          r.on('RemoveEditor', N(bm, r));
      },
          ...
          e = function () {
            ...
            $E.unbind(window, 'ready', e),
              ...
              (o = hu.unique(
                (function (t) {
                  var n = [];
                  if (wt.browser.isIE() && wt.browser.version.major < 11)
                    return (
                      mb(
              ...
              r.types
                ? KE(r.types, function (t) {
                    kt.each(o, function (e) {
                      return (
                        !$E.is(e, t.selector) || (n(c(e), XE({}, r, t), e), !1)
                      );
                    });
                  })
                : (kt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          JE[e.id] === e ||
            (null === n.get(e.id) &&
              ('length' !== e.id && (JE[e.id] = e), JE.push(e), QE.push(e)),
            ek(!0),
            (n.activeEditor = e),
        ...
        if (e) {
          if (!q(e))
            return (
              ...
              x(r.get(n.id))
                ? null
                : (tk(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === QE.length &&
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new LE(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ''),
        )),
          (this.baseURI = new LE(this.baseURL));
      },
  ...
  var ok,
    ...
    pk =
      ...
      (ik = {}),
      {
        ...
        add: function (e, t) {
          ik[e] !== undefined && (ik[e](t), delete ik[e]),
            (ok[e] = Br.resolve(t));
        },
      }),
    gk = kt.each,
  ...
  vk.extend = ak = function (n) {
    ...
    return (
      (uk = !1),
      n.Mixins &&
        (gk(n.Mixins, function (e) {
          for (var t in e) 'init' !== t && (n[t] = e[t]);
        }),
        o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
      n.Methods &&
        gk(n.Methods.split(','), function (e) {
          n[e] = t;
        }),
      n.Properties &&
        gk(n.Properties.split(','), function (e) {
          var t = '_' + e;
          n[e] = function (e) {
      ...
      n.Statics &&
        gk(n.Statics, function (e, t) {
          r[t] = e;
        }),
      n.Defaults && o.Defaults && (n.Defaults = hk({}, o.Defaults, n.Defaults)),
      ue(n, function (e, t) {
        var n, r;
    ...
    Sk = ke(ke({}, gE), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ''),
          Sk.fire('beforeInitialize', { settings: e }),
          ...
          (t = Sk.fire('beforeSend', { xhr: t, settings: e }).xhr).send(e.data),
          !e.async)
        )
          return r();
        qr.setTimeout(r, 10);
    ...
    Ek =
      ...
      (kk.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          void 0 === (e = wk.parse(e)) && (e = { error: 'JSON Parse error.' }),
            e.error

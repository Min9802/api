    ...
    a.fn.extend({
      maxlength: function (b, c) {
        ...
        function e(a, c) {
          ...
          b.twoCharLinebreak &&
            ((d = d.replace(/\r(?!\n)|\n(?!\r)/g, '\r\n')),
            '\n' === d.substr(d.length - 1) && d.length % 2 === 1 && (e = 1)),
            a.val(d.substr(0, c - e));
        }
        function f(a) {
            ...
            b.message
              ? (e =
                  'function' == typeof b.message
                    ? b.message(a, c)
                    : b.message
                        .replace('%charsTyped%', d)
                        .replace('%charsRemaining%', c - d)
                        .replace('%charsTotal%', c))
              : (b.preText && (e += b.preText),
                (e += b.showCharsTyped ? d : c - d),
                b.showMaxLength && (e += b.separator + c),
                b.postText && (e += b.postText)),
            e
          );
        }
        function l(a, c, d, e) {
          e &&
            (e.html(k(c.val(), d, d - a)),
            a > 0
              ? g(c, b.threshold, d)
                ? i(
                    c,
                    e.removeClass(b.limitReachedClass).addClass(b.warningClass),
                  )
                : j(c, e)
              : i(
                  c,
                  e.removeClass(b.warningClass).addClass(b.limitReachedClass),
                )),
            b.allowOverMax &&
              (0 > a ? c.addClass('overmax') : c.removeClass('overmax'));
        }
        function m(b) {
          var c = b[0];
          return a.extend(
        ...
        function n(c, d) {
          var e = m(c);
          if ('function' === a.type(b.placement))
            return void b.placement(c, d, e);
          ...
          switch (
            (b.appendToParent &&
              ((e.top -= c.parent().offset().top),
              (e.left -= c.parent().offset().left)),
            b.placement)
          ) {
            case 'bottom':
              d.css({
                top: e.top + e.height,
                left: e.left + e.width / 2 - h / 2,
              });
              break;
            case 'top':
        ...
        function o(c, d) {
          if (c && d) {
            var e = ['top', 'bottom', 'left', 'right', 'position'],
              f = {};
        ...
        function p(a) {
          var c = 'maxlength';
          return (
            b.allowOverMax && (c = 'data-bs-mxl'), a.attr(c) || a.attr('size')
          );
        }
        var q = a('body'),
          r = {
        ...
        return (
          ...
          this.each(function () {
            function c() {
              ...
              (d = p(g)),
                f ||
                  (f = a('<span class="bootstrap-maxlength"></span>')
                    .css({
                      display: 'none',
                      position: 'absolute',
                      whiteSpace: 'nowrap',
                    ...
                    .html(c)),
                g.is('textarea') &&
                  (g.data('maxlenghtsizex', g.outerWidth()),
                  g.data('maxlenghtsizey', g.outerHeight()),
                  g.mouseup(function () {
                    (g.outerWidth() !== g.data('maxlenghtsizex') ||
                      g.outerHeight() !== g.data('maxlenghtsizey')) &&
                      n(g, f),
                      g.data('maxlenghtsizex', g.outerWidth()),
                      g.data('maxlenghtsizey', g.outerHeight());
                  })),
            ...
            a(window).resize(function () {
              ...
              b.allowOverMax &&
                (a(this).attr('data-bs-mxl', a(this).attr('maxlength')),
              ...
              g.on('input', function () {
                var a = p(g),
                  ...
                  i = !0;
                return (
                  b.validate && 0 > c ? (e(g, a), (i = !1)) : l(c, g, d, f),
                  ('bottom-right-inside' === b.placement ||
                    'top-right-inside' === b.placement) &&
                    n(g, f),
                  i
                );
              });

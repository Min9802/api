...
!(function (a) {
  ...
  (b.prototype = {
    ...
    initButtons: function () {
      ...
      b.append(a.fn.editableform.buttons),
        'bottom' === this.options.showbuttons &&
          b.addClass('editable-buttons-bottom');
    },
    render: function () {
    ...
    showLoading: function () {
      var a, b;
      this.$form
        ? ((a = this.$form.outerWidth()),
          (b = this.$form.outerHeight()),
          a && this.$loading.width(a),
          b && this.$loading.height(b),
          this.$form.hide())
        : ((a = this.$loading.parent().width()), a && this.$loading.width(a)),
        this.$loading.show();
    },
    showForm: function (a) {
      this.$loading.hide(),
    ...
    error: function (b) {
      ...
      if (b === !1)
        d.removeClass(a.fn.editableform.errorGroupClass),
    ...
    submit: function (b) {
      ...
      if ('object' === a.type(d) && void 0 !== d.newValue) {
        if (
          ...
          return this.error(d.msg), this.showForm(), void 0;
      } else if (d) return this.error(d), this.showForm(), void 0;
      if (
        !this.options.savenochange &&
        this.input.value2str(c) == this.input.value2str(this.value)
      )
        return this.$div.triggerHandler('nochange'), void 0;
            ...
            a.proxy(function (a) {
              ...
              var b =
                'function' == typeof this.options.success
                  ? this.options.success.call(this.options.scope, a, c)
                  : null;
              return b === !1
                ? (this.error(!1), this.showForm(!1), void 0)
                : 'string' == typeof b
                ? (this.error(b), this.showForm(), void 0)
                : (b &&
                    'object' == typeof b &&
                    b.hasOwnProperty('newValue') &&
                    (c = b.newValue),
                  this.error(!1),
                  (this.value = c),
            ...
            a.proxy(function (a) {
              ...
              (b =
                'function' == typeof this.options.error
                  ? this.options.error.call(this.options.scope, a, c)
                  : 'string' == typeof a
                  ? a
                  : a.responseText || a.statusText || 'Unknown error!'),
                this.error(b),
                this.showForm();
            }, this),
          );
    ...
    save: function (b) {
      ...
      var c,
        d =
          'function' == typeof this.options.pk
            ? this.options.pk.call(this.options.scope)
            : this.options.pk,
        e = !!(
          'function' == typeof this.options.url ||
          (this.options.url &&
            ('always' === this.options.send ||
              ('auto' === this.options.send && null !== d && void 0 !== d)))
        );
      return e
        ? (this.showLoading(),
          (c = { name: this.options.name || '', value: b, pk: d }),
          'function' == typeof this.options.params
            ? (c = this.options.params.call(this.options.scope, c))
            : ((this.options.params = a.fn.editableutils.tryParseJson(
                this.options.params,
                !0,
              )),
              a.extend(c, this.options.params)),
          'function' == typeof this.options.url
            ? this.options.url.call(this.options.scope, c)
            : a.ajax(
                a.extend(
                  { url: this.options.url, data: c, type: 'POST' },
    ...
    validate: function (a) {
      return (
        void 0 === a && (a = this.value),
        'function' == typeof this.options.validate
          ? this.options.validate.call(this.options.scope, a)
          : void 0
      );
    },
    option: function (a, b) {
    ...
    a.fn.editableutils = {
      ...
      sliceObj: function (b, c, d) {
        ...
        for (var h = 0; h < c.length; h++)
          (e = c[h]),
            ...
            d !== !0 &&
              ((f = e.toLowerCase()), b.hasOwnProperty(f) && (g[e] = b[f]));
        return g;
      },
      ...
      createInput: function (b) {
        ...
        return (
          'date' === f &&
            ('inline' === b.mode
              ? a.fn.editabletypes.datefield
                ? (f = 'datefield')
                : a.fn.editabletypes.dateuifield && (f = 'dateuifield')
              : a.fn.editabletypes.date
              ? (f = 'date')
              : a.fn.editabletypes.dateui && (f = 'dateui'),
            'date' !== f || a.fn.editabletypes.date || (f = 'combodate')),
          'datetime' === f && 'inline' === b.mode && (f = 'datetimefield'),
          'wysihtml5' !== f || a.fn.editabletypes[f] || (f = 'textarea'),
          'function' == typeof a.fn.editabletypes[f]
            ? ((c = a.fn.editabletypes[f]),
              (d = this.sliceObj(b, this.objectKeys(c.defaults))),
              (e = new c(d)))
            : (a.error('Unknown type: ' + f), !1)
        );
      },
    ...
    (b.prototype = {
      ...
      init: function (c, d) {
        (this.$element = a(c)),
          ...
          a(document).data('editable-handlers-attached') ||
            (a(document).on('keyup.editable', function (b) {
            ...
            a(document).on('click.editable', function (c) {
              ...
              if (
                a.contains(document.documentElement, c.target) &&
                !e.is(document)
              ) {
      ...
      splitOptions: function () {
        ...
        for (var b in this.options)
          b in this.defaults
            ? (this.containerOptions[b] = this.options[b])
            : (this.formOptions[b] = this.options[b]);
      },
      tip: function () {
      ...
      container: function () {
        var a;
        return this.containerDataName &&
          (a = this.$element.data(this.containerDataName))
          ? a
          : (a = this.$element.data(this.containerName));
      },
      call: function () {
        ...
        this.$form
          ...
          .on({
            ...
            show: a.proxy(function () {
              this.delayedHide
                ? (this.hide(this.delayedHide.reason), (this.delayedHide = !1))
                : this.setPosition();
            }, this),
            ...
            rendered: a.proxy(function () {
              this.$element.triggerHandler(
                'shown',
                a(this.options.scope).data('editable'),
              );
            }, this),
          })
          .editableform('render');
      ...
      hide: function (a) {
        if (
          ...
          if (this.$form.data('editableform').isSaving)
            return (this.delayedHide = { reason: a }), void 0;
          (this.delayedHide = !1),
      ...
      innerHide: function () {},
      toggle: function (a) {
        this.container() && this.tip() && this.tip().is(':visible')
          ? this.hide()
          : this.show(a);
      },
      ...
      option: function (a, b) {
        (this.options[a] = b),
          a in this.containerOptions
            ? ((this.containerOptions[a] = b), this.setContainerOption(a, b))
            : ((this.formOptions[a] = b),
              this.$form && this.$form.editableform('option', a, b));
      },
      ...
      closeOthers: function (b) {
        a('.editable-open').each(function (c, d) {
          if (d !== b && !a(d).find(b).length) {
            ...
            f &&
              ('cancel' === f.options.onblur
                ? e.data('editableContainer').hide('onblur')
                : 'submit' === f.options.onblur &&
                  e.data('editableContainer').tip().find('form').submit());
          }
        });
      },
      activate: function () {
  ...
  (function (a) {
    'use strict';
    a.extend(
      a.fn.editableContainer.Inline.prototype,
      a.fn.editableContainer.Popup.prototype,
      {
    ...
    var b = function (b, c) {
      (this.$element = a(b)),
        (this.options = a.extend(
          ...
          c,
          a.fn.editableutils.getConfigData(this.$element),
        )),
        this.options.selector ? this.initLive() : this.init(),
        this.options.highlight &&
          !a.fn.editableutils.supportsTransitions() &&
    ...
    (b.prototype = {
      ...
      init: function () {
        ...
        if (
          ...
          (this.input = a.fn.editableutils.createInput(this.options)),
          this.input)
        ) {
          switch (
            (void 0 === this.options.value || null === this.options.value
              ? ((this.value = this.input.html2value(
                  a.trim(this.$element.html()),
                )),
                (c = !0))
              : ((this.options.value = a.fn.editableutils.tryParseJson(
                  this.options.value,
                  !0,
                )),
                (this.value =
                  'string' == typeof this.options.value
                    ? this.input.str2value(this.options.value)
                    : this.options.value)),
            this.$element.addClass('editable'),
            'textarea' === this.input.type &&
              this.$element.addClass('editable-pre-wrapped'),
            'manual' !== this.options.toggle
              ? (this.$element.addClass('editable-click'),
                this.$element.on(
                  this.options.toggle + '.editable',
                  a.proxy(function (a) {
                    if (
                      (this.options.disabled || a.preventDefault(),
                      'mouseenter' === this.options.toggle)
                    )
                      this.show();
                    else {
            ...
            'function' == typeof this.options.display &&
            ...
            case 'auto':
              b =
                !a.trim(this.$element.text()).length &&
                null !== this.value &&
                void 0 !== this.value &&
                !c;
              break;
        ...
        (this.options.selector = !1),
          ...
          this.$element.on(
            ...
            a.proxy(function (b) {
              var c = a(b.target);
              c.data('editable') ||
                (c.hasClass(this.options.emptyclass) && c.empty(),
                c.editable(this.options).trigger(b));
            }, this),
          );
      },
      render: function (a) {
        return this.options.display !== !1
          ? this.input.value2htmlFinal
            ? this.input.value2html(
                this.value,
                this.$element[0],
            ...
            : 'function' == typeof this.options.display
            ? this.options.display.call(this.$element[0], this.value, a)
            : this.input.value2html(this.value, this.$element[0])
          : void 0;
      },
      enable: function () {
          ...
          : ((this.options[b] = c),
            'disabled' === b
              ? c
                ? this.disable()
                : this.enable()
              : ('value' === b && this.setValue(c),
                this.container && this.container.option(b, c),
                this.input.option && this.input.option(b, c),
                void 0));
      },
      handleEmpty: function (b) {
        this.options.display !== !1 &&
          ((this.isEmpty =
            void 0 !== b
              ? b
              : 'function' == typeof this.input.isEmpty
              ? this.input.isEmpty(this.$element)
              : '' === a.trim(this.$element.html())),
      ...
      toggle: function (a) {
        this.container && this.container.tip().is(':visible')
          ? this.hide()
          : this.show(a);
      },
      save: function (a, b) {
            ...
            (c =
              ...
              (this.options.savenochange &&
                this.input.value2str(this.value) !==
                  this.input.value2str(b.newValue))),
            c
      ...
      (a.fn.editable = function (c) {
        ...
        switch (c) {
          ...
          case 'getValue':
            return (
              2 === arguments.length && arguments[1] === !0
                ? (d = this.eq(0).data(f).value)
                : this.each(function () {
                    var b = a(this),
                      c = b.data(f);
                    c &&
                      void 0 !== c.value &&
                      null !== c.value &&
                      (d[c.options.name] = c.input.value2submit(c.value));
                  }),
              d
            );
          case 'submit':
            ...
            if (a.isEmptyObject(i)) {
              ...
              if (1 === h.length) {
                var k = h.data('editable'),
                  l = {
                    ...
                    pk:
                      'function' == typeof k.options.pk
                        ? k.options.pk.call(k.options.scope)
                        : k.options.pk,
                  };
                'function' == typeof k.options.params
                  ? (l = k.options.params.call(k.options.scope, l))
                  : ((k.options.params = a.fn.editableutils.tryParseJson(
                      k.options.params,
                      !0,
                    )),
                    a.extend(l, k.options.params)),
                  (j = { url: k.options.url, data: l, type: 'POST' }),
              ...
              (j.success =
                'function' == typeof g.success
                  ? function (a) {
                      g.success.call(h, a, g);
                    }
                  : a.noop),
                (j.error =
                  'function' == typeof g.error
                    ? function () {
        ...
        return this.each(function () {
          var d = a(this),
            ...
            h = 'object' == typeof c && c;
          return h && h.selector
            ? ((g = new b(this, h)), void 0)
            : (g || d.data(f, (g = new b(this, h))),
              'string' == typeof c &&
                g[c].apply(g, Array.prototype.slice.call(e, 1)),
              void 0);
        });
      }),
      (a.fn.editable.defaults = {
  ...
  (function (a) {
    ...
    (b.prototype = {
      ...
      setAttr: function (a) {
        void 0 !== this.options[a] &&
          null !== this.options[a] &&
          this.$input.attr(a, this.options[a]);
      },
      option: function (a, b) {
        this.options[a] = b;
      },
      ...
      a.extend(b.prototype, {
        ...
        value2html: function (b, c, d, e) {
          var f = a.Deferred(),
            g = function () {
              'function' == typeof d
                ? d.call(c, b, this.sourceData, e)
                : this.value2htmlFinal(b, c),
                f.resolve();
            };
          return (
            null === b
              ? g.call(this)
              : this.onSourceReady(g, function () {
                  f.resolve();
                }),
            f.promise()
          );
        ...
        onSourceReady: function (b, c) {
          var d;
          if (
            (a.isFunction(this.options.source)
              ? ((d = this.options.source.call(this.options.scope)),
                (this.sourceData = null))
              : (d = this.options.source),
            this.options.sourceCache && a.isArray(this.sourceData))
          )
            return b.call(this), void 0;
          try {
          ...
          if ('string' == typeof d) {
            if (this.options.sourceCache) {
              var f,
                g = d;
              if (
                (a(document).data(g) || a(document).data(g, {}),
                (f = a(document).data(g)),
                f.loading === !1 && f.sourceData)
              )
                return (
              ...
              if (f.loading === !0)
                return (
                  ...
                  f.err_callbacks.push(a.proxy(c, this)),
                  void 0
                );
                ...
                success: a.proxy(function (d) {
                  f && (f.loading = !1),
                    ...
                    a.isArray(this.sourceData)
                      ...
                      : (c.call(this),
                        f &&
                          a.each(f.err_callbacks, function () {
                            this.call();
                          }));
                }, this),
            ...
            (this.sourceData = this.makeArray(d)),
              a.isArray(this.sourceData)
                ? (this.doPrepend(), b.call(this))
                : c.call(this);
        },
        doPrepend: function () {
          null !== this.options.prepend &&
            void 0 !== this.options.prepend &&
            (a.isArray(this.prependData) ||
              (a.isFunction(this.options.prepend) &&
                (this.options.prepend = this.options.prepend.call(
                  this.options.scope,
                )),
              (this.options.prepend = a.fn.editableutils.tryParseJson(
                this.options.prepend,
                !0,
              )),
              'string' == typeof this.options.prepend &&
                ...
                'object' == typeof e
                  ? ((c = 0),
                    ...
                    1 === c
                      ...
                      : c > 1 &&
                        (e.children &&
                          (e.children = this.makeArray(e.children)),
                        g.push(e)))
                  : g.push({ value: e, text: e });
          } else
      ...
      a.extend(b.prototype, {
        ...
        activate: function () {
          this.$input.is(':visible') &&
            (this.$input.focus(),
            a.fn.editableutils.setCursorPosition(
              this.$input.get(0),
        ...
        renderClear: function () {
          this.options.clear &&
            ((this.$clear = a('<span class="editable-clear-x"></span>')),
            this.$input
              .after(this.$clear)
            ...
            this.$clear.click(a.proxy(this.clear, this)));
        },
        postrender: function () {},
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
      a.extend(b.prototype, {
            ...
            if (a.isArray(d))
              for (var f = 0; f < d.length; f++)
                (e = {}),
                  d[f].children
                    ? ((e.label = d[f].text),
                      c.append(b(a('<optgroup>', e), d[f].children)))
                    : ((e.value = d[f].value),
                      d[f].disabled && (e.disabled = !0),
        ...
        value2htmlFinal: function (b, c) {
          ...
          e.length && (d = e[0].text),
            a.fn.editabletypes.abstractinput.prototype.value2html.call(
              this,
              d,
              c,
            );
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
      a.extend(b.prototype, {
          ...
          if ((this.$tpl.empty(), a.isArray(this.sourceData))) {
            for (var c = 0; c < this.sourceData.length; c++)
              (b = a('<label>')
                ...
                .append(a('<span>').text(' ' + this.sourceData[c].text))),
                a('<div>').append(b).appendTo(this.$tpl);
        ...
        value2str: function (b) {
          return a.isArray(b)
            ? b.sort().join(a.trim(this.options.separator))
            : '';
        },
        str2value: function (b) {
          ...
          return (
            'string' == typeof b && b.length
              ? ((c = new RegExp(
                  '\\s*' + a.trim(this.options.separator) + '\\s*',
                )),
                (d = b.split(c)))
              : (d = a.isArray(b) ? b : [b]),
            d
        ...
        input2value: function () {
          var b = [];
          return (
            this.$input.filter(':checked').each(function (c, d) {
              b.push(a(d).val());
            }),
            b
          );
  ...
  (function (a) {
    ...
    var b = function (c) {
      if (
        (this.init('select2', c, b.defaults),
        (c.select2 = c.select2 || {}),
        (this.sourceData = null),
        c.placeholder && (c.select2.placeholder = c.placeholder),
        !c.select2.tags && c.source)
      ) {
        var d = c.source;
        a.isFunction(c.source) && (d = c.source.call(c.scope)),
          'string' == typeof d
            ? ((c.select2.ajax = c.select2.ajax || {}),
              c.select2.ajax.data ||
                (c.select2.ajax.data = function (a) {
                  return { query: a };
                }),
              c.select2.ajax.results ||
                (c.select2.ajax.results = function (a) {
                  return { results: a };
                }),
              (c.select2.ajax.url = d))
            : ((this.sourceData = this.convertSource(d)),
              (c.select2.data = this.sourceData));
      }
      if (
        ((this.options.select2 = a.extend({}, b.defaults.select2, c.select2)),
        (this.isMultiple =
          this.options.select2.tags || this.options.select2.multiple),
      ...
      (this.formatSelection = this.options.select2.formatSelection),
        'function' != typeof this.formatSelection &&
          (this.formatSelection = function (a) {
            return a.text;
          });
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        ...
        value2html: function (c, d) {
          var e,
            f = '',
            g = this;
          this.options.select2.tags
            ? (e = c)
            : this.sourceData &&
              (e = a.fn.editableutils.itemsByValue(
                c,
                this.sourceData,
                this.idFunc,
              )),
        ...
        html2value: function (a) {
          return this.options.select2.tags
            ? this.str2value(a, this.options.viewseparator)
            : null;
        },
        value2input: function (b) {
          if (
            ...
            this.$input.data('select2')
              ? this.$input.val(b).trigger('change', !0)
              : (this.$input.val(b), this.$input.select2(this.options.select2)),
            this.isRemote &&
              !this.isMultiple &&
        ...
        getSeparator: function () {
          return (
            this.options.select2.separator || a.fn.select2.defaults.separator
          );
        },
        convertSource: function (b) {
          if (a.isArray(b) && b.length && void 0 !== b[0].value)
            for (var c = 0; c < b.length; c++)
              void 0 !== b[c].value &&
                ((b[c].id = b[c].value), delete b[c].value);
          return b;
        },
        destroy: function () {
      ...
      return (
        ...
        this.$element.is('input')
          ? ((this.options = a.extend(
            ...
            this.init(),
            void 0)
          : (a.error('Combodate should be applied to INPUT element'), void 0)
      );
    };
    (b.prototype = {
      constructor: b,
      init: function () {
        (this.map = {
          ...
          (this.$widget = a('<span class="combodate"></span>').html(
            this.getTemplate(),
          )),
          this.initCombos(),
          this.$widget.on(
            ...
            a.proxy(function (b) {
              this.$element.val(this.getValue()).change(),
                this.options.smartDays &&
                  (a(b.target).is('.month') || a(b.target).is('.year')) &&
                  this.fillCombo('day');
            }, this),
          ),
      ...
      fillCombo: function (a) {
        ...
        if (b) {
          ...
          for (var f = 0; f < d.length; f++)
            b.append(
              '<option value="' + d[f][0] + '">' + d[f][1] + '</option>',
            );
          b.val(e);
        }
      },
      ...
      fillMonth: function () {
        ...
        for (b = 0; 11 >= b; b++)
          (a = d
            ? moment().date(1).month(b).format('MMMM')
            : e
            ? moment().date(1).month(b).format('MMM')
            : f
            ? this.leadZero(b + 1)
            : b + 1),
            c.push([b, a]);
      ...
      fillYear: function () {
        ...
        for (b = this.options.maxYear; b >= this.options.minYear; b--)
          (a = d ? b : (b + '').substring(2)),
      ...
      fillHour: function () {
        var a,
          ...
          e =
            (-1 !== this.options.template.indexOf('H'),
            -1 !== this.options.template.toLowerCase().indexOf('hh')),
          f = d ? 1 : 0,
          g = d ? 12 : 23;
      ...
      fillMinute: function () {
        ...
        for (b = 0; 59 >= b; b += this.options.minuteStep)
      ...
      fillSecond: function () {
        ...
        for (b = 0; 59 >= b; b += this.options.secondStep)
          (a = d ? this.leadZero(b) : b), c.push([b, a]);
        return c;
      },
      fillAmpm: function () {
        var a = -1 !== this.options.template.indexOf('a'),
          b =
            (-1 !== this.options.template.indexOf('A'),
            [
              ['am', a ? 'am' : 'AM'],
              ['pm', a ? 'pm' : 'PM'],
            ]);
        ...
        return (
          a.each(this.map, function (a) {
            if ('ampm' !== a) {
              var b = 'day' === a ? 1 : 0;
              return (
                (d[a] = e['$' + a] ? parseInt(e['$' + a].val(), 10) : b),
                isNaN(d[a]) ? ((f = !0), !1) : void 0
              );
            }
          }),
          f
            ...
            : (this.$ampm &&
              ...
              this.highlight(c),
              (b = void 0 === b ? this.options.format : b),
              null === b
                ? c.isValid()
                  ? c
                  : null
      ...
      setValue: function (b) {
        function c(b, c) {
          var d = {};
          return (
            b.children('option').each(function (b, e) {
              var f,
                g = a(e).attr('value');
              '' !== g &&
                ((f = Math.abs(g - c)),
                ('undefined' == typeof d.distance || f < d.distance) &&
                  (d = { value: g, distance: f }));
            }),
            d.value
          );
        }
        if (b) {
          var d =
              'string' == typeof b ? moment(b, this.options.format) : moment(b),
            e = this,
            f = {};
          d.isValid() &&
            (a.each(this.map, function (a, b) {
              'ampm' !== a && (f[a] = d[b[1]]());
            }),
            this.$ampm &&
              (f.hour >= 12
                ? ((f.ampm = 'pm'), f.hour > 12 && (f.hour -= 12))
                : ((f.ampm = 'am'), 0 === f.hour && (f.hour = 12))),
            a.each(f, function (a, b) {
              e['$' + a] &&
                ('minute' === a &&
                  e.options.minuteStep > 1 &&
                  e.options.roundTime &&
                  (b = c(e['$' + a], b)),
                'second' === a &&
                  e.options.secondStep > 1 &&
                  e.options.roundTime &&
                  (b = c(e['$' + a], b)),
                e['$' + a].val(b));
            }),
            this.options.smartDays && this.fillCombo('day'),
            this.$element.val(d.format(this.options.format)).change());
        }
      },
      ...
      (a.fn.combodate = function (c) {
        ...
        return (
          e.shift(),
          'getValue' === c && this.length && (d = this.eq(0).data('combodate'))
            ? d.getValue.apply(d, e)
            : this.each(function () {
                var d = a(this),
                  f = d.data('combodate'),
                  g = 'object' == typeof c && c;
                f || d.data('combodate', (f = new b(this, g))),
                  'string' == typeof c &&
                    'function' == typeof f[c] &&
                    f[c].apply(f, e);
              })
  ...
  (function (a) {
    ...
    var b = function (c) {
      this.init('combodate', c, b.defaults),
        ...
        (this.options.combodate = a.extend(
          {},
          b.defaults.combodate,
          c.combodate,
          { format: this.options.format, template: this.options.template },
        ));
    };
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
  ...
  (function (a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
      ...
      initInput: function () {
        b.apply(this);
        var c =
            null === this.input.options.inputclass ||
            this.input.options.inputclass === !1,
          d = 'input-sm',
          e =
            'text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs'.split(
              ',',
            );
        ~a.inArray(this.input.type, e) &&
          (this.input.$input.addClass('form-control'),
          c &&
            ((this.input.options.inputclass = d),
            this.input.$input.addClass(d)));
        for (
          var f = this.$form.find('.editable-buttons'),
            g = c ? [d] : this.input.options.inputclass.split(' '),
            h = 0;
          h < g.length;
          h++
        )
          'input-lg' === g[h].toLowerCase() &&
            f.find('button').removeClass('btn-sm').addClass('btn-lg');
      },
    }),
      (a.fn.editableform.buttons =
    ...
    e.prototype = {
      ...
      _process_options: function (b) {
        ...
        var c = (this.o = a.extend({}, this._o)),
          d = c.language;
        switch (
          (k[d] || ((d = d.split('-')[0]), k[d] || (d = i.language)),
          (c.language = d),
          c.startView)
        ) {
          case 2:
        ...
        c.startDate !== -1 / 0 &&
          (c.startDate = l.parseDate(c.startDate, e, c.language)),
          1 / 0 !== c.endDate &&
            (c.endDate = l.parseDate(c.endDate, e, c.language)),
              ...
              a(document),
              {
                mousedown: a.proxy(function (a) {
                  this.element.is(a.target) ||
                    this.element.find(a.target).size() ||
                    this.picker.is(a.target) ||
                    this.picker.find(a.target).size() ||
                    this.hide();
                }, this),
              },
            ],
      ...
      getFormattedDate: function (a) {
        return (
          ...
          l.formatDate(this.date, a, this.o.language)
        );
      },
      ...
      update: function () {
        if (this._allow_update) {
          ...
          ('string' == typeof arguments[0] || arguments[0] instanceof Date)
            ...
            (this.date = l.parseDate(a, this.o.format, this.o.language)),
            b && this.setValue(),
            (this.viewDate =
              this.date < this.o.startDate
                ? new Date(this.o.startDate)
                : this.date > this.o.endDate
      ...
      fillDow: function () {
        ...
        for (; a < this.o.weekStart + 7; )
          b +=
            '<th class="dow">' + k[this.o.language].daysMin[a++ % 7] + '</th>';
      ...
      fillMonths: function () {
        for (var a = '', b = 0; 12 > b; )
          a +=
            '<span class="month">' +
            k[this.o.language].monthsShort[b++] +
            '</span>';
      ...
      fill: function () {
        ...
        this.date && this.date.valueOf(),
          this.picker
            ...
            .text(k[this.o.language].months[f] + ' ' + e),
          this.picker
            .find('tfoot th.today')
            .text(k[this.o.language].today)
            .toggle(this.o.todayBtn !== !1),
          this.picker
            .find('tfoot th.clear')
            .text(k[this.o.language].clear)
        ...
        m.setUTCDate(n),
          m.setUTCDate(n - ((m.getUTCDay() - this.o.weekStart + 7) % 7));
        var o = new Date(m);
        o.setUTCDate(o.getUTCDate() + 42), (o = o.valueOf());
        for (var p, q = []; m.valueOf() < o; ) {
          if (
            m.getUTCDay() == this.o.weekStart &&
            (q.push('<tr>'), this.o.calendarWeeks)
          ) {
            var r = new Date(
                +m + 864e5 * ((this.o.weekStart - m.getUTCDay() - 7) % 7),
              ),
              s = new Date(+r + 864e5 * ((11 - r.getUTCDay()) % 7)),
              t = new Date(
                +(t = b(s.getUTCFullYear(), 0, 1)) +
                  864e5 * ((11 - t.getUTCDay()) % 7),
              ),
              u = (s - t) / 864e5 / 7 + 1;
          ...
          void 0 === v
            ...
            v.enabled === !1 && p.push('disabled'),
            v.classes && (p = p.concat(v.classes.split(/\s+/))),
            ...
            m.getUTCDay() == this.o.weekEnd && q.push('</tr>'),
        ...
        var w = this.date && this.date.getUTCFullYear(),
          x = this.picker
            ...
            .find('span')
            .removeClass('active');
        w && w == e && x.eq(this.date.getUTCMonth()).addClass('active'),
          (g > e || e > i) && x.addClass('disabled'),
          e == g && x.slice(0, h).addClass('disabled'),
          e == i && x.slice(j + 1).addClass('disabled'),
          (q = ''),
          ...
          switch (this.viewMode) {
            ...
            case 2:
              ...
              b <= this.o.startDate.getUTCFullYear()
                ? this.picker.find('.prev').css({ visibility: 'hidden' })
                : this.picker.find('.prev').css({ visibility: 'visible' }),
                1 / 0 !== this.o.endDate && b >= this.o.endDate.getUTCFullYear()
                  ? this.picker.find('.next').css({ visibility: 'hidden' })
                  : this.picker.find('.next').css({ visibility: 'visible' });
          }
        }
          ...
          switch (d[0].nodeName.toLowerCase()) {
            case 'th':
              switch (d[0].className) {
                ...
                case 'next':
                  var e =
                    l.modes[this.viewMode].navStep *
                    ('prev' == d[0].className ? -1 : 1);
                  switch (this.viewMode) {
                    case 0:
                ...
                case 'today':
                  var f = new Date();
                  (f = b(f.getFullYear(), f.getMonth(), f.getDate(), 0, 0, 0)),
                    this.showMode(-2);
            ...
            case 'span':
              if (!d.is('.disabled')) {
                if ((this.viewDate.setUTCDate(1), d.is('.month'))) {
                  ...
                  this.viewDate.setUTCMonth(j),
                    this._trigger('changeMonth', this.viewDate),
                    1 === this.o.minViewMode &&
                      this._setDate(b(k, j, i, 0, 0, 0, 0));
                } else {
      ...
      keydown: function (a) {
        if (this.picker.is(':not(:visible)'))
          return 27 == a.keyCode && this.show(), void 0;
        var b,
          c,
          d,
          e = !1;
        switch (a.keyCode) {
          ...
          case 39:
            ...
            (b = 37 == a.keyCode ? -1 : 1),
              a.ctrlKey
                ? ((c = this.moveYear(this.date, b)),
                  (d = this.moveYear(this.viewDate, b)))
                : a.shiftKey
                ? ((c = this.moveMonth(this.date, b)),
                  (d = this.moveMonth(this.viewDate, b)))
                : ((c = new Date(this.date)),
                  c.setUTCDate(this.date.getUTCDate() + b),
                  (d = new Date(this.viewDate)),
                  d.setUTCDate(this.viewDate.getUTCDate() + b)),
              this.dateWithinRange(c) &&
                ((this.date = c),
                (this.viewDate = d),
                this.setValue(),
                this.update(),
      ...
      showMode: function (a) {
        a &&
          ...
          this.picker
            .find('>div')
            .hide()
            .filter('.datepicker-' + l.modes[this.viewMode].clsName)
            .css('display', 'block'),
          this.updateNavArrows();
      },
    };
    ...
    var k = (a.fn.datepicker.dates = {
      ...
      l = {
        ...
        parseDate: function (c, d, f) {
          ...
          if (
            ('string' == typeof d && (d = l.parseFormat(d)),
            ...
            for (var m = 0; m < j.length; m++)
              switch (((g = i.exec(j[m])), (h = parseInt(g[1])), g[2])) {
                case 'd':
  ...
  (function (a) {
    'use strict';
    (a.fn.bdatepicker = a.fn.datepicker.noConflict()),
      a.fn.datepicker || (a.fn.datepicker = a.fn.bdatepicker);
    var b = function (a) {
      ...
      a.extend(b.prototype, {
        initPicker: function (b, c) {
          this.options.viewformat ||
            ...
            (this.options.datepicker = a.extend(
              {},
              c.datepicker,
              b.datepicker,
            ...
            (this.parsedViewFormat = this.dpg.parseFormat(
              this.options.viewformat,
            ));
        },
        render: function () {
          this.$input.bdatepicker(this.options.datepicker),
            this.options.clear &&
              ...
              this.$tpl
                .parent()
                .append(a('<div class="editable-clear">').append(this.$clear)));
        },
        value2html: function (a, c) {
          var d = a
            ? this.dpg.formatDate(
        ...
        autosubmit: function () {
          this.$input.on('mouseup', '.day', function (b) {
            if (
              !a(b.currentTarget).is('.old') &&
              !a(b.currentTarget).is('.new')
            ) {
        ...
        parseDate: function (a, b) {
          ...
          return (
            a &&
              ((d = this.dpg.parseDate(a, b, this.options.datepicker.language)),
              'string' == typeof a &&
                ((c = this.dpg.formatDate(
                  d,
                  b,
                  this.options.datepicker.language,
                )),
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
      a.extend(b.prototype, {
        initPicker: function (b, c) {
          this.options.viewformat ||
            (this.options.viewformat = this.options.format),
            (b.datetimepicker = a.fn.editableutils.tryParseJson(
              b.datetimepicker,
              !0,
            )),
            (this.options.datetimepicker = a.extend(
              {},
              c.datetimepicker,
              b.datetimepicker,
              { format: this.options.viewformat },
            ...
            (this.parsedFormat = this.dpg.parseFormat(
              this.options.format,
        ...
        render: function () {
          this.$input.datetimepicker(this.options.datetimepicker),
            this.$input.on('changeMode', function () {

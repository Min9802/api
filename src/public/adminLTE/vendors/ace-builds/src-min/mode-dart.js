define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        s = e('./text_highlight_rules').TextHighlightRules,
        o = function () {
          var e = 'true|false|null',
            t = 'this|super',
            n =
              'try|catch|finally|throw|rethrow|assert|break|case|continue|default|do|else|for|if|in|return|switch|while|new|deferred|async|await',
            r =
              'abstract|class|extends|external|factory|implements|get|native|operator|set|typedef|with|enum',
            s = 'static|final|const',
            o = 'void|bool|num|int|double|dynamic|var|String',
          ...
          (this.$rules = {
            start: [
              ...
              { token: ['meta.preprocessor.script.dart'], regex: '^(#!.*)$' },
              {
                ...
                regex:
                  '(?:\\b)(?:library|import|export|part|of|show|hide)(?:\\b)',
              },
              {
            ...
            qstring: [{ token: 'string', regex: "'|$", next: 'start' }].concat(
              a,
            ),
            qqstring: [{ token: 'string', regex: '"|$', next: 'start' }].concat(
              a,
            ),
          }),
            this.embedRules(i, 'doc-', [i.getEndRule('start')]);
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./c_cpp').Mode,
        s = e('./dart_highlight_rules').DartHighlightRules,

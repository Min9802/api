      ...
      (r =
        ...
        (t.Mode = i =
          (function (t) {
            function o() {
              var t;
              this.$tokenizer = new (e('../tokenizer').Tokenizer)(o.Rules);
              if ((t = e('../mode/matching_brace_outdent')))
            ...
            return (
              ...
              (i.getNextLineIndent = function (e, t, r) {
                var i, s;
                return (
                  (i = this.$getIndent(t)),
                  (s = this.$tokenizer.getLineTokens(t, e).tokens),
              ...
              (i.lineCommentStart = '#'),
              (i.blockComment = { start: '###', end: '###' }),
              (i.checkOutdent = function (e, t, n) {
                var r;
                return (r = this.$outdent) != null
                  ? r.checkOutdent(t, n)
                  : void 8;
              }),
        ...
        (i.Rules = {
          start: [
            ...
            },
            {
              ...
              regex: '(?:true|false|yes|no|on|off|null|void|undefined)' + s,
            },
            {
            ...
            },
            {
              ...
              regex: '(?:t(?:hat|il|o)|f(?:rom|allthrough)|it|by|e)' + s,
            },
          ...
          key: [
            { token: 'keyword.operator', regex: '[.?@!]+' },
            { token: 'identifier', regex: r, next: 'start' },

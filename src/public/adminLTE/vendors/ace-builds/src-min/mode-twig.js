define(
      ...
      var r = e('../lib/oop'),
        ...
        u = function () {
          ...
          var t =
            ...
            r = 'constant|divisibleby|sameas|defined|empty|even|iterable|odd',
            i = 'null|none|true|false',
            o = 'b-and|b-xor|b-or|in|is|and|or|not',
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./twig_highlight_rules').TwigHighlightRules,
        o = e('./matching_brace_outdent').MatchingBraceOutdent,
        u = function () {

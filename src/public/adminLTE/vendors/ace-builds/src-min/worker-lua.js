...
!(function (e) {
  ...
  define('ace/mode/lua/luaparse', [], function (e, t, n) {
    (function (e, n, r) {
      r(t);
      ...
      function m(e) {
        if (mt) {
          var t = vt.pop();
          t.complete(),
            n.locations && (e.loc = t.loc),
            n.ranges && (e.range = t.range);
        }
        return e;
      }
      function w(e, t, n) {
      ...
      function x(e) {
        var t = E.apply(null, g.call(arguments, 1)),
          n,
          r;
        throw (
          ('undefined' != typeof e.line
            ? ((r = e.range[0] - e.lineStart),
              (n = new SyntaxError(E('[%1:%2] %3', e.line, r, t))),
              (n.line = e.line),
              (n.index = e.range[0]),
              (n.column = r))
            : ((r = C - D + 1),
              (n = new SyntaxError(E('[%1:%2] %3', _, r, t))),
              (n.index = C),
              (n.line = _),
              (n.column = r)),
          n)
      ...
      function P() {
        H();
        while (45 === t.charCodeAt(C) && 45 === t.charCodeAt(C + 1)) X(), H();
        if (C >= r)
          return {
            type: s,
            value: '<eof>',
        ...
        switch (e) {
          ...
          case 46:
            if (Y(n)) return R();
            if (46 === n) return 46 === t.charCodeAt(C + 2) ? F() : j('..');
            return j('.');
          case 61:
            if (61 === n) return j('==');
            return j('=');
      ...
      function B() {
        ...
        return (
          ...
          nt(e)
            ...
            ? ((n = h), (e = null))
            : (n = a),
          { type: n, value: e, line: _, lineStart: D, range: [M, C] }
        );
      }
      function j(e) {
        return (
          (C += e.length),
          { type: l, value: e, line: _, lineStart: D, range: [M, C] }
        );
      }
      function F() {
        return (
          (C += 3),
          { type: p, value: '...', line: _, lineStart: D, range: [M, C] }
        );
      }
      function I() {
        var e = t.charCodeAt(C++),
        ...
        while (C < r) {
          s = t.charCodeAt(C++);
          if (e === s) break;
          if (92 === s) (i += t.slice(n, C - 1) + W()), (n = C);
          else if (C >= r || G(s))
            (i += t.slice(n, C - 1)),
              x({}, d.unfinishedString, i + String.fromCharCode(s));
        }
        return (
          (i += t.slice(n, C - 1)),
          { type: o, value: i, line: _, lineStart: D, range: [M, C] }
        );
      }
      function q() {
        var e = V();
        return (
          !1 === e && x(k, d.expected, '[', k.value),
          { type: o, value: e, line: _, lineStart: D, range: [M, C] }
        );
      }
      function R() {
        var e = t.charAt(C),
          n = t.charAt(C + 1),
          r = '0' === e && 'xX'.indexOf(n || null) >= 0 ? U() : z();
        return { type: f, value: r, line: _, lineStart: D, range: [M, C] };
      }
      function U() {
        var e = 0,
          n = 1,
          ...
          u;
        (u = C += 2),
          Z(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));
        while (Z(t.charCodeAt(C))) C++;
        i = parseInt(t.slice(u, C), 16);
        if ('.' === t.charAt(C)) {
          s = ++C;
          while (Z(t.charCodeAt(C))) C++;
          (e = t.slice(s, C)),
            (e = s === C ? 0 : parseInt(e, 16) / Math.pow(16, C - s));
        }
        if ('pP'.indexOf(t.charAt(C) || null) >= 0) {
          C++,
            '+-'.indexOf(t.charAt(C) || null) >= 0 &&
              (r = '+' === t.charAt(C++) ? 1 : -1),
            (o = C),
            Y(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));
          while (Y(t.charCodeAt(C))) C++;
      ...
      function X() {
        ...
        if (n.comments) {
          ...
          n.locations &&
            (f.loc = {
              start: { line: a, column: M - u },
              end: { line: _, column: C - D },
            }),
            n.ranges && (f.range = [M, C]),
            O.push(f);
        }
      }
      function V() {
        var e = 0,
          ...
          o;
        C++;
        while ('=' === t.charAt(C + e)) e++;
        if ('[' !== t.charAt(C + e)) return !1;
        (C += e + 1), G(t.charCodeAt(C)) && (_++, (D = C++)), (o = C);
        while (C < r) {
          (s = t.charAt(C++)), G(s.charCodeAt(0)) && (_++, (D = C));
          if (']' === s) {
            i = !0;
            for (var u = 0; u < e; u++) '=' !== t.charAt(C + u) && (i = !1);
            ']' !== t.charAt(C + e) && (i = !1);
          }
          if (i) break;
        }
      ...
      function Ct() {
        var e = k.value,
          t = Ht();
        return (
          n.scope && (t.isLabel = dt('::' + e + '::')), m(v.gotoStatement(t))
        );
      }
      function kt() {
        var e = St();
      ...
      function Mt() {
        var e = [],
          ...
          n,
          r;
        mt && ((r = vt[vt.length - 1]), vt.push(r)),
          (t = qt()),
          K('then'),
          (n = St()),
          e.push(m(v.ifClause(t, n))),
          mt && (r = gt());
        while (J('elseif'))
          wt(r),
            (t = qt()),
            K('then'),
            (n = St()),
            e.push(m(v.elseifClause(t, n))),
            mt && (r = gt());
        return (
          J('else') &&
            (mt && ((r = new yt(L)), vt.push(r)),
            (n = St()),
            e.push(m(v.elseClause(n)))),
          K('end'),
          m(v.ifStatement(e))
        );
      }
      function _t() {
        ...
        if (J('=')) {
          ...
          return (
            ...
            (t = St()),
            K('end'),
            m(v.forNumericStatement(e, r, i, s, t))
          );
        }
        var o = [e];
        while (J(',')) (e = Ht()), n.scope && ht(e), o.push(e);
        K('in');
        var u = [];
        do {
          var a = qt();
      ...
      function Dt() {
        ...
        if (a === k.type) {
          ...
          if (n.scope) for (var s = 0, o = t.length; s < o; s++) ht(t[s]);
          return m(v.localStatement(t, r));
        }
        if (J('function')) return (e = Ht()), n.scope && ht(e), Bt(e, !0);
        T('<name>', k);
      }
      function Pt() {
        var e = k,
      ...
      function Ft() {
        ...
        for (;;) {
          ...
          if (l === k.type && J('['))
            ...
            (t = qt()),
              J('=')
                ? ((n = qt()), e.push(m(v.tableKeyString(t, n))))
                : e.push(m(v.tableValue(t)));
          else {
            if (null == (n = It())) {
              vt.pop();
              break;
      ...
      function Ut(e) {
        ...
        for (;;) {
          ...
          ('^' === t || '..' === t) && s--, $();
          var o = Ut(s);
          null == o && T('<expression>', k),
            mt && vt.push(r),
            (n = m(v.binaryExpression(t, n, o)));
        }
        return n;
      }
      function zt() {
      ...
      function Wt(e) {
        ...
        else if (o === k.type) return m(v.stringCallExpression(e, Xt()));
      ...
      function Xt() {
        ...
        if (u === r && 'function' === n) return wt(i), $(), Bt(null);
        if (J('{')) return wt(i), Ft();
      }
      function Vt(s, o) {
        return (
      ...
      (yt.prototype.complete = function () {
        n.locations &&
          ((this.loc.end.line = L.line),
          (this.loc.end.column = L.range[1] - L.lineStart)),
          n.ranges && (this.range[1] = L.range[1]);
      }),
        (e.parse = Vt),
        (e.write = $t),
        (e.end = Jt);
  ...
  define('ace/mode/lua_worker', [], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),

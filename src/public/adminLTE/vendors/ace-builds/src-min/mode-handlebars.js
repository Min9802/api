define(
          ...
          (this.$rules.handlebars = [
            {
              ...
              regex: '{{!--',
              push: [
                { token: 'comment.end', regex: '--}}', next: s },
                { defaultToken: 'comment' },
              ],
            },
            {
            ...
            },
            {
              ...
              regex: '{{{',
              push: [
                { token: 'support.function', regex: '}}}', next: s },
                {
            ...
            },
            {
              ...
              regex: '{{[#\\^/&]?',
              push: [
                { token: 'storage.type.end', regex: '}}', next: s },
                {
                  token: 'variable.parameter',
                  regex: '[a-zA-Z_$][a-zA-Z0-9_$]*',
                },
  ...
  define(
    ...
    function (e, t, n) {
      'use strict';
      var r = e('../../lib/oop'),
        i = e('../behaviour/xml').XmlBehaviour,
        s = function () {
          i.call(this);
        };
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./handlebars_highlight_rules').HandlebarsHighlightRules,
        o = e('./behaviour/html').HtmlBehaviour,

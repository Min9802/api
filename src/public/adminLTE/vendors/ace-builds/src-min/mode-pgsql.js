        ...
        s = function () {
          var e =
            ...
            r = this.createKeywordMapper(
              { keyword: e, 'constant.language': t, 'support.function': n },
              'identifier',
            );
          this.$rules = {
            start: [
  ...
  define(
    ...
    function (e, t, n) {
      var r = e('../lib/oop'),
        ...
        u = e('./perl_highlight_rules').PerlHighlightRules,
        a = e('./python_highlight_rules').PythonHighlightRules,
        f = e('./json_highlight_rules').JsonHighlightRules,
      ...
      r.inherits(c, o), (t.PgsqlHighlightRules = c);
    },
  ),
  define(
    'ace/mode/pgsql',
    ...
    function (e, t, n) {
      var r = e('../lib/oop'),
        i = e('../mode/text').Mode,
        s = e('./pgsql_highlight_rules').PgsqlHighlightRules,
        o = function () {

define(
  ...
  define(
    'ace/mode/drools_highlight_rules',
    [
      'require',
      'exports',
      'module',
      ...
      var r = e('../lib/oop'),
        ...
        f = function () {
          var e =
            ...
            f = function (e) {
              return [
                { token: 'comment.block', regex: '\\*\\/', next: e },
          ...
          (this.$rules = {
            start: [].concat(
              ...
              [
                ...
                { token: ['keyword', 'text'], regex: '(when)(\\s*)' },
                {
                  token: ['keyword', 'text'],
                  regex: '(then)(\\s*)',
                  next: 'java-start',
          ...
          (this.foldingStartMarker = /\b(rule|declare|query|when|then)\b/),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              if (s) {
                var u = s.index;
                if (s[1]) {
                  var a = { row: n, column: r.length },
                    f = new o(e, a.row, a.column),
                    l = 'end',
                    c = f.getCurrentToken();
                  c.value == 'when' && (l = 'then');
                  while (c) {
                    if (c.value == l)
                      return i.fromPoints(a, {
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./drools_highlight_rules').DroolsHighlightRules,
        o = e('./folding/drools').FoldMode,
        u = function () {

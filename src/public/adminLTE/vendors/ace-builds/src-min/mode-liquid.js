define(
            ...
            this.add(
              ...
              function (e, t, n, r, i) {
                if (i == '}') {
                  ...
                  if (!f) return;
                  var h = u.getCurrentTokenRow(),
                    p = u.getCurrentTokenColumn();
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text_highlight_rules').TextHighlightRules,
        s = e('./html_highlight_rules').HtmlHighlightRules,
        o = function () {
          s.call(this);
          var e =
              'date|capitalize|downcase|upcase|first|last|join|sort|map|size|escape|escape_once|strip_html|strip_newlines|newline_to_br|replace|replace_first|truncate|truncatewords|prepend|append|minus|plus|times|divided_by|split',
            t =
              'capture|endcapture|case|endcase|when|comment|endcomment|cycle|for|endfor|in|reversed|if|endif|else|elsif|include|endinclude|unless|endunless|style|text|image|widget|plugin|marker|endmarker|tablerow|endtablerow',
            n = 'for|if|case|capture|unless|tablerow|marker|comment',
            r = 'forloop|tablerowloop',
            i = 'assign',
  ...
  define(
    ...
    function (e, t, n) {
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./html').Mode,
        o = e('./html_completions').HtmlCompletions,
        u = e('./behaviour/liquid').LiquidBehaviour,
        a = e('./liquid_highlight_rules').LiquidHighlightRules,
        f = e('./matching_brace_outdent').MatchingBraceOutdent,
        l = function () {
          (this.HighlightRules = a),
            (this.$outdent = new f()),
      ...
      r.inherits(l, i),
        function () {
          (this.blockComment = { start: '<!--', end: '-->' }),
            (this.voidElements = new s().voidElements),
            (this.getNextLineIndent = function (e, t, n) {
              var r = this.$getIndent(t),
                i = this.getTokenizer().getLineTokens(t, e),
                s = i.tokens,

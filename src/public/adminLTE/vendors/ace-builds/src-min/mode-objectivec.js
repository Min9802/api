  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        o = s.c_cppHighlightRules,
        u = function () {
          var e =
              '\\\\(?:[abefnrtv\'"?\\\\]|[0-3]\\d{1,2}|[4-7]\\d?|222|x[a-zA-Z0-9]+)',
            t = [
          ...
          this.$rules = {
            start: [
              ...
              { token: 'comment', regex: '\\/\\*', next: 'comment' },
              {
                ...
                regex:
                  '(@)(interface|protocol)(?!.+;)(\\s+[A-Za-z_][A-Za-z0-9_]*)(\\s*:\\s*)([A-Za-z]+)',
              },
          ...
          for (var u in r)
            this.$rules[u]
              ? this.$rules[u].push &&
                this.$rules[u].push.apply(this.$rules[u], r[u])
              : (this.$rules[u] = r[u]);

define(
  ...
  define(
    'ace/mode/wollok_highlight_rules',
    [
      'require',
      'exports',
      'module',
      ...
      var r = e('../lib/oop'),
        ...
        o = function () {
          var e =
            ...
            n =
              'Object|Pair|String|Boolean|Number|Integer|Double|Collection|Set|List|Exception|Range|StackTraceElement',
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./javascript').Mode,
        s = e('./wollok_highlight_rules').WollokHighlightRules,
        o = function () {

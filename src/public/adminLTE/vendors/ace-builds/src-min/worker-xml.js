...
!(function (e) {
  ...
  define('ace/mode/xml/sax', [], function (e, t, n) {
    function d() {}
        ...
        switch (e.charAt(E + 1)) {
          case '/':
            ...
            A.tagName != L &&
              ...
              r.endElement(A.uri, A.localName, L);
            if (O) for (var M in O) r.endPrefixMapping(M);
            k++;
            break;
          case '?':
            h && a(E), (k = x(e, E, r));
          ...
          default:
            try {
              ...
              !_.closed &&
                ...
                y(_, r, p),
                _.uri === 'http://www.w3.org/1999/xhtml' && !_.closed
                  ? (k = b(e, k, _.tagName, o, r))
                  : k++;
            } catch (B) {
          ...
          case '"':
            if (m === f) {
              ...
              (d = e.slice(t, v).replace(/&#?\w+;/g, r)),
                n.add(s, d, t),
                i.warning(
                  'attribute "' + s + '" missed start quot(' + g + ')!!',
                ),
                (t = v + 1),
                (m = c);
            }
    ...
    function y(e, t, n) {
      ...
      while (o--) {
        var u = e[o],
          ...
          l = a.indexOf(':');
        if (l > 0)
          var c = (u.prefix = a.slice(0, l)),
            h = a.slice(l + 1),
            p = c === 'xmlns' && h;
        else (h = a), (c = null), (p = a === 'xmlns' && '');
        (u.localName = h),
          p !== !1 &&
            (i == null && ((i = {}), E(s, (s = {}))),
            (s[p] = i[p] = f),
      ...
      while (o--) {
        ...
        var c = u.prefix;
        c &&
          (c === 'xml' && (u.uri = 'http://www.w3.org/XML/1998/namespace'),
          c !== 'xmlns' && (u.uri = s[c]));
      }
      var l = r.indexOf(':');
      l > 0
        ? ((c = e.prefix = r.slice(0, l)), (h = e.localName = r.slice(l + 1)))
        : ((c = null), (h = e.localName = r));
      var d = (e.uri = s[c || '']);
      t.startElement(d, h, r, e);
      if (e.closed) {
        t.endElement(d, h, r);
        if (i) for (c in i) t.endPrefixMapping(c);
      } else (e.currentNSMap = s), (e.localNSMap = i), n.push(e);
    }
      ...
      if (/^(?:script|textarea)$/i.test(n)) {
        ...
        if (/[&<]/.test(o))
          return /^script$/i.test(n)
            ? (i.characters(o, 0, o.length), s)
            : ((o = o.replace(/&#?\w+;/g, r)), i.characters(o, 0, o.length), s);
      }
      return t + 1;
    }
    function w(e, t, n, r) {
      ...
      switch (i) {
        ...
        default:
          ...
          if (u > 1 && /!doctype/i.test(o[0][0])) {
            var a = o[1][0],
              f = u > 3 && /^public$/i.test(o[2][0]) && o[3][0],
              l = u > 4 && o[4][0],
              c = o[u - 1];
            return (
              n.startDTD(
  ...
  define('ace/mode/xml/dom', [], function (e, t, n) {
    function r(e, t) {
      for (var n in e) t[n] = e[n];
    }
    function i(e, t) {
    ...
    function z(e, t, n) {
      var r = R(t, n);
      if (!(r >= 0)) throw new B(L, new Error());
      var i = t.length - 1;
      while (r < i) t[r] = t[++r];
      t.length = i;
      if (e) {
    ...
    function W(e) {
      this._features = {};
      if (e) for (var t in e) this._features = e[t];
    }
    function X() {}
    function V(e) {
      return (
    ...
    function Z(e, t, n) {
      ...
      (i.previousSibling = o),
        ...
        n == null ? (e.lastChild = s) : (n.previousSibling = s);
      do i.parentNode = e;
      while (i !== s && (i = i.nextSibling));
      return (
        G(e.ownerDocument || e, e),
      ...
      switch (e.nodeType) {
        case u:
          var n = e.attributes,
            ...
            h = s === e.namespaceURI;
          t.push('<', o);
          for (var y = 0; y < r; y++) dt(n.item(y), t);
          if (i || (h && !/^(?:meta|link|img|br|hr|input|button)$/i.test(o))) {
            t.push('>');
            if (h && /^script$/i.test(o)) i && t.push(i.data);
            else while (i) dt(i, t), (i = i.nextSibling);
            t.push('</', o, '>');
          } else t.push('/>');
          return;
        case v:
        case g:
          var i = e.firstChild;
          while (i) dt(i, t), (i = i.nextSibling);
          return;
        case a:
    ...
    function vt(e, t, n) {
      ...
      if (n) {
        var i = t.firstChild;
        while (i) r.appendChild(vt(e, i, n)), (i = i.nextSibling);
      }
      return r;
    }
    function mt(e, t, n) {
      ...
      switch (r.nodeType) {
        case u:
          var o = t.attributes,
            f = (r.attributes = new q()),
            l = o.length;
          f._ownerElement = r;
          for (var c = 0; c < l; c++) r.setAttributeNode(mt(e, o.item(c), !0));
          break;
        case a:
          n = !0;
      }
      if (n) {
        var h = t.firstChild;
        while (h) r.appendChild(mt(e, h, n)), (h = h.nextSibling);
      }
      return r;
    }
    function gt(e, t, n) {
    ...
    function yt(e) {
      switch (e.nodeType) {
        ...
        case 11:
          ...
          e = e.firstChild;
          while (e)
            e.nodeType !== 7 && e.nodeType !== 8 && t.push(yt(e)),
              (e = e.nextSibling);
          return t.join('');
        default:
          return e.nodeValue;
    ...
    var s = 'http://www.w3.org/1999/xhtml',
      ...
      f = (o.TEXT_NODE = 3),
      l = (o.CDATA_SECTION_NODE = 4),
      c = (o.ENTITY_REFERENCE_NODE = 5),
      h = (o.ENTITY_NODE = 6),
      ...
      y = (o.NOTATION_NODE = 12),
      b = {},
      w = {},
      E = (b.INDEX_SIZE_ERR = ((w[1] = 'Index size error'), 1)),
      S = (b.DOMSTRING_SIZE_ERR = ((w[2] = 'DOMString size error'), 2)),
      x = (b.HIERARCHY_REQUEST_ERR = ((w[3] = 'Hierarchy request error'), 3)),
      T = (b.WRONG_DOCUMENT_ERR = ((w[4] = 'Wrong document'), 4)),
      N = (b.INVALID_CHARACTER_ERR = ((w[5] = 'Invalid character'), 5)),
      C = (b.NO_DATA_ALLOWED_ERR = ((w[6] = 'No data allowed'), 6)),
      k = (b.NO_MODIFICATION_ALLOWED_ERR =
        ((w[7] = 'No modification allowed'), 7)),
      L = (b.NOT_FOUND_ERR = ((w[8] = 'Not found'), 8)),
      A = (b.NOT_SUPPORTED_ERR = ((w[9] = 'Not supported'), 9)),
      O = (b.INUSE_ATTRIBUTE_ERR = ((w[10] = 'Attribute in use'), 10)),
      M = (b.INVALID_STATE_ERR = ((w[11] = 'Invalid state'), 11)),
      _ = (b.SYNTAX_ERR = ((w[12] = 'Syntax error'), 12)),
      D = (b.INVALID_MODIFICATION_ERR = ((w[13] = 'Invalid modification'), 13)),
      P = (b.NAMESPACE_ERR = ((w[14] = 'Invalid namespace'), 14)),
      H = (b.INVALID_ACCESS_ERR = ((w[15] = 'Invalid access'), 15));
    (B.prototype = Error.prototype),
      ...
      (q.prototype = {
        ...
        setNamedItem: function (e) {
          ...
          if (t && t != this._ownerElement) throw new B(O);
      ...
      (J.prototype.getElementsByTagName = tt.prototype.getElementsByTagName),
      (J.prototype.getElementsByTagNameNS =
        tt.prototype.getElementsByTagNameNS),
      i(tt, X),
      (nt.prototype.nodeType = a),
      i(nt, X),
      (rt.prototype = {
        data: '',
      ...
      i(it, rt),
      (st.prototype = { nodeName: '#comment', nodeType: d }),
      i(st, rt),
      (ot.prototype = { nodeName: '#cdata-section', nodeType: l }),
      i(ot, rt),
      (ut.prototype.nodeType = m),
      i(ut, X),
      (at.prototype.nodeType = y),
      i(at, X),
      (ft.prototype.nodeType = h),
      i(ft, X),
      (lt.prototype.nodeType = c),
      i(lt, X),
      (ct.prototype.nodeName = '#document-fragment'),
      (ct.prototype.nodeType = g),
      i(ct, X),
      (ht.prototype.nodeType = p),
      i(ht, X),
      (pt.prototype.serializeToString = function (e) {
        var t = [];
  ...
  define('ace/mode/xml/dom-parser', [], function (e, t, n) {
    'use strict';
    function s(e) {
    ...
    function o(e, t, n) {
      function s(t) {
        ...
        if (!s)
          if (i)
            ...
            while (--o) if ((s = e[arguments[o]])) break;
          }
        r[t] =
          (s &&
            function (e) {
      ...
      return (
        ...
        s('fatalError', 'warn', 'warning', 'error'),
        r
      );
    }
    function u() {
    ...
    function c(e, t) {
      e.currentElement
        ...
        : e.document.appendChild(t);
    }
    var r = e('./sax'),
      i = e('./dom');
    return (
      (s.prototype.parseFromString = function (e, t) {
        var n = this.options,
          i = new r(),
          s = n.domBuilder || new u(),
          a = n.errorHandler,
          f = n.locator,
          l = n.xmlns || {},
          c = { lt: '<', gt: '>', amp: '&', quot: '"', apos: "'" };
        return (
          f && s.setDocumentLocator(f),
          (i.errorHandler = o(a, s, f)),
      ...
      (u.prototype = {
        ...
        startElement: function (e, t, n, r) {
          ...
          for (var u = 0; u < o; u++) {
            var e = r.getURI(u),
              f = r.getValue(u),
              n = r.getQName(u),
              l = i.createAttributeNS(e, n);
            l.getOffset && a(l.getOffset(1), l),
              (l.value = l.nodeValue = f),
        ...
        setDocumentLocator: function (e) {
          if ((this.locator = e)) e.lineNumber = 0;
        },
  ...
  define('ace/mode/xml_worker', [], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('../lib/lang'),
      s = e('../worker/mirror').Mirror,
      o = e('./xml/dom-parser').DOMParser,

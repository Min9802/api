          ...
          (this.foldingStartMarker =
            ...
            (this.latexBlock = function (e, t, n, r) {
              ...
              if (
                !a ||
                (a.type != 'storage.type' &&
                  a.type != 'constant.character.escape')
              )
                return;
              var f = a.value,
                l = i[f],
                c = function () {
                  var e = u.stepForward(),
                    t = e.type == 'lparen' ? u.stepForward().value : '';
                  return (
                    l === -1 && (u.stepBackward(), t && u.stepBackward()), t
                  );
                },
                h = [c()],
                p = l === -1 ? u.getCurrentTokenColumn() : e.getLine(t).length,
                d = t;
              u.step = l === -1 ? u.stepBackward : u.stepForward;
              while ((a = u.step())) {
                if (
                  !a ||
                  (a.type != 'storage.type' &&
                ...
                var m = c();
                if (v === l) h.unshift(m);
                else if (h.shift() !== m || !h.length) break;
              }
              if (h.length) return;
              l == 1 && (u.stepBackward(), u.stepBackward());
              if (r) return u.getCurrentTokenRange();
              var t = u.getCurrentTokenRow();
              return l === -1
                ? new s(t, e.getLine(t).length, d, p)
                : new s(d, p, t, u.getCurrentTokenColumn());
            }),
            (this.latexSection = function (e, t, n) {
              var r = new o(e, t, n),
                i = r.getCurrentToken();
              if (!i || i.type != 'storage.type') return;
              var a = u[i.value] || 0,
                f = 0,
                l = t;
              while ((i = r.stepForward())) {
                if (i.type !== 'storage.type') continue;
                var c = u[i.value] || 0;
                if (c >= 9) {
                  f || (l = r.getCurrentTokenRow() - 1), (f += c == 9 ? 1 : -1);
                  if (f < 0) break;
                } else if (c >= a) break;
              }
              f || (l = r.getCurrentTokenRow() - 1);
        ...
        function () {
          (this.type = 'text'),
            ...
            (this.getMatching = function (e, t, n) {
              ...
              if (!r) return;
              if (r.value == '\\begin' || r.value == '\\end')
                return this.foldingRules.latexBlock(e, t, n, !0);
            });
        }.call(a.prototype),
        (t.Mode = a);
    },

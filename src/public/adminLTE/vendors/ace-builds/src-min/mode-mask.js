define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      function N() {
        function t(e, t, n) {
          var r = 'js-' + e + '-',
            i = e === 'block' ? ['start'] : ['start', 'no_regex'];
          s(o, r, t, i, n);
        }
        function n() {
          s(u, 'css-block-', /\}/);
        ...
        function s(t, n, r, i, s) {
          var o = 'pop',
            u = i || ['start'];
          u.length === 0 && (u = null),
            /block|multiline/.test(n) &&
              ((o = n + 'end'), (e.$rules[o] = [k('empty', '', 'start')])),
            e.embedRules(t, n, [k(s || w, r, o)], u, u == null ? !0 : !1);
        }
        this.$rules = {
          start: [
            k('comment', '\\/\\/.*$'),
      ...
      var r = e('../lib/oop'),
        ...
        f = e('./html_highlight_rules').HtmlHighlightRules,
        l = 'keyword.support.constant.language',
        c = 'support.function.markup.bold',
        h = 'keyword',
        p = 'constant.language',
        d = 'keyword.control.markup.italic',
        v = 'support.variable.class',
        m = 'keyword.operator',
        g = 'markup.italic',
        y = 'markup.bold',
        b = 'paren.lparen',
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./mask_highlight_rules').MaskHighlightRules,

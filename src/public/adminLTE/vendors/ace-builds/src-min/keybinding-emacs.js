      ...
      function () {
        (this.enter = function (e, t) {
          ...
          (this.exit = function (e, t) {
            ...
            return (
              this.displayOriginalContent(e), r && e.moveCursorToPosition(r), !0
            );
          }),
          ...
          (this.originalToOccurPosition = function (e, t) {
            ...
            for (var i = 0; i < n.length; i++)
              if (n[i].row === t.row) return { row: i, column: t.column };
            return r;
          }),
          (this.occurToOriginalPosition = function (e, t) {
            ...
            return !n || !n[t.row]
              ? t
              : { row: n[t.row].row, column: t.column };
          }),
              ...
              var t = e.$editor,
                ...
                r =
                  n && n.cache
                    ...
                    : [];
              e.deactivate(!1),
                r.forEach(t.selection.addRange.bind(t.selection));
            },
          },
          {
            name: 'searchAsRegExp',
        ...
        function () {
          (this.attach = function (e) {
            ...
            s.call(this, t.iSearchCommands, e.commands.platform),
              (this.$commandExecHandler = e.commands.on('exec', function (t) {
    ...
    function (e, t, n) {
          ...
          (this.activate = function (e, t) {
            ...
            (this.deactivate = function (e) {
              ...
              t.keyBinding.removeKeyboardHandler(this.$keyboardHandler),
                this.$mousedownHandler &&
                  (t.off('mousedown', this.$mousedownHandler),
            ...
            (this.highlight = function (e) {
              var t = this.$editor.session,
                n = (t.$isearchHighlight =
                  t.$isearchHighlight ||
                  t.addDynamicMarker(
                    new o(null, 'ace_isearch-result', 'text'),
                  ));
            ...
            (this.cancelSearch = function (e) {
              ...
              return (
                ...
                this.highlight(null),
                i.fromPoints(this.$currentPos, this.$currentPos)
              );
            }),
            (this.highlightAndFindWithNeedle = function (e, t) {
              ...
              var r = this.$editor.session,
                s = this.find(r),
                o = this.$editor.emacsMark
                  ? !!this.$editor.emacsMark()
                  : !this.$editor.selection.isEmpty();
              return (
                s &&
                  (n.backwards && (s = i.fromPoints(s.end, s.start)),
                  this.$editor.selection.setRange(
                    i.fromPoints(o ? this.$startPos : s.end, s.end),
                  ),
                  e && (this.$currentPos = s.end),
                  this.highlight(n.re)),
            ...
            (this.next = function (e) {
              return (
                ...
                this.highlightAndFindWithNeedle(!0, function (t) {
                  return e.useCurrentOrPrevSearch && t.length === 0
                    ? this.$prevNeedle || ''
                    : t;
                })
              );
      ...
      (function () {
        this.setupIncrementalSearch = function (e, t) {
          ...
          var n = u.iSearchStartCommands,
            r = t ? 'addCommands' : 'removeCommands';
          this[r](n);
        };
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var f = function (e) {
        ...
        c = e('../lib/keys').KEY_MODS,
        h = { C: 'ctrl', S: 'shift', M: 'alt', CMD: 'command' },
        p = [
          'C-S-M-CMD',
          'S-M-CMD',
          'C-M-CMD',

define(
  ...
  define(
    'ace/mode/php_laravel_blade_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      'use strict';
      var r = e('../lib/oop'),
        i = e('./php_highlight_rules').PhpHighlightRules,
        s = function () {
          i.call(this);
          var e = {
              start: [
              ...
              directives: [
                {
                  token: [
                    ...
                    'keyword.directives.blade',
                  ],
                  regex:
                    '(@)(endunless|endisset|endempty|endauth|endguest|endcomponent|endslot|endalert|endverbatim|endsection|show|php|endphp|endpush|endprepend|endenv|endforelse|isset|empty|component|slot|alert|json|verbatim|section|auth|guest|hasSection|forelse|includeIf|includeWhen|includeFirst|each|push|stack|prepend|inject|env|elseenv|unless|yield|extends|parent|include|acfrepeater|block|can|cannot|choice|debug|elsecan|elsecannot|embed|hipchat|lang|layout|macro|macrodef|minify|partial|render|servers|set|slack|story|task|unset|wpposts|acfend|after|append|breakpoint|endafter|endcan|endcannot|endembed|endmacro|endmarkdown|endminify|endpartial|endsetup|endstory|endtask|endunless|markdown|overwrite|setup|stop|wpempty|wpend|wpquery)',
                },
                {
                  token: [
                    'directive.declaration.blade',
                  ...
                  regex:
                    '(@)(if|else|elseif|endif|foreach|endforeach|switch|case|break|default|endswitch|for|endfor|while|endwhile|continue)',
                },
                {
              ...
              lang: [
                {
                  ...
                  regex:
                    '(?:!=|!|<=|>=|<|>|===|==|=|\\+\\+|\\;|\\,|%|&&|\\|\\|)|\\b(?:and|or|eq|neq|ne|gte|gt|ge|lte|lt|le|not|mod|as)\\b',
                },
                {
              ...
              strings: [
                {
                  ...
                  push: [
                    ...
                    { token: 'string.character.escape.blade', regex: '\\\\.' },
            ...
            t = e.start;
          for (var n in this.$rules)
            this.$rules[n].unshift.apply(this.$rules[n], t);
    ...
    function (e, t, n) {
      ...
      (function () {
        (this.getCompletions = function (e, t, n, r) {
          ...
          return i.type === 'string' && /(\$[\w]*)\[["']([^'"]*)$/i.test(u)
            ? this.getArrayKeyCompletions(e, t, n, r)
            : [];
        }),
          (this.getTagCompletions = function (e, t, n, r) {
            return [
              { caption: 'php', value: 'php', meta: 'php tag', score: 1e6 },
              { caption: '=', value: '=', meta: 'php tag', score: 1e6 },
            ];
          }),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      r.inherits(g, i),
        function () {
          (this.tokenRe = new RegExp('^[' + p.wordChars + '_]+', 'g')),
      ...
      var y = function (e) {
        ...
        d.call(this),
          (this.HighlightRules = s),
          this.createModeDelegates({ 'js-': v, 'css-': m, 'php-': g }),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e(
          './php_laravel_blade_highlight_rules',
        ).PHPLaravelBladeHighlightRules,
        s = e('./php').Mode,
        o = e('./javascript').Mode,
        u = e('./css').Mode,
        a = e('./html').Mode,
        f = function () {
          s.call(this),
            ...
            this.createModeDelegates({ 'js-': o, 'css-': u, 'html-': a });
        };
      r.inherits(f, s),
        function () {

        ...
        function () {
          (this.foldingStartMarker =
            ...
            (this.luaBlock = function (e, t, n, r) {
              ...
              if (!c) return;
              var h =
                  c === -1 ? i.getCurrentTokenColumn() : e.getLine(t).length,
                p = t;
        ...
        function () {
          ...
          (this.getNextLineIndent = function (e, t, r) {
            ...
            (this.checkOutdent = function (e, n, r) {
              ...
              return !i || !i.length
                ? !1
                : i[0].type == 'keyword' && t.indexOf(i[0].value) != -1;
            }),
            (this.getMatching = function (t, n, r) {
              ...
              if (s && s.value in e)
                return this.foldingRules.luaBlock(t, n, r, !0);
            }),
            (this.autoOutdent = function (e, t, n) {
              var r = t.getLine(n),
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        o = function () {
          i.call(this);
          var e = [
              { token: 'keyword', regex: '<\\%\\=?', push: 'lua-start' },
              { token: 'keyword', regex: '<\\?lua\\=?', push: 'lua-start' },
            ],
            t = [
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./lua').Mode,
        o = e('./luapage_highlight_rules').LuaPageHighlightRules,
        u = function () {
          i.call(this),

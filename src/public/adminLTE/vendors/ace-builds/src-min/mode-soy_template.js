define(
  ...
  define(
    'ace/mode/soy_template_highlight_rules',
    [
      'require',
      'exports',
      'module',
          ...
          var e = {
            ...
            '#function': [
              {
                ...
                regex:
                  '\\b(?:isFirst|isLast|index|hasData|length|keys|round|floor|ceiling|min|max|randomInt)\\b',
              },
            ],
            '#if': [
              {
            ...
            '#print-parameter': [
              { token: 'keyword.operator.soy', regex: '\\|' },
              {
                ...
                regex:
                  'noAutoescape|id|escapeHtml|escapeJs|insertWorkBreaks|truncate',
              },
            ],
            '#special-character': [
              {
            ...
            '#template': [
              {
                ...
                push: [
                  ...
                  },
                  {
                    ...
                    regex:
                      '\\b(autoescape)(\\s*)(=)(\\s*)("true"|"false"|"contextual")',
                  },
                  {
                    token: [
                      'entity.other.attribute-name.soy',
            ...
            '#variable': [
              { token: 'variable.other.soy', regex: '\\$[\\w\\.]+' },
            ],
          };
          for (var t in e)
            this.$rules[t]
              ? this.$rules[t].unshift.apply(this.$rules[t], e[t])
              : (this.$rules[t] = e[t]);
          this.normalizeRules();
        };
      (s.metaData = {
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./soy_template_highlight_rules').SoyTemplateHighlightRules,
        o = function () {

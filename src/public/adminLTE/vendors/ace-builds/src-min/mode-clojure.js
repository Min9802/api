define(
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        var e =
          ...
          t =
            'throw try var def do fn if let loop monitor-enter monitor-exit new quote recur set!',
          n = 'true false nil',
          r = this.createKeywordMapper(
            { keyword: t, 'constant.language': n, 'support.function': e },
            'identifier',
            !1,
            ' ',
          );
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./clojure_highlight_rules').ClojureHighlightRules,
        o = e('./matching_parens_outdent').MatchingParensOutdent,
        u = function () {
          ...
          (this.lineCommentStart = ';'),
            ...
            (this.$calculateIndent = function (e, t) {
              ...
              for (;;) {
                s = e[o];
                if (s === ' ' || s === '	')
                  return this.minorIndentFunctions.indexOf(a) !== -1
                    ? this.$toIndent(e.substring(0, u - 1) + t)
                    : this.$toIndent(e.substring(0, o + 1));
                if (s === undefined)
                  return this.$toIndent(e.substring(0, u - 1) + t);
                (a += e[o]), o++;
              }
            }),

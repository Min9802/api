define(
          ...
          start: [
            {
              ...
              onMatch: function (e, t, n) {
                ...
                return (
                  f < u.length && s.push({ type: i[2], value: u.substr(f) }), s
                );
              },
            },
            {
              ...
              onMatch: function (e, t, n) {
                ...
                r[2] !== ' in' &&
                  ...
                  r[a + 1]
                    ? ((s = r[a + 1]),
                      f.push({ value: '(' + r[a + 1] + ')', type: 'text' }),
                      (a += 1))
                    : (a -= 1);
                while (a++ < r.length)
                  r[a] && f.push({ value: r[a], type: 'text' });
                u &&
                  (/regex/.test(s) || (u = i.escapeRegExp(u)),
                  /whole/.test(s) && (u = '\\b' + u + '\\b'));
                var l =
                  u && o('(' + u + ')', / sensitive/.test(s) ? 'g' : 'ig');
          ...
          (this.foldingStartMarker = /^(\S.*:|Searching for.*)$/),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              if (this.foldingStartMarker.test(s)) {
                for (var c = n + 1, h = e.getLength(); c < h; c++)
                  if (a.test(r[c])) break;
                l = c;
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./c9search_highlight_rules').C9SearchHighlightRules,
        o = e('./matching_brace_outdent').MatchingBraceOutdent,
        u = e('./folding/c9search').FoldMode,
        a = function () {

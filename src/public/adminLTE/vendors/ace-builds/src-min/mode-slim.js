define(
        ...
        (this.$rules = {
          start: [
            {
              ...
              onMatch: function (e, t, n, r) {
                var i = /^\s*/.exec(r)[0],
                  ...
                  o = s[2];
                return (
                  /^(javascript|ruby|coffee|markdown|css|scss|sass|less)$/.test(
                    o,
                  ) || (o = ''),
                  n.unshift('language-embed', [], [i, o], t),
                  this.token
                );
              },
              ...
              next: [
                {
                  ...
                  onMatch: function (e, t, n, r) {
                    ...
                    return i.length >= e.length
                      ? (n.splice(0, 3), (this.next = n.shift()), this.token)
                      : ((this.next = ''), [{ type: 'text', value: i }]);
                  },
                  next: '',
                },
                {
                  ...
                  onMatch: function (e, t, n, i) {
                    ...
                    if (r[o]) {
                      var a = r[o]
                        .getTokenizer()
                        .getLineTokens(i.slice(s.length), u.slice(0));
            ...
            { token: 'constant.begin..filter.slim', regex: '^(\\s*)(ruby):$' },
            {
            ...
            },
            {
              ...
              onMatch: function (e, t, n, r) {
                var i = /^\s*/.exec(r)[0];
                return (
                  n.length < 1 ? n.push(this.next) : (n[0] = 'mlString'),
                  n.length < 2 ? n.push(i.length) : (n[1] = i.length),
                  this.token
                );
              },
              next: 'mlString',
            },
            {
              ...
              regex: '^(\\s*)(\\-|==|=)',
              push: [
                { token: 'control.end.slim', regex: '$', next: 'pop' },
                { include: 'rubyline' },
                { include: 'misc' },
              ],
            },
          ...
          rubyline: [
            ...
            },
            {
              ...
              regex:
                '(\\b)(for|in|do|if|else|elsif|unless|while|yield|not|and|or)\\b',
            },
            { token: 'string', regex: "['](.)*?[']" },
            { token: 'string', regex: '["](.)*?["]' },
          ],
          misc: [
            ...
            { token: 'list.meta.slim', regex: '(\\b)(true|false|nil)(\\b)' },
        ...
        f = function () {
          ...
          var e = {
              ...
              onMatch: function (e, t, n, i) {
                ...
                return (
                  r[o] || (o = ''),
                  n.unshift('githubblock', [], [s[1], s[2], o], t),
                  this.token
                );
              },
              next: 'githubblock',
            ...
            t = [
              {
                ...
                onMatch: function (e, t, n, i) {
                  ...
                  if (
                    ...
                    return n.splice(0, 3), (this.next = n.shift()), this.token;
                  this.next = '';
                  if (a && r[a]) {
        ...
        function () {
          (this.foldingStartMarker = /^(?:[=-]+\s*$|#{1,6} |`{3})/),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              function l(t) {
                return (
                  (f = e.getTokens(t)[0]), f && f.type.lastIndexOf(c, 0) === 0
                );
              }
              function h() {
                var e = f.value[0];
          ...
          (this.checkOutdent = function (t, n, r) {
            ...
            (this.autoOutdent = function (e, t, n) {
              ...
              var r = this.$getIndent(t.getLine(n)),
                i = t.getTabString();
              r.slice(-i.length) == i &&
                t.remove(new o(n, r.length - i.length, n, r.length));
            }),
            (this.$id = 'ace/mode/sh'),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('./coffee_highlight_rules').CoffeeHighlightRules,
          ...
          (this.lineCommentStart = '#'),
            ...
            (this.getNextLineIndent = function (t, n, r) {
              var i = this.$getIndent(n),
                s = this.getTokenizer().getLineTokens(n, t).tokens;
              return (
        ...
        o = function () {
          ...
          e[1].token == 'comment' &&
            (e.splice(
              ...
              { token: 'support.type', regex: /^\s*:[\w\-]+\s/ },
            ),
            (this.$rules.comment = [
              {
                regex: /^\s*/,
                onMatch: function (e, t, n) {
                  return (
                    n[1] === -1 && (n[1] = Math.max(n[2], e.length - 1)),
                    e.length <= n[1]
                      ? (n.shift(),
                        n.shift(),
                        n.shift(),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./sass_highlight_rules').SassHighlightRules,
        ...
        o = function () {
          ...
          (this.$rules = {
            start: [
              ...
              {
                token: function (e, t) {
                  return n.indexOf(e.toLowerCase()) > -1
                    ? ['support.type.property', 'text']
                    : ['support.type.unknownProperty', 'text'];
                },
                regex: '([a-z0-9-_]+)(\\s*:)',
              },
              { token: 'keyword', regex: '&' },
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./less_highlight_rules').LessHighlightRules,
        o = e('./matching_brace_outdent').MatchingBraceOutdent,
        u = e('./behaviour/css').CssBehaviour,
        a = e('./css_completions').CssCompletions,
        f = e('./folding/cstyle').FoldMode,
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./slim_highlight_rules').SlimHighlightRules,
        o = function () {
          i.call(this),
            (this.HighlightRules = s),
            this.createModeDelegates({

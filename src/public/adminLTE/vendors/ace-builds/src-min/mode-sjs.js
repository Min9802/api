define(
        ...
        o = function () {
          var e = new i({ noES6: !0 }),
            ...
            r = function (e) {
              return {
                ...
                next: n(function (t, n) {
                  return (
                    n.length === 0 && n.unshift(t), n.unshift(e.next), e.next
                  );
                }),
              };
            },
          ...
          (this.$rules = e.$rules),
            (this.$rules.no_regex = [
              ...
              { token: 'variable.language', regex: '(hold|default)\\b' },
              r({ token: 'string', regex: '`', next: 'bstring' }),
            ...
            (this.$rules.block_arguments = [
              { token: 'paren.rparen', regex: '\\|', next: 'no_regex' },
          ...
          for (var u = 0; u < this.$rules.no_regex.length; u++) {
            var a = this.$rules.no_regex[u],
              f = String(a.token);
            f.indexOf('paren') == -1 &&
              (!a.next || a.next.isContextAware) &&
              o.push(a);
          }
          (this.$rules.string_interp = [
            s({ token: 'paren.rparen', regex: '\\}' }),
            r({ token: 'paren.lparen', regex: '{', next: 'string_interp' }),
          ].concat(o)),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./javascript').Mode,
        s = e('./sjs_highlight_rules').SJSHighlightRules,
        o = e('./matching_brace_outdent').MatchingBraceOutdent,

define(
  ...
  define(
    'ace/mode/elixir_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
          ...
          (this.$rules = {
            start: [
              ...
              },
              {
                ...
                regex:
                  '\\b(?:do|end|case|bc|lc|for|if|cond|unless|try|receive|fn|defmodule|defp?|defprotocol|defimpl|defrecord|defstruct|defmacrop?|defdelegate|defcallback|defmacrocallback|defexception|defoverridable|exit|after|rescue|catch|else|raise|throw|import|require|alias|use|quote|unquote|super)\\b(?![?!])',
              ...
              },
              {
                ...
                TODO: "FIXME: regexp doesn't have js equivalent",
                originalRegex:
                  '(?<!\\.)\\b(and|not|or|when|xor|in|inlist|inbits)\\b',
                comment:
              ...
              },
              {
                ...
                regex:
                  '\\b(?:0x[\\da-fA-F](?:_?[\\da-fA-F])*|\\d(?:_?\\d)*(?:\\.(?![^[:space:][:digit:]])(?:_?\\d)*)?(?:[eE][-+]?\\d(?:_?\\d)*)?|0b[01]+|0o[0-7]+)\\b',
                TODO: "FIXME: regexp doesn't have js equivalent",
                originalRegex:
                  '\\b(0x\\h(?>_?\\h)*|\\d(?>_?\\d)*(\\.(?![^[:space:][:digit:]])(?>_?\\d)*)?([eE][-+]?\\d(?>_?\\d)*)?|0b[01]+|0o[0-7]+)\\b',
              },
              {
              ...
              },
              {
                ...
                push: [
                  ...
                  {
                    defaultToken:
                      'support.function.variable.quoted.single.heredoc.elixir',
                  },
                ],
              ...
              { token: 'punctuation.separator.statement.elixir', regex: '\\;' },
      ...
      (s.metaData = {
        ...
        r.inherits(s, i),
        (t.ElixirHighlightRules = s);
    },
  ),
  define(
    'ace/mode/html_elixir_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        s = e('./elixir_highlight_rules').ElixirHighlightRules,
        o = function () {
          i.call(this);
          var e = [
              { regex: '<%%|%%>', token: 'constant.language.escape' },
              {
            ...
            t = [
              { token: 'support.elixir_tag', regex: '%>', next: 'pop' },
              { token: 'comment', regex: '#(?:[^%]|%[^>])*' },
            ];
  ...
  define(
    ...
    function (e, t, n) {
      'use strict';
      var r = e('../lib/oop'),
        i = e('./html_elixir_highlight_rules').HtmlElixirHighlightRules,
        s = e('./html').Mode,
        o = e('./javascript').Mode,
        u = e('./css').Mode,
        a = e('./elixir').Mode,
        f = function () {
          s.call(this),
            ...
            this.createModeDelegates({ 'js-': o, 'css-': u, 'elixir-': a });
        };
      r.inherits(f, s),
        function () {

define(
  'ace/mode/perl6_highlight_rules',
  [
    'require',
    'exports',
    'module',
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        var e =
          ...
          o = '[a-zA-Z_][a-zA-Z_0-9:-]*\\b',
          u = { token: 'constant.numeric', regex: '0x[0-9a-fA-F]+\\b' },
          a = {
            token: 'constant.numeric',
            regex: '[+-.]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b',
          },
          f = { token: 'constant.numeric', regex: '(?:\\d+_?\\d+)+\\b' },
          l = { token: 'constant.numeric', regex: '\\+?\\d+i\\b' },
          c = {
          ...
          p = { token: s, regex: '[a-zA-Z][\\:a-zA-Z0-9_-]*\\b' },
          d = {
            token: 'variable.language',
            regex: '[$@%&][?*!.]?[a-zA-Z0-9_-]+\\b',
          },
          v = { token: 'variable.language', regex: '\\$[/|!]?|@\\$/' },
          m = {
        ...
        this.$rules = {
          start: [
            ...
            w,
            y,
            { token: 'string.quoted.double', regex: '"', next: 'qqstring' },
            b,
            {
          ...
          qqstring: [
            ...
            d,
            v,
            { token: 'lparen', regex: '{', next: 'qqinterpolation' },
          ...
          qqinterpolation: [
            ...
            y,
            w,
            { token: 'rparen', regex: '}', next: 'qqstring' },
          ],
          block_comment: [
            {
              token: 'comment.doc',
          ...
          qheredoc: [
            { token: 'string.unquoted', regex: 'END$', next: 'start' },
            { defaultToken: 'string.unquoted' },
          ],
          qqheredoc: [
            d,
            v,
            { token: 'lparen', regex: '{', next: 'qqheredocinterpolation' },
            { token: 'string.unquoted', regex: 'END$', next: 'start' },
            { defaultToken: 'string.unquoted' },
          ],
          qqheredocinterpolation: [
            ...
            y,
            w,
            { token: 'rparen', regex: '}', next: 'qqheredoc' },
          ],
        };
      };
    r.inherits(s, i), (t.Perl6HighlightRules = s);
  },
),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./perl6_highlight_rules').Perl6HighlightRules,
      ...
      r.inherits(a, i),
        function () {
          (this.lineCommentStart = '#'),
            (this.blockComment = [
              { start: '=begin', end: '=end', lineStartOnly: !0 },
              { start: '=item', end: '=end', lineStartOnly: !0 },
            ]),

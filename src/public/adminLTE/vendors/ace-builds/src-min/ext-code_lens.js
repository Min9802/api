define('ace/ext/code_lens', [
    ...
    (e.codeLensProviders = []),
      ...
      (e.$updateLenses = function () {
        function o() {
          ...
          var u = n.documentToScreenRow(r),
            a = e.renderer.layerConfig.lineHeight,
  ...
  e('../config').defineOptions(h.prototype, 'editor', {
    ...
    o.importCssString(
      '.ace_codeLens {    position: absolute;    color: #aaa;    font-size: 88%;    background: inherit;    width: 100%;    display: flex;    align-items: flex-end;    pointer-events: none;}.ace_codeLens > a {    cursor: pointer;    pointer-events: auto;}.ace_codeLens > a:hover {    color: #0000ff;    text-decoration: underline;}.ace_dark > .ace_codeLens > a:hover {    color: #4e94ce;}',
      '',
    );
});
(function () {

define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        o = function () {
          s.call(this),
            (this.$rules.tag[2].token = function (e, t) {
          ...
          this.embedRules(
            ...
            '',
            [{ regex: '<!---', token: 'comment.start', push: 'cfmlComment' }],
            ['comment', 'start', 'tag_whitespace', 'cdata'].concat(e),
          ),
            (this.$rules.cfTag = [
              { include: 'attributes' },
              {
  ...
  define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, s),
        function () {
          (this.voidElements = r.mixin(i.arrayToMap(u), this.voidElements)),
            (this.getNextLineIndent = function (e, t, n) {
              return this.$getIndent(t);
            }),

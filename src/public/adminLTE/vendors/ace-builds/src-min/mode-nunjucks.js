define(
  ...
  define(
    'ace/mode/nunjucks_highlight_rules',
    [
      'require',
      'exports',
      'module',
            ...
            this.addRules({
              ...
              statement: [
                {
                  ...
                  regex:
                    /\b(block|endblock|extends|endif|elif|for|endfor|asyncEach|endeach|include|asyncAll|endall|macro|endmacro|set|endset|ignore missing|as|from|raw|verbatim|filter|endfilter)\b/,
                },
                { include: 'expression' },
              ],
              expression: [
                { token: 'constant.language', regex: /\b(true|false|none)\b/ },
                {
                  token: 'string',
                  regex: /"/,
                  push: [
                ...
                { token: 'support.function', regex: /[a-zA-Z_]+(?=\()/ },
              ...
              escapeStrings: [
                ...
                },
                {
                  token: 'constant.language.escape',
                  regex:
                    /\\(?:x[0-9A-F]{2}|(?:U[0-9A-Fa-f]{8})|(?:u[0-9A-Fa-f]{4})|(?:N{[a-zA-Z ]+}))/,
                },
              ],
            }),
            this.normalizeRules();
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./nunjucks_highlight_rules').NunjucksHighlightRules,
        o = function () {
          this.HighlightRules = s;
        };
      r.inherits(o, i),

...
!(function (e) {
    ...
    (function () {
      ...
      (function () {
        ...
        function PropertyValue(e, t, n) {
          SyntaxUnit.call(this, e.join(' '), t, n, Parser.PROPERTY_VALUE_TYPE),
            (this.parts = e);
        }
              ...
              n = {
                ...
                _media: function () {
                  ...
                  e.mustMatch(Tokens.RBRACE),
                    this._readWhitespace(),
                    this.fire({ type: 'endmedia', media: r, line: t, col: n });
                },
                ...
                _selectors_group: function () {
                  ...
                  if (n !== null) {
                    ...
                    while (e.match(Tokens.COMMA))
                      this._readWhitespace(),
                        (n = this._selector()),
                        n !== null ? t.push(n) : this._unexpectedToken(e.LT(1));
                  }
                ...
                _selector: function () {
                  ...
                  do {
                    ...
                    if (r !== null)
                      t.push(r),
                        (n = this._simple_selector_sequence()),
                        n === null ? this._unexpectedToken(e.LT(1)) : t.push(n);
                    else {
                ...
                _declaration: function () {
                  ...
                  if (t !== null) {
                    e.mustMatch(Tokens.COLON),
                      this._readWhitespace(),
                      (n = this._expr()),
                      (!n || n.length === 0) && this._unexpectedToken(e.LT(1)),
                      (r = this._prio()),
                      (o = t.toString());
                    if (
                ...
                _skipCruft: function () {
                  while (
                    this._tokenStream.match([Tokens.S, Tokens.CDO, Tokens.CDC])
                  );
                },
        ...
        TokenStream.prototype = mix(new TokenStreamBase(), {
          ...
          readEscape: function (e) {
            ...
            return (
              (n.length == 3 && /\s/.test(i)) || n.length == 7 || n.length == 1
                ? t.read()
                : (i = ''),
              n + i
            );
    ...
    var CSSLint = (function () {
      ...
      return (
        ...
        (r.verify = function (t, r) {
          ...
          return (
            (a = { messages: o.messages, stats: o.stats, ruleset: o.ruleset }),
    ...
    (Reporter.prototype = {
                  ...
                  r.hasOwnProperty(a) &&
                    ...
                    CSSLint.Util.indexOf(f, u.text) > -1 &&
                      ...
                      CSSLint.Util.indexOf(e[a].actual, u.text) === -1 &&
                        (e[a].actual.push(u.text), e[a].actualNodes.push(u))));
              }
              for (a in e)
      ...
      CSSLint.addRule({
        ...
        init: function (e, t) {
          function s(e, s, o) {
            i[e] &&
              (typeof r[e] != 'string' || i[e].value.toLowerCase() !== r[e]) &&
              t.report(
          ...
          e.addListener('startrule', function (e) {
            ...
            e.addListener('endstylesheet', function () {
              var e,
                i = [];
              for (e in r)
                r.hasOwnProperty(e) && r[e] > 1 && i.push(r[e] + ' ' + e + 's');
              i.length &&
                t.rollupWarn(
  ...
  define('ace/mode/css_worker', [], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),
      i = e('../lib/lang'),

define(
  ...
  define(
    'ace/mode/razor_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        o = e('./html_highlight_rules').HtmlHighlightRules,
        u = e('./csharp_highlight_rules').CSharpHighlightRules,
        a = 'razor-block-',
        f = function () {
          u.call(this);
          var e = function (e, t) {
          ...
          var n = { '{': '}', '[': ']', '(': ')' };
          (this.$rules[t] = i.deepCopy(this.$rules.start)),
      ...
      var l = function () {
        ...
        var e = {
          ...
          i = { token: '', regex: '(?=[^A-Za-z_\\.()\\[\\]])', next: 'pop' },
          s = {
            regex: '@(?=if)',
            onMatch: function (e, t, n) {
              return (
        ...
        for (var a in this.$rules)
          this.$rules[a].unshift.apply(this.$rules[a], u);
        this.embedRules(f, 'razor-block-', [n], ['start']),
          this.embedRules(f, 'razor-short-', [i], ['start']),
          this.normalizeRules();
      };
      r.inherits(l, o),
        (t.RazorHighlightRules = l),
        (t.RazorLangHighlightRules = f);
    },
  ),
  define(
    'ace/mode/razor_completions',
    ['require', 'exports', 'module', 'ace/token_iterator'],
    function (e, t, n) {
      'use strict';
      var r = e('../token_iterator').TokenIterator,
        ...
        s = ['Html', 'Model', 'Url', 'Layout'],
        o = function () {};
      (function () {
        (this.getCompletions = function (e, t, n, r) {
          if (
            e.lastIndexOf('razor-short-start') == -1 &&
            e.lastIndexOf('razor-block-start') == -1
          )
            return [];
          var i = t.getTokenAt(n.row, n.column);
          if (!i) return [];
          if (e.lastIndexOf('razor-short-start') != -1)
            return this.getShortStartCompletions(e, t, n, r);
          if (e.lastIndexOf('razor-block-start') != -1)
            return this.getKeywordCompletions(e, t, n, r);
        }),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./razor_highlight_rules').RazorHighlightRules,
        o = e('./razor_completions').RazorCompletions,
        u = e('./html_completions').HtmlCompletions,
        a = function () {
          i.call(this),
            (this.$highlightRules = new s()),
            (this.$completer = new o()),
            (this.$htmlCompleter = new u());
        };
      r.inherits(a, i),
        function () {
          (this.getCompletions = function (e, t, n, r) {
            var i = this.$completer.getCompletions(e, t, n, r),
              s = this.$htmlCompleter.getCompletions(e, t, n, r);
            return i.concat(s);
          }),
            (this.createWorker = function (e) {
              return null;

define(
  ...
  define(
    'ace/mode/html_ruby_highlight_rules',
    [
      'require',
      'exports',
      'module',
      ...
      var r = e('../lib/oop'),
        ...
        o = function () {
          ...
          var e = [
            ...
            t = [
              { token: 'support.ruby_tag', regex: '%>', next: 'pop' },
              { token: 'comment', regex: '#(?:[^%]|%[^>])*' },
            ];
  ...
  define(
    ...
    function (e, t, n) {
      'use strict';
      var r = e('../lib/oop'),
        i = e('./html_ruby_highlight_rules').HtmlRubyHighlightRules,
        s = e('./html').Mode,
        o = e('./javascript').Mode,
        u = e('./css').Mode,
        a = e('./ruby').Mode,
        f = function () {
          s.call(this),
            ...
            this.createModeDelegates({ 'js-': o, 'css-': u, 'ruby-': a });
        };
      r.inherits(f, s),
        function () {

define(
  ...
  define(
    'ace/mode/csound_orchestra_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/lang'),
        ...
        u = e('./lua_highlight_rules').LuaHighlightRules,
        ...
        f = function (e) {
            ...
            i.push(
              ...
              { token: 'support.variable.csound', regex: /\bp\d+\b/ },
              {
                ...
                onMatch: function (e, r, i, s) {
                  var o = e.split(this.splitRegex),
                    u = o[1],
                    a;
                  return (
                    t.hasOwnProperty(u)
                      ? (a = 'support.function.csound')
                      : n.hasOwnProperty(u) &&
                        (a = 'invalid.deprecated.csound'),
                    a
                      ? o[2]
                        ? [
                            { type: a, value: u },
          ...
          this.addRules({
            'macro parameter value braced string': [
              { token: 'constant.character.escape.csound', regex: /\\[#'()]/ },
              { token: 'invalid.illegal.csound.csound', regex: /[#'()]/ },
              {
                token: 'punctuation.definition.string.end.csound',
                regex: /}}/,
                next: 'macro parameter value list',
            ...
            'goto before argument': [
              this.popRule({ token: 'text.csound', regex: /,/ }),
              i,
            ],
            'goto before label': [
              { token: 'text.csound', regex: /\s+/ },
              this.comments,
              this.popRule({ token: 'entity.name.label.csound', regex: /\w+/ }),
          ...
          this.embedRules(f.getRules(), f.embeddedRulePrefix, l),
            this.embedRules(a, 'python-', l),
            this.embedRules(u, 'lua-', l),
            this.normalizeRules();
        };
  ...
  define(
    'ace/mode/csound_document_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e(
          './csound_orchestra_highlight_rules',
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./csound_document_highlight_rules').CsoundDocumentHighlightRules,
        o = function () {

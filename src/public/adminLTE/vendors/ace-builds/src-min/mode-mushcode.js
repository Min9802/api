define(
  ...
  function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        ...
        this.$rules = {
          start: [
            { token: 'variable', regex: '%[0-9]{1}' },
            { token: 'variable', regex: '%q[0-9A-Za-z]{1}' },
            { token: 'variable', regex: '%[a-zA-Z]{1}' },
    ...
    r.inherits(s, i), (t.MushCodeRules = s);
  },
),
  define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./mushcode_highlight_rules').MushCodeRules,

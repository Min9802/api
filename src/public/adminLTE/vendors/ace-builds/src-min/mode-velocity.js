define(
  ...
  define(
    'ace/mode/velocity_highlight_rules',
    [
      'require',
      'exports',
      'module',
      ...
      var r = e('../lib/oop'),
        ...
        u = function () {
          ...
          this.$rules.start.push(
            { token: 'comment', regex: '##.*$' },
            { token: 'comment.block', regex: '#\\*', next: 'vm_comment' },
            {
              token: 'string.regexp',
              regex:
                '[/](?:(?:\\[(?:\\\\]|[^\\]])+\\])|(?:\\\\/|[^\\]/]))*[/]\\w*\\s*(?=[).,;]|$)',
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./velocity_highlight_rules').VelocityHighlightRules,
        o = e('./folding/velocity').FoldMode,
        u = function () {
          i.call(this),
            (this.HighlightRules = s),

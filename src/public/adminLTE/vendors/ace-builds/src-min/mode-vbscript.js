          ...
          (this.indentKeywords = {
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              if (i || s) {
                var o = s
                  ...
                  u = o && o[1].toLowerCase();
                if (u) {
                  var a = e.getTokenAt(n, o.index + 2).type;
                  if (
                    a === 'keyword.control.asp' ||
                    a === 'storage.type.function.asp'
                  )
                    return this.vbsBlock(e, n, o.index + 2);
                }
              }
            }),
            (this.getFoldWidget = function (e, t, n) {
              var r = e.getLine(n),
                ...
                s = this.foldingStopMarker.test(r);
              if (i && !s) {
                var o = this.foldingStartMarker.exec(r),
                  u = o && o[1].toLowerCase();
                if (u) {
                  var a = e.getTokenAt(n, o.index + 2).type;
                  if (
                    ...
                    return u == 'if' && !/then\s*('|$)/i.test(r) ? '' : 'start';
                }
              }
              return '';
            }),
            (this.vbsBlock = function (e, t, n, r) {
              ...
              if (
                !a ||
                (a.type != 'keyword.control.asp' &&
                  a.type != 'storage.type.function.asp')
              )
                return;
              ...
              switch (l) {
                ...
                case 'with':
                  var d = e.getLine(t),
                    v = /^\s*If\s+.*\s+Then(?!')\s+(?!')\S/i.test(d);
                  if (v) return;
                  var m = new RegExp('(?:^|\\s)' + l, 'i'),
                    g =
                      /^\s*End\s(If|Sub|Select|Function|Class|With|Property)\s*/i.test(
                        d,
                      );
                  if (!m.test(d) && !g) return;
                  if (g) {
                  ...
                  break;
                case 'end':
                  var y = i.getCurrentTokenPosition();
                  (p = i.getCurrentTokenRange()),
                  ...
                  if (a) {
                    ...
                    if (l in u) {
                      ...
                      var b = i.getCurrentTokenPosition(),
                        w = b.column + l.length;
                      p = new s(y.row, y.column, b.row, w);
                    }
                  }
                  (i.step = i.stepBackward), i.step(), i.step();
              }
              var E = h === -1 ? e.getLine(t - 1).length : e.getLine(t).length,
                S = t,
                x = [];
              x.push(p), (i.step = h === -1 ? i.stepBackward : i.stepForward);
              while ((a = i.step())) {
                var T = null,
                  N = !1;
                if (
                ...
                switch (l) {
                  ...
                  case 'while':
                  case 'with':
                    var d = e.getLine(i.getCurrentTokenRow()),
                      v = /^\s*If\s+.*\s+Then(?!')\s+(?!')\S/i.test(d);
                    v && ((C = 0), (N = !0));
                    var m = new RegExp('^\\s* end\\s+' + l, 'i');
                    m.test(d) && ((C = 0), (N = !0));
                    break;
                  case 'elseif':
                  case 'else':
                      ...
                      case 'end':
                        ...
                        if (a) {
                          ...
                          if (l in u) {
                            ...
                            var b = i.getCurrentTokenPosition(),
                              w = b.column + l.length;
                            T = new s(y.row, y.column, b.row, w);
                          } else x.shift();
                        } else x.shift();
                        (i.step = i.stepBackward),
                          i.step(),
              ...
              if (!a) return null;
              if (r) return T ? x.push(T) : x.push(i.getCurrentTokenRange()), x;
              var t = i.getCurrentTokenRow();
              if (h === -1) {
                var w = e.getLine(t).length;
                return new s(t, w, S - 1, E);
              }
              return new s(S, E, t - 1, e.getLine(t - 1).length);
            });
        }.call(u.prototype);
    },
  ),
        ...
        function () {
          function t(e, t, n) {
            ...
            for (var i = 0; i < e.length; i++) {
              var s = e[i];
              if (
                s.type == 'keyword.control.asp' ||
                s.type == 'storage.type.function.asp'
              ) {
                ...
                if (o in n)
                  switch (o) {
                    ...
                    case 'with':
                    case 'if':
                      var u = new RegExp('^\\s* end\\s+' + o, 'i'),
                        a = /^\s*If\s+.*\s+Then(?!')\s+(?!')\S/i.test(t);
                      !a && !u.test(t) && (r += n[o]);
                      break;
                    default:
                      r += n[o];
          ...
          (this.getNextLineIndent = function (e, n, r) {
            var i = this.$getIndent(n),
              ...
              u = o.tokens;
            return (
              e == 'start' && (s = t(u, n, this.indentKeywords)),
              s > 0
                ? i + r
                : s < 0 &&
                  i.substr(i.length - r.length) == r &&
                  !this.checkOutdent(e, n, '\n')
            ...
            (this.checkOutdent = function (t, n, r) {
              ...
              return (
                (i[0].type == 'keyword.control.asp' ||
                  i[0].type == 'storage.type.function.asp') &&
                e.indexOf(s) != -1
              );
            }),
            (this.getMatching = function (e, t, n, r) {
              ...
              if (s) {
                var o = s.value.toLowerCase();
                if (o in this.indentKeywords)
                  return this.foldingRules.vbsBlock(e, t, n, r);
              }
            }),
            (this.autoOutdent = function (e, t, n) {
              ...
              o.length != i &&
                (t.replace(new u(n, 0, n, i), o),
                t.outdentRows(new u(n + 1, 0, n + 1, 0)));
            }),

define(
      ...
      s = function () {
        (this.$rules = {
          start: [
            ...
            { token: 'storage.type.function.nsis', regex: /\$\w+/ },
            {
              ...
              push: [
                ...
                { token: 'constant.character.escape.nsis', regex: /\$\\./ },
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./nsis_highlight_rules').NSISHighlightRules,

define(
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        s = function () {
          var e = 'true|false',
            t = 'with|import|if|else|then|inherit',
            n = 'let|in|rec',
          ...
          (this.$rules = {
            start: [
              ...
              { regex: '=', token: 'keyword.operator.assignment.nix' },
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./c_cpp').Mode,
        s = e('./nix_highlight_rules').NixHighlightRules,

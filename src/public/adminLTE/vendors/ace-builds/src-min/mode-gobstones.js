define(
        ...
        i = function () {
          var e = {
            ...
            r = {
              ...
              expressions:
                'nroBolitas|hayBolitas|puedeMover|siguiente|previo|opuesto|minBool|maxBool|minDir|maxDir|minColor|maxColor|primero|sinElPrimero|esVac\u00eda|boom',
          ...
          this.$rules = {
            start: [
              ...
              { token: 'string.quoted.double.gobstones', regex: n.strings },
              {
                ...
                token: this.createKeywordMapper(
                  {
                    ...
                    'keyword.control.commands.repetitions.gobstones':
                      t.commands.repetitions,
                    'keyword.control.commands.alternatives.gobstones':
                      t.commands.alternatives,
                    'keyword.control.expressions.alternatives.gobstones':
                      t.expressions.alternatives,
              ...
              { token: 'comma.gobstones', regex: ',' },
              { token: 'semicolon.gobstones', regex: ';' },
              { token: 'lparen', regex: '[[({]' },
              { token: 'rparen', regex: '[\\])}]' },
              { token: 'text', regex: '\\s+' },
            ],
  ...
  define(
    ...
    function (e, t) {
      ...
      var n = e('../lib/oop'),
        r = e('./javascript').Mode,
        i = e('./gobstones_highlight_rules').GobstonesHighlightRules,
        s = function () {
          r.call(this),

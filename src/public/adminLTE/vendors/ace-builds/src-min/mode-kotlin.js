define(
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        (this.$rules = {
          ...
          '#classes': [
            {
              ...
              push: [
                { token: 'text', regex: /}|(?=$)/, next: 'pop' },
                {
                  ...
                  push: [
                    { token: 'text', regex: /(?=<|{|\(|:)/, next: 'pop' },
                    { token: 'keyword.other.kotlin', regex: /\bobject\b/ },
                    { token: 'entity.name.type.class.kotlin', regex: /\w+/ },
                  ],
                },
                {
                  token: 'text',
          ...
          '#getters-and-setters': [
            {
              ...
              regex: /\b(get)\b(\s*\(\s*\))/,
              push: [
                { token: 'text', regex: /\}|(?=\bset\b)|$/, next: 'pop' },
                {
                  token: 'keyword.operator.assignment.kotlin',
                  regex: /=/,
                  push: [
            ...
            },
            {
              ...
              regex: /\b(set)\b(\s*)(?=\()/,
              push: [
                { token: 'text', regex: /\}|(?=\bget\b)|$/, next: 'pop' },
                {
                  token: 'text',
                  regex: /\(/,
                  push: [
          ...
          '#namespaces': [
            { token: 'keyword.other.kotlin', regex: /\bnamespace\b/ },
            {
              token: 'text',
              regex: /\{/,
              push: [
          ...
          '#parameters': [
            ...
            { include: '#keywords' },
            { token: 'variable.parameter.function.kotlin', regex: /\w+/ },
          ],
          '#statements': [
            { include: '#namespaces' },
            { include: '#typedefs' },
          ...
          '#typedefs': [
            {
              ...
              push: [
                { token: 'text', regex: /(?=$)/, next: 'pop' },
                { token: 'keyword.other.kotlin', regex: /\btype\b/ },
                {
                  token: 'text',
                  regex: /</,
                  push: [
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./kotlin_highlight_rules').KotlinHighlightRules,

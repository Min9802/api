define(
  ...
  define(
    'ace/mode/visualforce_highlight_rules',
    [
      'require',
      'exports',
      'module',
    ...
    function (e, t, n) {
      ...
      function s(e) {
        return {
          ...
          regex: e.start,
          push: [
            { token: 'constant.language.escape', regex: e.escape },
            { token: e.token + '.end', regex: e.start, next: 'pop' },
            { defaultToken: e.token },
          ],
        };
      }
      var r = e('../lib/oop'),
        i = e('../mode/html_highlight_rules').HtmlHighlightRules,
        o = function () {
          var e = this.createKeywordMapper(
            {
              'variable.language':
                '$Action|$Api|$Component|$ComponentLabel|$CurrentPage|$FieldSet|$Label|$Label|$ObjectType|$Organization|$Page|$Permission|$Profile|$Resource|$SControl|$Setup|$Site|$System.OriginDateTime|$User|$UserRole|Site|UITheme|UIThemeDisplayed',
              keyword: '',
              'storage.type': '',
              'constant.language': 'true|false|null|TRUE|FALSE|NULL',
              'support.function':
                'DATE|DATEVALUE|DATETIMEVALUE|DAY|MONTH|NOW|TODAY|YEAR|BLANKVALUE|ISBLANK|NULLVALUE|PRIORVALUE|AND|CASE|IF|ISCHANGED|ISNEW|ISNUMBER|NOT|OR|ABS|CEILING|EXP|FLOOR|LN|LOG|MAX|MIN|MOD|ROUND|SQRT|BEGINS|BR|CASESAFEID|CONTAINS|FIND|GETSESSIONID|HTMLENCODE|ISPICKVAL|JSENCODE|JSINHTMLENCODE|LEFT|LEN|LOWER|LPAD|MID|RIGHT|RPAD|SUBSTITUTE|TEXT|TRIM|UPPER|URLENCODE|VALUE|GETRECORDIDS|INCLUDE|LINKTO|REGEX|REQUIRESCRIPT|URLFOR|VLOOKUP|HTMLENCODE|JSENCODE|JSINHTMLENCODE|URLENCODE',
            },
            'identifier',
          );
          i.call(this);
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./html').Mode,
        s = e('./visualforce_highlight_rules').VisualforceHighlightRules,
        o = e('./behaviour/xml').XmlBehaviour,
        u = e('./folding/html').FoldMode;
      r.inherits(a, i),
        (a.prototype.emmetConfig = { profile: 'xhtml' }),
        (t.Mode = a);
    },
  );
(function () {

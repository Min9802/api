define(
  ...
  function (e, t, n) {
    ...
    var r = e('../lib/oop'),
      ...
      s = function () {
        var e =
            'and|as|assert|begin|class|constraint|do|done|downto|else|end|exception|external|for|fun|function|functor|if|in|include|inherit|initializer|lazy|let|match|method|module|mutable|new|object|of|open|or|private|rec|sig|struct|then|to|try|type|val|virtual|when|while|with',
          t = 'true|false',
          n =
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        i = e('./text').Mode,
        s = e('./ocaml_highlight_rules').OcamlHighlightRules,
      ...
      (function () {
        (this.toggleCommentLines = function (e, t, n, r) {
          ...
          (this.getNextLineIndent = function (e, t, n) {
            ...
            return (
              (!i.length || i[i.length - 1].type !== 'comment') &&
                e === 'start' &&
                f.test(t) &&
                (r += n),
              r

...
!(function (e) {
  ...
  define('ace/mode/json/json_parse', [], function (e, t, n) {
    'use strict';
    var r,
      i,
      s = {
      ...
      a = function (e) {
        return (
          e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"),
          (i = o.charAt(r)),
          (r += 1),
          i
        );
          ...
          typeof t == 'function'
            ? (function s(e, n) {
                ...
                if (o && typeof o == 'object')
                  for (r in o)
                    Object.hasOwnProperty.call(o, r) &&
                      ((i = s(o, r)),
                      i !== undefined ? (o[r] = i) : delete o[r]);
                return t.call(e, n, o);
              })({ '': n }, '')
            : n
        );
  ...
  define('ace/mode/json_worker', [], function (e, t, n) {
    'use strict';
    var r = e('../lib/oop'),

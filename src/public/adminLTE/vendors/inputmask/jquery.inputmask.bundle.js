          ...
          function resolveTestFromToken(
            ...
            function handleMatch(match, loopNdx, quantifierRecurse) {
              function isFirstMatch(latestMatch, tokenGroup) {
                var firstMatch =
                  $.inArray(latestMatch, tokenGroup.matches) === 0;
                if (!firstMatch) {
            ...
            while (
              ...
              if (!isValidRslt) {
                ...
                if (getMaskSet().excludes[decisionPos]) {
                  ...
                  if (
                    getMaskSet().excludes[decisionPos].indexOf(
                      decisionTaker,
                    ) !== -1
                  ) {
        ...
        function trackbackPositions(originalPos, newPos, fillOnly) {
          ...
          for (var ps = originalPos; ps < newPos; ps++) {
            if (
              ...
              var vp =
                ps == 0 ? getTest(ps) : getMaskSet().validPositions[ps - 1];
              if (vp) {
            ...
            if (
              ...
              if (k) {
                ...
                if (opts._radixDance && opts.numericInput) {
                  var caretPos =
                    getBuffer().indexOf(opts.radixPoint.charAt(0)) + 1;
        ...
        numeric: {
          mask: function mask(opts) {
            ...
            if (opts.autoGroup) {
              ...
              if (isFinite(opts.integerDigits)) {
                ...
                opts.integerDigits =
                  parseInt(opts.integerDigits) + (mod === 0 ? seps - 1 : seps);
          ...
          postValidation: function postValidation(
            ...
            function buildPostMask(buffer, opts) {
              var postMask = '';
              postMask +=
                '(' + opts.groupSeparator + '*{' + opts.groupSize + '}){*}';
              if (opts.radixPoint !== '') {
            ...
            if (charAtPos !== undefined) {
              if (
                ...
                if (
                  ...
                  caretPos <
                    opts.prefix.length - 1 + (opts.isNegative === false ? 1 : 0)
                ) {
          ...
          onBeforeMask: function onBeforeMask(initialValue, opts) {
            ...
            if (
              opts.digits === 0 &&
              initialValue.indexOf(Inputmask.escapeRegex(radixPoint)) !== -1
            ) {
      ...
      if ($.fn.inputmask === undefined) {
        $.fn.inputmask = function (fn, options) {
          ...
          if (typeof fn === 'string') {
            ...
            (typeof fn === 'undefined' ? 'undefined' : _typeof(fn)) == 'object'
          ) {
